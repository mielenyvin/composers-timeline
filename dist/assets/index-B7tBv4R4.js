...
`).trim(),ke&&(x[$e]=ke)}),Se=[],ke=null,q=null};for(const Ce of d){const $e=Ce.match(/^##\s+(.+?)\s+essentials(?:\s*\((\w{2})\))?(?:\s*\{#([a-z0-9_-]+)\})?/i);if($e){Ae();const[,te,Me,Ye]=$e;D=Be(Ye||te),q=Be(te),Te=(Me||"en").toLowerCase(),ke=Ye||null;continue}const un=D?Ce.match(/^name\s*(?:\((\w{2})\))?\s*:\s*(.+)$/i):null;if(un){const[,te,Me]=un,Ye=(te||Te||"en").toLowerCase(),Pe=Me.trim();[D,q].filter(Boolean).forEach(ns=>{v[ns]=v[ns]||{},v[ns][Ye]=Pe});continue}D&&Ce.startsWith("- ")&&Se.push(Ce.replace(/^- /,"").trim())}return Ae(),{descriptionsByLocale:m,playlistIdsByKey:x,namesByLocale:v}}function el(o){const d=il(o),m=Be(o),v=K.value[m];if(v)return v;const x=d[r.value];return x||(d.en?d.en:Object.values(d)[0]||"")}function nl(o){const d=Y.value[Be(o)];return d||rl(o)}function tl(o,d){const m=Be(d);if(o[m])return o[m];const v=m.split(" ").filter(Boolean),x=v[v.length-1];return x&&o[x]?o[x]:""}function il(o){const d=Be(o),m=d.split(" ").filter(Boolean),v=[d],x=m[m.length-1];x&&x!==d&&v.push(x);for(const D of v)if(tr[D])return tr[D];return{}}function sl(o){return Be(o).replace(/\s+/g,"-").replace(/-+/g,"-")}function rl(o){const d=s[r.value]||s.en,m=r.value==="ru"?Yi(o):"";if(r.value==="ru"&&m)return`${m} - ${d}`;const v=String(o||"").trim().split(/\s+/).filter(Boolean);if(!v.length)return"";const x=v[v.length-1];return`${/^(?:[IVX]+|\d+|Jr\.?|Sr\.?)$/i.test(x)&&v.length>=2?v[v.length-2]:x} ${d}`}function ol(o){const d=[],m=sl(o);m&&!d.includes(m)&&d.push(m);const v=tl(ja,o);return v&&!d.includes(v)&&d.push(v),d}function ii(o=window.location.pathname){if(o.startsWith(mi)){de.value="composers";return}de.value=o==="/about"?"about":"composers"}const cr=()=>ar();function ur(o){window.location.pathname!==o&&(history.pushState({},"",o),ii(o)),Z.value=!1}function dr(o){ur(o==="about"?"/about":"/")}function al(){Z.value=!Z.value}function ll(){Z.value=!1}function hr(o){b.value!==o&&(b.value=o)}function cl(){hr(!b.value)}function si(){if(typeof document>"u")return 0;const o=document.querySelector(".topbar");return o&&o.offsetHeight?o.offsetHeight:0}function On(){if(typeof window>"u")return{width:0,height:0,offsetLeft:0,offsetTop:0};const o=window.visualViewport;return o?{width:o.width,height:o.height,offsetLeft:o.offsetLeft||0,offsetTop:o.offsetTop||0}:{width:window.innerWidth,height:window.innerHeight,offsetLeft:0,offsetTop:0}}function Dn(o){const d=Re.value;if(!d||typeof window>"u")return o;const{width:m,offsetLeft:v}=On(),x=v+We,D=Math.max(x,v+m-d.offsetWidth-We);return Math.min(Math.max(o,x),D)}function Sn(o){const d=Re.value;if(!d||typeof window>"u")return o;const{height:m,offsetTop:v}=On(),x=Math.max(si()+We,v+We),D=Math.max(x,v+m-d.offsetHeight-We);return Math.min(Math.max(o,x),D)}function ht(){const o=Re.value;if(u.value==null&&o&&typeof window<"u"){const{height:d,offsetTop:m}=On();u.value=Sn(m+d-o.offsetHeight-24)}cn.value=Dn(cn.value),u.value!=null&&(u.value=Sn(u.value))}function Zi(){ht(),y.value="top-right";const d=Re.value?.offsetWidth||0,{width:m,offsetLeft:v,offsetTop:x}=On();cn.value=Dn(v+m-d-We);const D=si()+ys+ws;u.value=Sn(x+D)}function Mt(){ht(),y.value="bottom-left";const d=Re.value?.offsetHeight||0,{height:m,offsetTop:v}=On();cn.value=Dn(We),u.value=Sn(v+m-d-We)}function fr(){ht(),y.value="top-left";const{offsetTop:o}=On(),d=si()+ys+ws;cn.value=Dn(We),u.value=Sn(o+d)}function mr(){ht(),y.value="bottom-right";const o=Re.value,d=o?.offsetWidth||0,m=o?.offsetHeight||0,{width:v,height:x,offsetLeft:D,offsetTop:q}=On();cn.value=Dn(D+v-d-We),u.value=Sn(q+x-m-We)}function ul(){const o=Re.value;if(!o)return;const{width:d,height:m,offsetLeft:v,offsetTop:x}=On(),D=si()+ys+ws,q=Dn(We),ke=Dn(v+d-o.offsetWidth-We),Te=Sn(x+D),Se=Sn(x+m-o.offsetHeight-We),Ae=cn.value,Ce=u.value??0,$e=[{anchor:"top-left",dx:Ae-q,dy:Ce-Te},{anchor:"top-right",dx:Ae-ke,dy:Ce-Te},{anchor:"bottom-left",dx:Ae-q,dy:Ce-Se},{anchor:"bottom-right",dx:Ae-ke,dy:Ce-Se}];$e.sort((te,Me)=>te.dx*te.dx+te.dy*te.dy-(Me.dx*Me.dx+Me.dy*Me.dy));const un=$e[0]?.anchor;if(un==="top-left"){fr();return}if(un==="top-right"){Zi();return}if(un==="bottom-left"){Mt();return}mr()}function pr(o){if(!_.active||o.pointerId!==_.pointerId)return;o.preventDefault();const d=o.clientX-_.startX,m=o.clientY-_.startY;cn.value=Dn(_.startLeft+d),u.value!=null&&(u.value=Sn(_.startTop+m))}function gr(){window.removeEventListener("pointermove",pr),window.removeEventListener("pointerup",ri),window.removeEventListener("pointercancel",ri)}function br(o){const d=_.element;if(_.active=!1,_.element=null,_.pointerId=null,d?.releasePointerCapture&&o!=null)try{d.releasePointerCapture(o)}catch{}}function ri(o){!_.active||o.pointerId!==_.pointerId||(gr(),br(o.pointerId),ul())}function dl(){_.active&&(gr(),br(_.pointerId))}function hl(o){const d=o.timeStamp||Date.now();d-f<=uf&&o.preventDefault(),f=d}function fl(o){if(_.active||o.pointerType==="mouse"&&o.button!==0)return;const d=o.target;if(d&&typeof d.closest=="function"&&d.closest("button, a, input, select, textarea, label, [role='button'], .filter-panel"))return;ht(),y.value="free",o.preventDefault(),_.active=!0,_.pointerId=o.pointerId,_.startX=o.clientX,_.startY=o.clientY,_.startLeft=cn.value,_.startTop=u.value??0,_.element=Re.value;const v=Re.value;if(v?.setPointerCapture)try{v.setPointerCapture(o.pointerId)}catch{}window.addEventListener("pointermove",pr),window.addEventListener("pointerup",ri),window.addEventListener("pointercancel",ri)}function vr(o){!o||!o.touches||o.touches.length===2&&(C.active=!0,C.startDistance=k(o.touches[0],o.touches[1]))}function yr(o){if(!C.active||!o||!o.touches||o.touches.length!==2)return;o.preventDefault();const d=k(o.touches[0],o.touches[1]),m=C.startDistance||d,v=m?d/m:1;if(v>=ff){ze(1),C.startDistance=d;return}v<=hf&&(ze(-1),C.startDistance=d)}function oi(o){(o?.touches?.length??0)<2&&(C.active=!1,C.startDistance=0)}function wr(){w()&&!b.value&&hr(!0)}function kr(){Mt()}function ml(){_n()}function _n(){if(y.value==="top-left"){fr();return}if(y.value==="top-right"){Zi();return}if(y.value==="bottom-right"){mr();return}if(y.value==="bottom-left"){Mt();return}ht()}function xt(o,{persist:d=!1}={}){const m=t.includes(o)?o:pt;if(r.value=m,d)try{localStorage.setItem(So,m),localStorage.setItem(_o,"1")}catch{}}function pl(o){i.value=!0,xt(o,{persist:!0})}function gl(o){const d=o?.target?.value;d&&pl(d)}function bl(){try{return localStorage.getItem(So)}catch{return null}}function vl(){try{const o=localStorage.getItem(To);return o?dt(JSON.parse(o)):null}catch{return null}}function yl(){const o=vl();o&&(nn.value=o)}function wl(){try{return localStorage.getItem(_o)==="1"}catch{return!1}}function kl(){const o=bl(),d=wl();if(xt(pt),o&&d&&t.includes(o)){i.value=!0,xt(o);return}Sl()}async function Sl(){const o=!i.value;o||(r.value,void 0);const d=[_l,Tl];for(const m of d){const v=await m();if(v){const x=String(v).toUpperCase();if(!o)return;const D=x==="RU"?"ru":["DE","AT","CH"].includes(x)?"de":pt;xt(D);return}}o&&xt(pt)}async function _l(){try{const o=await fetch("https://ipapi.co/json/");return o.ok&&(await o.json())?.country_code||null}catch(o){console.warn("ipapi lookup failed:",o)}return null}async function Tl(){try{const o=await fetch("https://ipwho.is/");return o.ok&&(await o.json())?.country_code||null}catch(o){console.warn("ipwho.is lookup failed:",o)}return null}function vf(o,d){}function Sr(){ur("/"),window.timeline&&typeof window.timeline.goToStart=="function"&&window.timeline.goToStart()}function Qi(o){const d=o.detail,m=d?.laneIndex;if(Number.isInteger(m)&&Ue.value[m]){we.value=m;return}const v=d?.composer?.name;if(!v)return;const x=Ue.value.findIndex(D=>D.name===v);x>=0&&(we.value=x)}function _r(){we.value=null}function Tr(){!qi.value||we.value===null||(we.value-=1)}function Cr(){!Xi.value||we.value===null||(we.value+=1)}Ki(async()=>{kl(),yl(),await ar(),await vn(),Mt(),typeof ResizeObserver<"u"&&(S=new ResizeObserver(ml),Re.value&&S.observe(Re.value)),window.timeline&&typeof window.timeline.onBarClick=="function"&&window.timeline.onBarClick(Qi),window.addEventListener("popstate",cr),window.addEventListener("composer-select",Qi),window.addEventListener("resize",_n),window.visualViewport&&(window.visualViewport.addEventListener("resize",_n),window.visualViewport.addEventListener("scroll",_n)),_n();const o=document.getElementById("timeline");o&&(o.addEventListener("scroll",_e,{passive:!0}),o.addEventListener("timeline-pan-start",wr),o.addEventListener("touchstart",vr,{passive:!0}),o.addEventListener("touchmove",yr,{passive:!1}),o.addEventListener("touchend",oi,{passive:!0}),o.addEventListener("touchcancel",oi,{passive:!0}),_e())}),ji(()=>{window.removeEventListener("popstate",cr),window.removeEventListener("composer-select",Qi),window.removeEventListener("resize",_n),window.visualViewport&&(window.visualViewport.removeEventListener("resize",_n),window.visualViewport.removeEventListener("scroll",_n)),S&&(S.disconnect(),S=null),dl(),Xn&&(clearTimeout(Xn),Xn=null);const o=document.getElementById("timeline");o&&(o.removeEventListener("scroll",_e),o.removeEventListener("timeline-pan-start",wr),o.removeEventListener("touchstart",vr),o.removeEventListener("touchmove",yr),o.removeEventListener("touchend",oi),o.removeEventListener("touchcancel",oi))}),qe(h,o=>{o&&(document.title=o)},{immediate:!0}),qe(nn,o=>{try{localStorage.setItem(To,JSON.stringify(o))}catch{}},{deep:!0}),qe(r,async o=>{const d=t.includes(o)?o:pt;if(d!==o){r.value=d;return}try{document.documentElement.setAttribute("data-lang",d)}catch{}window.timeline&&typeof window.timeline.updateEraLabels=="function"&&window.timeline.updateEraLabels(ce.value),await vn(),_n()}),qe(Ji,async o=>{o?(document.documentElement.style.overscrollBehavior="none",document.body.style.overscrollBehavior="none",document.body.style.overflow="hidden",document.body.style.touchAction="none",await vn(),Yn.value.length&&Lr()):(document.documentElement.style.overscrollBehavior="",document.body.style.overscrollBehavior="",document.body.style.overflow="",document.body.style.touchAction="",Er())}),qe(we,o=>{const d=window.timeline;!d||typeof d.setSelectedLane!="function"||(Number.isInteger(o)?d.setSelectedLane(o):d.setSelectedLane(null))}),qe(we,o=>{if($i.value)return;if(Number.isInteger(o)&&Ue.value[o]){const m=Ue.value[o].name,v=or(m);window.location.pathname!==v&&(history.pushState({},"",v),ii(v));return}const d=de.value==="about"?"/about":"/";window.location.pathname!==d&&(history.replaceState({},"",d),ii(d))}),qe(Yn,async o=>{Ji.value&&(Er(),await vn(),o.length&&Lr())}),qe(()=>Ue.value.map(o=>o.name),o=>{if(we.value===null)return;const d=Le.value;if(!d){we.value=null;return}const m=o.findIndex(v=>v===d.name);m===-1?we.value=null:we.value=m});function es(o){return o?J?J.endsWith("/")&&o.startsWith("/")?J+o.slice(1):!J.endsWith("/")&&!o.startsWith("/")?`${J}/${o}`:J+o:o:J}function Cl(o){if(!o)return"";const d=en;if(!d)return"";const m=d.endsWith("/");return`${d}${m?"":"/"}${o}`}function Er(){ve.forEach(o=>{try{o.pause(),o.currentTime=0}catch(d){console.error("Failed to stop SoundCloud audio",d)}}),ve.clear()}function Lr(o,d=document){const v=(d||document).querySelectorAll("[data-soundcloud-playlist]");v.length&&(v.length,v.forEach(x=>{El(x,()=>{})}))}async function El(o,d){const m=()=>{typeof d=="function"&&setTimeout(()=>d(),0)};if(!o||o.dataset.soundcloudReady==="true"||o.dataset.soundcloudReady==="loading"||o.dataset.soundcloudReady==="error"){m();return}const v=o.getAttribute("data-soundcloud-playlist"),x=o.getAttribute("data-soundcloud-playlist-alt")||"",D=[v,...x.split("|")].map(Te=>(Te||"").trim()).filter(Boolean);if(!D.length){m();return}o.dataset.soundcloudReady="loading",o.innerHTML=Ll();let q=null;for(const Te of D)try{const Se=await xl(Te),Ae=Array.isArray(Se.tracks)&&Se.tracks.length?Se.tracks:Se&&Se.kind==="track"?[Se]:[],Ce=zl(Ae);Pl(o,Ce,Te),m();return}catch(Se){if(q=Se,Se&&Se.status===429){Mr(o,Te),m();return}}console.error("Failed to build SoundCloud player",q);const ke=D[0]||ne;Mr(o,ke),m()}function Ll(){return`
  ...
  `.trim()}async function Ml(o){if(!o)throw new Error("No track provided");const d=o.media&&Array.isArray(o.media.transcodings)?o.media.transcodings:[];if(d.length){let m=d.find(v=>v&&v.format&&v.format.protocol==="progressive");if(m||(m=d[0]),m&&m.url)try{const v=await Rl(m.url,o.track_authorization);return console.debug("[SC] Using transcoding URL",{trackId:o.id,transcodingUrl:m.url,finalUrl:v}),v}catch(v){console.error("[SC] Transcoding proxy failed, falling back to streams endpoint",v)}}if(!o.id)throw new Error("No track id provided");return Al(o.id,o.track_authorization)}async function xl(o){const d=es("/api/soundcloud/playlist")+`?url=${encodeURIComponent(o)}`,m=await fetch(d);if(!m.ok){const v=new Error(`SoundCloud playlist error: ${m.status}`);throw v.status=m.status,v.retryAfter=Number(m.headers?.get("Retry-After"))||void 0,v}return m.json()}function zl(o=[]){return Array.isArray(o)?o.map((d,m)=>{if(!d)return null;const v=`Track ${m+1}`,D=[d.title,d.publisher_metadata?.release_title,d.permalink,d.permalink_url,d.id?String(d.id):null].map(q=>typeof q=="string"?q.trim():"").filter(Boolean)[0]||v;return{...d,title:D}}).filter(Boolean):[]}async function Rl(o,d){const m=new URLSearchParams;m.set("url",o),d&&m.set("track_authorization",d),l.value&&m.set("proxy","1");const v=es("/api/soundcloud/transcoding")+`?${m.toString()}`,x=await fetch(v);if(!x.ok){const q=new Error(`SoundCloud transcoding error: ${x.status}`);throw q.status=x.status,q.retryAfter=Number(x.headers?.get("Retry-After"))||void 0,q}const D=await x.json();if(!D?.url)throw new Error("Transcoding response missing url");return D.url}async function Al(o,d){const m=new URLSearchParams;d&&m.set("track_authorization",d),l.value&&m.set("proxy","1");const v=m.toString(),x=es(`/api/soundcloud/streams/${o}`)+(v?`?${v}`:""),D=await fetch(x);if(!D.ok){const ke=new Error(`SoundCloud stream error: ${D.status}`);throw ke.status=D.status,ke.retryAfter=Number(D.headers?.get("Retry-After"))||void 0,ke}const q=await D.json();if(!q?.url)throw new Error("Stream response missing url");return q.url}function Mr(o,d){const m=`https://w.soundcloud.com/player/?url=${encodeURIComponent(d)}&auto_play=false&show_user=false&hide_related=true&show_comments=false&show_reposts=false&show_teaser=false&show_playcount=false&sharing=false&show_artwork=false&buying=false&liking=false&download=false&visual=false`;o.innerHTML=`
    <iframe
      show_user="false"
