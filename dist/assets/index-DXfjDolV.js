(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();function Os(e){const n=Object.create(null);for(const t of e.split(","))n[t]=1;return t=>t in n}const fe={},bt=[],wn=()=>{},Lo=()=>!1,Fi=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Ds=e=>e.startsWith("onUpdate:"),Ie=Object.assign,Ns=(e,n)=>{const t=e.indexOf(n);t>-1&&e.splice(t,1)},Il=Object.prototype.hasOwnProperty,ae=(e,n)=>Il.call(e,n),N=Array.isArray,vt=e=>qt(e)==="[object Map]",Ct=e=>qt(e)==="[object Set]",xr=e=>qt(e)==="[object Date]",G=e=>typeof e=="function",Ee=e=>typeof e=="string",kn=e=>typeof e=="symbol",he=e=>e!==null&&typeof e=="object",xo=e=>(he(e)||G(e))&&G(e.then)&&G(e.catch),zo=Object.prototype.toString,qt=e=>zo.call(e),Hl=e=>qt(e).slice(8,-1),Ao=e=>qt(e)==="[object Object]",Bs=e=>Ee(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,Ft=Os(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Ii=e=>{const n=Object.create(null);return(t=>n[t]||(n[t]=e(t)))},Ol=/-\w/g,$n=Ii(e=>e.replace(Ol,n=>n.slice(1).toUpperCase())),Dl=/\B([A-Z])/g,ct=Ii(e=>e.replace(Dl,"-$1").toLowerCase()),Ro=Ii(e=>e.charAt(0).toUpperCase()+e.slice(1)),ts=Ii(e=>e?`on${Ro(e)}`:""),Un=(e,n)=>!Object.is(e,n),vi=(e,...n)=>{for(let t=0;t<e.length;t++)e[t](...n)},Po=(e,n,t,i=!1)=>{Object.defineProperty(e,n,{configurable:!0,enumerable:!1,writable:i,value:t})},Fo=e=>{const n=parseFloat(e);return isNaN(n)?e:n},Nl=e=>{const n=Ee(e)?Number(e):NaN;return isNaN(n)?e:n};let zr;const Hi=()=>zr||(zr=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Oi(e){if(N(e)){const n={};for(let t=0;t<e.length;t++){const i=e[t],s=Ee(i)?jl(i):Oi(i);if(s)for(const r in s)n[r]=s[r]}return n}else if(Ee(e)||he(e))return e}const Bl=/;(?![^(]*\))/g,Wl=/:([^]+)/,Kl=/\/\*[^]*?\*\//g;function jl(e){const n={};return e.replace(Kl,"").split(Bl).forEach(t=>{if(t){const i=t.split(Wl);i.length>1&&(n[i[0].trim()]=i[1].trim())}}),n}function yt(e){let n="";if(Ee(e))n=e;else if(N(e))for(let t=0;t<e.length;t++){const i=yt(e[t]);i&&(n+=i+" ")}else if(he(e))for(const t in e)e[t]&&(n+=t+" ");return n.trim()}const Vl="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Gl=Os(Vl);function Io(e){return!!e||e===""}function Ul(e,n){if(e.length!==n.length)return!1;let t=!0;for(let i=0;t&&i<e.length;i++)t=Xt(e[i],n[i]);return t}function Xt(e,n){if(e===n)return!0;let t=xr(e),i=xr(n);if(t||i)return t&&i?e.getTime()===n.getTime():!1;if(t=kn(e),i=kn(n),t||i)return e===n;if(t=N(e),i=N(n),t||i)return t&&i?Ul(e,n):!1;if(t=he(e),i=he(n),t||i){if(!t||!i)return!1;const s=Object.keys(e).length,r=Object.keys(n).length;if(s!==r)return!1;for(const a in e){const l=e.hasOwnProperty(a),c=n.hasOwnProperty(a);if(l&&!c||!l&&c||!Xt(e[a],n[a]))return!1}}return String(e)===String(n)}function Ws(e,n){return e.findIndex(t=>Xt(t,n))}const Ho=e=>!!(e&&e.__v_isRef===!0),re=e=>Ee(e)?e:e==null?"":N(e)||he(e)&&(e.toString===zo||!G(e.toString))?Ho(e)?re(e.value):JSON.stringify(e,Oo,2):String(e),Oo=(e,n)=>Ho(n)?Oo(e,n.value):vt(n)?{[`Map(${n.size})`]:[...n.entries()].reduce((t,[i,s],r)=>(t[is(i,r)+" =>"]=s,t),{})}:Ct(n)?{[`Set(${n.size})`]:[...n.values()].map(t=>is(t))}:kn(n)?is(n):he(n)&&!N(n)&&!Ao(n)?String(n):n,is=(e,n="")=>{var t;return kn(e)?`Symbol(${(t=e.description)!=null?t:n})`:e};let Je;class $l{constructor(n=!1){this.detached=n,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.parent=Je,!n&&Je&&(this.index=(Je.scopes||(Je.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let n,t;if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].pause();for(n=0,t=this.effects.length;n<t;n++)this.effects[n].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let n,t;if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].resume();for(n=0,t=this.effects.length;n<t;n++)this.effects[n].resume()}}run(n){if(this._active){const t=Je;try{return Je=this,n()}finally{Je=t}}}on(){++this._on===1&&(this.prevScope=Je,Je=this)}off(){this._on>0&&--this._on===0&&(Je=this.prevScope,this.prevScope=void 0)}stop(n){if(this._active){this._active=!1;let t,i;for(t=0,i=this.effects.length;t<i;t++)this.effects[t].stop();for(this.effects.length=0,t=0,i=this.cleanups.length;t<i;t++)this.cleanups[t]();if(this.cleanups.length=0,this.scopes){for(t=0,i=this.scopes.length;t<i;t++)this.scopes[t].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!n){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0}}}function Jl(){return Je}let be;const ss=new WeakSet;class Do{constructor(n){this.fn=n,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,Je&&Je.active&&Je.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,ss.has(this)&&(ss.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Bo(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,Ar(this),Wo(this);const n=be,t=hn;be=this,hn=!0;try{return this.fn()}finally{Ko(this),be=n,hn=t,this.flags&=-3}}stop(){if(this.flags&1){for(let n=this.deps;n;n=n.nextDep)Vs(n);this.deps=this.depsTail=void 0,Ar(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?ss.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){ks(this)&&this.run()}get dirty(){return ks(this)}}let No=0,It,Ht;function Bo(e,n=!1){if(e.flags|=8,n){e.next=Ht,Ht=e;return}e.next=It,It=e}function Ks(){No++}function js(){if(--No>0)return;if(Ht){let n=Ht;for(Ht=void 0;n;){const t=n.next;n.next=void 0,n.flags&=-9,n=t}}let e;for(;It;){let n=It;for(It=void 0;n;){const t=n.next;if(n.next=void 0,n.flags&=-9,n.flags&1)try{n.trigger()}catch(i){e||(e=i)}n=t}}if(e)throw e}function Wo(e){for(let n=e.deps;n;n=n.nextDep)n.version=-1,n.prevActiveLink=n.dep.activeLink,n.dep.activeLink=n}function Ko(e){let n,t=e.depsTail,i=t;for(;i;){const s=i.prevDep;i.version===-1?(i===t&&(t=s),Vs(i),ql(i)):n=i,i.dep.activeLink=i.prevActiveLink,i.prevActiveLink=void 0,i=s}e.deps=n,e.depsTail=t}function ks(e){for(let n=e.deps;n;n=n.nextDep)if(n.dep.version!==n.version||n.dep.computed&&(jo(n.dep.computed)||n.dep.version!==n.version))return!0;return!!e._dirty}function jo(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===Wt)||(e.globalVersion=Wt,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!ks(e))))return;e.flags|=2;const n=e.dep,t=be,i=hn;be=e,hn=!0;try{Wo(e);const s=e.fn(e._value);(n.version===0||Un(s,e._value))&&(e.flags|=128,e._value=s,n.version++)}catch(s){throw n.version++,s}finally{be=t,hn=i,Ko(e),e.flags&=-3}}function Vs(e,n=!1){const{dep:t,prevSub:i,nextSub:s}=e;if(i&&(i.nextSub=s,e.prevSub=void 0),s&&(s.prevSub=i,e.nextSub=void 0),t.subs===e&&(t.subs=i,!i&&t.computed)){t.computed.flags&=-5;for(let r=t.computed.deps;r;r=r.nextDep)Vs(r,!0)}!n&&!--t.sc&&t.map&&t.map.delete(t.key)}function ql(e){const{prevDep:n,nextDep:t}=e;n&&(n.nextDep=t,e.prevDep=void 0),t&&(t.prevDep=n,e.nextDep=void 0)}let hn=!0;const Vo=[];function An(){Vo.push(hn),hn=!1}function Rn(){const e=Vo.pop();hn=e===void 0?!0:e}function Ar(e){const{cleanup:n}=e;if(e.cleanup=void 0,n){const t=be;be=void 0;try{n()}finally{be=t}}}let Wt=0;class Xl{constructor(n,t){this.sub=n,this.dep=t,this.version=t.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Gs{constructor(n){this.computed=n,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(n){if(!be||!hn||be===this.computed)return;let t=this.activeLink;if(t===void 0||t.sub!==be)t=this.activeLink=new Xl(be,this),be.deps?(t.prevDep=be.depsTail,be.depsTail.nextDep=t,be.depsTail=t):be.deps=be.depsTail=t,Go(t);else if(t.version===-1&&(t.version=this.version,t.nextDep)){const i=t.nextDep;i.prevDep=t.prevDep,t.prevDep&&(t.prevDep.nextDep=i),t.prevDep=be.depsTail,t.nextDep=void 0,be.depsTail.nextDep=t,be.depsTail=t,be.deps===t&&(be.deps=i)}return t}trigger(n){this.version++,Wt++,this.notify(n)}notify(n){Ks();try{for(let t=this.subs;t;t=t.prevSub)t.sub.notify()&&t.sub.dep.notify()}finally{js()}}}function Go(e){if(e.dep.sc++,e.sub.flags&4){const n=e.dep.computed;if(n&&!e.dep.subs){n.flags|=20;for(let i=n.deps;i;i=i.nextDep)Go(i)}const t=e.dep.subs;t!==e&&(e.prevSub=t,t&&(t.nextSub=e)),e.dep.subs=e}}const Ss=new WeakMap,ot=Symbol(""),_s=Symbol(""),Kt=Symbol("");function He(e,n,t){if(hn&&be){let i=Ss.get(e);i||Ss.set(e,i=new Map);let s=i.get(t);s||(i.set(t,s=new Gs),s.map=i,s.key=t),s.track()}}function xn(e,n,t,i,s,r){const a=Ss.get(e);if(!a){Wt++;return}const l=c=>{c&&c.trigger()};if(Ks(),n==="clear")a.forEach(l);else{const c=N(e),p=c&&Bs(t);if(c&&t==="length"){const h=Number(i);a.forEach((g,T)=>{(T==="length"||T===Kt||!kn(T)&&T>=h)&&l(g)})}else switch((t!==void 0||a.has(void 0))&&l(a.get(t)),p&&l(a.get(Kt)),n){case"add":c?p&&l(a.get("length")):(l(a.get(ot)),vt(e)&&l(a.get(_s)));break;case"delete":c||(l(a.get(ot)),vt(e)&&l(a.get(_s)));break;case"set":vt(e)&&l(a.get(ot));break}}js()}function ft(e){const n=oe(e);return n===e?n:(He(n,"iterate",Kt),ln(e)?n:n.map(fn))}function Di(e){return He(e=oe(e),"iterate",Kt),e}function Bn(e,n){return Pn(e)?at(e)?Tt(fn(n)):Tt(n):fn(n)}const Yl={__proto__:null,[Symbol.iterator](){return rs(this,Symbol.iterator,e=>Bn(this,e))},concat(...e){return ft(this).concat(...e.map(n=>N(n)?ft(n):n))},entries(){return rs(this,"entries",e=>(e[1]=Bn(this,e[1]),e))},every(e,n){return Cn(this,"every",e,n,void 0,arguments)},filter(e,n){return Cn(this,"filter",e,n,t=>t.map(i=>Bn(this,i)),arguments)},find(e,n){return Cn(this,"find",e,n,t=>Bn(this,t),arguments)},findIndex(e,n){return Cn(this,"findIndex",e,n,void 0,arguments)},findLast(e,n){return Cn(this,"findLast",e,n,t=>Bn(this,t),arguments)},findLastIndex(e,n){return Cn(this,"findLastIndex",e,n,void 0,arguments)},forEach(e,n){return Cn(this,"forEach",e,n,void 0,arguments)},includes(...e){return os(this,"includes",e)},indexOf(...e){return os(this,"indexOf",e)},join(e){return ft(this).join(e)},lastIndexOf(...e){return os(this,"lastIndexOf",e)},map(e,n){return Cn(this,"map",e,n,void 0,arguments)},pop(){return zt(this,"pop")},push(...e){return zt(this,"push",e)},reduce(e,...n){return Rr(this,"reduce",e,n)},reduceRight(e,...n){return Rr(this,"reduceRight",e,n)},shift(){return zt(this,"shift")},some(e,n){return Cn(this,"some",e,n,void 0,arguments)},splice(...e){return zt(this,"splice",e)},toReversed(){return ft(this).toReversed()},toSorted(e){return ft(this).toSorted(e)},toSpliced(...e){return ft(this).toSpliced(...e)},unshift(...e){return zt(this,"unshift",e)},values(){return rs(this,"values",e=>Bn(this,e))}};function rs(e,n,t){const i=Di(e),s=i[n]();return i!==e&&!ln(e)&&(s._next=s.next,s.next=()=>{const r=s._next();return r.done||(r.value=t(r.value)),r}),s}const Zl=Array.prototype;function Cn(e,n,t,i,s,r){const a=Di(e),l=a!==e&&!ln(e),c=a[n];if(c!==Zl[n]){const g=c.apply(e,r);return l?fn(g):g}let p=t;a!==e&&(l?p=function(g,T){return t.call(this,Bn(e,g),T,e)}:t.length>2&&(p=function(g,T){return t.call(this,g,T,e)}));const h=c.call(a,p,i);return l&&s?s(h):h}function Rr(e,n,t,i){const s=Di(e);let r=t;return s!==e&&(ln(e)?t.length>3&&(r=function(a,l,c){return t.call(this,a,l,c,e)}):r=function(a,l,c){return t.call(this,a,Bn(e,l),c,e)}),s[n](r,...i)}function os(e,n,t){const i=oe(e);He(i,"iterate",Kt);const s=i[n](...t);return(s===-1||s===!1)&&Js(t[0])?(t[0]=oe(t[0]),i[n](...t)):s}function zt(e,n,t=[]){An(),Ks();const i=oe(e)[n].apply(e,t);return js(),Rn(),i}const Ql=Os("__proto__,__v_isRef,__isVue"),Uo=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(kn));function ec(e){kn(e)||(e=String(e));const n=oe(this);return He(n,"has",e),n.hasOwnProperty(e)}class $o{constructor(n=!1,t=!1){this._isReadonly=n,this._isShallow=t}get(n,t,i){if(t==="__v_skip")return n.__v_skip;const s=this._isReadonly,r=this._isShallow;if(t==="__v_isReactive")return!s;if(t==="__v_isReadonly")return s;if(t==="__v_isShallow")return r;if(t==="__v_raw")return i===(s?r?uc:Yo:r?Xo:qo).get(n)||Object.getPrototypeOf(n)===Object.getPrototypeOf(i)?n:void 0;const a=N(n);if(!s){let c;if(a&&(c=Yl[t]))return c;if(t==="hasOwnProperty")return ec}const l=Reflect.get(n,t,De(n)?n:i);if((kn(t)?Uo.has(t):Ql(t))||(s||He(n,"get",t),r))return l;if(De(l)){const c=a&&Bs(t)?l:l.value;return s&&he(c)?Cs(c):c}return he(l)?s?Cs(l):wt(l):l}}class Jo extends $o{constructor(n=!1){super(!1,n)}set(n,t,i,s){let r=n[t];const a=N(n)&&Bs(t);if(!this._isShallow){const p=Pn(r);if(!ln(i)&&!Pn(i)&&(r=oe(r),i=oe(i)),!a&&De(r)&&!De(i))return p||(r.value=i),!0}const l=a?Number(t)<n.length:ae(n,t),c=Reflect.set(n,t,i,De(n)?n:s);return n===oe(s)&&(l?Un(i,r)&&xn(n,"set",t,i):xn(n,"add",t,i)),c}deleteProperty(n,t){const i=ae(n,t);n[t];const s=Reflect.deleteProperty(n,t);return s&&i&&xn(n,"delete",t,void 0),s}has(n,t){const i=Reflect.has(n,t);return(!kn(t)||!Uo.has(t))&&He(n,"has",t),i}ownKeys(n){return He(n,"iterate",N(n)?"length":ot),Reflect.ownKeys(n)}}class nc extends $o{constructor(n=!1){super(!0,n)}set(n,t){return!0}deleteProperty(n,t){return!0}}const tc=new Jo,ic=new nc,sc=new Jo(!0);const Ts=e=>e,ai=e=>Reflect.getPrototypeOf(e);function rc(e,n,t){return function(...i){const s=this.__v_raw,r=oe(s),a=vt(r),l=e==="entries"||e===Symbol.iterator&&a,c=e==="keys"&&a,p=s[e](...i),h=t?Ts:n?Tt:fn;return!n&&He(r,"iterate",c?_s:ot),{next(){const{value:g,done:T}=p.next();return T?{value:g,done:T}:{value:l?[h(g[0]),h(g[1])]:h(g),done:T}},[Symbol.iterator](){return this}}}}function li(e){return function(...n){return e==="delete"?!1:e==="clear"?void 0:this}}function oc(e,n){const t={get(s){const r=this.__v_raw,a=oe(r),l=oe(s);e||(Un(s,l)&&He(a,"get",s),He(a,"get",l));const{has:c}=ai(a),p=n?Ts:e?Tt:fn;if(c.call(a,s))return p(r.get(s));if(c.call(a,l))return p(r.get(l));r!==a&&r.get(s)},get size(){const s=this.__v_raw;return!e&&He(oe(s),"iterate",ot),s.size},has(s){const r=this.__v_raw,a=oe(r),l=oe(s);return e||(Un(s,l)&&He(a,"has",s),He(a,"has",l)),s===l?r.has(s):r.has(s)||r.has(l)},forEach(s,r){const a=this,l=a.__v_raw,c=oe(l),p=n?Ts:e?Tt:fn;return!e&&He(c,"iterate",ot),l.forEach((h,g)=>s.call(r,p(h),p(g),a))}};return Ie(t,e?{add:li("add"),set:li("set"),delete:li("delete"),clear:li("clear")}:{add(s){!n&&!ln(s)&&!Pn(s)&&(s=oe(s));const r=oe(this);return ai(r).has.call(r,s)||(r.add(s),xn(r,"add",s,s)),this},set(s,r){!n&&!ln(r)&&!Pn(r)&&(r=oe(r));const a=oe(this),{has:l,get:c}=ai(a);let p=l.call(a,s);p||(s=oe(s),p=l.call(a,s));const h=c.call(a,s);return a.set(s,r),p?Un(r,h)&&xn(a,"set",s,r):xn(a,"add",s,r),this},delete(s){const r=oe(this),{has:a,get:l}=ai(r);let c=a.call(r,s);c||(s=oe(s),c=a.call(r,s)),l&&l.call(r,s);const p=r.delete(s);return c&&xn(r,"delete",s,void 0),p},clear(){const s=oe(this),r=s.size!==0,a=s.clear();return r&&xn(s,"clear",void 0,void 0),a}}),["keys","values","entries",Symbol.iterator].forEach(s=>{t[s]=rc(s,e,n)}),t}function Us(e,n){const t=oc(e,n);return(i,s,r)=>s==="__v_isReactive"?!e:s==="__v_isReadonly"?e:s==="__v_raw"?i:Reflect.get(ae(t,s)&&s in i?t:i,s,r)}const ac={get:Us(!1,!1)},lc={get:Us(!1,!0)},cc={get:Us(!0,!1)};const qo=new WeakMap,Xo=new WeakMap,Yo=new WeakMap,uc=new WeakMap;function dc(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function hc(e){return e.__v_skip||!Object.isExtensible(e)?0:dc(Hl(e))}function wt(e){return Pn(e)?e:$s(e,!1,tc,ac,qo)}function fc(e){return $s(e,!1,sc,lc,Xo)}function Cs(e){return $s(e,!0,ic,cc,Yo)}function $s(e,n,t,i,s){if(!he(e)||e.__v_raw&&!(n&&e.__v_isReactive))return e;const r=hc(e);if(r===0)return e;const a=s.get(e);if(a)return a;const l=new Proxy(e,r===2?i:t);return s.set(e,l),l}function at(e){return Pn(e)?at(e.__v_raw):!!(e&&e.__v_isReactive)}function Pn(e){return!!(e&&e.__v_isReadonly)}function ln(e){return!!(e&&e.__v_isShallow)}function Js(e){return e?!!e.__v_raw:!1}function oe(e){const n=e&&e.__v_raw;return n?oe(n):e}function mc(e){return!ae(e,"__v_skip")&&Object.isExtensible(e)&&Po(e,"__v_skip",!0),e}const fn=e=>he(e)?wt(e):e,Tt=e=>he(e)?Cs(e):e;function De(e){return e?e.__v_isRef===!0:!1}function Fe(e){return pc(e,!1)}function pc(e,n){return De(e)?e:new gc(e,n)}class gc{constructor(n,t){this.dep=new Gs,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=t?n:oe(n),this._value=t?n:fn(n),this.__v_isShallow=t}get value(){return this.dep.track(),this._value}set value(n){const t=this._rawValue,i=this.__v_isShallow||ln(n)||Pn(n);n=i?n:oe(n),Un(n,t)&&(this._rawValue=n,this._value=i?n:fn(n),this.dep.trigger())}}function bc(e){return De(e)?e.value:e}const vc={get:(e,n,t)=>n==="__v_raw"?e:bc(Reflect.get(e,n,t)),set:(e,n,t,i)=>{const s=e[n];return De(s)&&!De(t)?(s.value=t,!0):Reflect.set(e,n,t,i)}};function Zo(e){return at(e)?e:new Proxy(e,vc)}class yc{constructor(n,t,i){this.fn=n,this.setter=t,this._value=void 0,this.dep=new Gs(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Wt-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!t,this.isSSR=i}notify(){if(this.flags|=16,!(this.flags&8)&&be!==this)return Bo(this,!0),!0}get value(){const n=this.dep.track();return jo(this),n&&(n.version=this.dep.version),this._value}set value(n){this.setter&&this.setter(n)}}function wc(e,n,t=!1){let i,s;return G(e)?i=e:(i=e.get,s=e.set),new yc(i,s,t)}const ci={},Ti=new WeakMap;let tt;function kc(e,n=!1,t=tt){if(t){let i=Ti.get(t);i||Ti.set(t,i=[]),i.push(e)}}function Sc(e,n,t=fe){const{immediate:i,deep:s,once:r,scheduler:a,augmentJob:l,call:c}=t,p=I=>s?I:ln(I)||s===!1||s===0?zn(I,1):zn(I);let h,g,T,M,P=!1,W=!1;if(De(e)?(g=()=>e.value,P=ln(e)):at(e)?(g=()=>p(e),P=!0):N(e)?(W=!0,P=e.some(I=>at(I)||ln(I)),g=()=>e.map(I=>{if(De(I))return I.value;if(at(I))return p(I);if(G(I))return c?c(I,2):I()})):G(e)?n?g=c?()=>c(e,2):e:g=()=>{if(T){An();try{T()}finally{Rn()}}const I=tt;tt=h;try{return c?c(e,3,[M]):e(M)}finally{tt=I}}:g=wn,n&&s){const I=g,ee=s===!0?1/0:s;g=()=>zn(I(),ee)}const ce=Jl(),R=()=>{h.stop(),ce&&ce.active&&Ns(ce.effects,h)};if(r&&n){const I=n;n=(...ee)=>{I(...ee),R()}}let F=W?new Array(e.length).fill(ci):ci;const $=I=>{if(!(!(h.flags&1)||!h.dirty&&!I))if(n){const ee=h.run();if(s||P||(W?ee.some((B,V)=>Un(B,F[V])):Un(ee,F))){T&&T();const B=tt;tt=h;try{const V=[ee,F===ci?void 0:W&&F[0]===ci?[]:F,M];F=ee,c?c(n,3,V):n(...V)}finally{tt=B}}}else h.run()};return l&&l($),h=new Do(g),h.scheduler=a?()=>a($,!1):$,M=I=>kc(I,!1,h),T=h.onStop=()=>{const I=Ti.get(h);if(I){if(c)c(I,4);else for(const ee of I)ee();Ti.delete(h)}},n?i?$(!0):F=h.run():a?a($.bind(null,!0),!0):h.run(),R.pause=h.pause.bind(h),R.resume=h.resume.bind(h),R.stop=R,R}function zn(e,n=1/0,t){if(n<=0||!he(e)||e.__v_skip||(t=t||new Map,(t.get(e)||0)>=n))return e;if(t.set(e,n),n--,De(e))zn(e.value,n,t);else if(N(e))for(let i=0;i<e.length;i++)zn(e[i],n,t);else if(Ct(e)||vt(e))e.forEach(i=>{zn(i,n,t)});else if(Ao(e)){for(const i in e)zn(e[i],n,t);for(const i of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,i)&&zn(e[i],n,t)}return e}function Yt(e,n,t,i){try{return i?e(...i):e()}catch(s){Ni(s,n,t)}}function mn(e,n,t,i){if(G(e)){const s=Yt(e,n,t,i);return s&&xo(s)&&s.catch(r=>{Ni(r,n,t)}),s}if(N(e)){const s=[];for(let r=0;r<e.length;r++)s.push(mn(e[r],n,t,i));return s}}function Ni(e,n,t,i=!0){const s=n?n.vnode:null,{errorHandler:r,throwUnhandledErrorInProduction:a}=n&&n.appContext.config||fe;if(n){let l=n.parent;const c=n.proxy,p=`https://vuejs.org/error-reference/#runtime-${t}`;for(;l;){const h=l.ec;if(h){for(let g=0;g<h.length;g++)if(h[g](e,c,p)===!1)return}l=l.parent}if(r){An(),Yt(r,null,10,[e,c,p]),Rn();return}}_c(e,t,s,i,a)}function _c(e,n,t,i=!0,s=!1){if(s)throw e;console.error(e)}const je=[];let bn=-1;const kt=[];let Wn=null,gt=0;const Qo=Promise.resolve();let Ci=null;function vn(e){const n=Ci||Qo;return e?n.then(this?e.bind(this):e):n}function Tc(e){let n=bn+1,t=je.length;for(;n<t;){const i=n+t>>>1,s=je[i],r=jt(s);r<e||r===e&&s.flags&2?n=i+1:t=i}return n}function qs(e){if(!(e.flags&1)){const n=jt(e),t=je[je.length-1];!t||!(e.flags&2)&&n>=jt(t)?je.push(e):je.splice(Tc(n),0,e),e.flags|=1,ea()}}function ea(){Ci||(Ci=Qo.then(ta))}function Cc(e){N(e)?kt.push(...e):Wn&&e.id===-1?Wn.splice(gt+1,0,e):e.flags&1||(kt.push(e),e.flags|=1),ea()}function Pr(e,n,t=bn+1){for(;t<je.length;t++){const i=je[t];if(i&&i.flags&2){if(e&&i.id!==e.uid)continue;je.splice(t,1),t--,i.flags&4&&(i.flags&=-2),i(),i.flags&4||(i.flags&=-2)}}}function na(e){if(kt.length){const n=[...new Set(kt)].sort((t,i)=>jt(t)-jt(i));if(kt.length=0,Wn){Wn.push(...n);return}for(Wn=n,gt=0;gt<Wn.length;gt++){const t=Wn[gt];t.flags&4&&(t.flags&=-2),t.flags&8||t(),t.flags&=-2}Wn=null,gt=0}}const jt=e=>e.id==null?e.flags&2?-1:1/0:e.id;function ta(e){try{for(bn=0;bn<je.length;bn++){const n=je[bn];n&&!(n.flags&8)&&(n.flags&4&&(n.flags&=-2),Yt(n,n.i,n.i?15:14),n.flags&4||(n.flags&=-2))}}finally{for(;bn<je.length;bn++){const n=je[bn];n&&(n.flags&=-2)}bn=-1,je.length=0,na(),Ci=null,(je.length||kt.length)&&ta()}}let an=null,ia=null;function Ei(e){const n=an;return an=e,ia=e&&e.type.__scopeId||null,n}function Es(e,n=an,t){if(!n||e._n)return e;const i=(...s)=>{i._d&&xi(-1);const r=Ei(n);let a;try{a=e(...s)}finally{Ei(r),i._d&&xi(1)}return a};return i._n=!0,i._c=!0,i._d=!0,i}function as(e,n){if(an===null)return e;const t=Ui(an),i=e.dirs||(e.dirs=[]);for(let s=0;s<n.length;s++){let[r,a,l,c=fe]=n[s];r&&(G(r)&&(r={mounted:r,updated:r}),r.deep&&zn(a),i.push({dir:r,instance:t,value:a,oldValue:void 0,arg:l,modifiers:c}))}return e}function Zn(e,n,t,i){const s=e.dirs,r=n&&n.dirs;for(let a=0;a<s.length;a++){const l=s[a];r&&(l.oldValue=r[a].value);let c=l.dir[i];c&&(An(),mn(c,t,8,[e.el,l,e,n]),Rn())}}const Ec=Symbol("_vte"),sa=e=>e.__isTeleport,Ln=Symbol("_leaveCb"),ui=Symbol("_enterCb");function Mc(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Ki(()=>{e.isMounted=!0}),ji(()=>{e.isUnmounting=!0}),e}const on=[Function,Array],ra={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:on,onEnter:on,onAfterEnter:on,onEnterCancelled:on,onBeforeLeave:on,onLeave:on,onAfterLeave:on,onLeaveCancelled:on,onBeforeAppear:on,onAppear:on,onAfterAppear:on,onAppearCancelled:on},oa=e=>{const n=e.subTree;return n.component?oa(n.component):n},Lc={name:"BaseTransition",props:ra,setup(e,{slots:n}){const t=Ra(),i=Mc();return()=>{const s=n.default&&ca(n.default(),!0);if(!s||!s.length)return;const r=aa(s),a=oe(e),{mode:l}=a;if(i.isLeaving)return ls(r);const c=Fr(r);if(!c)return ls(r);let p=Ms(c,a,i,t,g=>p=g);c.type!==Ve&&Vt(c,p);let h=t.subTree&&Fr(t.subTree);if(h&&h.type!==Ve&&!st(h,c)&&oa(t).type!==Ve){let g=Ms(h,a,i,t);if(Vt(h,g),l==="out-in"&&c.type!==Ve)return i.isLeaving=!0,g.afterLeave=()=>{i.isLeaving=!1,t.job.flags&8||t.update(),delete g.afterLeave,h=void 0},ls(r);l==="in-out"&&c.type!==Ve?g.delayLeave=(T,M,P)=>{const W=la(i,h);W[String(h.key)]=h,T[Ln]=()=>{M(),T[Ln]=void 0,delete p.delayedLeave,h=void 0},p.delayedLeave=()=>{P(),delete p.delayedLeave,h=void 0}}:h=void 0}else h&&(h=void 0);return r}}};function aa(e){let n=e[0];if(e.length>1){for(const t of e)if(t.type!==Ve){n=t;break}}return n}const xc=Lc;function la(e,n){const{leavingVNodes:t}=e;let i=t.get(n.type);return i||(i=Object.create(null),t.set(n.type,i)),i}function Ms(e,n,t,i,s){const{appear:r,mode:a,persisted:l=!1,onBeforeEnter:c,onEnter:p,onAfterEnter:h,onEnterCancelled:g,onBeforeLeave:T,onLeave:M,onAfterLeave:P,onLeaveCancelled:W,onBeforeAppear:ce,onAppear:R,onAfterAppear:F,onAppearCancelled:$}=n,I=String(e.key),ee=la(t,e),B=(K,Y)=>{K&&mn(K,i,9,Y)},V=(K,Y)=>{const ue=Y[1];B(K,Y),N(K)?K.every(A=>A.length<=1)&&ue():K.length<=1&&ue()},Q={mode:a,persisted:l,beforeEnter(K){let Y=c;if(!t.isMounted)if(r)Y=ce||c;else return;K[Ln]&&K[Ln](!0);const ue=ee[I];ue&&st(e,ue)&&ue.el[Ln]&&ue.el[Ln](),B(Y,[K])},enter(K){let Y=p,ue=h,A=g;if(!t.isMounted)if(r)Y=R||p,ue=F||h,A=$||g;else return;let Z=!1;const de=K[ui]=xe=>{Z||(Z=!0,xe?B(A,[K]):B(ue,[K]),Q.delayedLeave&&Q.delayedLeave(),K[ui]=void 0)};Y?V(Y,[K,de]):de()},leave(K,Y){const ue=String(e.key);if(K[ui]&&K[ui](!0),t.isUnmounting)return Y();B(T,[K]);let A=!1;const Z=K[Ln]=de=>{A||(A=!0,Y(),de?B(W,[K]):B(P,[K]),K[Ln]=void 0,ee[ue]===e&&delete ee[ue])};ee[ue]=e,M?V(M,[K,Z]):Z()},clone(K){const Y=Ms(K,n,t,i,s);return s&&s(Y),Y}};return Q}function ls(e){if(Bi(e))return e=Jn(e),e.children=null,e}function Fr(e){if(!Bi(e))return sa(e.type)&&e.children?aa(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:n,children:t}=e;if(t){if(n&16)return t[0];if(n&32&&G(t.default))return t.default()}}function Vt(e,n){e.shapeFlag&6&&e.component?(e.transition=n,Vt(e.component.subTree,n)):e.shapeFlag&128?(e.ssContent.transition=n.clone(e.ssContent),e.ssFallback.transition=n.clone(e.ssFallback)):e.transition=n}function ca(e,n=!1,t){let i=[],s=0;for(let r=0;r<e.length;r++){let a=e[r];const l=t==null?a.key:String(t)+String(a.key!=null?a.key:r);a.type===Xe?(a.patchFlag&128&&s++,i=i.concat(ca(a.children,n,l))):(n||a.type!==Ve)&&i.push(l!=null?Jn(a,{key:l}):a)}if(s>1)for(let r=0;r<i.length;r++)i[r].patchFlag=-2;return i}function ua(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}const Mi=new WeakMap;function Ot(e,n,t,i,s=!1){if(N(e)){e.forEach((P,W)=>Ot(P,n&&(N(n)?n[W]:n),t,i,s));return}if(Dt(i)&&!s){i.shapeFlag&512&&i.type.__asyncResolved&&i.component.subTree.component&&Ot(e,n,t,i.component.subTree);return}const r=i.shapeFlag&4?Ui(i.component):i.el,a=s?null:r,{i:l,r:c}=e,p=n&&n.r,h=l.refs===fe?l.refs={}:l.refs,g=l.setupState,T=oe(g),M=g===fe?Lo:P=>ae(T,P);if(p!=null&&p!==c){if(Ir(n),Ee(p))h[p]=null,M(p)&&(g[p]=null);else if(De(p)){p.value=null;const P=n;P.k&&(h[P.k]=null)}}if(G(c))Yt(c,l,12,[a,h]);else{const P=Ee(c),W=De(c);if(P||W){const ce=()=>{if(e.f){const R=P?M(c)?g[c]:h[c]:c.value;if(s)N(R)&&Ns(R,r);else if(N(R))R.includes(r)||R.push(r);else if(P)h[c]=[r],M(c)&&(g[c]=h[c]);else{const F=[r];c.value=F,e.k&&(h[e.k]=F)}}else P?(h[c]=a,M(c)&&(g[c]=a)):W&&(c.value=a,e.k&&(h[e.k]=a))};if(a){const R=()=>{ce(),Mi.delete(e)};R.id=-1,Mi.set(e,R),Ze(R,t)}else Ir(e),ce()}}}function Ir(e){const n=Mi.get(e);n&&(n.flags|=8,Mi.delete(e))}Hi().requestIdleCallback;Hi().cancelIdleCallback;const Dt=e=>!!e.type.__asyncLoader,Bi=e=>e.type.__isKeepAlive;function zc(e,n){da(e,"a",n)}function Ac(e,n){da(e,"da",n)}function da(e,n,t=Ge){const i=e.__wdc||(e.__wdc=()=>{let s=t;for(;s;){if(s.isDeactivated)return;s=s.parent}return e()});if(Wi(n,i,t),t){let s=t.parent;for(;s&&s.parent;)Bi(s.parent.vnode)&&Rc(i,n,t,s),s=s.parent}}function Rc(e,n,t,i){const s=Wi(n,e,i,!0);ha(()=>{Ns(i[n],s)},t)}function Wi(e,n,t=Ge,i=!1){if(t){const s=t[e]||(t[e]=[]),r=n.__weh||(n.__weh=(...a)=>{An();const l=Zt(t),c=mn(n,t,e,a);return l(),Rn(),c});return i?s.unshift(r):s.push(r),r}}const Fn=e=>(n,t=Ge)=>{(!Ut||e==="sp")&&Wi(e,(...i)=>n(...i),t)},Pc=Fn("bm"),Ki=Fn("m"),Fc=Fn("bu"),Ic=Fn("u"),ji=Fn("bum"),ha=Fn("um"),Hc=Fn("sp"),Oc=Fn("rtg"),Dc=Fn("rtc");function Nc(e,n=Ge){Wi("ec",e,n)}const Bc=Symbol.for("v-ndc");function di(e,n,t,i){let s;const r=t,a=N(e);if(a||Ee(e)){const l=a&&at(e);let c=!1,p=!1;l&&(c=!ln(e),p=Pn(e),e=Di(e)),s=new Array(e.length);for(let h=0,g=e.length;h<g;h++)s[h]=n(c?p?Tt(fn(e[h])):fn(e[h]):e[h],h,void 0,r)}else if(typeof e=="number"){s=new Array(e);for(let l=0;l<e;l++)s[l]=n(l+1,l,void 0,r)}else if(he(e))if(e[Symbol.iterator])s=Array.from(e,(l,c)=>n(l,c,void 0,r));else{const l=Object.keys(e);s=new Array(l.length);for(let c=0,p=l.length;c<p;c++){const h=l[c];s[c]=n(e[h],h,c,r)}}else s=[];return s}const Ls=e=>e?Pa(e)?Ui(e):Ls(e.parent):null,Nt=Ie(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Ls(e.parent),$root:e=>Ls(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>ma(e),$forceUpdate:e=>e.f||(e.f=()=>{qs(e.update)}),$nextTick:e=>e.n||(e.n=vn.bind(e.proxy)),$watch:e=>Zc.bind(e)}),cs=(e,n)=>e!==fe&&!e.__isScriptSetup&&ae(e,n),Wc={get({_:e},n){if(n==="__v_skip")return!0;const{ctx:t,setupState:i,data:s,props:r,accessCache:a,type:l,appContext:c}=e;if(n[0]!=="$"){const T=a[n];if(T!==void 0)switch(T){case 1:return i[n];case 2:return s[n];case 4:return t[n];case 3:return r[n]}else{if(cs(i,n))return a[n]=1,i[n];if(s!==fe&&ae(s,n))return a[n]=2,s[n];if(ae(r,n))return a[n]=3,r[n];if(t!==fe&&ae(t,n))return a[n]=4,t[n];xs&&(a[n]=0)}}const p=Nt[n];let h,g;if(p)return n==="$attrs"&&He(e.attrs,"get",""),p(e);if((h=l.__cssModules)&&(h=h[n]))return h;if(t!==fe&&ae(t,n))return a[n]=4,t[n];if(g=c.config.globalProperties,ae(g,n))return g[n]},set({_:e},n,t){const{data:i,setupState:s,ctx:r}=e;return cs(s,n)?(s[n]=t,!0):i!==fe&&ae(i,n)?(i[n]=t,!0):ae(e.props,n)||n[0]==="$"&&n.slice(1)in e?!1:(r[n]=t,!0)},has({_:{data:e,setupState:n,accessCache:t,ctx:i,appContext:s,props:r,type:a}},l){let c;return!!(t[l]||e!==fe&&l[0]!=="$"&&ae(e,l)||cs(n,l)||ae(r,l)||ae(i,l)||ae(Nt,l)||ae(s.config.globalProperties,l)||(c=a.__cssModules)&&c[l])},defineProperty(e,n,t){return t.get!=null?e._.accessCache[n]=0:ae(t,"value")&&this.set(e,n,t.value,null),Reflect.defineProperty(e,n,t)}};function Hr(e){return N(e)?e.reduce((n,t)=>(n[t]=null,n),{}):e}let xs=!0;function Kc(e){const n=ma(e),t=e.proxy,i=e.ctx;xs=!1,n.beforeCreate&&Or(n.beforeCreate,e,"bc");const{data:s,computed:r,methods:a,watch:l,provide:c,inject:p,created:h,beforeMount:g,mounted:T,beforeUpdate:M,updated:P,activated:W,deactivated:ce,beforeDestroy:R,beforeUnmount:F,destroyed:$,unmounted:I,render:ee,renderTracked:B,renderTriggered:V,errorCaptured:Q,serverPrefetch:K,expose:Y,inheritAttrs:ue,components:A,directives:Z,filters:de}=n;if(p&&jc(p,i,null),a)for(const J in a){const ie=a[J];G(ie)&&(i[J]=ie.bind(t))}if(s){const J=s.call(t,t);he(J)&&(e.data=wt(J))}if(xs=!0,r)for(const J in r){const ie=r[J],en=G(ie)?ie.bind(t,t):G(ie.get)?ie.get.bind(t,t):wn,ne=!G(ie)&&G(ie.set)?ie.set.bind(t):wn,ve=U({get:en,set:ne});Object.defineProperty(i,J,{enumerable:!0,configurable:!0,get:()=>ve.value,set:pe=>ve.value=pe})}if(l)for(const J in l)fa(l[J],i,t,J);if(c){const J=G(c)?c.call(t):c;Reflect.ownKeys(J).forEach(ie=>{qc(ie,J[ie])})}h&&Or(h,e,"c");function me(J,ie){N(ie)?ie.forEach(en=>J(en.bind(t))):ie&&J(ie.bind(t))}if(me(Pc,g),me(Ki,T),me(Fc,M),me(Ic,P),me(zc,W),me(Ac,ce),me(Nc,Q),me(Dc,B),me(Oc,V),me(ji,F),me(ha,I),me(Hc,K),N(Y))if(Y.length){const J=e.exposed||(e.exposed={});Y.forEach(ie=>{Object.defineProperty(J,ie,{get:()=>t[ie],set:en=>t[ie]=en,enumerable:!0})})}else e.exposed||(e.exposed={});ee&&e.render===wn&&(e.render=ee),ue!=null&&(e.inheritAttrs=ue),A&&(e.components=A),Z&&(e.directives=Z),K&&ua(e)}function jc(e,n,t=wn){N(e)&&(e=zs(e));for(const i in e){const s=e[i];let r;he(s)?"default"in s?r=yi(s.from||i,s.default,!0):r=yi(s.from||i):r=yi(s),De(r)?Object.defineProperty(n,i,{enumerable:!0,configurable:!0,get:()=>r.value,set:a=>r.value=a}):n[i]=r}}function Or(e,n,t){mn(N(e)?e.map(i=>i.bind(n.proxy)):e.bind(n.proxy),n,t)}function fa(e,n,t,i){let s=i.includes(".")?ba(t,i):()=>t[i];if(Ee(e)){const r=n[e];G(r)&&qe(s,r)}else if(G(e))qe(s,e.bind(t));else if(he(e))if(N(e))e.forEach(r=>fa(r,n,t,i));else{const r=G(e.handler)?e.handler.bind(t):n[e.handler];G(r)&&qe(s,r,e)}}function ma(e){const n=e.type,{mixins:t,extends:i}=n,{mixins:s,optionsCache:r,config:{optionMergeStrategies:a}}=e.appContext,l=r.get(n);let c;return l?c=l:!s.length&&!t&&!i?c=n:(c={},s.length&&s.forEach(p=>Li(c,p,a,!0)),Li(c,n,a)),he(n)&&r.set(n,c),c}function Li(e,n,t,i=!1){const{mixins:s,extends:r}=n;r&&Li(e,r,t,!0),s&&s.forEach(a=>Li(e,a,t,!0));for(const a in n)if(!(i&&a==="expose")){const l=Vc[a]||t&&t[a];e[a]=l?l(e[a],n[a]):n[a]}return e}const Vc={data:Dr,props:Nr,emits:Nr,methods:Rt,computed:Rt,beforeCreate:Ke,created:Ke,beforeMount:Ke,mounted:Ke,beforeUpdate:Ke,updated:Ke,beforeDestroy:Ke,beforeUnmount:Ke,destroyed:Ke,unmounted:Ke,activated:Ke,deactivated:Ke,errorCaptured:Ke,serverPrefetch:Ke,components:Rt,directives:Rt,watch:Uc,provide:Dr,inject:Gc};function Dr(e,n){return n?e?function(){return Ie(G(e)?e.call(this,this):e,G(n)?n.call(this,this):n)}:n:e}function Gc(e,n){return Rt(zs(e),zs(n))}function zs(e){if(N(e)){const n={};for(let t=0;t<e.length;t++)n[e[t]]=e[t];return n}return e}function Ke(e,n){return e?[...new Set([].concat(e,n))]:n}function Rt(e,n){return e?Ie(Object.create(null),e,n):n}function Nr(e,n){return e?N(e)&&N(n)?[...new Set([...e,...n])]:Ie(Object.create(null),Hr(e),Hr(n??{})):n}function Uc(e,n){if(!e)return n;if(!n)return e;const t=Ie(Object.create(null),e);for(const i in n)t[i]=Ke(e[i],n[i]);return t}function pa(){return{app:null,config:{isNativeTag:Lo,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let $c=0;function Jc(e,n){return function(i,s=null){G(i)||(i=Ie({},i)),s!=null&&!he(s)&&(s=null);const r=pa(),a=new WeakSet,l=[];let c=!1;const p=r.app={_uid:$c++,_component:i,_props:s,_container:null,_context:r,_instance:null,version:Ru,get config(){return r.config},set config(h){},use(h,...g){return a.has(h)||(h&&G(h.install)?(a.add(h),h.install(p,...g)):G(h)&&(a.add(h),h(p,...g))),p},mixin(h){return r.mixins.includes(h)||r.mixins.push(h),p},component(h,g){return g?(r.components[h]=g,p):r.components[h]},directive(h,g){return g?(r.directives[h]=g,p):r.directives[h]},mount(h,g,T){if(!c){const M=p._ceVNode||Oe(i,s);return M.appContext=r,T===!0?T="svg":T===!1&&(T=void 0),e(M,h,T),c=!0,p._container=h,h.__vue_app__=p,Ui(M.component)}},onUnmount(h){l.push(h)},unmount(){c&&(mn(l,p._instance,16),e(null,p._container),delete p._container.__vue_app__)},provide(h,g){return r.provides[h]=g,p},runWithContext(h){const g=St;St=p;try{return h()}finally{St=g}}};return p}}let St=null;function qc(e,n){if(Ge){let t=Ge.provides;const i=Ge.parent&&Ge.parent.provides;i===t&&(t=Ge.provides=Object.create(i)),t[e]=n}}function yi(e,n,t=!1){const i=Ra();if(i||St){let s=St?St._context.provides:i?i.parent==null||i.ce?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides:void 0;if(s&&e in s)return s[e];if(arguments.length>1)return t&&G(n)?n.call(i&&i.proxy):n}}const Xc=Symbol.for("v-scx"),Yc=()=>yi(Xc);function qe(e,n,t){return ga(e,n,t)}function ga(e,n,t=fe){const{immediate:i,deep:s,flush:r,once:a}=t,l=Ie({},t),c=n&&i||!n&&r!=="post";let p;if(Ut){if(r==="sync"){const M=Yc();p=M.__watcherHandles||(M.__watcherHandles=[])}else if(!c){const M=()=>{};return M.stop=wn,M.resume=wn,M.pause=wn,M}}const h=Ge;l.call=(M,P,W)=>mn(M,h,P,W);let g=!1;r==="post"?l.scheduler=M=>{Ze(M,h&&h.suspense)}:r!=="sync"&&(g=!0,l.scheduler=(M,P)=>{P?M():qs(M)}),l.augmentJob=M=>{n&&(M.flags|=4),g&&(M.flags|=2,h&&(M.id=h.uid,M.i=h))};const T=Sc(e,n,l);return Ut&&(p?p.push(T):c&&T()),T}function Zc(e,n,t){const i=this.proxy,s=Ee(e)?e.includes(".")?ba(i,e):()=>i[e]:e.bind(i,i);let r;G(n)?r=n:(r=n.handler,t=n);const a=Zt(this),l=ga(s,r.bind(i),t);return a(),l}function ba(e,n){const t=n.split(".");return()=>{let i=e;for(let s=0;s<t.length&&i;s++)i=i[t[s]];return i}}const Qc=(e,n)=>n==="modelValue"||n==="model-value"?e.modelModifiers:e[`${n}Modifiers`]||e[`${$n(n)}Modifiers`]||e[`${ct(n)}Modifiers`];function eu(e,n,...t){if(e.isUnmounted)return;const i=e.vnode.props||fe;let s=t;const r=n.startsWith("update:"),a=r&&Qc(i,n.slice(7));a&&(a.trim&&(s=t.map(h=>Ee(h)?h.trim():h)),a.number&&(s=t.map(Fo)));let l,c=i[l=ts(n)]||i[l=ts($n(n))];!c&&r&&(c=i[l=ts(ct(n))]),c&&mn(c,e,6,s);const p=i[l+"Once"];if(p){if(!e.emitted)e.emitted={};else if(e.emitted[l])return;e.emitted[l]=!0,mn(p,e,6,s)}}const nu=new WeakMap;function va(e,n,t=!1){const i=t?nu:n.emitsCache,s=i.get(e);if(s!==void 0)return s;const r=e.emits;let a={},l=!1;if(!G(e)){const c=p=>{const h=va(p,n,!0);h&&(l=!0,Ie(a,h))};!t&&n.mixins.length&&n.mixins.forEach(c),e.extends&&c(e.extends),e.mixins&&e.mixins.forEach(c)}return!r&&!l?(he(e)&&i.set(e,null),null):(N(r)?r.forEach(c=>a[c]=null):Ie(a,r),he(e)&&i.set(e,a),a)}function Vi(e,n){return!e||!Fi(n)?!1:(n=n.slice(2).replace(/Once$/,""),ae(e,n[0].toLowerCase()+n.slice(1))||ae(e,ct(n))||ae(e,n))}function Br(e){const{type:n,vnode:t,proxy:i,withProxy:s,propsOptions:[r],slots:a,attrs:l,emit:c,render:p,renderCache:h,props:g,data:T,setupState:M,ctx:P,inheritAttrs:W}=e,ce=Ei(e);let R,F;try{if(t.shapeFlag&4){const I=s||i,ee=I;R=yn(p.call(ee,I,h,g,M,T,P)),F=l}else{const I=n;R=yn(I.length>1?I(g,{attrs:l,slots:a,emit:c}):I(g,null)),F=n.props?l:tu(l)}}catch(I){Bt.length=0,Ni(I,e,1),R=Oe(Ve)}let $=R;if(F&&W!==!1){const I=Object.keys(F),{shapeFlag:ee}=$;I.length&&ee&7&&(r&&I.some(Ds)&&(F=iu(F,r)),$=Jn($,F,!1,!0))}return t.dirs&&($=Jn($,null,!1,!0),$.dirs=$.dirs?$.dirs.concat(t.dirs):t.dirs),t.transition&&Vt($,t.transition),R=$,Ei(ce),R}const tu=e=>{let n;for(const t in e)(t==="class"||t==="style"||Fi(t))&&((n||(n={}))[t]=e[t]);return n},iu=(e,n)=>{const t={};for(const i in e)(!Ds(i)||!(i.slice(9)in n))&&(t[i]=e[i]);return t};function su(e,n,t){const{props:i,children:s,component:r}=e,{props:a,children:l,patchFlag:c}=n,p=r.emitsOptions;if(n.dirs||n.transition)return!0;if(t&&c>=0){if(c&1024)return!0;if(c&16)return i?Wr(i,a,p):!!a;if(c&8){const h=n.dynamicProps;for(let g=0;g<h.length;g++){const T=h[g];if(a[T]!==i[T]&&!Vi(p,T))return!0}}}else return(s||l)&&(!l||!l.$stable)?!0:i===a?!1:i?a?Wr(i,a,p):!0:!!a;return!1}function Wr(e,n,t){const i=Object.keys(n);if(i.length!==Object.keys(e).length)return!0;for(let s=0;s<i.length;s++){const r=i[s];if(n[r]!==e[r]&&!Vi(t,r))return!0}return!1}function ru({vnode:e,parent:n},t){for(;n;){const i=n.subTree;if(i.suspense&&i.suspense.activeBranch===e&&(i.el=e.el),i===e)(e=n.vnode).el=t,n=n.parent;else break}}const ya={},wa=()=>Object.create(ya),ka=e=>Object.getPrototypeOf(e)===ya;function ou(e,n,t,i=!1){const s={},r=wa();e.propsDefaults=Object.create(null),Sa(e,n,s,r);for(const a in e.propsOptions[0])a in s||(s[a]=void 0);t?e.props=i?s:fc(s):e.type.props?e.props=s:e.props=r,e.attrs=r}function au(e,n,t,i){const{props:s,attrs:r,vnode:{patchFlag:a}}=e,l=oe(s),[c]=e.propsOptions;let p=!1;if((i||a>0)&&!(a&16)){if(a&8){const h=e.vnode.dynamicProps;for(let g=0;g<h.length;g++){let T=h[g];if(Vi(e.emitsOptions,T))continue;const M=n[T];if(c)if(ae(r,T))M!==r[T]&&(r[T]=M,p=!0);else{const P=$n(T);s[P]=As(c,l,P,M,e,!1)}else M!==r[T]&&(r[T]=M,p=!0)}}}else{Sa(e,n,s,r)&&(p=!0);let h;for(const g in l)(!n||!ae(n,g)&&((h=ct(g))===g||!ae(n,h)))&&(c?t&&(t[g]!==void 0||t[h]!==void 0)&&(s[g]=As(c,l,g,void 0,e,!0)):delete s[g]);if(r!==l)for(const g in r)(!n||!ae(n,g))&&(delete r[g],p=!0)}p&&xn(e.attrs,"set","")}function Sa(e,n,t,i){const[s,r]=e.propsOptions;let a=!1,l;if(n)for(let c in n){if(Ft(c))continue;const p=n[c];let h;s&&ae(s,h=$n(c))?!r||!r.includes(h)?t[h]=p:(l||(l={}))[h]=p:Vi(e.emitsOptions,c)||(!(c in i)||p!==i[c])&&(i[c]=p,a=!0)}if(r){const c=oe(t),p=l||fe;for(let h=0;h<r.length;h++){const g=r[h];t[g]=As(s,c,g,p[g],e,!ae(p,g))}}return a}function As(e,n,t,i,s,r){const a=e[t];if(a!=null){const l=ae(a,"default");if(l&&i===void 0){const c=a.default;if(a.type!==Function&&!a.skipFactory&&G(c)){const{propsDefaults:p}=s;if(t in p)i=p[t];else{const h=Zt(s);i=p[t]=c.call(null,n),h()}}else i=c;s.ce&&s.ce._setProp(t,i)}a[0]&&(r&&!l?i=!1:a[1]&&(i===""||i===ct(t))&&(i=!0))}return i}const lu=new WeakMap;function _a(e,n,t=!1){const i=t?lu:n.propsCache,s=i.get(e);if(s)return s;const r=e.props,a={},l=[];let c=!1;if(!G(e)){const h=g=>{c=!0;const[T,M]=_a(g,n,!0);Ie(a,T),M&&l.push(...M)};!t&&n.mixins.length&&n.mixins.forEach(h),e.extends&&h(e.extends),e.mixins&&e.mixins.forEach(h)}if(!r&&!c)return he(e)&&i.set(e,bt),bt;if(N(r))for(let h=0;h<r.length;h++){const g=$n(r[h]);Kr(g)&&(a[g]=fe)}else if(r)for(const h in r){const g=$n(h);if(Kr(g)){const T=r[h],M=a[g]=N(T)||G(T)?{type:T}:Ie({},T),P=M.type;let W=!1,ce=!0;if(N(P))for(let R=0;R<P.length;++R){const F=P[R],$=G(F)&&F.name;if($==="Boolean"){W=!0;break}else $==="String"&&(ce=!1)}else W=G(P)&&P.name==="Boolean";M[0]=W,M[1]=ce,(W||ae(M,"default"))&&l.push(g)}}const p=[a,l];return he(e)&&i.set(e,p),p}function Kr(e){return e[0]!=="$"&&!Ft(e)}const Xs=e=>e==="_"||e==="_ctx"||e==="$stable",Ys=e=>N(e)?e.map(yn):[yn(e)],cu=(e,n,t)=>{if(n._n)return n;const i=Es((...s)=>Ys(n(...s)),t);return i._c=!1,i},Ta=(e,n,t)=>{const i=e._ctx;for(const s in e){if(Xs(s))continue;const r=e[s];if(G(r))n[s]=cu(s,r,i);else if(r!=null){const a=Ys(r);n[s]=()=>a}}},Ca=(e,n)=>{const t=Ys(n);e.slots.default=()=>t},Ea=(e,n,t)=>{for(const i in n)(t||!Xs(i))&&(e[i]=n[i])},uu=(e,n,t)=>{const i=e.slots=wa();if(e.vnode.shapeFlag&32){const s=n._;s?(Ea(i,n,t),t&&Po(i,"_",s,!0)):Ta(n,i)}else n&&Ca(e,n)},du=(e,n,t)=>{const{vnode:i,slots:s}=e;let r=!0,a=fe;if(i.shapeFlag&32){const l=n._;l?t&&l===1?r=!1:Ea(s,n,t):(r=!n.$stable,Ta(n,s)),a=n}else n&&(Ca(e,n),a={default:1});if(r)for(const l in s)!Xs(l)&&a[l]==null&&delete s[l]},Ze=gu;function hu(e){return fu(e)}function fu(e,n){const t=Hi();t.__VUE__=!0;const{insert:i,remove:s,patchProp:r,createElement:a,createText:l,createComment:c,setText:p,setElementText:h,parentNode:g,nextSibling:T,setScopeId:M=wn,insertStaticContent:P}=e,W=(u,f,b,S=null,w=null,y=null,_=void 0,L=null,C=!!f.dynamicChildren)=>{if(u===f)return;u&&!st(u,f)&&(S=dt(u),pe(u,w,y,!0),u=null),f.patchFlag===-2&&(C=!1,f.dynamicChildren=null);const{type:k,ref:H,shapeFlag:z}=f;switch(k){case Gi:ce(u,f,b,S);break;case Ve:R(u,f,b,S);break;case ds:u==null&&F(f,b,S,_);break;case Xe:A(u,f,b,S,w,y,_,L,C);break;default:z&1?ee(u,f,b,S,w,y,_,L,C):z&6?Z(u,f,b,S,w,y,_,L,C):(z&64||z&128)&&k.process(u,f,b,S,w,y,_,L,C,Ae)}H!=null&&w?Ot(H,u&&u.ref,y,f||u,!f):H==null&&u&&u.ref!=null&&Ot(u.ref,null,y,u,!0)},ce=(u,f,b,S)=>{if(u==null)i(f.el=l(f.children),b,S);else{const w=f.el=u.el;f.children!==u.children&&p(w,f.children)}},R=(u,f,b,S)=>{u==null?i(f.el=c(f.children||""),b,S):f.el=u.el},F=(u,f,b,S)=>{[u.el,u.anchor]=P(u.children,f,b,S,u.el,u.anchor)},$=({el:u,anchor:f},b,S)=>{let w;for(;u&&u!==f;)w=T(u),i(u,b,S),u=w;i(f,b,S)},I=({el:u,anchor:f})=>{let b;for(;u&&u!==f;)b=T(u),s(u),u=b;s(f)},ee=(u,f,b,S,w,y,_,L,C)=>{if(f.type==="svg"?_="svg":f.type==="math"&&(_="mathml"),u==null)B(f,b,S,w,y,_,L,C);else{const k=u.el&&u.el._isVueCE?u.el:null;try{k&&k._beginPatch(),K(u,f,w,y,_,L,C)}finally{k&&k._endPatch()}}},B=(u,f,b,S,w,y,_,L)=>{let C,k;const{props:H,shapeFlag:z,transition:O,dirs:j}=u;if(C=u.el=a(u.type,y,H&&H.is,H),z&8?h(C,u.children):z&16&&Q(u.children,C,null,S,w,us(u,y),_,L),j&&Zn(u,null,S,"created"),V(C,u,u.scopeId,_,S),H){for(const le in H)le!=="value"&&!Ft(le)&&r(C,le,null,H[le],y,S);"value"in H&&r(C,"value",null,H.value,y),(k=H.onVnodeBeforeMount)&&gn(k,S,u)}j&&Zn(u,null,S,"beforeMount");const X=mu(w,O);X&&O.beforeEnter(C),i(C,f,b),((k=H&&H.onVnodeMounted)||X||j)&&Ze(()=>{k&&gn(k,S,u),X&&O.enter(C),j&&Zn(u,null,S,"mounted")},w)},V=(u,f,b,S,w)=>{if(b&&M(u,b),S)for(let y=0;y<S.length;y++)M(u,S[y]);if(w){let y=w.subTree;if(f===y||xa(y.type)&&(y.ssContent===f||y.ssFallback===f)){const _=w.vnode;V(u,_,_.scopeId,_.slotScopeIds,w.parent)}}},Q=(u,f,b,S,w,y,_,L,C=0)=>{for(let k=C;k<u.length;k++){const H=u[k]=L?Kn(u[k]):yn(u[k]);W(null,H,f,b,S,w,y,_,L)}},K=(u,f,b,S,w,y,_)=>{const L=f.el=u.el;let{patchFlag:C,dynamicChildren:k,dirs:H}=f;C|=u.patchFlag&16;const z=u.props||fe,O=f.props||fe;let j;if(b&&Qn(b,!1),(j=O.onVnodeBeforeUpdate)&&gn(j,b,f,u),H&&Zn(f,u,b,"beforeUpdate"),b&&Qn(b,!0),(z.innerHTML&&O.innerHTML==null||z.textContent&&O.textContent==null)&&h(L,""),k?Y(u.dynamicChildren,k,L,b,S,us(f,w),y):_||ie(u,f,L,null,b,S,us(f,w),y,!1),C>0){if(C&16)ue(L,z,O,b,w);else if(C&2&&z.class!==O.class&&r(L,"class",null,O.class,w),C&4&&r(L,"style",z.style,O.style,w),C&8){const X=f.dynamicProps;for(let le=0;le<X.length;le++){const se=X[le],ze=z[se],_e=O[se];(_e!==ze||se==="value")&&r(L,se,ze,_e,w,b)}}C&1&&u.children!==f.children&&h(L,f.children)}else!_&&k==null&&ue(L,z,O,b,w);((j=O.onVnodeUpdated)||H)&&Ze(()=>{j&&gn(j,b,f,u),H&&Zn(f,u,b,"updated")},S)},Y=(u,f,b,S,w,y,_)=>{for(let L=0;L<f.length;L++){const C=u[L],k=f[L],H=C.el&&(C.type===Xe||!st(C,k)||C.shapeFlag&198)?g(C.el):b;W(C,k,H,null,S,w,y,_,!0)}},ue=(u,f,b,S,w)=>{if(f!==b){if(f!==fe)for(const y in f)!Ft(y)&&!(y in b)&&r(u,y,f[y],null,w,S);for(const y in b){if(Ft(y))continue;const _=b[y],L=f[y];_!==L&&y!=="value"&&r(u,y,L,_,w,S)}"value"in b&&r(u,"value",f.value,b.value,w)}},A=(u,f,b,S,w,y,_,L,C)=>{const k=f.el=u?u.el:l(""),H=f.anchor=u?u.anchor:l("");let{patchFlag:z,dynamicChildren:O,slotScopeIds:j}=f;j&&(L=L?L.concat(j):j),u==null?(i(k,b,S),i(H,b,S),Q(f.children||[],b,H,w,y,_,L,C)):z>0&&z&64&&O&&u.dynamicChildren?(Y(u.dynamicChildren,O,b,w,y,_,L),(f.key!=null||w&&f===w.subTree)&&Ma(u,f,!0)):ie(u,f,b,H,w,y,_,L,C)},Z=(u,f,b,S,w,y,_,L,C)=>{f.slotScopeIds=L,u==null?f.shapeFlag&512?w.ctx.activate(f,b,S,_,C):de(f,b,S,w,y,_,C):xe(u,f,C)},de=(u,f,b,S,w,y,_)=>{const L=u.component=Cu(u,S,w);if(Bi(u)&&(L.ctx.renderer=Ae),Eu(L,!1,_),L.asyncDep){if(w&&w.registerDep(L,me,_),!u.el){const C=L.subTree=Oe(Ve);R(null,C,f,b),u.placeholder=C.el}}else me(L,u,f,b,w,y,_)},xe=(u,f,b)=>{const S=f.component=u.component;if(su(u,f,b))if(S.asyncDep&&!S.asyncResolved){J(S,f,b);return}else S.next=f,S.update();else f.el=u.el,S.vnode=f},me=(u,f,b,S,w,y,_)=>{const L=()=>{if(u.isMounted){let{next:z,bu:O,u:j,parent:X,vnode:le}=u;{const sn=La(u);if(sn){z&&(z.el=le.el,J(u,z,_)),sn.asyncDep.then(()=>{u.isUnmounted||L()});return}}let se=z,ze;Qn(u,!1),z?(z.el=le.el,J(u,z,_)):z=le,O&&vi(O),(ze=z.props&&z.props.onVnodeBeforeUpdate)&&gn(ze,X,z,le),Qn(u,!0);const _e=Br(u),tn=u.subTree;u.subTree=_e,W(tn,_e,g(tn.el),dt(tn),u,w,y),z.el=_e.el,se===null&&ru(u,_e.el),j&&Ze(j,w),(ze=z.props&&z.props.onVnodeUpdated)&&Ze(()=>gn(ze,X,z,le),w)}else{let z;const{el:O,props:j}=f,{bm:X,m:le,parent:se,root:ze,type:_e}=u,tn=Dt(f);Qn(u,!1),X&&vi(X),!tn&&(z=j&&j.onVnodeBeforeMount)&&gn(z,se,f),Qn(u,!0);{ze.ce&&ze.ce._def.shadowRoot!==!1&&ze.ce._injectChildStyle(_e);const sn=u.subTree=Br(u);W(null,sn,b,S,u,w,y),f.el=sn.el}if(le&&Ze(le,w),!tn&&(z=j&&j.onVnodeMounted)){const sn=f;Ze(()=>gn(z,se,sn),w)}(f.shapeFlag&256||se&&Dt(se.vnode)&&se.vnode.shapeFlag&256)&&u.a&&Ze(u.a,w),u.isMounted=!0,f=b=S=null}};u.scope.on();const C=u.effect=new Do(L);u.scope.off();const k=u.update=C.run.bind(C),H=u.job=C.runIfDirty.bind(C);H.i=u,H.id=u.uid,C.scheduler=()=>qs(H),Qn(u,!0),k()},J=(u,f,b)=>{f.component=u;const S=u.vnode.props;u.vnode=f,u.next=null,au(u,f.props,S,b),du(u,f.children,b),An(),Pr(u),Rn()},ie=(u,f,b,S,w,y,_,L,C=!1)=>{const k=u&&u.children,H=u?u.shapeFlag:0,z=f.children,{patchFlag:O,shapeFlag:j}=f;if(O>0){if(O&128){ne(k,z,b,S,w,y,_,L,C);return}else if(O&256){en(k,z,b,S,w,y,_,L,C);return}}j&8?(H&16&&Hn(k,w,y),z!==k&&h(b,z)):H&16?j&16?ne(k,z,b,S,w,y,_,L,C):Hn(k,w,y,!0):(H&8&&h(b,""),j&16&&Q(z,b,S,w,y,_,L,C))},en=(u,f,b,S,w,y,_,L,C)=>{u=u||bt,f=f||bt;const k=u.length,H=f.length,z=Math.min(k,H);let O;for(O=0;O<z;O++){const j=f[O]=C?Kn(f[O]):yn(f[O]);W(u[O],j,b,null,w,y,_,L,C)}k>H?Hn(u,w,y,!0,!1,z):Q(f,b,S,w,y,_,L,C,z)},ne=(u,f,b,S,w,y,_,L,C)=>{let k=0;const H=f.length;let z=u.length-1,O=H-1;for(;k<=z&&k<=O;){const j=u[k],X=f[k]=C?Kn(f[k]):yn(f[k]);if(st(j,X))W(j,X,b,null,w,y,_,L,C);else break;k++}for(;k<=z&&k<=O;){const j=u[z],X=f[O]=C?Kn(f[O]):yn(f[O]);if(st(j,X))W(j,X,b,null,w,y,_,L,C);else break;z--,O--}if(k>z){if(k<=O){const j=O+1,X=j<H?f[j].el:S;for(;k<=O;)W(null,f[k]=C?Kn(f[k]):yn(f[k]),b,X,w,y,_,L,C),k++}}else if(k>O)for(;k<=z;)pe(u[k],w,y,!0),k++;else{const j=k,X=k,le=new Map;for(k=X;k<=O;k++){const Ne=f[k]=C?Kn(f[k]):yn(f[k]);Ne.key!=null&&le.set(Ne.key,k)}let se,ze=0;const _e=O-X+1;let tn=!1,sn=0;const qn=new Array(_e);for(k=0;k<_e;k++)qn[k]=0;for(k=j;k<=z;k++){const Ne=u[k];if(ze>=_e){pe(Ne,w,y,!0);continue}let rn;if(Ne.key!=null)rn=le.get(Ne.key);else for(se=X;se<=O;se++)if(qn[se-X]===0&&st(Ne,f[se])){rn=se;break}rn===void 0?pe(Ne,w,y,!0):(qn[rn-X]=k+1,rn>=sn?sn=rn:tn=!0,W(Ne,f[rn],b,null,w,y,_,L,C),ze++)}const ei=tn?pu(qn):bt;for(se=ei.length-1,k=_e-1;k>=0;k--){const Ne=X+k,rn=f[Ne],Mt=f[Ne+1],Ue=Ne+1<H?Mt.el||Mt.placeholder:S;qn[k]===0?W(null,rn,b,Ue,w,y,_,L,C):tn&&(se<0||k!==ei[se]?ve(rn,b,Ue,2):se--)}}},ve=(u,f,b,S,w=null)=>{const{el:y,type:_,transition:L,children:C,shapeFlag:k}=u;if(k&6){ve(u.component.subTree,f,b,S);return}if(k&128){u.suspense.move(f,b,S);return}if(k&64){_.move(u,f,b,Ae);return}if(_===Xe){i(y,f,b);for(let z=0;z<C.length;z++)ve(C[z],f,b,S);i(u.anchor,f,b);return}if(_===ds){$(u,f,b);return}if(S!==2&&k&1&&L)if(S===0)L.beforeEnter(y),i(y,f,b),Ze(()=>L.enter(y),w);else{const{leave:z,delayLeave:O,afterLeave:j}=L,X=()=>{u.ctx.isUnmounted?s(y):i(y,f,b)},le=()=>{y._isLeaving&&y[Ln](!0),z(y,()=>{X(),j&&j()})};O?O(y,X,le):le()}else i(y,f,b)},pe=(u,f,b,S=!1,w=!1)=>{const{type:y,props:_,ref:L,children:C,dynamicChildren:k,shapeFlag:H,patchFlag:z,dirs:O,cacheIndex:j}=u;if(z===-2&&(w=!1),L!=null&&(An(),Ot(L,null,b,u,!0),Rn()),j!=null&&(f.renderCache[j]=void 0),H&256){f.ctx.deactivate(u);return}const X=H&1&&O,le=!Dt(u);let se;if(le&&(se=_&&_.onVnodeBeforeUnmount)&&gn(se,f,u),H&6)pn(u.component,b,S);else{if(H&128){u.suspense.unmount(b,S);return}X&&Zn(u,null,f,"beforeUnmount"),H&64?u.type.remove(u,f,b,Ae,S):k&&!k.hasOnce&&(y!==Xe||z>0&&z&64)?Hn(k,f,b,!1,!0):(y===Xe&&z&384||!w&&H&16)&&Hn(C,f,b),S&&In(u)}(le&&(se=_&&_.onVnodeUnmounted)||X)&&Ze(()=>{se&&gn(se,f,u),X&&Zn(u,null,f,"unmounted")},b)},In=u=>{const{type:f,el:b,anchor:S,transition:w}=u;if(f===Xe){ut(b,S);return}if(f===ds){I(u);return}const y=()=>{s(b),w&&!w.persisted&&w.afterLeave&&w.afterLeave()};if(u.shapeFlag&1&&w&&!w.persisted){const{leave:_,delayLeave:L}=w,C=()=>_(b,y);L?L(u.el,y,C):C()}else y()},ut=(u,f)=>{let b;for(;u!==f;)b=T(u),s(u),u=b;s(f)},pn=(u,f,b)=>{const{bum:S,scope:w,job:y,subTree:_,um:L,m:C,a:k}=u;jr(C),jr(k),S&&vi(S),w.stop(),y&&(y.flags|=8,pe(_,u,f,b)),L&&Ze(L,f),Ze(()=>{u.isUnmounted=!0},f)},Hn=(u,f,b,S=!1,w=!1,y=0)=>{for(let _=y;_<u.length;_++)pe(u[_],f,b,S,w)},dt=u=>{if(u.shapeFlag&6)return dt(u.component.subTree);if(u.shapeFlag&128)return u.suspense.next();const f=T(u.anchor||u.el),b=f&&f[Ec];return b?T(b):f};let nn=!1;const Et=(u,f,b)=>{u==null?f._vnode&&pe(f._vnode,null,null,!0):W(f._vnode||null,u,f,null,null,null,b),f._vnode=u,nn||(nn=!0,Pr(),na(),nn=!1)},Ae={p:W,um:pe,m:ve,r:In,mt:de,mc:Q,pc:ie,pbc:Y,n:dt,o:e};return{render:Et,hydrate:void 0,createApp:Jc(Et)}}function us({type:e,props:n},t){return t==="svg"&&e==="foreignObject"||t==="mathml"&&e==="annotation-xml"&&n&&n.encoding&&n.encoding.includes("html")?void 0:t}function Qn({effect:e,job:n},t){t?(e.flags|=32,n.flags|=4):(e.flags&=-33,n.flags&=-5)}function mu(e,n){return(!e||e&&!e.pendingBranch)&&n&&!n.persisted}function Ma(e,n,t=!1){const i=e.children,s=n.children;if(N(i)&&N(s))for(let r=0;r<i.length;r++){const a=i[r];let l=s[r];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=s[r]=Kn(s[r]),l.el=a.el),!t&&l.patchFlag!==-2&&Ma(a,l)),l.type===Gi&&l.patchFlag!==-1&&(l.el=a.el),l.type===Ve&&!l.el&&(l.el=a.el)}}function pu(e){const n=e.slice(),t=[0];let i,s,r,a,l;const c=e.length;for(i=0;i<c;i++){const p=e[i];if(p!==0){if(s=t[t.length-1],e[s]<p){n[i]=s,t.push(i);continue}for(r=0,a=t.length-1;r<a;)l=r+a>>1,e[t[l]]<p?r=l+1:a=l;p<e[t[r]]&&(r>0&&(n[i]=t[r-1]),t[r]=i)}}for(r=t.length,a=t[r-1];r-- >0;)t[r]=a,a=n[a];return t}function La(e){const n=e.subTree.component;if(n)return n.asyncDep&&!n.asyncResolved?n:La(n)}function jr(e){if(e)for(let n=0;n<e.length;n++)e[n].flags|=8}const xa=e=>e.__isSuspense;function gu(e,n){n&&n.pendingBranch?N(e)?n.effects.push(...e):n.effects.push(e):Cc(e)}const Xe=Symbol.for("v-fgt"),Gi=Symbol.for("v-txt"),Ve=Symbol.for("v-cmt"),ds=Symbol.for("v-stc"),Bt=[];let Qe=null;function ge(e=!1){Bt.push(Qe=e?null:[])}function bu(){Bt.pop(),Qe=Bt[Bt.length-1]||null}let Gt=1;function xi(e,n=!1){Gt+=e,e<0&&Qe&&n&&(Qe.hasOnce=!0)}function za(e){return e.dynamicChildren=Gt>0?Qe||bt:null,bu(),Gt>0&&Qe&&Qe.push(e),e}function ye(e,n,t,i,s,r){return za(E(e,n,t,i,s,r,!0))}function vu(e,n,t,i,s){return za(Oe(e,n,t,i,s,!0))}function zi(e){return e?e.__v_isVNode===!0:!1}function st(e,n){return e.type===n.type&&e.key===n.key}const Aa=({key:e})=>e??null,wi=({ref:e,ref_key:n,ref_for:t})=>(typeof e=="number"&&(e=""+e),e!=null?Ee(e)||De(e)||G(e)?{i:an,r:e,k:n,f:!!t}:e:null);function E(e,n=null,t=null,i=0,s=null,r=e===Xe?0:1,a=!1,l=!1){const c={__v_isVNode:!0,__v_skip:!0,type:e,props:n,key:n&&Aa(n),ref:n&&wi(n),scopeId:ia,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:i,dynamicProps:s,dynamicChildren:null,appContext:null,ctx:an};return l?(Zs(c,t),r&128&&e.normalize(c)):t&&(c.shapeFlag|=Ee(t)?8:16),Gt>0&&!a&&Qe&&(c.patchFlag>0||r&6)&&c.patchFlag!==32&&Qe.push(c),c}const Oe=yu;function yu(e,n=null,t=null,i=0,s=null,r=!1){if((!e||e===Bc)&&(e=Ve),zi(e)){const l=Jn(e,n,!0);return t&&Zs(l,t),Gt>0&&!r&&Qe&&(l.shapeFlag&6?Qe[Qe.indexOf(e)]=l:Qe.push(l)),l.patchFlag=-2,l}if(zu(e)&&(e=e.__vccOpts),n){n=wu(n);let{class:l,style:c}=n;l&&!Ee(l)&&(n.class=yt(l)),he(c)&&(Js(c)&&!N(c)&&(c=Ie({},c)),n.style=Oi(c))}const a=Ee(e)?1:xa(e)?128:sa(e)?64:he(e)?4:G(e)?2:0;return E(e,n,t,i,s,a,r,!0)}function wu(e){return e?Js(e)||ka(e)?Ie({},e):e:null}function Jn(e,n,t=!1,i=!1){const{props:s,ref:r,patchFlag:a,children:l,transition:c}=e,p=n?Su(s||{},n):s,h={__v_isVNode:!0,__v_skip:!0,type:e.type,props:p,key:p&&Aa(p),ref:n&&n.ref?t&&r?N(r)?r.concat(wi(n)):[r,wi(n)]:wi(n):r,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:l,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:n&&e.type!==Xe?a===-1?16:a|16:a,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:c,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Jn(e.ssContent),ssFallback:e.ssFallback&&Jn(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return c&&i&&Vt(h,c.clone(h)),h}function ku(e=" ",n=0){return Oe(Gi,null,e,n)}function dn(e="",n=!1){return n?(ge(),vu(Ve,null,e)):Oe(Ve,null,e)}function yn(e){return e==null||typeof e=="boolean"?Oe(Ve):N(e)?Oe(Xe,null,e.slice()):zi(e)?Kn(e):Oe(Gi,null,String(e))}function Kn(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Jn(e)}function Zs(e,n){let t=0;const{shapeFlag:i}=e;if(n==null)n=null;else if(N(n))t=16;else if(typeof n=="object")if(i&65){const s=n.default;s&&(s._c&&(s._d=!1),Zs(e,s()),s._c&&(s._d=!0));return}else{t=32;const s=n._;!s&&!ka(n)?n._ctx=an:s===3&&an&&(an.slots._===1?n._=1:(n._=2,e.patchFlag|=1024))}else G(n)?(n={default:n,_ctx:an},t=32):(n=String(n),i&64?(t=16,n=[ku(n)]):t=8);e.children=n,e.shapeFlag|=t}function Su(...e){const n={};for(let t=0;t<e.length;t++){const i=e[t];for(const s in i)if(s==="class")n.class!==i.class&&(n.class=yt([n.class,i.class]));else if(s==="style")n.style=Oi([n.style,i.style]);else if(Fi(s)){const r=n[s],a=i[s];a&&r!==a&&!(N(r)&&r.includes(a))&&(n[s]=r?[].concat(r,a):a)}else s!==""&&(n[s]=i[s])}return n}function gn(e,n,t,i=null){mn(e,n,7,[t,i])}const _u=pa();let Tu=0;function Cu(e,n,t){const i=e.type,s=(n?n.appContext:e.appContext)||_u,r={uid:Tu++,vnode:e,type:i,parent:n,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new $l(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:n?n.provides:Object.create(s.provides),ids:n?n.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:_a(i,s),emitsOptions:va(i,s),emit:null,emitted:null,propsDefaults:fe,inheritAttrs:i.inheritAttrs,ctx:fe,data:fe,props:fe,attrs:fe,slots:fe,refs:fe,setupState:fe,setupContext:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=n?n.root:r,r.emit=eu.bind(null,r),e.ce&&e.ce(r),r}let Ge=null;const Ra=()=>Ge||an;let Ai,Rs;{const e=Hi(),n=(t,i)=>{let s;return(s=e[t])||(s=e[t]=[]),s.push(i),r=>{s.length>1?s.forEach(a=>a(r)):s[0](r)}};Ai=n("__VUE_INSTANCE_SETTERS__",t=>Ge=t),Rs=n("__VUE_SSR_SETTERS__",t=>Ut=t)}const Zt=e=>{const n=Ge;return Ai(e),e.scope.on(),()=>{e.scope.off(),Ai(n)}},Vr=()=>{Ge&&Ge.scope.off(),Ai(null)};function Pa(e){return e.vnode.shapeFlag&4}let Ut=!1;function Eu(e,n=!1,t=!1){n&&Rs(n);const{props:i,children:s}=e.vnode,r=Pa(e);ou(e,i,r,n),uu(e,s,t||n);const a=r?Mu(e,n):void 0;return n&&Rs(!1),a}function Mu(e,n){const t=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,Wc);const{setup:i}=t;if(i){An();const s=e.setupContext=i.length>1?xu(e):null,r=Zt(e),a=Yt(i,e,0,[e.props,s]),l=xo(a);if(Rn(),r(),(l||e.sp)&&!Dt(e)&&ua(e),l){if(a.then(Vr,Vr),n)return a.then(c=>{Gr(e,c)}).catch(c=>{Ni(c,e,0)});e.asyncDep=a}else Gr(e,a)}else Fa(e)}function Gr(e,n,t){G(n)?e.type.__ssrInlineRender?e.ssrRender=n:e.render=n:he(n)&&(e.setupState=Zo(n)),Fa(e)}function Fa(e,n,t){const i=e.type;e.render||(e.render=i.render||wn);{const s=Zt(e);An();try{Kc(e)}finally{Rn(),s()}}}const Lu={get(e,n){return He(e,"get",""),e[n]}};function xu(e){const n=t=>{e.exposed=t||{}};return{attrs:new Proxy(e.attrs,Lu),slots:e.slots,emit:e.emit,expose:n}}function Ui(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(Zo(mc(e.exposed)),{get(n,t){if(t in n)return n[t];if(t in Nt)return Nt[t](e)},has(n,t){return t in n||t in Nt}})):e.proxy}function zu(e){return G(e)&&"__vccOpts"in e}const U=(e,n)=>wc(e,n,Ut);function Au(e,n,t){try{xi(-1);const i=arguments.length;return i===2?he(n)&&!N(n)?zi(n)?Oe(e,null,[n]):Oe(e,n):Oe(e,null,n):(i>3?t=Array.prototype.slice.call(arguments,2):i===3&&zi(t)&&(t=[t]),Oe(e,n,t))}finally{xi(1)}}const Ru="3.5.25";let Ps;const Ur=typeof window<"u"&&window.trustedTypes;if(Ur)try{Ps=Ur.createPolicy("vue",{createHTML:e=>e})}catch{}const Ia=Ps?e=>Ps.createHTML(e):e=>e,Pu="http://www.w3.org/2000/svg",Fu="http://www.w3.org/1998/Math/MathML",Mn=typeof document<"u"?document:null,$r=Mn&&Mn.createElement("template"),Iu={insert:(e,n,t)=>{n.insertBefore(e,t||null)},remove:e=>{const n=e.parentNode;n&&n.removeChild(e)},createElement:(e,n,t,i)=>{const s=n==="svg"?Mn.createElementNS(Pu,e):n==="mathml"?Mn.createElementNS(Fu,e):t?Mn.createElement(e,{is:t}):Mn.createElement(e);return e==="select"&&i&&i.multiple!=null&&s.setAttribute("multiple",i.multiple),s},createText:e=>Mn.createTextNode(e),createComment:e=>Mn.createComment(e),setText:(e,n)=>{e.nodeValue=n},setElementText:(e,n)=>{e.textContent=n},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Mn.querySelector(e),setScopeId(e,n){e.setAttribute(n,"")},insertStaticContent(e,n,t,i,s,r){const a=t?t.previousSibling:n.lastChild;if(s&&(s===r||s.nextSibling))for(;n.insertBefore(s.cloneNode(!0),t),!(s===r||!(s=s.nextSibling)););else{$r.innerHTML=Ia(i==="svg"?`<svg>${e}</svg>`:i==="mathml"?`<math>${e}</math>`:e);const l=$r.content;if(i==="svg"||i==="mathml"){const c=l.firstChild;for(;c.firstChild;)l.appendChild(c.firstChild);l.removeChild(c)}n.insertBefore(l,t)}return[a?a.nextSibling:n.firstChild,t?t.previousSibling:n.lastChild]}},Nn="transition",At="animation",$t=Symbol("_vtc"),Ha={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},Hu=Ie({},ra,Ha),Ou=e=>(e.displayName="Transition",e.props=Hu,e),Jr=Ou((e,{slots:n})=>Au(xc,Du(e),n)),et=(e,n=[])=>{N(e)?e.forEach(t=>t(...n)):e&&e(...n)},qr=e=>e?N(e)?e.some(n=>n.length>1):e.length>1:!1;function Du(e){const n={};for(const A in e)A in Ha||(n[A]=e[A]);if(e.css===!1)return n;const{name:t="v",type:i,duration:s,enterFromClass:r=`${t}-enter-from`,enterActiveClass:a=`${t}-enter-active`,enterToClass:l=`${t}-enter-to`,appearFromClass:c=r,appearActiveClass:p=a,appearToClass:h=l,leaveFromClass:g=`${t}-leave-from`,leaveActiveClass:T=`${t}-leave-active`,leaveToClass:M=`${t}-leave-to`}=e,P=Nu(s),W=P&&P[0],ce=P&&P[1],{onBeforeEnter:R,onEnter:F,onEnterCancelled:$,onLeave:I,onLeaveCancelled:ee,onBeforeAppear:B=R,onAppear:V=F,onAppearCancelled:Q=$}=n,K=(A,Z,de,xe)=>{A._enterCancelled=xe,nt(A,Z?h:l),nt(A,Z?p:a),de&&de()},Y=(A,Z)=>{A._isLeaving=!1,nt(A,g),nt(A,M),nt(A,T),Z&&Z()},ue=A=>(Z,de)=>{const xe=A?V:F,me=()=>K(Z,A,de);et(xe,[Z,me]),Xr(()=>{nt(Z,A?c:r),En(Z,A?h:l),qr(xe)||Yr(Z,i,W,me)})};return Ie(n,{onBeforeEnter(A){et(R,[A]),En(A,r),En(A,a)},onBeforeAppear(A){et(B,[A]),En(A,c),En(A,p)},onEnter:ue(!1),onAppear:ue(!0),onLeave(A,Z){A._isLeaving=!0;const de=()=>Y(A,Z);En(A,g),A._enterCancelled?(En(A,T),eo(A)):(eo(A),En(A,T)),Xr(()=>{A._isLeaving&&(nt(A,g),En(A,M),qr(I)||Yr(A,i,ce,de))}),et(I,[A,de])},onEnterCancelled(A){K(A,!1,void 0,!0),et($,[A])},onAppearCancelled(A){K(A,!0,void 0,!0),et(Q,[A])},onLeaveCancelled(A){Y(A),et(ee,[A])}})}function Nu(e){if(e==null)return null;if(he(e))return[hs(e.enter),hs(e.leave)];{const n=hs(e);return[n,n]}}function hs(e){return Nl(e)}function En(e,n){n.split(/\s+/).forEach(t=>t&&e.classList.add(t)),(e[$t]||(e[$t]=new Set)).add(n)}function nt(e,n){n.split(/\s+/).forEach(i=>i&&e.classList.remove(i));const t=e[$t];t&&(t.delete(n),t.size||(e[$t]=void 0))}function Xr(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let Bu=0;function Yr(e,n,t,i){const s=e._endId=++Bu,r=()=>{s===e._endId&&i()};if(t!=null)return setTimeout(r,t);const{type:a,timeout:l,propCount:c}=Wu(e,n);if(!a)return i();const p=a+"end";let h=0;const g=()=>{e.removeEventListener(p,T),r()},T=M=>{M.target===e&&++h>=c&&g()};setTimeout(()=>{h<c&&g()},l+1),e.addEventListener(p,T)}function Wu(e,n){const t=window.getComputedStyle(e),i=P=>(t[P]||"").split(", "),s=i(`${Nn}Delay`),r=i(`${Nn}Duration`),a=Zr(s,r),l=i(`${At}Delay`),c=i(`${At}Duration`),p=Zr(l,c);let h=null,g=0,T=0;n===Nn?a>0&&(h=Nn,g=a,T=r.length):n===At?p>0&&(h=At,g=p,T=c.length):(g=Math.max(a,p),h=g>0?a>p?Nn:At:null,T=h?h===Nn?r.length:c.length:0);const M=h===Nn&&/\b(?:transform|all)(?:,|$)/.test(i(`${Nn}Property`).toString());return{type:h,timeout:g,propCount:T,hasTransform:M}}function Zr(e,n){for(;e.length<n.length;)e=e.concat(e);return Math.max(...n.map((t,i)=>Qr(t)+Qr(e[i])))}function Qr(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function eo(e){return(e?e.ownerDocument:document).body.offsetHeight}function Ku(e,n,t){const i=e[$t];i&&(n=(n?[n,...i]:[...i]).join(" ")),n==null?e.removeAttribute("class"):t?e.setAttribute("class",n):e.className=n}const no=Symbol("_vod"),ju=Symbol("_vsh"),Vu=Symbol(""),Gu=/(?:^|;)\s*display\s*:/;function Uu(e,n,t){const i=e.style,s=Ee(t);let r=!1;if(t&&!s){if(n)if(Ee(n))for(const a of n.split(";")){const l=a.slice(0,a.indexOf(":")).trim();t[l]==null&&ki(i,l,"")}else for(const a in n)t[a]==null&&ki(i,a,"");for(const a in t)a==="display"&&(r=!0),ki(i,a,t[a])}else if(s){if(n!==t){const a=i[Vu];a&&(t+=";"+a),i.cssText=t,r=Gu.test(t)}}else n&&e.removeAttribute("style");no in e&&(e[no]=r?i.display:"",e[ju]&&(i.display="none"))}const to=/\s*!important$/;function ki(e,n,t){if(N(t))t.forEach(i=>ki(e,n,i));else if(t==null&&(t=""),n.startsWith("--"))e.setProperty(n,t);else{const i=$u(e,n);to.test(t)?e.setProperty(ct(i),t.replace(to,""),"important"):e[i]=t}}const io=["Webkit","Moz","ms"],fs={};function $u(e,n){const t=fs[n];if(t)return t;let i=$n(n);if(i!=="filter"&&i in e)return fs[n]=i;i=Ro(i);for(let s=0;s<io.length;s++){const r=io[s]+i;if(r in e)return fs[n]=r}return n}const so="http://www.w3.org/1999/xlink";function ro(e,n,t,i,s,r=Gl(n)){i&&n.startsWith("xlink:")?t==null?e.removeAttributeNS(so,n.slice(6,n.length)):e.setAttributeNS(so,n,t):t==null||r&&!Io(t)?e.removeAttribute(n):e.setAttribute(n,r?"":kn(t)?String(t):t)}function oo(e,n,t,i,s){if(n==="innerHTML"||n==="textContent"){t!=null&&(e[n]=n==="innerHTML"?Ia(t):t);return}const r=e.tagName;if(n==="value"&&r!=="PROGRESS"&&!r.includes("-")){const l=r==="OPTION"?e.getAttribute("value")||"":e.value,c=t==null?e.type==="checkbox"?"on":"":String(t);(l!==c||!("_value"in e))&&(e.value=c),t==null&&e.removeAttribute(n),e._value=t;return}let a=!1;if(t===""||t==null){const l=typeof e[n];l==="boolean"?t=Io(t):t==null&&l==="string"?(t="",a=!0):l==="number"&&(t=0,a=!0)}try{e[n]=t}catch{}a&&e.removeAttribute(s||n)}function Qs(e,n,t,i){e.addEventListener(n,t,i)}function Ju(e,n,t,i){e.removeEventListener(n,t,i)}const ao=Symbol("_vei");function qu(e,n,t,i,s=null){const r=e[ao]||(e[ao]={}),a=r[n];if(i&&a)a.value=i;else{const[l,c]=Xu(n);if(i){const p=r[n]=Qu(i,s);Qs(e,l,p,c)}else a&&(Ju(e,l,a,c),r[n]=void 0)}}const lo=/(?:Once|Passive|Capture)$/;function Xu(e){let n;if(lo.test(e)){n={};let i;for(;i=e.match(lo);)e=e.slice(0,e.length-i[0].length),n[i[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):ct(e.slice(2)),n]}let ms=0;const Yu=Promise.resolve(),Zu=()=>ms||(Yu.then(()=>ms=0),ms=Date.now());function Qu(e,n){const t=i=>{if(!i._vts)i._vts=Date.now();else if(i._vts<=t.attached)return;mn(ed(i,t.value),n,5,[i])};return t.value=e,t.attached=Zu(),t}function ed(e,n){if(N(n)){const t=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{t.call(e),e._stopped=!0},n.map(i=>s=>!s._stopped&&i&&i(s))}else return n}const co=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,nd=(e,n,t,i,s,r)=>{const a=s==="svg";n==="class"?Ku(e,i,a):n==="style"?Uu(e,t,i):Fi(n)?Ds(n)||qu(e,n,t,i,r):(n[0]==="."?(n=n.slice(1),!0):n[0]==="^"?(n=n.slice(1),!1):td(e,n,i,a))?(oo(e,n,i),!e.tagName.includes("-")&&(n==="value"||n==="checked"||n==="selected")&&ro(e,n,i,a,r,n!=="value")):e._isVueCE&&(/[A-Z]/.test(n)||!Ee(i))?oo(e,$n(n),i,r,n):(n==="true-value"?e._trueValue=i:n==="false-value"&&(e._falseValue=i),ro(e,n,i,a))};function td(e,n,t,i){if(i)return!!(n==="innerHTML"||n==="textContent"||n in e&&co(n)&&G(t));if(n==="spellcheck"||n==="draggable"||n==="translate"||n==="autocorrect"||n==="sandbox"&&e.tagName==="IFRAME"||n==="form"||n==="list"&&e.tagName==="INPUT"||n==="type"&&e.tagName==="TEXTAREA")return!1;if(n==="width"||n==="height"){const s=e.tagName;if(s==="IMG"||s==="VIDEO"||s==="CANVAS"||s==="SOURCE")return!1}return co(n)&&Ee(t)?!1:n in e}const Ri=e=>{const n=e.props["onUpdate:modelValue"]||!1;return N(n)?t=>vi(n,t):n},_t=Symbol("_assign"),uo={deep:!0,created(e,n,t){e[_t]=Ri(t),Qs(e,"change",()=>{const i=e._modelValue,s=Jt(e),r=e.checked,a=e[_t];if(N(i)){const l=Ws(i,s),c=l!==-1;if(r&&!c)a(i.concat(s));else if(!r&&c){const p=[...i];p.splice(l,1),a(p)}}else if(Ct(i)){const l=new Set(i);r?l.add(s):l.delete(s),a(l)}else a(Oa(e,r))})},mounted:ho,beforeUpdate(e,n,t){e[_t]=Ri(t),ho(e,n,t)}};function ho(e,{value:n,oldValue:t},i){e._modelValue=n;let s;if(N(n))s=Ws(n,i.props.value)>-1;else if(Ct(n))s=n.has(i.props.value);else{if(n===t)return;s=Xt(n,Oa(e,!0))}e.checked!==s&&(e.checked=s)}const id={deep:!0,created(e,{value:n,modifiers:{number:t}},i){const s=Ct(n);Qs(e,"change",()=>{const r=Array.prototype.filter.call(e.options,a=>a.selected).map(a=>t?Fo(Jt(a)):Jt(a));e[_t](e.multiple?s?new Set(r):r:r[0]),e._assigning=!0,vn(()=>{e._assigning=!1})}),e[_t]=Ri(i)},mounted(e,{value:n}){fo(e,n)},beforeUpdate(e,n,t){e[_t]=Ri(t)},updated(e,{value:n}){e._assigning||fo(e,n)}};function fo(e,n){const t=e.multiple,i=N(n);if(!(t&&!i&&!Ct(n))){for(let s=0,r=e.options.length;s<r;s++){const a=e.options[s],l=Jt(a);if(t)if(i){const c=typeof l;c==="string"||c==="number"?a.selected=n.some(p=>String(p)===String(l)):a.selected=Ws(n,l)>-1}else a.selected=n.has(l);else if(Xt(Jt(a),n)){e.selectedIndex!==s&&(e.selectedIndex=s);return}}!t&&e.selectedIndex!==-1&&(e.selectedIndex=-1)}}function Jt(e){return"_value"in e?e._value:e.value}function Oa(e,n){const t=n?"_trueValue":"_falseValue";return t in e?e[t]:n}const sd=["ctrl","shift","alt","meta"],rd={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,n)=>sd.some(t=>e[`${t}Key`]&&!n.includes(t))},od=(e,n)=>{const t=e._withMods||(e._withMods={}),i=n.join(".");return t[i]||(t[i]=((s,...r)=>{for(let a=0;a<n.length;a++){const l=rd[n[a]];if(l&&l(s,n))return}return e(s,...r)}))},ad=Ie({patchProp:nd},Iu);let mo;function ld(){return mo||(mo=hu(ad))}const cd=((...e)=>{const n=ld().createApp(...e),{mount:t}=n;return n.mount=i=>{const s=dd(i);if(!s)return;const r=n._component;!G(r)&&!r.render&&!r.template&&(r.template=s.innerHTML),s.nodeType===1&&(s.textContent="");const a=t(s,!1,ud(s));return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),a},n});function ud(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function dd(e){return Ee(e)?document.querySelector(e):e}const hd="/favicon.png",fd="/images/zoom-out.png",md="/images/zoom-in.png",pd="/images/about_music_logo.png",gd="/images/dk3-min.jpg",bd="/images/share-icon.png",vd="/images/powered_by_black-4339b4c3c9cf88da9bfb15a16c4f6914.png",lt=[{name:"Antonio Vivaldi",birth:1678,death:1741},{name:"Johann Sebastian Bach",birth:1685,death:1750},{name:"Domenico Scarlatti",birth:1685,death:1757},{name:"George Frideric Handel",birth:1685,death:1759},{name:"Joseph Haydn",birth:1732,death:1809},{name:"Wolfgang Amadeus Mozart",birth:1756,death:1791},{name:"Ludwig van Beethoven",birth:1770,death:1827},{name:"Niccolò Paganini",birth:1782,death:1840},{name:"Gioachino Rossini",birth:1792,death:1868},{name:"Franz Schubert",birth:1797,death:1828},{name:"Hector Berlioz",birth:1803,death:1869},{name:"Mikhail Glinka",birth:1804,death:1857},{name:"Felix Mendelssohn",birth:1809,death:1847},{name:"Frédéric Chopin",birth:1810,death:1849},{name:"Robert Schumann",birth:1810,death:1856},{name:"Franz Liszt",birth:1811,death:1886},{name:"Giuseppe Verdi",birth:1813,death:1901},{name:"Johann Strauss II",birth:1825,death:1899},{name:"Johannes Brahms",birth:1833,death:1897},{name:"Alexander Borodin",birth:1833,death:1887},{name:"Camille Saint-Saëns",birth:1835,death:1921},{name:"Jacques Offenbach",birth:1819,death:1880},{name:"Georges Bizet",birth:1838,death:1875},{name:"Modest Mussorgsky",birth:1839,death:1881},{name:"Pyotr Ilyich Tchaikovsky",birth:1840,death:1893},{name:"Antonín Dvořák",birth:1841,death:1904},{name:"Edvard Grieg",birth:1843,death:1907},{name:"Nikolai Rimsky-Korsakov",birth:1844,death:1908},{name:"Giacomo Puccini",birth:1858,death:1924},{name:"Gustav Mahler",birth:1860,death:1911},{name:"Claude Debussy",birth:1862,death:1918},{name:"Richard Strauss",birth:1864,death:1949},{name:"Jean Sibelius",birth:1865,death:1957},{name:"Erik Satie",birth:1866,death:1925},{name:"Alexander Scriabin",birth:1872,death:1915},{name:"Sergei Rachmaninoff",birth:1873,death:1943},{name:"Maurice Ravel",birth:1875,death:1937},{name:"Igor Stravinsky",birth:1882,death:1971},{name:"Sergei Prokofiev",birth:1891,death:1953},{name:"Carl Orff",birth:1895,death:1982},{name:"George Gershwin",birth:1898,death:1937},{name:"Dmitri Shostakovich",birth:1906,death:1975}],yd={"Richard Wagner":"comp/wagner.jpg","Igor Stravinsky":"comp/strawinski.jpg","Antonio Vivaldi":"comp/vivaldi.jpg","Johann Sebastian Bach":"comp/bach.png","Domenico Scarlatti":"comp/scarlatti.jpg","George Frideric Handel":"comp/handel.jpg","Joseph Haydn":"comp/haydn.jpg","Wolfgang Amadeus Mozart":"comp/mozart.jpg","Ludwig van Beethoven":"comp/beethoven.jpg","Niccolò Paganini":"comp/paganini.jpeg","Franz Schubert":"comp/schubert.jpg","Hector Berlioz":"comp/berlioz.jpg","Mikhail Glinka":"comp/glinka.jpg","Felix Mendelssohn":"comp/mendelssohn.jpg","Frédéric Chopin":"comp/chopin.jpeg","Robert Schumann":"comp/schumann.jpg","Franz Liszt":"comp/liszt.jpg","Giuseppe Verdi":"comp/verdi.jpg","Richard Strauss":"comp/rstrauss.jpg","Johann Strauss II":"comp/strauss.jpg","Johannes Brahms":"comp/brahms.jpg","Alexander Borodin":"comp/borodin.jpg","Camille Saint-Saëns":"comp/saint-saens.jpg","Jacques Offenbach":"comp/offenbach.jpg","Georges Bizet":"comp/bizet.jpg","Modest Mussorgsky":"comp/musorgskiy.jpg","Pyotr Ilyich Tchaikovsky":"comp/tchaikovsky.jpg","Antonín Dvořák":"comp/dvorak.jpg","Edvard Grieg":"comp/grieg.jpg","Nikolai Rimsky-Korsakov":"comp/rimsky-korsakov.jpg","Gustav Mahler":"comp/mahler.jpg","Claude Debussy":"comp/debussy.jpg","Erik Satie":"comp/satie.jpg","Alexander Scriabin":"comp/scriabin.jpg","Sergei Rachmaninoff":"comp/rachmaninoff.jpg","Maurice Ravel":"comp/ravel.jpg","Béla Bartók":"comp/bartok.jpg","Sergei Prokofiev":"comp/prokofiev.jpg","Dmitri Shostakovich":"comp/shostakovich.jpg","George Gershwin":"comp/gershwin.jpg","Carl Orff":"comp/orff.jpg","Carl Maria von Weber":"comp/weber.jpg","Giacomo Puccini":"comp/puccini.jpg","Jean Sibelius":"comp/sibelius.jpg","Christoph Willibald Gluck":"comp/gluck.jpg","Gioachino Rossini":"comp/rossini.jpg","Jean-Philippe Rameau":"comp/rameau.jpg"};function Da(e){const n=yd[e];return n?n.startsWith("/")?n:`/${n}`:null}function wd(e){const n=String(e||"").trim().split(/\s+/).filter(Boolean);if(n.length<=1)return e;const t=n[n.length-1];return/^(?:[IVX]+|\d+|Jr\.?|Sr\.?)$/i.test(t)&&n.length>=2?n[n.length-2]+" "+t:t}const Qt=[{id:"baroque",label:"Baroque",from:1600,to:1750},{id:"classical",label:"Classical",from:1750,to:1820},{id:"romantic",label:"Romantic",from:1820,to:1900},{id:"twentieth",label:"20th Century",from:1900,to:2e3}];let Fs=Qt.reduce((e,n)=>(e[n.id]=n.label,e),{});const po=Math.min(...lt.map(e=>e.birth)),kd=Math.max(...lt.map(e=>e.birth));let Is=[...lt],jn=null,Vn=null;const Sd={r:255,g:255,b:255},_d={r:37,g:99,b:235};Pt("#f3f4f6"),vo(1750),Pt("#e6eef8"),vo(1820),Pt("#e8f4ff"),Pt("#eef2f7");const Pi=1677.5,Si=1980,Na=Si-Pi,Td=6,Cd=2,Ed=0,_i={barHeight:50,widthScale:1,fontScale:1},mt={barHeight:{min:25,max:150},widthScale:{min:.05,max:2},fontScale:{min:.9,max:1.8}};let Gn={..._i};function ps(e,n,t){return Number.isNaN(e)?n:Math.min(t,Math.max(n,e))}function go(e={}){Gn={barHeight:ps(e.barHeight??Gn.barHeight??_i.barHeight,mt.barHeight.min,mt.barHeight.max),widthScale:ps(e.widthScale??Gn.widthScale??_i.widthScale,mt.widthScale.min,mt.widthScale.max),fontScale:ps(e.fontScale??Gn.fontScale??_i.fontScale,mt.fontScale.min,mt.fontScale.max)}}function Md(){return Td*Gn.widthScale}function hi(){const e=document.querySelector(".timeline-inner"),n=document.getElementById("timeline");if(!e||!n)return;const t=Na*Md()+Ed,i=(n.clientWidth||window.innerWidth)*Cd*Gn.widthScale,s=Math.max(t,i);e.style.width=s+"px",e.style.minWidth=s+"px"}function rt(e){return(e-Pi)/Na*100}function Ba(e){return Number.isNaN(e)?0:Math.min(1,Math.max(0,e))}function Pt(e){const n=e.replace("#",""),t=n.length===3?n.split("").map(s=>s+s).join(""):n,i=parseInt(t,16);return{r:i>>16&255,g:i>>8&255,b:i&255}}function gs({r:e,g:n,b:t}){const i=s=>Math.round(s).toString(16).padStart(2,"0");return`#${i(e)}${i(n)}${i(t)}`}function bo(e,n,t){const i=Ba(t);return{r:e.r+(n.r-e.r)*i,g:e.g+(n.g-e.g)*i,b:e.b+(n.b-e.b)*i}}function vo(e){const n=kd-po;return n<=0?0:Ba((e-po)/n)}const Ld={baroque:"#f3f4f6",classical:"#eef5ff",romantic:"#e3f0ff",twentieth:"#dfdfdf"};function er(e){return Ld[e]||"#f3f4f6"}function xd(e){return e?Fs[e]||Qt.find(n=>n.id===e)?.label||e:""}function yo(e={}){!e||typeof e!="object"||(Fs={...Fs,...e})}function zd(e){const n=Qt.find(t=>e>=t.from&&e<t.to);return n?n.id:null}function Ad(e,n){const t=Number(e),i=Number(n),s=zd(t);if(!Number.isFinite(t)||!Number.isFinite(i)||i<=t)return s;const r=i-t;let a=null,l=0;return Qt.forEach(c=>{const p=Math.max(0,Math.min(i,c.to)-Math.max(t,c.from));p>l&&(l=p,a=c.id)}),a&&l>r/2?a:s}function Rd(e){const n=er(e),t=Pt(n),i=bo(t,Sd,.12),s=bo(t,_d,.04);return`linear-gradient(145deg, ${gs(i)} 0%, ${gs(t)} 58%, ${gs(s)} 100%)`}function wo(e){Array.isArray(e)?Is=[...e]:Is=[...lt]}function nr(){const e=document.getElementById("gantt"),n=document.getElementById("axis");if(!e)return;const t=s=>Number.isInteger(jn)&&s===jn,i=s=>Number.isInteger(Vn)&&s===Vn;e.querySelectorAll(".bar").forEach(s=>{const r=Number(s.getAttribute("data-lane-index"));s.classList.toggle("bar--selected",t(r)),s.classList.toggle("bar--hovered",i(r))}),e.querySelectorAll(".bar-connector").forEach(s=>{const r=Number(s.getAttribute("data-lane-index")),a=t(r),l=i(r);s.classList.toggle("bar-connector--selected",a),s.classList.toggle("bar-connector--hover",l)}),n&&n.querySelectorAll(".life-label").forEach(s=>{const r=Number(s.getAttribute("data-lane-index")),a=t(r),l=i(r);s.classList.toggle("life-label--active",a||l),s.classList.toggle("life-label--hover",l)})}function Wa(e){Number.isInteger(e)?jn=e:jn=null,nr()}function it(e){Number.isInteger(e)?Vn=e:Vn=null,nr()}function ko(){const e=document.getElementById("axis");if(!e)return;e.innerHTML="";const n=Math.ceil(Pi/10)*10,t=Math.ceil(Si/10)*10;Qt.forEach(i=>{const s=Math.max(i.from,Pi),r=Math.min(i.to,Si);if(r<=s)return;const a=document.createElement("div");a.className="era-band",a.style.left=rt(s)+"%",a.style.width=rt(r)-rt(s)+"%",a.style.backgroundImage="none",a.style.backgroundColor=er(i.id),a.textContent=xd(i.id)||i.label,i.id==="baroque"&&(a.style.justifyContent="flex-end",a.style.paddingLeft="6px",a.style.paddingRight="26px",a.style.textAlign="right"),r===Si&&(a.style.borderRight="none"),e.appendChild(a)});for(let i=n;i<=t;i+=10){const s=document.createElement("div"),r=i%50===0;s.className="axis-tick "+(r?"major":"minor"),s.style.left=rt(i)+"%",e.appendChild(s);const a=document.createElement("div");a.className="axis-label "+(r?"axis-label-major":"axis-label-minor"),a.style.left=rt(i)+"%",a.textContent=i,e.appendChild(a)}}function fi(){const e=document.getElementById("gantt"),n=document.getElementById("axis"),t=document.getElementById("timeline");if(!e)return;e.innerHTML="",n&&n.querySelectorAll(".life-label").forEach(R=>R.remove());const i=parseFloat(window.getComputedStyle(e).marginTop||"0")||0,s=document.createDocumentFragment(),r=document.createDocumentFragment(),a=Is||[],l=e&&e.clientWidth||n&&n.clientWidth||t&&t.clientWidth||window.innerWidth,c=6,p=c/l*100,h=[...a].sort((R,F)=>R.birth-F.birth),g=h.length,T=h.map((R,F)=>({composer:R,laneIndex:F}));Number.isInteger(jn)&&(jn<0||jn>=g)&&(jn=null),Number.isInteger(Vn)&&(Vn<0||Vn>=g)&&(Vn=null);const M=2,P=Gn.barHeight,W=P+M,ce=g*P+Math.max(0,g-1)*M;e.style.height=ce+"px",g&&(T.forEach(({composer:R,laneIndex:F})=>{const $=R.displayName||R.name,I=rt(R.birth),ee=rt(R.death),B=document.createElement("div");B.className="bar",B.setAttribute("data-lane-index",F),B.setAttribute("data-name",R.name);const V=Ad(R.birth,R.death);B.style.backgroundImage=Rd(V),B.style.backgroundColor=er(V);const Q=I,K=ee-I,Y=ee-p,A=F*W+P*.5+i,Z=(ne,ve)=>{const pe=document.createElement("div");pe.className="bar-connector",pe.setAttribute("data-lane-index",F),pe.setAttribute("data-side",ve),pe.style.left=ne+"%",pe.style.top=-i+"px",pe.style.height=A+"px",s.appendChild(pe)};if(Z(Q,"start"),Z(Y,"end"),n){const ne=document.createElement("div");ne.className="life-label",ne.setAttribute("data-lane-index",F),ne.setAttribute("data-side","start"),ne.style.left=Q+"%",ne.textContent=R.birth,r.appendChild(ne);const ve=document.createElement("div");ve.className="life-label",ve.setAttribute("data-lane-index",F),ve.setAttribute("data-side","end"),ve.style.left=Y+"%",ve.textContent=R.death,r.appendChild(ve)}B.style.left=Q+"%",B.style.width="calc("+K+"% - "+c+"px)",B.style.top=F*W+"px",B.style.height=P+"px",B.style.lineHeight="1.15",B.style.fontSize=P*.28*Gn.fontScale+"px";const de=Da(R.name);let xe=0;if(de){const ne=document.createElement("img");ne.className="bar-avatar",xe=Math.max(10,Math.round(P*1.1)),ne.style.width=xe+"px",ne.style.height=xe+"px",ne.src=de,ne.alt=$||R.name,B.appendChild(ne)}const me=document.createElement("div");me.className="bar-text";const J=document.createElement("span");J.className="bar-label",J.textContent=$,me.appendChild(J);const ie=document.createElement("span");ie.className="bar-dates",ie.textContent=`${R.birth} – ${R.death}`,me.appendChild(ie),B.appendChild(me),e.appendChild(B);const en=()=>{J.scrollWidth>J.clientWidth&&(J.textContent=wd($))};J.clientWidth>0?en():typeof window<"u"&&window.requestAnimationFrame(en),B.addEventListener("click",ne=>{ne.stopPropagation(),Wa(F),window.dispatchEvent(new CustomEvent("composer-select",{detail:{composer:R,laneIndex:F}}))}),B.addEventListener("mouseenter",()=>it(F)),B.addEventListener("mouseleave",()=>it(null)),B.addEventListener("touchstart",ne=>{if(!ne.touches||ne.touches.length!==1)return;const ve=ne.touches[0];B.dataset.touchStartX=String(ve.clientX),B.dataset.touchStartY=String(ve.clientY),it(F)},{passive:!0}),B.addEventListener("touchmove",ne=>{if(!ne.touches||ne.touches.length!==1)return;const ve=Number(B.dataset.touchStartX||"0"),pe=Number(B.dataset.touchStartY||"0"),In=ne.touches[0],ut=Math.abs(In.clientX-ve),pn=Math.abs(In.clientY-pe);(ut>6||pn>6)&&it(null)},{passive:!0}),B.addEventListener("touchend",()=>{it(null)},{passive:!0}),B.addEventListener("touchcancel",()=>{it(null)},{passive:!0})}),e.appendChild(s),n&&n.appendChild(r),nr())}function Pd(){const e=document.getElementById("timeline");if(!e)return;let n=!1,t=!1;const i=4;let s=0,r=0,a=0,l=0,c=0,p=0,h=null;const g=()=>{e.dispatchEvent(new CustomEvent("timeline-pan-end"))},T=()=>{t||(t=!0,e.classList.add("panning"),e.dataset.panning="true",e.dispatchEvent(new CustomEvent("timeline-pan-start")))},M=()=>{t&&(t=!1,e.classList.remove("panning"),e.dataset.panning="false",g())};function P(){if(h=null,!n||!t)return;const V=c-s,Q=p-r;e.scrollLeft=a-V,e.scrollTop=l-Q}const W=V=>{V.button===0&&(n=!0,t=!1,e.classList.remove("panning"),s=V.clientX,r=V.clientY,c=V.clientX,p=V.clientY,a=e.scrollLeft,l=e.scrollTop,e.scrollTo&&e.scrollTo({left:e.scrollLeft,top:e.scrollTop,behavior:"auto"}),V.preventDefault())},ce=V=>{if(n){if(c=V.clientX,p=V.clientY,!t){const Q=Math.abs(c-s),K=Math.abs(p-r);if(Q>i||K>i)T();else return}h===null&&(h=window.requestAnimationFrame(P)),V.preventDefault()}},R=()=>{n&&(n=!1,M(),h!==null&&(cancelAnimationFrame(h),h=null))};e.addEventListener("mousedown",W),window.addEventListener("mousemove",ce),window.addEventListener("mouseup",R);let F=null,$=!1;const I=V=>{if(F!==null||V.touches.length!==1)return;const Q=V.touches[0];F=Q.identifier,$=!1,s=Q.clientX,r=Q.clientY,c=Q.clientX,p=Q.clientY,a=e.scrollLeft,l=e.scrollTop,e.scrollTo&&e.scrollTo({left:e.scrollLeft,top:e.scrollTop,behavior:"auto"}),M()},ee=V=>{if(F===null)return;const Q=Array.from(V.touches).find(Z=>Z.identifier===F);if(!Q)return;const K=Q.clientX-s,Y=Q.clientY-r,ue=Math.abs(K),A=Math.abs(Y);if(!$)if(ue>i||A>i)$=!0,T();else return;e.scrollLeft=a-K,e.scrollTop=l-Y,V.preventDefault()},B=V=>{F===null||!Array.from(V.changedTouches).some(K=>K.identifier===F)||(F=null,$=!1,M())};e.addEventListener("touchstart",I,{passive:!0}),e.addEventListener("touchmove",ee,{passive:!1}),e.addEventListener("touchend",B,{passive:!0}),e.addEventListener("touchcancel",B,{passive:!0})}function Fd(){const e=document.getElementById("timeline"),n=document.getElementById("gantt"),t=document.getElementById("axis");if(!e||!n)return()=>{};const i=.5,s=12,r=(p,h,g)=>{const T=p.getBoundingClientRect();return T.bottom>h&&T.top<g},a=()=>e.scrollTop+e.clientHeight>=e.scrollHeight-s,l=()=>{if(a())return;const p=Array.from(n.querySelectorAll(".bar"));if(!p.length)return;const h=e.getBoundingClientRect(),T=(t?.getBoundingClientRect()?.bottom??h.top)+1,M=h.bottom,P=p.find(F=>r(F,T,M));if(!P)return;const W=P.getBoundingClientRect(),ce=T,R=W.top-ce;Math.abs(R)<=i||Hs(e,{left:e.scrollLeft,top:Math.max(0,e.scrollTop+R),behavior:"auto"})},c=()=>{l()};return e.addEventListener("timeline-pan-end",c),()=>{e.removeEventListener("timeline-pan-end",c)}}function Hs(e,{left:n=0,top:t=0,behavior:i="smooth"}){const r=window.matchMedia?.("(prefers-reduced-motion: reduce)").matches?"auto":i;if(e.scrollTo){e.scrollTo({left:n,top:t,behavior:r});return}e.scrollLeft=n,e.scrollTop=t}function Id(e={}){go(e.settings||{});const n=Object.prototype.hasOwnProperty.call(e,"composers")?e.composers:lt;wo(n),yo(e.eraLabels||{}),hi(),ko(),fi(),Pd();const t=Fd(),i=()=>hi();window.addEventListener("resize",i);const s=document.getElementById("timeline");s&&(s.style.visibility="visible");function r(){const l=document.getElementById("timeline");l&&Hs(l,{left:0,top:0,behavior:"smooth"})}function a(){const l=document.getElementById("timeline");l&&Hs(l,{left:Math.max(0,l.scrollWidth-l.clientWidth),top:Math.max(0,l.scrollHeight-l.clientHeight),behavior:"smooth"})}return{goToStart:r,goToEnd:a,setComposers(l){wo(l),fi()},updateSettings(l){go(l||{}),hi(),fi()},updateEraLabels(l){yo(l||{}),hi(),ko(),fi()},setSelectedLane:Wa,setHoveredLane:it,destroy(){window.removeEventListener("resize",i),t()}}}const Ka=(e,n)=>{const t=e.__vccOpts||e;for(const[i,s]of n)t[i]=s;return t},Hd={class:"timeline-wrapper"},Od={__name:"ComposersTimeline",props:{composers:{type:Array,default:()=>[]},settings:{type:Object,default:()=>({})},eraLabels:{type:Object,default:()=>({})}},setup(e){const n=e;let t=null;const i=s=>{const r=s.target?.closest?.(".bar");if(!r)return;const a=r.getAttribute("data-name"),l=Number(r.getAttribute("data-lane-index"));window.dispatchEvent(new CustomEvent("composer-select",{detail:{composer:a?{name:a}:null,laneIndex:Number.isNaN(l)?null:l}}))};return Ki(()=>{const s=document.getElementById("timeline");s&&s.addEventListener("click",i),t=Id({composers:n.composers,settings:n.settings,eraLabels:n.eraLabels}),window.timeline=t}),ji(()=>{const s=document.getElementById("timeline");s&&s.removeEventListener("click",i),t?.destroy?.(),t=null}),qe(()=>n.composers,s=>{t&&t.setComposers(s)},{deep:!0}),qe(()=>n.settings,s=>{!t||!t.updateSettings||t.updateSettings(s)},{deep:!0}),qe(()=>n.eraLabels,s=>{!t||!t.updateEraLabels||t.updateEraLabels(s)},{deep:!0}),(s,r)=>(ge(),ye("div",Hd,[...r[0]||(r[0]=[E("div",{id:"timeline"},[E("div",{class:"timeline-inner"},[E("div",{id:"axis",class:"axis"}),E("div",{id:"gantt"})])],-1)])]))}},Dd=Ka(Od,[["__scopeId","data-v-095e97d5"]]),Nd=`# Composer fact sheets
...
- Orff-Schulwerk: Sein paedagogisches Konzept Orff-Schulwerk praegte Musikunterricht weltweit - Bewegung, Sprache und Perkussion als Basis.`,Bd={class:"app"},Wd={class:"topbar"},Kd={class:"language-switcher"},jd={class:"visually-hidden",for:"language-select"},Vd=["aria-label"],Gd=["value"],Ud={class:"menu-nav"},$d={class:"content"},Jd={key:0},qd={class:"control-stack control-pill",role:"group","aria-label":"Timeline controls"},Xd={class:"filter-dock__header"},Yd=["aria-pressed","aria-label"],Zd=["src"],Qd={key:0,class:"filter-dock__body"},eh={class:"filter-dock__body-inner"},nh={class:"nav-controls",role:"group","aria-label":"Timeline navigation and zoom"},th=["disabled"],ih=["disabled"],sh=["disabled"],rh=["disabled"],oh={class:"filter-panel",role:"group","aria-label":"Composer filters"},ah={class:"filter-panel__options"},lh=["onUpdate:modelValue","aria-label"],ch={class:"filter-panel__label"},uh={key:1,class:"about"},dh={class:"about__card"},hh={class:"about__title"},fh={class:"about__text"},mh={class:"about__text"},ph={class:"about__author"},gh={class:"about__author-body"},bh={class:"about__author-label"},vh={class:"about__author-name"},yh={class:"about__contributors"},wh={class:"about__contributors-title"},kh={class:"about__contributors-list"},Sh={class:"about__contributors-name"},_h=["href"],Th={key:0,class:"about__contributors-toggle"},Ch={class:"about__contributors-toggle-label"},Eh={class:"composer-modal__content"},Mh={class:"composer-modal__header"},Lh={class:"composer-modal__titles"},xh={class:"composer-modal__name"},zh={key:0,class:"composer-modal__dates"},Ah={class:"composer-modal__header-actions"},Rh=["aria-label"],Ph={key:0,class:"composer-modal__share-feedback"},Fh={class:"composer-modal__nav composer-modal__nav--header","aria-label":"Composer navigation"},Ih=["disabled"],Hh={class:"composer-modal__position"},Oh=["disabled"],Dh={class:"composer-modal__body"},Nh={key:0,class:"composer-modal__hero"},Bh=["src","alt"],Wh={class:"composer-modal__nav composer-modal__nav--mobile","aria-label":"Composer navigation"},Kh=["disabled"],jh={class:"composer-modal__position"},Vh=["disabled"],Gh={class:"composer-modal__hero-meta"},Uh={class:"composer-modal__name-small"},$h={key:0,class:"composer-modal__dates-small"},Jh={class:"composer-modal__playlist"},qh={class:"composer-modal__playlist-header"},Xh={class:"composer-modal__playlist-title"},Yh={key:0,class:"sc-powered",href:"https://soundcloud.com",target:"_blank",rel:"noopener noreferrer","aria-label":"Powered by SoundCloud"},Zh=["data-soundcloud-playlist","data-soundcloud-playlist-alt"],Qh={class:"sc-player__status"},ef={class:"sc-player__status-text"},nf={key:1,class:"composer-modal__playlist-box composer-modal__playlist-box--empty"},tf={class:"composer-modal__description"},sf={key:0,class:"composer-modal__facts-title"},rf={key:1,class:"composer-modal__facts"},of={class:"composer-modal__fact-text"},af={key:2,class:"composer-modal__muted"},pt="en",So="timeline-language",_o="timeline-language-user-set",To="timeline-filter-groups",mi="/composer/",pi=25,Co=150,bs=.2,Eo=1.5,lf=.35,vs=1.45,Mo=.5,cf=.6,gi=1,We=12,ys=35,ws=8,uf=320,df="(max-width: 720px), (pointer: coarse)",hf=.88,ff=1.12,bi=6,mf=520,pf=2,gf={__name:"App",setup(e){const n={en:{label:"En",appTitle:"The Story of Classical Music in Time",languageLabel:"Language",navigation:{composers:"Composers Timeline",about:"About"},modal:{keyWorks:"Key works to know"},share:{button:"Share",copied:"Link copied"},soundcloud:{loading:"Loading tracks from SoundCloud..."},about:{title:"Understand classical music by ear",intro:"Sometimes you hear a familiar melody and know it is classical music. But whose? Bach, Beethoven, or Mozart - it can be hard to tell immediately.",goal:"This site is designed to help you hear the character of each era and each composer, compare their stories and musical voices, and never get lost in the names again.",authorLabel:"Project creator and author",authorName:"Dmitrii Kotikov",contributorsTitle:"Project collaborators",testFeaturesLabel:"Turn on test functions",contributors:[{name:"Timofey Muhortov",url:"https://timofeymuhortov.ru",linkText:"timofeymuhortov.ru"},{name:"Olga Matveeva",url:"https://facebook.com/olga.shibanova",linkText:"facebook.com/olga.shibanova"}]},eras:{baroque:"Baroque",classical:"Classical",romantic:"Romantic",twentieth:"20th Century"},composers:{},filter:{groups:{essentials:"Essential Icons",core:"Core Classics",expanded:"Extended"},apply:"Apply",minimizeControls:"Hide timeline controls",restoreControls:"Show timeline controls"}},de:{label:"De",appTitle:"Die Geschichte der klassischen Musik",languageLabel:"Sprache",navigation:{composers:"Zeitstrahl der Komponisten",about:"Über das Projekt"},modal:{keyWorks:"Wichtige Werke zum Kennenlernen"},share:{button:"Teilen",copied:"Link kopiert"},soundcloud:{loading:"Tracks von SoundCloud werden geladen..."},about:{title:"Klassische Musik mit dem Ohr verstehen",intro:"Manchmal hört man eine vertraute Melodie und weiß: Das ist klassische Musik. Aber von wem? Bach, Beethoven oder Mozart – das erkennt man nicht immer sofort.",goal:"Diese Seite soll helfen, den Charakter jeder Epoche und jedes Komponisten zu hören, ihre Geschichten und Klangfarben zu vergleichen und sich in all den Namen nicht mehr zu verlieren.",authorLabel:"Initiator und Autor des Projekts",authorName:"Dmitrii Kotikov",contributorsTitle:"Projektpartner",contributors:[{name:"Timofey Muhortov",url:"https://timofeymuhortov.ru",linkText:"timofeymuhortov.ru"},{name:"Olga Matveeva",url:"https://facebook.com/olga.shibanova",linkText:"facebook.com/olga.shibanova"}]},eras:{baroque:"Barock",classical:"Klassik",romantic:"Romantik",twentieth:"20. Jahrhundert"},composers:{},filter:{groups:{essentials:"Essenzielle Ikonen",core:"Kernklassiker",expanded:"Erweiterte Klassiker"},apply:"Anwenden",minimizeControls:"Steuerungselemente ausblenden",restoreControls:"Steuerungselemente anzeigen"}},ru:{label:"Ru",appTitle:"История классической музыки",languageLabel:"Язык",navigation:{composers:"Таймлайн композиторов",about:"О проекте"},modal:{keyWorks:"Ключевые произведения"},share:{button:"Поделиться",copied:"Ссылка скопирована"},soundcloud:{loading:"Загружаем треки из SoundCloud..."},about:{title:"Понимать классическую музыку на слух",intro:"Иногда слышишь знакомую мелодию и понимаешь: это классическая музыка. Но чья? Баха, Бетховена или Моцарта - сразу не всегда понятно.",goal:"Этот сайт помогает услышать характер каждой эпохи и каждого композитора, сравнивать их истории и музыкальные голоса - и больше не теряться в именах.",authorLabel:"Автор и создатель проекта",authorName:"Дмитрий Котиков",contributorsTitle:"Соавторы проекта",testFeaturesLabel:"Включить тестовые функции",contributors:[{name:"Тимофей Мухортов",url:"https://timofeymuhortov.ru",linkText:"timofeymuhortov.ru"},{name:"Ольга Матвеева",url:"https://facebook.com/olga.shibanova",linkText:"facebook.com/olga.shibanova"}]},eras:{baroque:"Барокко",classical:"Классицизм",romantic:"Романтизм",twentieth:"XX век"},composers:{},filter:{groups:{essentials:"Ключевые фигуры",core:"Основа классики",expanded:"Расширенный канон"},apply:"Применить",minimizeControls:"Скрыть панель управления",restoreControls:"Показать панель управления"}}},t=Object.keys(n),i=Fe(!1),s={en:"essentials",de:"- Kurzprofil",ru:"ключевые факты"},r=Fe(pt),a=Fe(!1),l=U(()=>!a.value),c=U(()=>n[r.value]||n.en),p=U(()=>t.map(o=>({value:o,label:n[o]?.label||o.toUpperCase()}))),h=U(()=>c.value.appTitle),g=U(()=>c.value.languageLabel||"Language"),T=U(()=>c.value.navigation||n.en.navigation),M=U(()=>c.value.about||n.en.about),P=U(()=>M.value.contributors||n.en.about.contributors||[]),W=U(()=>M.value.testFeaturesLabel||n.en.about.testFeaturesLabel||"Test functions"),ce=U(()=>c.value.eras||n.en.eras),R=U(()=>c.value.soundcloud||n.en.soundcloud||{}),F=U(()=>R.value.loading||"Loading tracks from SoundCloud..."),$=U(()=>c.value.composers||{}),I=U(()=>{const o=$.value.names||{},d={};return Object.entries(o).forEach(([m,v])=>{d[Be(m)]=v}),d}),ee=U(()=>{const o={};return Object.entries(Va||{}).forEach(([d,m])=>{const v=Be(d),x=m?.[r.value];if(x){o[v]=x;return}r.value==="en"&&m?.en&&(o[v]=m.en)}),o}),B=U(()=>({...ee.value,...I.value})),V=U(()=>c.value.filter||n.en.filter),Q=U(()=>({essentials:V.value.groups?.essentials||"Essential Icons",core:V.value.groups?.core||"Core Classics",expanded:V.value.groups?.expanded||"Extended Classics"})),K=U(()=>{const o=$.value.descriptions||{},d={};return Object.entries(o).forEach(([m,v])=>{d[Be(m)]=v}),d}),Y=U(()=>{const o=$.value.factsTitles||{},d={};return Object.entries(o).forEach(([m,v])=>{d[Be(m)]=v}),d}),ue=U(()=>c.value.modal||n.en.modal),A=U(()=>c.value.share||n.en.share),Z=Fe(!1),de=Fe("composers"),xe=[43,50,65],me=[30,35,45],J="".replace(/\/$/,""),en="https://soundcloud.com/dmitry-kotikov/sets/",ne="https://soundcloud.com/dmitry-kotikov/sets/antonio-vivaldi",ve=new Set;function pe(o,d,m){return Number.isNaN(o)?d:Math.min(m,Math.max(d,o))}function In(o){const d=pe((o-pi)/(Co-pi),0,1),m=Math.pow(d,lf),v=bs+(Eo-bs)*m;return pe(v,bs,Eo)}function ut(o){const d=pe((o-pi)/(Co-pi),0,1),m=Math.pow(d,cf),v=vs-(vs-Mo)*m;return pe(v,Mo,vs)}const pn=[{id:"essentials",label:"Essential Icons",composers:["Johann Sebastian Bach","Wolfgang Amadeus Mozart","Ludwig van Beethoven","Pyotr Ilyich Tchaikovsky","Frédéric Chopin","Antonio Vivaldi","Claude Debussy","Sergei Rachmaninoff"]},{id:"core",label:"Core Classics",composers:["Johannes Brahms","Giuseppe Verdi","Richard Strauss","George Frideric Handel","Franz Schubert","Felix Mendelssohn","Robert Schumann","Franz Liszt","Antonín Dvořák","Edvard Grieg","Maurice Ravel","Giacomo Puccini","Gustav Mahler","Domenico Scarlatti","Camille Saint-Saëns","Georges Bizet","Gioachino Rossini","Dmitri Shostakovich","Sergei Prokofiev","Mikhail Glinka","Johann Strauss II","Alexander Borodin","Modest Mussorgsky","Nikolai Rimsky-Korsakov","Erik Satie","Joseph Haydn"]},{id:"expanded",label:"Extended Classics",composers:["Niccolò Paganini","Hector Berlioz","Jacques Offenbach","Alexander Scriabin","George Gershwin","Igor Stravinsky","Jean Sibelius","Carl Orff"]}];function Hn(){return pn.reduce((o,d)=>(o[d.id]=d.id!=="expanded",o),{})}function dt(o){const d=Hn();return!o||typeof o!="object"||pn.forEach(m=>{const v=o[m.id];typeof v=="boolean"&&(d[m.id]=v)}),d}const nn=Fe(Hn()),Et=U(()=>{const o=c.value.filter||{};return{minimize:o.minimizeControls||"Hide timeline controls",restore:o.restoreControls||"Show timeline controls"}}),Ae=Fe(null),cn=Fe(We),u=Fe(null);let f=0;const b=Fe(!1);let S=null;function w(){return typeof window>"u"||!window.matchMedia?!1:window.matchMedia(df).matches}const y=Fe("bottom-left"),_=wt({active:!1,pointerId:null,startX:0,startY:0,startLeft:0,startTop:0,element:null}),L=U(()=>{const o={left:`${cn.value}px`,transition:_.active?"none":"left 360ms cubic-bezier(0.22, 0.61, 0.36, 1)"};return u.value!=null&&(o.top=`${u.value}px`),o}),C=wt({active:!1,startDistance:0});function k(o,d){const m=o.clientX-d.clientX,v=o.clientY-d.clientY;return Math.hypot(m,v)}const H=wt({barHeight:xe[gi],widthScale:In(me[gi]),fontScale:ut(xe[gi])}),z=Fe(gi),O=U(()=>z.value<=0),j=U(()=>z.value>=xe.length-1),X=Fe(!0),le=Fe(!1);function se(o){const d=pe(o,0,xe.length-1);z.value=d;const m=xe[d];H.barHeight=m,H.widthScale=In(me[d]),H.fontScale=ut(m)}function ze(o){const d=o>0?1:-1;se(z.value+d)}function _e(){const o=document.getElementById("timeline");if(!o)return;const d=Math.max(0,o.scrollWidth-o.clientWidth),m=Math.max(0,o.scrollHeight-o.clientHeight);X.value=o.scrollLeft<=bi&&o.scrollTop<=bi,le.value=o.scrollLeft>=d-bi&&o.scrollTop>=m-bi}async function tn(){window.timeline&&typeof window.timeline.goToStart=="function"&&window.timeline.goToStart(),_e(),await vn(),Lt()}async function sn(){window.timeline&&typeof window.timeline.goToEnd=="function"&&window.timeline.goToEnd(),_e(),await vn(),Zi()}function qn(o,{left:d,top:m,duration:v=mf}={}){const x=o.scrollLeft,D=o.scrollTop,q=Number.isFinite(d)?d:x,ke=Number.isFinite(m)?m:D,Te=q-x,Se=ke-D;if(!Te&&!Se)return;const Re=performance.now(),Ce=$e=>{const un=$e-Re,te=Math.min(1,un/v),Le=te<.5?4*te*te*te:1-Math.pow(-2*te+2,3)/2;o.scrollLeft=x+Te*Le,o.scrollTop=D+Se*Le,te<1&&requestAnimationFrame(Ce)};requestAnimationFrame(Ce)}async function ei(){if(de.value!=="composers"||!Mt.value.length)return;await vn();const o=document.getElementById("timeline");if(!o)return;const d=o.querySelector('.bar[data-lane-index="0"]');if(!d)return;const m=o.getBoundingClientRect(),v=d.getBoundingClientRect();let x=o.scrollLeft,D=o.scrollTop;const q=m.left+pf,ke=v.left-q;if(x=Math.max(0,o.scrollLeft+ke),v.top<m.top||v.bottom>m.bottom){const Te=v.top-m.top;D=Math.max(0,o.scrollTop+Te)}qn(o,{left:x,top:D}),_e()}async function Ne(){await ei()}const rn=U(()=>{const o=pn.map(m=>m.id).filter(m=>nn.value[m]),d=new Set;return o.forEach(m=>{pn.find(x=>x.id===m)?.composers?.forEach(x=>d.add(x))}),d}),Mt=U(()=>{const o=rn.value;return o.size?lt.filter(d=>o.has(d.name)):[]}),Ue=U(()=>[...Mt.value].sort((o,d)=>o.birth-d.birth).map(o=>({...o,displayName:Yi(o.name)}))),{descriptionsByLocale:tr,playlistIdsByKey:ja,namesByLocale:Va}=Qa(Nd),we=Fe(null),$i=Fe(!1),ni=Fe("");let Xn=null;const Ji=U(()=>we.value!==null),Me=U(()=>we.value===null?null:Ue.value[we.value]),ti=U(()=>Me.value?Yi(Me.value.name):""),ir=U(()=>Me.value?Da(Me.value.name):null),sr=U(()=>Me.value?el(Me.value.name):""),rr=U(()=>Me.value?nl(Me.value.name):""),Ga=U(()=>Me.value?ol(Me.value.name):[]),Ua=U(()=>Ga.value.map(o=>Cl(o)).filter(Boolean)),Yn=U(()=>{const o=Ua.value.filter(Boolean);return o.length?o:[ne]}),qi=U(()=>(we.value??0)>0),Xi=U(()=>we.value!==null&&we.value<Ue.value.length-1);function Be(o){return o.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g," ").trim()}function $a(o){return Be(o).replace(/\s+/g,"-")}function or(o){const d=$a(o);return`${mi}${encodeURIComponent(d)}`}function Ja(o){return o.startsWith(mi)?o.slice(mi.length):""}function qa(o){const d=Be(String(o||"").replace(/-/g," ")),m=lt.find(v=>Be(v.name)===d);return m?m.name:""}function Xa(o){if(!o)return;const d=pn.find(m=>m.composers.includes(o));!d||nn.value[d.id]||(nn.value={...nn.value,[d.id]:!0})}async function ar(o=window.location.pathname){$i.value=!0;try{ii(o);const d=Ja(o);if(!d){we.value=null;return}const m=decodeURIComponent(d),v=qa(m);if(!v){we.value=null;return}Xa(v),await vn();const x=Ue.value.findIndex(D=>D.name===v);we.value=x>=0?x:null}finally{$i.value=!1}}function Ya(o){if(!o||typeof window>"u")return"";const d=or(o);return new URL(d,window.location.origin).toString()}async function Za(){if(!Me.value)return;const o=Ya(Me.value.name);if(!o)return;const d=ti.value||Me.value.name;try{if(navigator.share){await navigator.share({title:d,url:o});return}}catch(m){if(m?.name!=="AbortError")console.warn("Share failed, falling back to clipboard",m);else return}try{if(navigator.clipboard&&navigator.clipboard.writeText)await navigator.clipboard.writeText(o);else{const m=document.createElement("textarea");m.value=o,m.setAttribute("readonly","true"),m.style.position="absolute",m.style.left="-9999px",document.body.appendChild(m),m.select(),document.execCommand("copy"),document.body.removeChild(m)}ni.value=A.value.copied||"Link copied",Xn&&clearTimeout(Xn),Xn=setTimeout(()=>{ni.value="",Xn=null},2200)}catch(m){console.warn("Failed to copy share link",m)}}function Yi(o){const d=Be(o);return B.value[d]||o}function lr(o){return Q.value[o]||o}function Qa(o){const d=o.split(`
`),m={},v={},x={};let D=null,q=null,ke=null,Te="en",Se=[];const Re=()=>{(D||q)&&[D,q].filter(Boolean).forEach($e=>{m[$e]=m[$e]||{},m[$e][Te]=Se.join(`
`).trim(),ke&&(x[$e]=ke)}),Se=[],ke=null,q=null};for(const Ce of d){const $e=Ce.match(/^##\s+(.+?)\s+essentials(?:\s*\((\w{2})\))?(?:\s*\{#([a-z0-9_-]+)\})?/i);if($e){Re();const[,te,Le,Ye]=$e;D=Be(Ye||te),q=Be(te),Te=(Le||"en").toLowerCase(),ke=Ye||null;continue}const un=D?Ce.match(/^name\s*(?:\((\w{2})\))?\s*:\s*(.+)$/i):null;if(un){const[,te,Le]=un,Ye=(te||Te||"en").toLowerCase(),Pe=Le.trim();[D,q].filter(Boolean).forEach(ns=>{v[ns]=v[ns]||{},v[ns][Ye]=Pe});continue}D&&Ce.startsWith("- ")&&Se.push(Ce.replace(/^- /,"").trim())}return Re(),{descriptionsByLocale:m,playlistIdsByKey:x,namesByLocale:v}}function el(o){const d=il(o),m=Be(o),v=K.value[m];if(v)return v;const x=d[r.value];return x||(d.en?d.en:Object.values(d)[0]||"")}function nl(o){const d=Y.value[Be(o)];return d||rl(o)}function tl(o,d){const m=Be(d);if(o[m])return o[m];const v=m.split(" ").filter(Boolean),x=v[v.length-1];return x&&o[x]?o[x]:""}function il(o){const d=Be(o),m=d.split(" ").filter(Boolean),v=[d],x=m[m.length-1];x&&x!==d&&v.push(x);for(const D of v)if(tr[D])return tr[D];return{}}function sl(o){return Be(o).replace(/\s+/g,"-").replace(/-+/g,"-")}function rl(o){const d=s[r.value]||s.en,m=r.value==="ru"?Yi(o):"";if(r.value==="ru"&&m)return`${m} - ${d}`;const v=String(o||"").trim().split(/\s+/).filter(Boolean);if(!v.length)return"";const x=v[v.length-1];return`${/^(?:[IVX]+|\d+|Jr\.?|Sr\.?)$/i.test(x)&&v.length>=2?v[v.length-2]:x} ${d}`}function ol(o){const d=[],m=sl(o);m&&!d.includes(m)&&d.push(m);const v=tl(ja,o);return v&&!d.includes(v)&&d.push(v),d}function ii(o=window.location.pathname){if(o.startsWith(mi)){de.value="composers";return}de.value=o==="/about"?"about":"composers"}const cr=()=>ar();function ur(o){window.location.pathname!==o&&(history.pushState({},"",o),ii(o)),Z.value=!1}function dr(o){ur(o==="about"?"/about":"/")}function al(){Z.value=!Z.value}function ll(){Z.value=!1}function hr(o){b.value!==o&&(b.value=o)}function cl(){hr(!b.value)}function si(){if(typeof document>"u")return 0;const o=document.querySelector(".topbar");return o&&o.offsetHeight?o.offsetHeight:0}function On(){if(typeof window>"u")return{width:0,height:0,offsetLeft:0,offsetTop:0};const o=window.visualViewport;return o?{width:o.width,height:o.height,offsetLeft:o.offsetLeft||0,offsetTop:o.offsetTop||0}:{width:window.innerWidth,height:window.innerHeight,offsetLeft:0,offsetTop:0}}function Dn(o){const d=Ae.value;if(!d||typeof window>"u")return o;const{width:m,offsetLeft:v}=On(),x=v+We,D=Math.max(x,v+m-d.offsetWidth-We);return Math.min(Math.max(o,x),D)}function Sn(o){const d=Ae.value;if(!d||typeof window>"u")return o;const{height:m,offsetTop:v}=On(),x=Math.max(si()+We,v+We),D=Math.max(x,v+m-d.offsetHeight-We);return Math.min(Math.max(o,x),D)}function ht(){const o=Ae.value;if(u.value==null&&o&&typeof window<"u"){const{height:d,offsetTop:m}=On();u.value=Sn(m+d-o.offsetHeight-24)}cn.value=Dn(cn.value),u.value!=null&&(u.value=Sn(u.value))}function Zi(){ht(),y.value="top-right";const d=Ae.value?.offsetWidth||0,{width:m,offsetLeft:v,offsetTop:x}=On();cn.value=Dn(v+m-d-We);const D=si()+ys+ws;u.value=Sn(x+D)}function Lt(){ht(),y.value="bottom-left";const d=Ae.value?.offsetHeight||0,{height:m,offsetTop:v}=On();cn.value=Dn(We),u.value=Sn(v+m-d-We)}function fr(){ht(),y.value="top-left";const{offsetTop:o}=On(),d=si()+ys+ws;cn.value=Dn(We),u.value=Sn(o+d)}function mr(){ht(),y.value="bottom-right";const o=Ae.value,d=o?.offsetWidth||0,m=o?.offsetHeight||0,{width:v,height:x,offsetLeft:D,offsetTop:q}=On();cn.value=Dn(D+v-d-We),u.value=Sn(q+x-m-We)}function ul(){const o=Ae.value;if(!o)return;const{width:d,height:m,offsetLeft:v,offsetTop:x}=On(),D=si()+ys+ws,q=Dn(We),ke=Dn(v+d-o.offsetWidth-We),Te=Sn(x+D),Se=Sn(x+m-o.offsetHeight-We),Re=cn.value,Ce=u.value??0,$e=[{anchor:"top-left",dx:Re-q,dy:Ce-Te},{anchor:"top-right",dx:Re-ke,dy:Ce-Te},{anchor:"bottom-left",dx:Re-q,dy:Ce-Se},{anchor:"bottom-right",dx:Re-ke,dy:Ce-Se}];$e.sort((te,Le)=>te.dx*te.dx+te.dy*te.dy-(Le.dx*Le.dx+Le.dy*Le.dy));const un=$e[0]?.anchor;if(un==="top-left"){fr();return}if(un==="top-right"){Zi();return}if(un==="bottom-left"){Lt();return}mr()}function pr(o){if(!_.active||o.pointerId!==_.pointerId)return;o.preventDefault();const d=o.clientX-_.startX,m=o.clientY-_.startY;cn.value=Dn(_.startLeft+d),u.value!=null&&(u.value=Sn(_.startTop+m))}function gr(){window.removeEventListener("pointermove",pr),window.removeEventListener("pointerup",ri),window.removeEventListener("pointercancel",ri)}function br(o){const d=_.element;if(_.active=!1,_.element=null,_.pointerId=null,d?.releasePointerCapture&&o!=null)try{d.releasePointerCapture(o)}catch{}}function ri(o){!_.active||o.pointerId!==_.pointerId||(gr(),br(o.pointerId),ul())}function dl(){_.active&&(gr(),br(_.pointerId))}function hl(o){const d=o.timeStamp||Date.now();d-f<=uf&&o.preventDefault(),f=d}function fl(o){if(_.active||o.pointerType==="mouse"&&o.button!==0)return;const d=o.target;if(d&&typeof d.closest=="function"&&d.closest("button, a, input, select, textarea, label, [role='button'], .filter-panel"))return;ht(),y.value="free",o.preventDefault(),_.active=!0,_.pointerId=o.pointerId,_.startX=o.clientX,_.startY=o.clientY,_.startLeft=cn.value,_.startTop=u.value??0,_.element=Ae.value;const v=Ae.value;if(v?.setPointerCapture)try{v.setPointerCapture(o.pointerId)}catch{}window.addEventListener("pointermove",pr),window.addEventListener("pointerup",ri),window.addEventListener("pointercancel",ri)}function vr(o){!o||!o.touches||o.touches.length===2&&(C.active=!0,C.startDistance=k(o.touches[0],o.touches[1]))}function yr(o){if(!C.active||!o||!o.touches||o.touches.length!==2)return;o.preventDefault();const d=k(o.touches[0],o.touches[1]),m=C.startDistance||d,v=m?d/m:1;if(v>=ff){ze(1),C.startDistance=d;return}v<=hf&&(ze(-1),C.startDistance=d)}function oi(o){(o?.touches?.length??0)<2&&(C.active=!1,C.startDistance=0)}function wr(){w()&&!b.value&&hr(!0)}function kr(){Lt()}function ml(){_n()}function _n(){if(y.value==="top-left"){fr();return}if(y.value==="top-right"){Zi();return}if(y.value==="bottom-right"){mr();return}if(y.value==="bottom-left"){Lt();return}ht()}function xt(o,{persist:d=!1}={}){const m=t.includes(o)?o:pt;if(r.value=m,d)try{localStorage.setItem(So,m),localStorage.setItem(_o,"1")}catch{}}function pl(o){i.value=!0,xt(o,{persist:!0})}function gl(o){const d=o?.target?.value;d&&pl(d)}function bl(){try{return localStorage.getItem(So)}catch{return null}}function vl(){try{const o=localStorage.getItem(To);return o?dt(JSON.parse(o)):null}catch{return null}}function yl(){const o=vl();o&&(nn.value=o)}function wl(){try{return localStorage.getItem(_o)==="1"}catch{return!1}}function kl(){const o=bl(),d=wl();if(xt(pt),o&&d&&t.includes(o)){i.value=!0,xt(o);return}Sl()}async function Sl(){const o=!i.value;o||(r.value,void 0);const d=[_l,Tl];for(const m of d){const v=await m();if(v){const x=String(v).toUpperCase();if(!o)return;const D=x==="RU"?"ru":["DE","AT","CH"].includes(x)?"de":pt;xt(D);return}}o&&xt(pt)}async function _l(){try{const o=await fetch("https://ipapi.co/json/");return o.ok&&(await o.json())?.country_code||null}catch(o){console.warn("ipapi lookup failed:",o)}return null}async function Tl(){try{const o=await fetch("https://ipwho.is/");return o.ok&&(await o.json())?.country_code||null}catch(o){console.warn("ipwho.is lookup failed:",o)}return null}function vf(o,d){}function Sr(){ur("/"),window.timeline&&typeof window.timeline.goToStart=="function"&&window.timeline.goToStart()}function Qi(o){const d=o.detail,m=d?.laneIndex;if(Number.isInteger(m)&&Ue.value[m]){we.value=m;return}const v=d?.composer?.name;if(!v)return;const x=Ue.value.findIndex(D=>D.name===v);x>=0&&(we.value=x)}function _r(){we.value=null}function Tr(){!qi.value||we.value===null||(we.value-=1)}function Cr(){!Xi.value||we.value===null||(we.value+=1)}Ki(async()=>{kl(),yl(),await ar(),await vn(),Lt(),typeof ResizeObserver<"u"&&(S=new ResizeObserver(ml),Ae.value&&S.observe(Ae.value)),window.timeline&&typeof window.timeline.onBarClick=="function"&&window.timeline.onBarClick(Qi),window.addEventListener("popstate",cr),window.addEventListener("composer-select",Qi),window.addEventListener("resize",_n),window.visualViewport&&(window.visualViewport.addEventListener("resize",_n),window.visualViewport.addEventListener("scroll",_n)),_n();const o=document.getElementById("timeline");o&&(o.addEventListener("scroll",_e,{passive:!0}),o.addEventListener("timeline-pan-start",wr),o.addEventListener("touchstart",vr,{passive:!0}),o.addEventListener("touchmove",yr,{passive:!1}),o.addEventListener("touchend",oi,{passive:!0}),o.addEventListener("touchcancel",oi,{passive:!0}),_e())}),ji(()=>{window.removeEventListener("popstate",cr),window.removeEventListener("composer-select",Qi),window.removeEventListener("resize",_n),window.visualViewport&&(window.visualViewport.removeEventListener("resize",_n),window.visualViewport.removeEventListener("scroll",_n)),S&&(S.disconnect(),S=null),dl(),Xn&&(clearTimeout(Xn),Xn=null);const o=document.getElementById("timeline");o&&(o.removeEventListener("scroll",_e),o.removeEventListener("timeline-pan-start",wr),o.removeEventListener("touchstart",vr),o.removeEventListener("touchmove",yr),o.removeEventListener("touchend",oi),o.removeEventListener("touchcancel",oi))}),qe(h,o=>{o&&(document.title=o)},{immediate:!0}),qe(nn,o=>{try{localStorage.setItem(To,JSON.stringify(o))}catch{}},{deep:!0}),qe(r,async o=>{const d=t.includes(o)?o:pt;if(d!==o){r.value=d;return}try{document.documentElement.setAttribute("data-lang",d)}catch{}window.timeline&&typeof window.timeline.updateEraLabels=="function"&&window.timeline.updateEraLabels(ce.value),await vn(),_n()}),qe(Ji,async o=>{o?(document.documentElement.style.overscrollBehavior="none",document.body.style.overscrollBehavior="none",document.body.style.overflow="hidden",document.body.style.touchAction="none",await vn(),Yn.value.length&&Mr()):(document.documentElement.style.overscrollBehavior="",document.body.style.overscrollBehavior="",document.body.style.overflow="",document.body.style.touchAction="",Er())}),qe(we,o=>{const d=window.timeline;!d||typeof d.setSelectedLane!="function"||(Number.isInteger(o)?d.setSelectedLane(o):d.setSelectedLane(null))}),qe(we,o=>{if($i.value)return;if(Number.isInteger(o)&&Ue.value[o]){const m=Ue.value[o].name,v=or(m);window.location.pathname!==v&&(history.pushState({},"",v),ii(v));return}const d=de.value==="about"?"/about":"/";window.location.pathname!==d&&(history.replaceState({},"",d),ii(d))}),qe(Yn,async o=>{Ji.value&&(Er(),await vn(),o.length&&Mr())}),qe(()=>Ue.value.map(o=>o.name),o=>{if(we.value===null)return;const d=Me.value;if(!d){we.value=null;return}const m=o.findIndex(v=>v===d.name);m===-1?we.value=null:we.value=m});function es(o){return o?J?J.endsWith("/")&&o.startsWith("/")?J+o.slice(1):!J.endsWith("/")&&!o.startsWith("/")?`${J}/${o}`:J+o:o:J}function Cl(o){if(!o)return"";const d=en;if(!d)return"";const m=d.endsWith("/");return`${d}${m?"":"/"}${o}`}function Er(){ve.forEach(o=>{try{o.pause(),o.currentTime=0}catch(d){console.error("Failed to stop SoundCloud audio",d)}}),ve.clear()}function Mr(o,d=document){const v=(d||document).querySelectorAll("[data-soundcloud-playlist]");v.length&&(v.length,v.forEach(x=>{El(x,()=>{})}))}async function El(o,d){const m=()=>{typeof d=="function"&&setTimeout(()=>d(),0)};if(!o||o.dataset.soundcloudReady==="true"||o.dataset.soundcloudReady==="loading"||o.dataset.soundcloudReady==="error"){m();return}const v=o.getAttribute("data-soundcloud-playlist"),x=o.getAttribute("data-soundcloud-playlist-alt")||"",D=[v,...x.split("|")].map(Te=>(Te||"").trim()).filter(Boolean);if(!D.length){m();return}o.dataset.soundcloudReady="loading",o.innerHTML=Ml();let q=null;for(const Te of D)try{const Se=await xl(Te),Re=Array.isArray(Se.tracks)&&Se.tracks.length?Se.tracks:Se&&Se.kind==="track"?[Se]:[],Ce=zl(Re);Pl(o,Ce,Te),m();return}catch(Se){if(q=Se,Se&&Se.status===429){Lr(o,Te),m();return}}console.error("Failed to build SoundCloud player",q);const ke=D[0]||ne;Lr(o,ke),m()}function Ml(){return`
    <div class="sc-player__status">
      <span class="sc-player__spinner" aria-hidden="true"></span>
      <span class="sc-player__status-text">${F.value}</span>
    </div>
  `.trim()}async function Ll(o){if(!o)throw new Error("No track provided");const d=o.media&&Array.isArray(o.media.transcodings)?o.media.transcodings:[];if(d.length){let m=d.find(v=>v&&v.format&&v.format.protocol==="progressive");if(m||(m=d[0]),m&&m.url)try{const v=await Al(m.url,o.track_authorization);return console.debug("[SC] Using transcoding URL",{trackId:o.id,transcodingUrl:m.url,finalUrl:v}),v}catch(v){console.error("[SC] Transcoding proxy failed, falling back to streams endpoint",v)}}if(!o.id)throw new Error("No track id provided");return Rl(o.id,o.track_authorization)}async function xl(o){const d=es("/api/soundcloud/playlist")+`?url=${encodeURIComponent(o)}`,m=await fetch(d);if(!m.ok){const v=new Error(`SoundCloud playlist error: ${m.status}`);throw v.status=m.status,v.retryAfter=Number(m.headers?.get("Retry-After"))||void 0,v}return m.json()}function zl(o=[]){return Array.isArray(o)?o.map((d,m)=>{if(!d)return null;const v=`Track ${m+1}`,D=[d.title,d.publisher_metadata?.release_title,d.permalink,d.permalink_url,d.id?String(d.id):null].map(q=>typeof q=="string"?q.trim():"").filter(Boolean)[0]||v;return{...d,title:D}}).filter(Boolean):[]}async function Al(o,d){const m=new URLSearchParams;m.set("url",o),d&&m.set("track_authorization",d),l.value&&m.set("proxy","1");const v=es("/api/soundcloud/transcoding")+`?${m.toString()}`,x=await fetch(v);if(!x.ok){const q=new Error(`SoundCloud transcoding error: ${x.status}`);throw q.status=x.status,q.retryAfter=Number(x.headers?.get("Retry-After"))||void 0,q}const D=await x.json();if(!D?.url)throw new Error("Transcoding response missing url");return D.url}async function Rl(o,d){const m=new URLSearchParams;d&&m.set("track_authorization",d),l.value&&m.set("proxy","1");const v=m.toString(),x=es(`/api/soundcloud/streams/${o}`)+(v?`?${v}`:""),D=await fetch(x);if(!D.ok){const ke=new Error(`SoundCloud stream error: ${D.status}`);throw ke.status=D.status,ke.retryAfter=Number(D.headers?.get("Retry-After"))||void 0,ke}const q=await D.json();if(!q?.url)throw new Error("Stream response missing url");return q.url}function Lr(o,d){const m=`https://w.soundcloud.com/player/?url=${encodeURIComponent(d)}&auto_play=false&show_user=false&hide_related=true&show_comments=false&show_reposts=false&show_teaser=false&show_playcount=false&sharing=false&show_artwork=false&buying=false&liking=false&download=false&visual=false`;o.innerHTML=`
    <iframe
      show_user="false"
      ...
      src="${m}"
    ></iframe>
  `,o.dataset.soundcloudReady="true"}function Pl(o,d,m){if(!Array.isArray(d)||!d.length){o.innerHTML='<div class="sc-player__status sc-player__status--error">No tracks found for this playlist.</div>',o.dataset.soundcloudReady="error";return}o.classList.add("sc-player");const v=document.createElement("div");v.className="sc-track-list";const x=document.createElement("audio");x.preload="none",ve.add(x);let D=null,q=null,ke=null,Te=!1;const Se=[],Re=(te,Le)=>{te.dataset.state=Le,te.textContent=Le==="playing"?"⏸":Le==="loading"?"...":"▶"},Ce=te=>Re(te,"idle"),$e=()=>{q&&Ce(q),D=null,q=null,ke=null};x.addEventListener("ended",()=>{const te=ke===null?-1:ke+1;if(te>=0&&te<d.length){un(te,{auto:!0});return}$e()}),x.addEventListener("pause",()=>{q&&x.currentTime<(x.duration||1/0)&&Ce(q)});const un=async(te,{auto:Le=!1}={})=>{if(Te)return;const Ye=d[te],Pe=Se[te];if(!(!Ye||!Pe)){if(!Le&&ke===te&&!x.paused){x.pause(),Ce(Pe);return}Te=!0,Re(Pe,"loading");try{const Tn=await Ll(Ye);if(!Tn)throw new Error("No stream URL returned");x.src=Tn,await x.play(),Fl(Ye),q&&q!==Pe&&Ce(q),q=Pe,D=Ye?.id??te,ke=te,Re(Pe,"playing")}catch(Tn){console.error("Failed to play SoundCloud track",Tn),Ce(Pe),o.dataset.soundcloudReady="error"}finally{Te=!1}}};d.forEach((te,Le)=>{const Ye=document.createElement("div");Ye.className="sc-track";const Pe=document.createElement("button");Pe.type="button",Pe.className="sc-track__button",Pe.setAttribute("aria-label","Play track"),Re(Pe,"idle"),Se.push(Pe);const Tn=document.createElement("div");Tn.className="sc-track__title",Tn.textContent=te?.title||`Track ${Le+1}`,Ye.append(Pe,Tn),v.append(Ye),Pe.addEventListener("click",()=>{un(Le)})}),o.innerHTML="",o.append(v,x),o.dataset.soundcloudReady="true"}function Fl(o){if(!("mediaSession"in navigator)||typeof MediaMetadata>"u")return;const d=o?.title||"Classical Music",m=o?.publisher_metadata?.artist||o?.user?.username||o?.user?.full_name||"",v=o?.publisher_metadata?.album_title||"";navigator.mediaSession.metadata=new MediaMetadata({title:d,artist:m,album:v,artwork:[{src:"/images/about_music_logo.png",type:"image/png"}]})}return(o,d)=>(ge(),ye("div",Bd,[E("header",Wd,[E("button",{class:"menu-button",onClick:al,"aria-label":"Toggle navigation menu"},[...d[6]||(d[6]=[E("span",{class:"menu-icon"},null,-1)])]),E("img",{class:"logo",src:hd,alt:"Logo",onClick:Sr}),E("div",{class:"app-title",role:"button",onClick:Sr},re(h.value),1),E("div",Kd,[E("label",jd,re(g.value),1),as(E("select",{id:"language-select",class:"language-select","onUpdate:modelValue":d[0]||(d[0]=m=>r.value=m),"aria-label":g.value,onChange:gl},[(ge(!0),ye(Xe,null,di(p.value,m=>(ge(),ye("option",{key:m.value,value:m.value},re(m.label),9,Gd))),128))],40,Vd),[[id,r.value]])])]),E("aside",{class:yt(["side-menu",{"side-menu--open":Z.value}])},[E("nav",Ud,[E("button",{class:yt(["menu-item",{"menu-item--active":de.value==="composers"}]),onClick:d[1]||(d[1]=m=>dr("composers"))},re(T.value.composers),3),E("button",{class:yt(["menu-item",{"menu-item--active":de.value==="about"}]),onClick:d[2]||(d[2]=m=>dr("about"))},re(T.value.about),3)])],2),Z.value?(ge(),ye("div",{key:0,class:"backdrop",onClick:ll})):dn("",!0),E("main",$d,[de.value==="composers"?(ge(),ye("section",Jd,[E("div",{class:"filter-dock",style:Oi(L.value),ref_key:"filterDockRef",ref:Ae,onPointerdown:fl,onTouchend:hl},[E("div",qd,[E("div",Xd,[E("button",{type:"button",class:"filter-dock__collapse control-btn","aria-pressed":b.value,"aria-label":b.value?Et.value.restore:Et.value.minimize,onClick:cl},[E("img",{src:b.value?"/images/window-maximize.svg":"/images/window-minimize.svg",alt:"","aria-hidden":"true"},null,8,Zd)],8,Yd)]),Oe(Jr,{name:"filter-dock-collapse",onAfterEnter:kr,onAfterLeave:kr},{default:Es(()=>[b.value?dn("",!0):(ge(),ye("div",Qd,[E("div",eh,[E("div",nh,[E("button",{type:"button",class:"control-btn",disabled:X.value,onClick:tn,"aria-label":"Jump to start of timeline"}," ⇤ ",8,th),E("button",{type:"button",class:"control-btn",disabled:O.value,onClick:d[3]||(d[3]=m=>ze(-1)),"aria-label":"Make timeline blocks smaller"},[...d[7]||(d[7]=[E("img",{class:"control-icon",src:fd,alt:"","aria-hidden":"true"},null,-1)])],8,ih),E("button",{type:"button",class:"control-btn",disabled:j.value,onClick:d[4]||(d[4]=m=>ze(1)),"aria-label":"Make timeline blocks larger"},[...d[8]||(d[8]=[E("img",{class:"control-icon",src:md,alt:"","aria-hidden":"true"},null,-1)])],8,sh),E("button",{type:"button",class:"control-btn",disabled:le.value,onClick:sn,"aria-label":"Jump to end of timeline"}," ⇥ ",8,rh)]),E("div",oh,[E("div",ah,[(ge(),ye(Xe,null,di(pn,m=>E("label",{key:m.id,class:"filter-panel__item"},[as(E("input",{"onUpdate:modelValue":v=>nn.value[m.id]=v,type:"checkbox",class:"filter-panel__checkbox","aria-label":`Toggle ${lr(m.id)}`,onChange:Ne},null,40,lh),[[uo,nn.value[m.id]]]),E("span",ch,re(lr(m.id)),1)])),64))])])])]))]),_:1})])],36),Oe(Dd,{composers:Ue.value,settings:H,"era-labels":ce.value},null,8,["composers","settings","era-labels"])])):de.value==="about"?(ge(),ye("section",uh,[E("div",dh,[d[12]||(d[12]=E("img",{class:"about__logo",src:pd,alt:"Music logo",loading:"lazy"},null,-1)),E("h1",hh,re(M.value.title),1),E("p",fh,re(M.value.intro),1),E("p",mh,re(M.value.goal),1),E("div",ph,[d[11]||(d[11]=E("img",{class:"about__photo",src:gd,alt:"Dmitrii Kotikov",loading:"lazy"},null,-1)),E("div",gh,[E("div",bh,re(M.value.authorLabel),1),E("div",vh,re(M.value.authorName),1),d[9]||(d[9]=E("a",{class:"about__link",href:"https://www.linkedin.com/in/dmitrykotikov/",target:"_blank",rel:"noreferrer"}," LinkedIn ",-1)),d[10]||(d[10]=E("a",{class:"about__link",href:"https://thequot.es/",target:"_blank",rel:"noreferrer"}," thequot.es ",-1))])]),E("div",yh,[E("div",wh,re(M.value.contributorsTitle),1),E("ul",kh,[(ge(!0),ye(Xe,null,di(P.value,m=>(ge(),ye("li",{key:m.url,class:"about__contributors-item"},[E("span",Sh,re(m.name),1),E("a",{class:"about__contributors-link",href:m.url,target:"_blank",rel:"noreferrer"},re(m.linkText),9,_h),m.url==="https://facebook.com/olga.shibanova"?(ge(),ye("div",Th,[E("label",Ch,[as(E("input",{"onUpdate:modelValue":d[5]||(d[5]=v=>a.value=v),class:"about__contributors-toggle-input",type:"checkbox","aria-label":"Toggle test features"},null,512),[[uo,a.value]]),E("span",null,re(W.value),1)])])):dn("",!0)]))),128))])])])])):dn("",!0)]),Oe(Jr,{name:"fade"},{default:Es(()=>[Ji.value?(ge(),ye("div",{key:0,class:"composer-modal",onClick:od(_r,["self"])},[E("div",Eh,[E("header",Mh,[E("div",Lh,[E("h2",xh,re(ti.value),1),Me.value?(ge(),ye("p",zh,re(Me.value.birth)+" — "+re(Me.value.death),1)):dn("",!0)]),E("div",Ah,[E("button",{class:"composer-modal__share",type:"button",onClick:Za,"aria-label":A.value.button},[...d[13]||(d[13]=[E("img",{class:"composer-modal__share-icon",src:bd,alt:""},null,-1)])],8,Rh),ni.value?(ge(),ye("span",Ph,re(ni.value),1)):dn("",!0),E("div",Fh,[E("button",{class:"composer-modal__arrow",onClick:Tr,disabled:!qi.value,"aria-label":"Previous"}," ← ",8,Ih),E("span",Hh,re((we.value??0)+1)+" / "+re(Ue.value.length),1),E("button",{class:"composer-modal__arrow",onClick:Cr,disabled:!Xi.value,"aria-label":"Next"}," → ",8,Oh)]),E("button",{class:"composer-modal__close",onClick:_r,"aria-label":"Close composer details"},"×")])]),E("div",Dh,[ir.value?(ge(),ye("div",Nh,[E("img",{class:"composer-modal__photo",src:ir.value,alt:ti.value},null,8,Bh),E("div",Wh,[E("button",{class:"composer-modal__arrow",onClick:Tr,disabled:!qi.value,"aria-label":"Previous"}," ← ",8,Kh),E("span",jh,re((we.value??0)+1)+" / "+re(Ue.value.length),1),E("button",{class:"composer-modal__arrow",onClick:Cr,disabled:!Xi.value,"aria-label":"Next"}," → ",8,Vh)]),E("div",Gh,[E("div",Uh,re(ti.value),1),Me.value?(ge(),ye("div",$h,re(Me.value.birth)+" — "+re(Me.value.death),1)):dn("",!0)])])):dn("",!0),E("div",Jh,[E("div",qh,[E("div",Xh,re(ue.value.keyWorks),1),Yn.value.length?(ge(),ye("a",Yh,[...d[14]||(d[14]=[E("img",{class:"sc-powered__img",src:vd,alt:"Powered by SoundCloud"},null,-1)])])):dn("",!0)]),Yn.value.length?(ge(),ye("div",{key:Yn.value[0],class:"composer-modal__playlist-box sc-player","data-soundcloud-playlist":Yn.value[0],"data-soundcloud-playlist-alt":Yn.value.slice(1).join("|")},[E("div",Qh,[d[15]||(d[15]=E("span",{class:"sc-player__spinner","aria-hidden":"true"},null,-1)),E("span",ef,re(F.value),1)])],8,Zh)):(ge(),ye("div",nf," Playlist will appear here soon. "))]),E("div",tf,[rr.value?(ge(),ye("div",sf,re(rr.value),1)):dn("",!0),sr.value?(ge(),ye("ul",rf,[(ge(!0),ye(Xe,null,di(sr.value.split(`
`),(m,v)=>(ge(),ye("li",{key:v},[E("span",of,re(m),1)]))),128))])):(ge(),ye("p",af,"No description yet."))])])])])):dn("",!0)]),_:1})]))}},bf=Ka(gf,[["__scopeId","data-v-2080dabc"]]);cd(bf).mount("#app");
