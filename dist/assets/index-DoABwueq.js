(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();function rs(e){const n=Object.create(null);for(const t of e.split(","))n[t]=1;return t=>t in n}const fe={},Yn=[],ln=()=>{},Rr=()=>!1,ci=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),os=e=>e.startsWith("onUpdate:"),xe=Object.assign,as=(e,n)=>{const t=e.indexOf(n);t>-1&&e.splice(t,1)},va=Object.prototype.hasOwnProperty,re=(e,n)=>va.call(e,n),K=Array.isArray,Zn=e=>Lt(e)==="[object Map]",st=e=>Lt(e)==="[object Set]",Hs=e=>Lt(e)==="[object Date]",q=e=>typeof e=="function",we=e=>typeof e=="string",cn=e=>typeof e=="symbol",ce=e=>e!==null&&typeof e=="object",Ir=e=>(ce(e)||q(e))&&q(e.then)&&q(e.catch),Fr=Object.prototype.toString,Lt=e=>Fr.call(e),ya=e=>Lt(e).slice(8,-1),Hr=e=>Lt(e)==="[object Object]",ls=e=>we(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,mt=rs(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),ui=e=>{const n=Object.create(null);return(t=>n[t]||(n[t]=e(t)))},wa=/-\w/g,zn=ui(e=>e.replace(wa,n=>n.slice(1).toUpperCase())),ka=/\B([A-Z])/g,Vn=ui(e=>e.replace(ka,"-$1").toLowerCase()),Nr=ui(e=>e.charAt(0).toUpperCase()+e.slice(1)),Ei=ui(e=>e?`on${Nr(e)}`:""),Ln=(e,n)=>!Object.is(e,n),$t=(e,...n)=>{for(let t=0;t<e.length;t++)e[t](...n)},Or=(e,n,t,i=!1)=>{Object.defineProperty(e,n,{configurable:!0,enumerable:!1,writable:i,value:t})},Wr=e=>{const n=parseFloat(e);return isNaN(n)?e:n},_a=e=>{const n=we(e)?Number(e):NaN;return isNaN(n)?e:n};let Ns;const di=()=>Ns||(Ns=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function cs(e){if(K(e)){const n={};for(let t=0;t<e.length;t++){const i=e[t],s=we(i)?Ea(i):cs(i);if(s)for(const r in s)n[r]=s[r]}return n}else if(we(e)||ce(e))return e}const Sa=/;(?![^(]*\))/g,Ta=/:([^]+)/,Ca=/\/\*[^]*?\*\//g;function Ea(e){const n={};return e.replace(Ca,"").split(Sa).forEach(t=>{if(t){const i=t.split(Ta);i.length>1&&(n[i[0].trim()]=i[1].trim())}}),n}function Qn(e){let n="";if(we(e))n=e;else if(K(e))for(let t=0;t<e.length;t++){const i=Qn(e[t]);i&&(n+=i+" ")}else if(ce(e))for(const t in e)e[t]&&(n+=t+" ");return n.trim()}const xa="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Ma=rs(xa);function Br(e){return!!e||e===""}function La(e,n){if(e.length!==n.length)return!1;let t=!0;for(let i=0;t&&i<e.length;i++)t=zt(e[i],n[i]);return t}function zt(e,n){if(e===n)return!0;let t=Hs(e),i=Hs(n);if(t||i)return t&&i?e.getTime()===n.getTime():!1;if(t=cn(e),i=cn(n),t||i)return e===n;if(t=K(e),i=K(n),t||i)return t&&i?La(e,n):!1;if(t=ce(e),i=ce(n),t||i){if(!t||!i)return!1;const s=Object.keys(e).length,r=Object.keys(n).length;if(s!==r)return!1;for(const o in e){const a=e.hasOwnProperty(o),l=n.hasOwnProperty(o);if(a&&!l||!a&&l||!zt(e[o],n[o]))return!1}}return String(e)===String(n)}function us(e,n){return e.findIndex(t=>zt(t,n))}const Dr=e=>!!(e&&e.__v_isRef===!0),ae=e=>we(e)?e:e==null?"":K(e)||ce(e)&&(e.toString===Fr||!q(e.toString))?Dr(e)?ae(e.value):JSON.stringify(e,Kr,2):String(e),Kr=(e,n)=>Dr(n)?Kr(e,n.value):Zn(n)?{[`Map(${n.size})`]:[...n.entries()].reduce((t,[i,s],r)=>(t[xi(i,r)+" =>"]=s,t),{})}:st(n)?{[`Set(${n.size})`]:[...n.values()].map(t=>xi(t))}:cn(n)?xi(n):ce(n)&&!K(n)&&!Hr(n)?String(n):n,xi=(e,n="")=>{var t;return cn(e)?`Symbol(${(t=e.description)!=null?t:n})`:e};let We;class za{constructor(n=!1){this.detached=n,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.parent=We,!n&&We&&(this.index=(We.scopes||(We.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let n,t;if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].pause();for(n=0,t=this.effects.length;n<t;n++)this.effects[n].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let n,t;if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].resume();for(n=0,t=this.effects.length;n<t;n++)this.effects[n].resume()}}run(n){if(this._active){const t=We;try{return We=this,n()}finally{We=t}}}on(){++this._on===1&&(this.prevScope=We,We=this)}off(){this._on>0&&--this._on===0&&(We=this.prevScope,this.prevScope=void 0)}stop(n){if(this._active){this._active=!1;let t,i;for(t=0,i=this.effects.length;t<i;t++)this.effects[t].stop();for(this.effects.length=0,t=0,i=this.cleanups.length;t<i;t++)this.cleanups[t]();if(this.cleanups.length=0,this.scopes){for(t=0,i=this.scopes.length;t<i;t++)this.scopes[t].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!n){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0}}}function Aa(){return We}let me;const Mi=new WeakSet;class jr{constructor(n){this.fn=n,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,We&&We.active&&We.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Mi.has(this)&&(Mi.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Gr(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,Os(this),$r(this);const n=me,t=Ye;me=this,Ye=!0;try{return this.fn()}finally{Ur(this),me=n,Ye=t,this.flags&=-3}}stop(){if(this.flags&1){for(let n=this.deps;n;n=n.nextDep)hs(n);this.deps=this.depsTail=void 0,Os(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Mi.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){ji(this)&&this.run()}get dirty(){return ji(this)}}let Vr=0,pt,gt;function Gr(e,n=!1){if(e.flags|=8,n){e.next=gt,gt=e;return}e.next=pt,pt=e}function ds(){Vr++}function fs(){if(--Vr>0)return;if(gt){let n=gt;for(gt=void 0;n;){const t=n.next;n.next=void 0,n.flags&=-9,n=t}}let e;for(;pt;){let n=pt;for(pt=void 0;n;){const t=n.next;if(n.next=void 0,n.flags&=-9,n.flags&1)try{n.trigger()}catch(i){e||(e=i)}n=t}}if(e)throw e}function $r(e){for(let n=e.deps;n;n=n.nextDep)n.version=-1,n.prevActiveLink=n.dep.activeLink,n.dep.activeLink=n}function Ur(e){let n,t=e.depsTail,i=t;for(;i;){const s=i.prevDep;i.version===-1?(i===t&&(t=s),hs(i),Pa(i)):n=i,i.dep.activeLink=i.prevActiveLink,i.prevActiveLink=void 0,i=s}e.deps=n,e.depsTail=t}function ji(e){for(let n=e.deps;n;n=n.nextDep)if(n.dep.version!==n.version||n.dep.computed&&(Jr(n.dep.computed)||n.dep.version!==n.version))return!0;return!!e._dirty}function Jr(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===kt)||(e.globalVersion=kt,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!ji(e))))return;e.flags|=2;const n=e.dep,t=me,i=Ye;me=e,Ye=!0;try{$r(e);const s=e.fn(e._value);(n.version===0||Ln(s,e._value))&&(e.flags|=128,e._value=s,n.version++)}catch(s){throw n.version++,s}finally{me=t,Ye=i,Ur(e),e.flags&=-3}}function hs(e,n=!1){const{dep:t,prevSub:i,nextSub:s}=e;if(i&&(i.nextSub=s,e.prevSub=void 0),s&&(s.prevSub=i,e.nextSub=void 0),t.subs===e&&(t.subs=i,!i&&t.computed)){t.computed.flags&=-5;for(let r=t.computed.deps;r;r=r.nextDep)hs(r,!0)}!n&&!--t.sc&&t.map&&t.map.delete(t.key)}function Pa(e){const{prevDep:n,nextDep:t}=e;n&&(n.nextDep=t,e.prevDep=void 0),t&&(t.prevDep=n,e.nextDep=void 0)}let Ye=!0;const qr=[];function bn(){qr.push(Ye),Ye=!1}function vn(){const e=qr.pop();Ye=e===void 0?!0:e}function Os(e){const{cleanup:n}=e;if(e.cleanup=void 0,n){const t=me;me=void 0;try{n()}finally{me=t}}}let kt=0;class Ra{constructor(n,t){this.sub=n,this.dep=t,this.version=t.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class ms{constructor(n){this.computed=n,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(n){if(!me||!Ye||me===this.computed)return;let t=this.activeLink;if(t===void 0||t.sub!==me)t=this.activeLink=new Ra(me,this),me.deps?(t.prevDep=me.depsTail,me.depsTail.nextDep=t,me.depsTail=t):me.deps=me.depsTail=t,Xr(t);else if(t.version===-1&&(t.version=this.version,t.nextDep)){const i=t.nextDep;i.prevDep=t.prevDep,t.prevDep&&(t.prevDep.nextDep=i),t.prevDep=me.depsTail,t.nextDep=void 0,me.depsTail.nextDep=t,me.depsTail=t,me.deps===t&&(me.deps=i)}return t}trigger(n){this.version++,kt++,this.notify(n)}notify(n){ds();try{for(let t=this.subs;t;t=t.prevSub)t.sub.notify()&&t.sub.dep.notify()}finally{fs()}}}function Xr(e){if(e.dep.sc++,e.sub.flags&4){const n=e.dep.computed;if(n&&!e.dep.subs){n.flags|=20;for(let i=n.deps;i;i=i.nextDep)Xr(i)}const t=e.dep.subs;t!==e&&(e.prevSub=t,t&&(t.nextSub=e)),e.dep.subs=e}}const Vi=new WeakMap,Kn=Symbol(""),Gi=Symbol(""),_t=Symbol("");function Me(e,n,t){if(Ye&&me){let i=Vi.get(e);i||Vi.set(e,i=new Map);let s=i.get(t);s||(i.set(t,s=new ms),s.map=i,s.key=t),s.track()}}function pn(e,n,t,i,s,r){const o=Vi.get(e);if(!o){kt++;return}const a=l=>{l&&l.trigger()};if(ds(),n==="clear")o.forEach(a);else{const l=K(e),h=l&&ls(t);if(l&&t==="length"){const u=Number(i);o.forEach((p,T)=>{(T==="length"||T===_t||!cn(T)&&T>=u)&&a(p)})}else switch((t!==void 0||o.has(void 0))&&a(o.get(t)),h&&a(o.get(_t)),n){case"add":l?h&&a(o.get("length")):(a(o.get(Kn)),Zn(e)&&a(o.get(Gi)));break;case"delete":l||(a(o.get(Kn)),Zn(e)&&a(o.get(Gi)));break;case"set":Zn(e)&&a(o.get(Kn));break}}fs()}function Jn(e){const n=se(e);return n===e?n:(Me(n,"iterate",_t),Ue(e)?n:n.map(Ze))}function fi(e){return Me(e=se(e),"iterate",_t),e}function Sn(e,n){return yn(e)?jn(e)?it(Ze(n)):it(n):Ze(n)}const Ia={__proto__:null,[Symbol.iterator](){return Li(this,Symbol.iterator,e=>Sn(this,e))},concat(...e){return Jn(this).concat(...e.map(n=>K(n)?Jn(n):n))},entries(){return Li(this,"entries",e=>(e[1]=Sn(this,e[1]),e))},every(e,n){return dn(this,"every",e,n,void 0,arguments)},filter(e,n){return dn(this,"filter",e,n,t=>t.map(i=>Sn(this,i)),arguments)},find(e,n){return dn(this,"find",e,n,t=>Sn(this,t),arguments)},findIndex(e,n){return dn(this,"findIndex",e,n,void 0,arguments)},findLast(e,n){return dn(this,"findLast",e,n,t=>Sn(this,t),arguments)},findLastIndex(e,n){return dn(this,"findLastIndex",e,n,void 0,arguments)},forEach(e,n){return dn(this,"forEach",e,n,void 0,arguments)},includes(...e){return zi(this,"includes",e)},indexOf(...e){return zi(this,"indexOf",e)},join(e){return Jn(this).join(e)},lastIndexOf(...e){return zi(this,"lastIndexOf",e)},map(e,n){return dn(this,"map",e,n,void 0,arguments)},pop(){return ct(this,"pop")},push(...e){return ct(this,"push",e)},reduce(e,...n){return Ws(this,"reduce",e,n)},reduceRight(e,...n){return Ws(this,"reduceRight",e,n)},shift(){return ct(this,"shift")},some(e,n){return dn(this,"some",e,n,void 0,arguments)},splice(...e){return ct(this,"splice",e)},toReversed(){return Jn(this).toReversed()},toSorted(e){return Jn(this).toSorted(e)},toSpliced(...e){return Jn(this).toSpliced(...e)},unshift(...e){return ct(this,"unshift",e)},values(){return Li(this,"values",e=>Sn(this,e))}};function Li(e,n,t){const i=fi(e),s=i[n]();return i!==e&&!Ue(e)&&(s._next=s.next,s.next=()=>{const r=s._next();return r.done||(r.value=t(r.value)),r}),s}const Fa=Array.prototype;function dn(e,n,t,i,s,r){const o=fi(e),a=o!==e&&!Ue(e),l=o[n];if(l!==Fa[n]){const p=l.apply(e,r);return a?Ze(p):p}let h=t;o!==e&&(a?h=function(p,T){return t.call(this,Sn(e,p),T,e)}:t.length>2&&(h=function(p,T){return t.call(this,p,T,e)}));const u=l.call(o,h,i);return a&&s?s(u):u}function Ws(e,n,t,i){const s=fi(e);let r=t;return s!==e&&(Ue(e)?t.length>3&&(r=function(o,a,l){return t.call(this,o,a,l,e)}):r=function(o,a,l){return t.call(this,o,Sn(e,a),l,e)}),s[n](r,...i)}function zi(e,n,t){const i=se(e);Me(i,"iterate",_t);const s=i[n](...t);return(s===-1||s===!1)&&bs(t[0])?(t[0]=se(t[0]),i[n](...t)):s}function ct(e,n,t=[]){bn(),ds();const i=se(e)[n].apply(e,t);return fs(),vn(),i}const Ha=rs("__proto__,__v_isRef,__isVue"),Yr=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(cn));function Na(e){cn(e)||(e=String(e));const n=se(this);return Me(n,"has",e),n.hasOwnProperty(e)}class Zr{constructor(n=!1,t=!1){this._isReadonly=n,this._isShallow=t}get(n,t,i){if(t==="__v_skip")return n.__v_skip;const s=this._isReadonly,r=this._isShallow;if(t==="__v_isReactive")return!s;if(t==="__v_isReadonly")return s;if(t==="__v_isShallow")return r;if(t==="__v_raw")return i===(s?r?Ua:to:r?no:eo).get(n)||Object.getPrototypeOf(n)===Object.getPrototypeOf(i)?n:void 0;const o=K(n);if(!s){let l;if(o&&(l=Ia[t]))return l;if(t==="hasOwnProperty")return Na}const a=Reflect.get(n,t,ze(n)?n:i);if((cn(t)?Yr.has(t):Ha(t))||(s||Me(n,"get",t),r))return a;if(ze(a)){const l=o&&ls(t)?a:a.value;return s&&ce(l)?Ui(l):l}return ce(a)?s?Ui(a):hi(a):a}}class Qr extends Zr{constructor(n=!1){super(!1,n)}set(n,t,i,s){let r=n[t];const o=K(n)&&ls(t);if(!this._isShallow){const h=yn(r);if(!Ue(i)&&!yn(i)&&(r=se(r),i=se(i)),!o&&ze(r)&&!ze(i))return h||(r.value=i),!0}const a=o?Number(t)<n.length:re(n,t),l=Reflect.set(n,t,i,ze(n)?n:s);return n===se(s)&&(a?Ln(i,r)&&pn(n,"set",t,i):pn(n,"add",t,i)),l}deleteProperty(n,t){const i=re(n,t);n[t];const s=Reflect.deleteProperty(n,t);return s&&i&&pn(n,"delete",t,void 0),s}has(n,t){const i=Reflect.has(n,t);return(!cn(t)||!Yr.has(t))&&Me(n,"has",t),i}ownKeys(n){return Me(n,"iterate",K(n)?"length":Kn),Reflect.ownKeys(n)}}class Oa extends Zr{constructor(n=!1){super(!0,n)}set(n,t){return!0}deleteProperty(n,t){return!0}}const Wa=new Qr,Ba=new Oa,Da=new Qr(!0);const $i=e=>e,Nt=e=>Reflect.getPrototypeOf(e);function Ka(e,n,t){return function(...i){const s=this.__v_raw,r=se(s),o=Zn(r),a=e==="entries"||e===Symbol.iterator&&o,l=e==="keys"&&o,h=s[e](...i),u=t?$i:n?it:Ze;return!n&&Me(r,"iterate",l?Gi:Kn),{next(){const{value:p,done:T}=h.next();return T?{value:p,done:T}:{value:a?[u(p[0]),u(p[1])]:u(p),done:T}},[Symbol.iterator](){return this}}}}function Ot(e){return function(...n){return e==="delete"?!1:e==="clear"?void 0:this}}function ja(e,n){const t={get(s){const r=this.__v_raw,o=se(r),a=se(s);e||(Ln(s,a)&&Me(o,"get",s),Me(o,"get",a));const{has:l}=Nt(o),h=n?$i:e?it:Ze;if(l.call(o,s))return h(r.get(s));if(l.call(o,a))return h(r.get(a));r!==o&&r.get(s)},get size(){const s=this.__v_raw;return!e&&Me(se(s),"iterate",Kn),s.size},has(s){const r=this.__v_raw,o=se(r),a=se(s);return e||(Ln(s,a)&&Me(o,"has",s),Me(o,"has",a)),s===a?r.has(s):r.has(s)||r.has(a)},forEach(s,r){const o=this,a=o.__v_raw,l=se(a),h=n?$i:e?it:Ze;return!e&&Me(l,"iterate",Kn),a.forEach((u,p)=>s.call(r,h(u),h(p),o))}};return xe(t,e?{add:Ot("add"),set:Ot("set"),delete:Ot("delete"),clear:Ot("clear")}:{add(s){!n&&!Ue(s)&&!yn(s)&&(s=se(s));const r=se(this);return Nt(r).has.call(r,s)||(r.add(s),pn(r,"add",s,s)),this},set(s,r){!n&&!Ue(r)&&!yn(r)&&(r=se(r));const o=se(this),{has:a,get:l}=Nt(o);let h=a.call(o,s);h||(s=se(s),h=a.call(o,s));const u=l.call(o,s);return o.set(s,r),h?Ln(r,u)&&pn(o,"set",s,r):pn(o,"add",s,r),this},delete(s){const r=se(this),{has:o,get:a}=Nt(r);let l=o.call(r,s);l||(s=se(s),l=o.call(r,s)),a&&a.call(r,s);const h=r.delete(s);return l&&pn(r,"delete",s,void 0),h},clear(){const s=se(this),r=s.size!==0,o=s.clear();return r&&pn(s,"clear",void 0,void 0),o}}),["keys","values","entries",Symbol.iterator].forEach(s=>{t[s]=Ka(s,e,n)}),t}function ps(e,n){const t=ja(e,n);return(i,s,r)=>s==="__v_isReactive"?!e:s==="__v_isReadonly"?e:s==="__v_raw"?i:Reflect.get(re(t,s)&&s in i?t:i,s,r)}const Va={get:ps(!1,!1)},Ga={get:ps(!1,!0)},$a={get:ps(!0,!1)};const eo=new WeakMap,no=new WeakMap,to=new WeakMap,Ua=new WeakMap;function Ja(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function qa(e){return e.__v_skip||!Object.isExtensible(e)?0:Ja(ya(e))}function hi(e){return yn(e)?e:gs(e,!1,Wa,Va,eo)}function Xa(e){return gs(e,!1,Da,Ga,no)}function Ui(e){return gs(e,!0,Ba,$a,to)}function gs(e,n,t,i,s){if(!ce(e)||e.__v_raw&&!(n&&e.__v_isReactive))return e;const r=qa(e);if(r===0)return e;const o=s.get(e);if(o)return o;const a=new Proxy(e,r===2?i:t);return s.set(e,a),a}function jn(e){return yn(e)?jn(e.__v_raw):!!(e&&e.__v_isReactive)}function yn(e){return!!(e&&e.__v_isReadonly)}function Ue(e){return!!(e&&e.__v_isShallow)}function bs(e){return e?!!e.__v_raw:!1}function se(e){const n=e&&e.__v_raw;return n?se(n):e}function Ya(e){return!re(e,"__v_skip")&&Object.isExtensible(e)&&Or(e,"__v_skip",!0),e}const Ze=e=>ce(e)?hi(e):e,it=e=>ce(e)?Ui(e):e;function ze(e){return e?e.__v_isRef===!0:!1}function sn(e){return Za(e,!1)}function Za(e,n){return ze(e)?e:new Qa(e,n)}class Qa{constructor(n,t){this.dep=new ms,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=t?n:se(n),this._value=t?n:Ze(n),this.__v_isShallow=t}get value(){return this.dep.track(),this._value}set value(n){const t=this._rawValue,i=this.__v_isShallow||Ue(n)||yn(n);n=i?n:se(n),Ln(n,t)&&(this._rawValue=n,this._value=i?n:Ze(n),this.dep.trigger())}}function el(e){return ze(e)?e.value:e}const nl={get:(e,n,t)=>n==="__v_raw"?e:el(Reflect.get(e,n,t)),set:(e,n,t,i)=>{const s=e[n];return ze(s)&&!ze(t)?(s.value=t,!0):Reflect.set(e,n,t,i)}};function io(e){return jn(e)?e:new Proxy(e,nl)}class tl{constructor(n,t,i){this.fn=n,this.setter=t,this._value=void 0,this.dep=new ms(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=kt-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!t,this.isSSR=i}notify(){if(this.flags|=16,!(this.flags&8)&&me!==this)return Gr(this,!0),!0}get value(){const n=this.dep.track();return Jr(this),n&&(n.version=this.dep.version),this._value}set value(n){this.setter&&this.setter(n)}}function il(e,n,t=!1){let i,s;return q(e)?i=e:(i=e.get,s=e.set),new tl(i,s,t)}const Wt={},Zt=new WeakMap;let Wn;function sl(e,n=!1,t=Wn){if(t){let i=Zt.get(t);i||Zt.set(t,i=[]),i.push(e)}}function rl(e,n,t=fe){const{immediate:i,deep:s,once:r,scheduler:o,augmentJob:a,call:l}=t,h=P=>s?P:Ue(P)||s===!1||s===0?gn(P,1):gn(P);let u,p,T,C,z=!1,O=!1;if(ze(e)?(p=()=>e.value,z=Ue(e)):jn(e)?(p=()=>h(e),z=!0):K(e)?(O=!0,z=e.some(P=>jn(P)||Ue(P)),p=()=>e.map(P=>{if(ze(P))return P.value;if(jn(P))return h(P);if(q(P))return l?l(P,2):P()})):q(e)?n?p=l?()=>l(e,2):e:p=()=>{if(T){bn();try{T()}finally{vn()}}const P=Wn;Wn=u;try{return l?l(e,3,[C]):e(C)}finally{Wn=P}}:p=ln,n&&s){const P=p,$=s===!0?1/0:s;p=()=>gn(P(),$)}const oe=Aa(),F=()=>{u.stop(),oe&&oe.active&&as(oe.effects,u)};if(r&&n){const P=n;n=(...$)=>{P(...$),F()}}let R=O?new Array(e.length).fill(Wt):Wt;const G=P=>{if(!(!(u.flags&1)||!u.dirty&&!P))if(n){const $=u.run();if(s||z||(O?$.some((ee,ue)=>Ln(ee,R[ue])):Ln($,R))){T&&T();const ee=Wn;Wn=u;try{const ue=[$,R===Wt?void 0:O&&R[0]===Wt?[]:R,C];R=$,l?l(n,3,ue):n(...ue)}finally{Wn=ee}}}else u.run()};return a&&a(G),u=new jr(p),u.scheduler=o?()=>o(G,!1):G,C=P=>sl(P,!1,u),T=u.onStop=()=>{const P=Zt.get(u);if(P){if(l)l(P,4);else for(const $ of P)$();Zt.delete(u)}},n?i?G(!0):R=u.run():o?o(G.bind(null,!0),!0):u.run(),F.pause=u.pause.bind(u),F.resume=u.resume.bind(u),F.stop=F,F}function gn(e,n=1/0,t){if(n<=0||!ce(e)||e.__v_skip||(t=t||new Map,(t.get(e)||0)>=n))return e;if(t.set(e,n),n--,ze(e))gn(e.value,n,t);else if(K(e))for(let i=0;i<e.length;i++)gn(e[i],n,t);else if(st(e)||Zn(e))e.forEach(i=>{gn(i,n,t)});else if(Hr(e)){for(const i in e)gn(e[i],n,t);for(const i of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,i)&&gn(e[i],n,t)}return e}function At(e,n,t,i){try{return i?e(...i):e()}catch(s){mi(s,n,t)}}function Qe(e,n,t,i){if(q(e)){const s=At(e,n,t,i);return s&&Ir(s)&&s.catch(r=>{mi(r,n,t)}),s}if(K(e)){const s=[];for(let r=0;r<e.length;r++)s.push(Qe(e[r],n,t,i));return s}}function mi(e,n,t,i=!0){const s=n?n.vnode:null,{errorHandler:r,throwUnhandledErrorInProduction:o}=n&&n.appContext.config||fe;if(n){let a=n.parent;const l=n.proxy,h=`https://vuejs.org/error-reference/#runtime-${t}`;for(;a;){const u=a.ec;if(u){for(let p=0;p<u.length;p++)if(u[p](e,l,h)===!1)return}a=a.parent}if(r){bn(),At(r,null,10,[e,l,h]),vn();return}}ol(e,t,s,i,o)}function ol(e,n,t,i=!0,s=!1){if(s)throw e;console.error(e)}const Ie=[];let on=-1;const et=[];let Tn=null,Xn=0;const so=Promise.resolve();let Qt=null;function ei(e){const n=Qt||so;return e?n.then(this?e.bind(this):e):n}function al(e){let n=on+1,t=Ie.length;for(;n<t;){const i=n+t>>>1,s=Ie[i],r=St(s);r<e||r===e&&s.flags&2?n=i+1:t=i}return n}function vs(e){if(!(e.flags&1)){const n=St(e),t=Ie[Ie.length-1];!t||!(e.flags&2)&&n>=St(t)?Ie.push(e):Ie.splice(al(n),0,e),e.flags|=1,ro()}}function ro(){Qt||(Qt=so.then(ao))}function ll(e){K(e)?et.push(...e):Tn&&e.id===-1?Tn.splice(Xn+1,0,e):e.flags&1||(et.push(e),e.flags|=1),ro()}function Bs(e,n,t=on+1){for(;t<Ie.length;t++){const i=Ie[t];if(i&&i.flags&2){if(e&&i.id!==e.uid)continue;Ie.splice(t,1),t--,i.flags&4&&(i.flags&=-2),i(),i.flags&4||(i.flags&=-2)}}}function oo(e){if(et.length){const n=[...new Set(et)].sort((t,i)=>St(t)-St(i));if(et.length=0,Tn){Tn.push(...n);return}for(Tn=n,Xn=0;Xn<Tn.length;Xn++){const t=Tn[Xn];t.flags&4&&(t.flags&=-2),t.flags&8||t(),t.flags&=-2}Tn=null,Xn=0}}const St=e=>e.id==null?e.flags&2?-1:1/0:e.id;function ao(e){try{for(on=0;on<Ie.length;on++){const n=Ie[on];n&&!(n.flags&8)&&(n.flags&4&&(n.flags&=-2),At(n,n.i,n.i?15:14),n.flags&4||(n.flags&=-2))}}finally{for(;on<Ie.length;on++){const n=Ie[on];n&&(n.flags&=-2)}on=-1,Ie.length=0,oo(),Qt=null,(Ie.length||et.length)&&ao()}}let $e=null,lo=null;function ni(e){const n=$e;return $e=e,lo=e&&e.type.__scopeId||null,n}function Ji(e,n=$e,t){if(!n||e._n)return e;const i=(...s)=>{i._d&&si(-1);const r=ni(n);let o;try{o=e(...s)}finally{ni(r),i._d&&si(1)}return o};return i._n=!0,i._c=!0,i._d=!0,i}function Ds(e,n){if($e===null)return e;const t=ki($e),i=e.dirs||(e.dirs=[]);for(let s=0;s<n.length;s++){let[r,o,a,l=fe]=n[s];r&&(q(r)&&(r={mounted:r,updated:r}),r.deep&&gn(o),i.push({dir:r,instance:t,value:o,oldValue:void 0,arg:a,modifiers:l}))}return e}function Fn(e,n,t,i){const s=e.dirs,r=n&&n.dirs;for(let o=0;o<s.length;o++){const a=s[o];r&&(a.oldValue=r[o].value);let l=a.dir[i];l&&(bn(),Qe(l,t,8,[e.el,a,e,n]),vn())}}const cl=Symbol("_vte"),co=e=>e.__isTeleport,mn=Symbol("_leaveCb"),Bt=Symbol("_enterCb");function ul(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return bi(()=>{e.isMounted=!0}),vi(()=>{e.isUnmounting=!0}),e}const Ve=[Function,Array],uo={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Ve,onEnter:Ve,onAfterEnter:Ve,onEnterCancelled:Ve,onBeforeLeave:Ve,onLeave:Ve,onAfterLeave:Ve,onLeaveCancelled:Ve,onBeforeAppear:Ve,onAppear:Ve,onAfterAppear:Ve,onAppearCancelled:Ve},fo=e=>{const n=e.subTree;return n.component?fo(n.component):n},dl={name:"BaseTransition",props:uo,setup(e,{slots:n}){const t=Oo(),i=ul();return()=>{const s=n.default&&po(n.default(),!0);if(!s||!s.length)return;const r=ho(s),o=se(e),{mode:a}=o;if(i.isLeaving)return Ai(r);const l=Ks(r);if(!l)return Ai(r);let h=qi(l,o,i,t,p=>h=p);l.type!==Fe&&Tt(l,h);let u=t.subTree&&Ks(t.subTree);if(u&&u.type!==Fe&&!Bn(u,l)&&fo(t).type!==Fe){let p=qi(u,o,i,t);if(Tt(u,p),a==="out-in"&&l.type!==Fe)return i.isLeaving=!0,p.afterLeave=()=>{i.isLeaving=!1,t.job.flags&8||t.update(),delete p.afterLeave,u=void 0},Ai(r);a==="in-out"&&l.type!==Fe?p.delayLeave=(T,C,z)=>{const O=mo(i,u);O[String(u.key)]=u,T[mn]=()=>{C(),T[mn]=void 0,delete h.delayedLeave,u=void 0},h.delayedLeave=()=>{z(),delete h.delayedLeave,u=void 0}}:u=void 0}else u&&(u=void 0);return r}}};function ho(e){let n=e[0];if(e.length>1){for(const t of e)if(t.type!==Fe){n=t;break}}return n}const fl=dl;function mo(e,n){const{leavingVNodes:t}=e;let i=t.get(n.type);return i||(i=Object.create(null),t.set(n.type,i)),i}function qi(e,n,t,i,s){const{appear:r,mode:o,persisted:a=!1,onBeforeEnter:l,onEnter:h,onAfterEnter:u,onEnterCancelled:p,onBeforeLeave:T,onLeave:C,onAfterLeave:z,onLeaveCancelled:O,onBeforeAppear:oe,onAppear:F,onAfterAppear:R,onAppearCancelled:G}=n,P=String(e.key),$=mo(t,e),ee=(B,j)=>{B&&Qe(B,i,9,j)},ue=(B,j)=>{const W=j[1];ee(B,j),K(B)?B.every(y=>y.length<=1)&&W():B.length<=1&&W()},ne={mode:o,persisted:a,beforeEnter(B){let j=l;if(!t.isMounted)if(r)j=oe||l;else return;B[mn]&&B[mn](!0);const W=$[P];W&&Bn(e,W)&&W.el[mn]&&W.el[mn](),ee(j,[B])},enter(B){let j=h,W=u,y=p;if(!t.isMounted)if(r)j=F||h,W=R||u,y=G||p;else return;let I=!1;const J=B[Bt]=de=>{I||(I=!0,de?ee(y,[B]):ee(W,[B]),ne.delayedLeave&&ne.delayedLeave(),B[Bt]=void 0)};j?ue(j,[B,J]):J()},leave(B,j){const W=String(e.key);if(B[Bt]&&B[Bt](!0),t.isUnmounting)return j();ee(T,[B]);let y=!1;const I=B[mn]=J=>{y||(y=!0,j(),J?ee(O,[B]):ee(z,[B]),B[mn]=void 0,$[W]===e&&delete $[W])};$[W]=e,C?ue(C,[B,I]):I()},clone(B){const j=qi(B,n,t,i,s);return s&&s(j),j}};return ne}function Ai(e){if(pi(e))return e=An(e),e.children=null,e}function Ks(e){if(!pi(e))return co(e.type)&&e.children?ho(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:n,children:t}=e;if(t){if(n&16)return t[0];if(n&32&&q(t.default))return t.default()}}function Tt(e,n){e.shapeFlag&6&&e.component?(e.transition=n,Tt(e.component.subTree,n)):e.shapeFlag&128?(e.ssContent.transition=n.clone(e.ssContent),e.ssFallback.transition=n.clone(e.ssFallback)):e.transition=n}function po(e,n=!1,t){let i=[],s=0;for(let r=0;r<e.length;r++){let o=e[r];const a=t==null?o.key:String(t)+String(o.key!=null?o.key:r);o.type===Be?(o.patchFlag&128&&s++,i=i.concat(po(o.children,n,a))):(n||o.type!==Fe)&&i.push(a!=null?An(o,{key:a}):o)}if(s>1)for(let r=0;r<i.length;r++)i[r].patchFlag=-2;return i}function go(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}const ti=new WeakMap;function bt(e,n,t,i,s=!1){if(K(e)){e.forEach((z,O)=>bt(z,n&&(K(n)?n[O]:n),t,i,s));return}if(vt(i)&&!s){i.shapeFlag&512&&i.type.__asyncResolved&&i.component.subTree.component&&bt(e,n,t,i.component.subTree);return}const r=i.shapeFlag&4?ki(i.component):i.el,o=s?null:r,{i:a,r:l}=e,h=n&&n.r,u=a.refs===fe?a.refs={}:a.refs,p=a.setupState,T=se(p),C=p===fe?Rr:z=>re(T,z);if(h!=null&&h!==l){if(js(n),we(h))u[h]=null,C(h)&&(p[h]=null);else if(ze(h)){h.value=null;const z=n;z.k&&(u[z.k]=null)}}if(q(l))At(l,a,12,[o,u]);else{const z=we(l),O=ze(l);if(z||O){const oe=()=>{if(e.f){const F=z?C(l)?p[l]:u[l]:l.value;if(s)K(F)&&as(F,r);else if(K(F))F.includes(r)||F.push(r);else if(z)u[l]=[r],C(l)&&(p[l]=u[l]);else{const R=[r];l.value=R,e.k&&(u[e.k]=R)}}else z?(u[l]=o,C(l)&&(p[l]=o)):O&&(l.value=o,e.k&&(u[e.k]=o))};if(o){const F=()=>{oe(),ti.delete(e)};F.id=-1,ti.set(e,F),De(F,t)}else js(e),oe()}}}function js(e){const n=ti.get(e);n&&(n.flags|=8,ti.delete(e))}di().requestIdleCallback;di().cancelIdleCallback;const vt=e=>!!e.type.__asyncLoader,pi=e=>e.type.__isKeepAlive;function hl(e,n){bo(e,"a",n)}function ml(e,n){bo(e,"da",n)}function bo(e,n,t=He){const i=e.__wdc||(e.__wdc=()=>{let s=t;for(;s;){if(s.isDeactivated)return;s=s.parent}return e()});if(gi(n,i,t),t){let s=t.parent;for(;s&&s.parent;)pi(s.parent.vnode)&&pl(i,n,t,s),s=s.parent}}function pl(e,n,t,i){const s=gi(n,e,i,!0);vo(()=>{as(i[n],s)},t)}function gi(e,n,t=He,i=!1){if(t){const s=t[e]||(t[e]=[]),r=n.__weh||(n.__weh=(...o)=>{bn();const a=Pt(t),l=Qe(n,t,e,o);return a(),vn(),l});return i?s.unshift(r):s.push(r),r}}const wn=e=>(n,t=He)=>{(!Et||e==="sp")&&gi(e,(...i)=>n(...i),t)},gl=wn("bm"),bi=wn("m"),bl=wn("bu"),vl=wn("u"),vi=wn("bum"),vo=wn("um"),yl=wn("sp"),wl=wn("rtg"),kl=wn("rtc");function _l(e,n=He){gi("ec",e,n)}const Sl=Symbol.for("v-ndc");function Dt(e,n,t,i){let s;const r=t,o=K(e);if(o||we(e)){const a=o&&jn(e);let l=!1,h=!1;a&&(l=!Ue(e),h=yn(e),e=fi(e)),s=new Array(e.length);for(let u=0,p=e.length;u<p;u++)s[u]=n(l?h?it(Ze(e[u])):Ze(e[u]):e[u],u,void 0,r)}else if(typeof e=="number"){s=new Array(e);for(let a=0;a<e;a++)s[a]=n(a+1,a,void 0,r)}else if(ce(e))if(e[Symbol.iterator])s=Array.from(e,(a,l)=>n(a,l,void 0,r));else{const a=Object.keys(e);s=new Array(a.length);for(let l=0,h=a.length;l<h;l++){const u=a[l];s[l]=n(e[u],u,l,r)}}else s=[];return s}const Xi=e=>e?Wo(e)?ki(e):Xi(e.parent):null,yt=xe(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Xi(e.parent),$root:e=>Xi(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>wo(e),$forceUpdate:e=>e.f||(e.f=()=>{vs(e.update)}),$nextTick:e=>e.n||(e.n=ei.bind(e.proxy)),$watch:e=>Fl.bind(e)}),Pi=(e,n)=>e!==fe&&!e.__isScriptSetup&&re(e,n),Tl={get({_:e},n){if(n==="__v_skip")return!0;const{ctx:t,setupState:i,data:s,props:r,accessCache:o,type:a,appContext:l}=e;if(n[0]!=="$"){const T=o[n];if(T!==void 0)switch(T){case 1:return i[n];case 2:return s[n];case 4:return t[n];case 3:return r[n]}else{if(Pi(i,n))return o[n]=1,i[n];if(s!==fe&&re(s,n))return o[n]=2,s[n];if(re(r,n))return o[n]=3,r[n];if(t!==fe&&re(t,n))return o[n]=4,t[n];Yi&&(o[n]=0)}}const h=yt[n];let u,p;if(h)return n==="$attrs"&&Me(e.attrs,"get",""),h(e);if((u=a.__cssModules)&&(u=u[n]))return u;if(t!==fe&&re(t,n))return o[n]=4,t[n];if(p=l.config.globalProperties,re(p,n))return p[n]},set({_:e},n,t){const{data:i,setupState:s,ctx:r}=e;return Pi(s,n)?(s[n]=t,!0):i!==fe&&re(i,n)?(i[n]=t,!0):re(e.props,n)||n[0]==="$"&&n.slice(1)in e?!1:(r[n]=t,!0)},has({_:{data:e,setupState:n,accessCache:t,ctx:i,appContext:s,props:r,type:o}},a){let l;return!!(t[a]||e!==fe&&a[0]!=="$"&&re(e,a)||Pi(n,a)||re(r,a)||re(i,a)||re(yt,a)||re(s.config.globalProperties,a)||(l=o.__cssModules)&&l[a])},defineProperty(e,n,t){return t.get!=null?e._.accessCache[n]=0:re(t,"value")&&this.set(e,n,t.value,null),Reflect.defineProperty(e,n,t)}};function Vs(e){return K(e)?e.reduce((n,t)=>(n[t]=null,n),{}):e}let Yi=!0;function Cl(e){const n=wo(e),t=e.proxy,i=e.ctx;Yi=!1,n.beforeCreate&&Gs(n.beforeCreate,e,"bc");const{data:s,computed:r,methods:o,watch:a,provide:l,inject:h,created:u,beforeMount:p,mounted:T,beforeUpdate:C,updated:z,activated:O,deactivated:oe,beforeDestroy:F,beforeUnmount:R,destroyed:G,unmounted:P,render:$,renderTracked:ee,renderTriggered:ue,errorCaptured:ne,serverPrefetch:B,expose:j,inheritAttrs:W,components:y,directives:I,filters:J}=n;if(h&&El(h,i,null),o)for(const X in o){const Y=o[X];q(Y)&&(i[X]=Y.bind(t))}if(s){const X=s.call(t,t);ce(X)&&(e.data=hi(X))}if(Yi=!0,r)for(const X in r){const Y=r[X],Te=q(Y)?Y.bind(t,t):q(Y.get)?Y.get.bind(t,t):ln,Je=!q(Y)&&q(Y.set)?Y.set.bind(t):ln,ge=te({get:Te,set:Je});Object.defineProperty(i,X,{enumerable:!0,configurable:!0,get:()=>ge.value,set:ve=>ge.value=ve})}if(a)for(const X in a)yo(a[X],i,t,X);if(l){const X=q(l)?l.call(t):l;Reflect.ownKeys(X).forEach(Y=>{Pl(Y,X[Y])})}u&&Gs(u,e,"c");function U(X,Y){K(Y)?Y.forEach(Te=>X(Te.bind(t))):Y&&X(Y.bind(t))}if(U(gl,p),U(bi,T),U(bl,C),U(vl,z),U(hl,O),U(ml,oe),U(_l,ne),U(kl,ee),U(wl,ue),U(vi,R),U(vo,P),U(yl,B),K(j))if(j.length){const X=e.exposed||(e.exposed={});j.forEach(Y=>{Object.defineProperty(X,Y,{get:()=>t[Y],set:Te=>t[Y]=Te,enumerable:!0})})}else e.exposed||(e.exposed={});$&&e.render===ln&&(e.render=$),W!=null&&(e.inheritAttrs=W),y&&(e.components=y),I&&(e.directives=I),B&&go(e)}function El(e,n,t=ln){K(e)&&(e=Zi(e));for(const i in e){const s=e[i];let r;ce(s)?"default"in s?r=Ut(s.from||i,s.default,!0):r=Ut(s.from||i):r=Ut(s),ze(r)?Object.defineProperty(n,i,{enumerable:!0,configurable:!0,get:()=>r.value,set:o=>r.value=o}):n[i]=r}}function Gs(e,n,t){Qe(K(e)?e.map(i=>i.bind(n.proxy)):e.bind(n.proxy),n,t)}function yo(e,n,t,i){let s=i.includes(".")?So(t,i):()=>t[i];if(we(e)){const r=n[e];q(r)&&Ge(s,r)}else if(q(e))Ge(s,e.bind(t));else if(ce(e))if(K(e))e.forEach(r=>yo(r,n,t,i));else{const r=q(e.handler)?e.handler.bind(t):n[e.handler];q(r)&&Ge(s,r,e)}}function wo(e){const n=e.type,{mixins:t,extends:i}=n,{mixins:s,optionsCache:r,config:{optionMergeStrategies:o}}=e.appContext,a=r.get(n);let l;return a?l=a:!s.length&&!t&&!i?l=n:(l={},s.length&&s.forEach(h=>ii(l,h,o,!0)),ii(l,n,o)),ce(n)&&r.set(n,l),l}function ii(e,n,t,i=!1){const{mixins:s,extends:r}=n;r&&ii(e,r,t,!0),s&&s.forEach(o=>ii(e,o,t,!0));for(const o in n)if(!(i&&o==="expose")){const a=xl[o]||t&&t[o];e[o]=a?a(e[o],n[o]):n[o]}return e}const xl={data:$s,props:Us,emits:Us,methods:ft,computed:ft,beforeCreate:Re,created:Re,beforeMount:Re,mounted:Re,beforeUpdate:Re,updated:Re,beforeDestroy:Re,beforeUnmount:Re,destroyed:Re,unmounted:Re,activated:Re,deactivated:Re,errorCaptured:Re,serverPrefetch:Re,components:ft,directives:ft,watch:Ll,provide:$s,inject:Ml};function $s(e,n){return n?e?function(){return xe(q(e)?e.call(this,this):e,q(n)?n.call(this,this):n)}:n:e}function Ml(e,n){return ft(Zi(e),Zi(n))}function Zi(e){if(K(e)){const n={};for(let t=0;t<e.length;t++)n[e[t]]=e[t];return n}return e}function Re(e,n){return e?[...new Set([].concat(e,n))]:n}function ft(e,n){return e?xe(Object.create(null),e,n):n}function Us(e,n){return e?K(e)&&K(n)?[...new Set([...e,...n])]:xe(Object.create(null),Vs(e),Vs(n??{})):n}function Ll(e,n){if(!e)return n;if(!n)return e;const t=xe(Object.create(null),e);for(const i in n)t[i]=Re(e[i],n[i]);return t}function ko(){return{app:null,config:{isNativeTag:Rr,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let zl=0;function Al(e,n){return function(i,s=null){q(i)||(i=xe({},i)),s!=null&&!ce(s)&&(s=null);const r=ko(),o=new WeakSet,a=[];let l=!1;const h=r.app={_uid:zl++,_component:i,_props:s,_container:null,_context:r,_instance:null,version:pc,get config(){return r.config},set config(u){},use(u,...p){return o.has(u)||(u&&q(u.install)?(o.add(u),u.install(h,...p)):q(u)&&(o.add(u),u(h,...p))),h},mixin(u){return r.mixins.includes(u)||r.mixins.push(u),h},component(u,p){return p?(r.components[u]=p,h):r.components[u]},directive(u,p){return p?(r.directives[u]=p,h):r.directives[u]},mount(u,p,T){if(!l){const C=h._ceVNode||Le(i,s);return C.appContext=r,T===!0?T="svg":T===!1&&(T=void 0),e(C,u,T),l=!0,h._container=u,u.__vue_app__=h,ki(C.component)}},onUnmount(u){a.push(u)},unmount(){l&&(Qe(a,h._instance,16),e(null,h._container),delete h._container.__vue_app__)},provide(u,p){return r.provides[u]=p,h},runWithContext(u){const p=nt;nt=h;try{return u()}finally{nt=p}}};return h}}let nt=null;function Pl(e,n){if(He){let t=He.provides;const i=He.parent&&He.parent.provides;i===t&&(t=He.provides=Object.create(i)),t[e]=n}}function Ut(e,n,t=!1){const i=Oo();if(i||nt){let s=nt?nt._context.provides:i?i.parent==null||i.ce?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides:void 0;if(s&&e in s)return s[e];if(arguments.length>1)return t&&q(n)?n.call(i&&i.proxy):n}}const Rl=Symbol.for("v-scx"),Il=()=>Ut(Rl);function Ge(e,n,t){return _o(e,n,t)}function _o(e,n,t=fe){const{immediate:i,deep:s,flush:r,once:o}=t,a=xe({},t),l=n&&i||!n&&r!=="post";let h;if(Et){if(r==="sync"){const C=Il();h=C.__watcherHandles||(C.__watcherHandles=[])}else if(!l){const C=()=>{};return C.stop=ln,C.resume=ln,C.pause=ln,C}}const u=He;a.call=(C,z,O)=>Qe(C,u,z,O);let p=!1;r==="post"?a.scheduler=C=>{De(C,u&&u.suspense)}:r!=="sync"&&(p=!0,a.scheduler=(C,z)=>{z?C():vs(C)}),a.augmentJob=C=>{n&&(C.flags|=4),p&&(C.flags|=2,u&&(C.id=u.uid,C.i=u))};const T=rl(e,n,a);return Et&&(h?h.push(T):l&&T()),T}function Fl(e,n,t){const i=this.proxy,s=we(e)?e.includes(".")?So(i,e):()=>i[e]:e.bind(i,i);let r;q(n)?r=n:(r=n.handler,t=n);const o=Pt(this),a=_o(s,r.bind(i),t);return o(),a}function So(e,n){const t=n.split(".");return()=>{let i=e;for(let s=0;s<t.length&&i;s++)i=i[t[s]];return i}}const Hl=(e,n)=>n==="modelValue"||n==="model-value"?e.modelModifiers:e[`${n}Modifiers`]||e[`${zn(n)}Modifiers`]||e[`${Vn(n)}Modifiers`];function Nl(e,n,...t){if(e.isUnmounted)return;const i=e.vnode.props||fe;let s=t;const r=n.startsWith("update:"),o=r&&Hl(i,n.slice(7));o&&(o.trim&&(s=t.map(u=>we(u)?u.trim():u)),o.number&&(s=t.map(Wr)));let a,l=i[a=Ei(n)]||i[a=Ei(zn(n))];!l&&r&&(l=i[a=Ei(Vn(n))]),l&&Qe(l,e,6,s);const h=i[a+"Once"];if(h){if(!e.emitted)e.emitted={};else if(e.emitted[a])return;e.emitted[a]=!0,Qe(h,e,6,s)}}const Ol=new WeakMap;function To(e,n,t=!1){const i=t?Ol:n.emitsCache,s=i.get(e);if(s!==void 0)return s;const r=e.emits;let o={},a=!1;if(!q(e)){const l=h=>{const u=To(h,n,!0);u&&(a=!0,xe(o,u))};!t&&n.mixins.length&&n.mixins.forEach(l),e.extends&&l(e.extends),e.mixins&&e.mixins.forEach(l)}return!r&&!a?(ce(e)&&i.set(e,null),null):(K(r)?r.forEach(l=>o[l]=null):xe(o,r),ce(e)&&i.set(e,o),o)}function yi(e,n){return!e||!ci(n)?!1:(n=n.slice(2).replace(/Once$/,""),re(e,n[0].toLowerCase()+n.slice(1))||re(e,Vn(n))||re(e,n))}function Js(e){const{type:n,vnode:t,proxy:i,withProxy:s,propsOptions:[r],slots:o,attrs:a,emit:l,render:h,renderCache:u,props:p,data:T,setupState:C,ctx:z,inheritAttrs:O}=e,oe=ni(e);let F,R;try{if(t.shapeFlag&4){const P=s||i,$=P;F=an(h.call($,P,u,p,C,T,z)),R=a}else{const P=n;F=an(P.length>1?P(p,{attrs:a,slots:o,emit:l}):P(p,null)),R=n.props?a:Wl(a)}}catch(P){wt.length=0,mi(P,e,1),F=Le(Fe)}let G=F;if(R&&O!==!1){const P=Object.keys(R),{shapeFlag:$}=G;P.length&&$&7&&(r&&P.some(os)&&(R=Bl(R,r)),G=An(G,R,!1,!0))}return t.dirs&&(G=An(G,null,!1,!0),G.dirs=G.dirs?G.dirs.concat(t.dirs):t.dirs),t.transition&&Tt(G,t.transition),F=G,ni(oe),F}const Wl=e=>{let n;for(const t in e)(t==="class"||t==="style"||ci(t))&&((n||(n={}))[t]=e[t]);return n},Bl=(e,n)=>{const t={};for(const i in e)(!os(i)||!(i.slice(9)in n))&&(t[i]=e[i]);return t};function Dl(e,n,t){const{props:i,children:s,component:r}=e,{props:o,children:a,patchFlag:l}=n,h=r.emitsOptions;if(n.dirs||n.transition)return!0;if(t&&l>=0){if(l&1024)return!0;if(l&16)return i?qs(i,o,h):!!o;if(l&8){const u=n.dynamicProps;for(let p=0;p<u.length;p++){const T=u[p];if(o[T]!==i[T]&&!yi(h,T))return!0}}}else return(s||a)&&(!a||!a.$stable)?!0:i===o?!1:i?o?qs(i,o,h):!0:!!o;return!1}function qs(e,n,t){const i=Object.keys(n);if(i.length!==Object.keys(e).length)return!0;for(let s=0;s<i.length;s++){const r=i[s];if(n[r]!==e[r]&&!yi(t,r))return!0}return!1}function Kl({vnode:e,parent:n},t){for(;n;){const i=n.subTree;if(i.suspense&&i.suspense.activeBranch===e&&(i.el=e.el),i===e)(e=n.vnode).el=t,n=n.parent;else break}}const Co={},Eo=()=>Object.create(Co),xo=e=>Object.getPrototypeOf(e)===Co;function jl(e,n,t,i=!1){const s={},r=Eo();e.propsDefaults=Object.create(null),Mo(e,n,s,r);for(const o in e.propsOptions[0])o in s||(s[o]=void 0);t?e.props=i?s:Xa(s):e.type.props?e.props=s:e.props=r,e.attrs=r}function Vl(e,n,t,i){const{props:s,attrs:r,vnode:{patchFlag:o}}=e,a=se(s),[l]=e.propsOptions;let h=!1;if((i||o>0)&&!(o&16)){if(o&8){const u=e.vnode.dynamicProps;for(let p=0;p<u.length;p++){let T=u[p];if(yi(e.emitsOptions,T))continue;const C=n[T];if(l)if(re(r,T))C!==r[T]&&(r[T]=C,h=!0);else{const z=zn(T);s[z]=Qi(l,a,z,C,e,!1)}else C!==r[T]&&(r[T]=C,h=!0)}}}else{Mo(e,n,s,r)&&(h=!0);let u;for(const p in a)(!n||!re(n,p)&&((u=Vn(p))===p||!re(n,u)))&&(l?t&&(t[p]!==void 0||t[u]!==void 0)&&(s[p]=Qi(l,a,p,void 0,e,!0)):delete s[p]);if(r!==a)for(const p in r)(!n||!re(n,p))&&(delete r[p],h=!0)}h&&pn(e.attrs,"set","")}function Mo(e,n,t,i){const[s,r]=e.propsOptions;let o=!1,a;if(n)for(let l in n){if(mt(l))continue;const h=n[l];let u;s&&re(s,u=zn(l))?!r||!r.includes(u)?t[u]=h:(a||(a={}))[u]=h:yi(e.emitsOptions,l)||(!(l in i)||h!==i[l])&&(i[l]=h,o=!0)}if(r){const l=se(t),h=a||fe;for(let u=0;u<r.length;u++){const p=r[u];t[p]=Qi(s,l,p,h[p],e,!re(h,p))}}return o}function Qi(e,n,t,i,s,r){const o=e[t];if(o!=null){const a=re(o,"default");if(a&&i===void 0){const l=o.default;if(o.type!==Function&&!o.skipFactory&&q(l)){const{propsDefaults:h}=s;if(t in h)i=h[t];else{const u=Pt(s);i=h[t]=l.call(null,n),u()}}else i=l;s.ce&&s.ce._setProp(t,i)}o[0]&&(r&&!a?i=!1:o[1]&&(i===""||i===Vn(t))&&(i=!0))}return i}const Gl=new WeakMap;function Lo(e,n,t=!1){const i=t?Gl:n.propsCache,s=i.get(e);if(s)return s;const r=e.props,o={},a=[];let l=!1;if(!q(e)){const u=p=>{l=!0;const[T,C]=Lo(p,n,!0);xe(o,T),C&&a.push(...C)};!t&&n.mixins.length&&n.mixins.forEach(u),e.extends&&u(e.extends),e.mixins&&e.mixins.forEach(u)}if(!r&&!l)return ce(e)&&i.set(e,Yn),Yn;if(K(r))for(let u=0;u<r.length;u++){const p=zn(r[u]);Xs(p)&&(o[p]=fe)}else if(r)for(const u in r){const p=zn(u);if(Xs(p)){const T=r[u],C=o[p]=K(T)||q(T)?{type:T}:xe({},T),z=C.type;let O=!1,oe=!0;if(K(z))for(let F=0;F<z.length;++F){const R=z[F],G=q(R)&&R.name;if(G==="Boolean"){O=!0;break}else G==="String"&&(oe=!1)}else O=q(z)&&z.name==="Boolean";C[0]=O,C[1]=oe,(O||re(C,"default"))&&a.push(p)}}const h=[o,a];return ce(e)&&i.set(e,h),h}function Xs(e){return e[0]!=="$"&&!mt(e)}const ys=e=>e==="_"||e==="_ctx"||e==="$stable",ws=e=>K(e)?e.map(an):[an(e)],$l=(e,n,t)=>{if(n._n)return n;const i=Ji((...s)=>ws(n(...s)),t);return i._c=!1,i},zo=(e,n,t)=>{const i=e._ctx;for(const s in e){if(ys(s))continue;const r=e[s];if(q(r))n[s]=$l(s,r,i);else if(r!=null){const o=ws(r);n[s]=()=>o}}},Ao=(e,n)=>{const t=ws(n);e.slots.default=()=>t},Po=(e,n,t)=>{for(const i in n)(t||!ys(i))&&(e[i]=n[i])},Ul=(e,n,t)=>{const i=e.slots=Eo();if(e.vnode.shapeFlag&32){const s=n._;s?(Po(i,n,t),t&&Or(i,"_",s,!0)):zo(n,i)}else n&&Ao(e,n)},Jl=(e,n,t)=>{const{vnode:i,slots:s}=e;let r=!0,o=fe;if(i.shapeFlag&32){const a=n._;a?t&&a===1?r=!1:Po(s,n,t):(r=!n.$stable,zo(n,s)),o=n}else n&&(Ao(e,n),o={default:1});if(r)for(const a in s)!ys(a)&&o[a]==null&&delete s[a]},De=Ql;function ql(e){return Xl(e)}function Xl(e,n){const t=di();t.__VUE__=!0;const{insert:i,remove:s,patchProp:r,createElement:o,createText:a,createComment:l,setText:h,setElementText:u,parentNode:p,nextSibling:T,setScopeId:C=ln,insertStaticContent:z}=e,O=(c,f,g,k=null,w=null,_=null,M=void 0,S=null,x=!!f.dynamicChildren)=>{if(c===f)return;c&&!Bn(c,f)&&(k=Pn(c),ve(c,w,_,!0),c=null),f.patchFlag===-2&&(x=!1,f.dynamicChildren=null);const{type:b,ref:N,shapeFlag:A}=f;switch(b){case wi:oe(c,f,g,k);break;case Fe:F(c,f,g,k);break;case Ii:c==null&&R(f,g,k,M);break;case Be:y(c,f,g,k,w,_,M,S,x);break;default:A&1?$(c,f,g,k,w,_,M,S,x):A&6?I(c,f,g,k,w,_,M,S,x):(A&64||A&128)&&b.process(c,f,g,k,w,_,M,S,x,qe)}N!=null&&w?bt(N,c&&c.ref,_,f||c,!f):N==null&&c&&c.ref!=null&&bt(c.ref,null,_,c,!0)},oe=(c,f,g,k)=>{if(c==null)i(f.el=a(f.children),g,k);else{const w=f.el=c.el;f.children!==c.children&&h(w,f.children)}},F=(c,f,g,k)=>{c==null?i(f.el=l(f.children||""),g,k):f.el=c.el},R=(c,f,g,k)=>{[c.el,c.anchor]=z(c.children,f,g,k,c.el,c.anchor)},G=({el:c,anchor:f},g,k)=>{let w;for(;c&&c!==f;)w=T(c),i(c,g,k),c=w;i(f,g,k)},P=({el:c,anchor:f})=>{let g;for(;c&&c!==f;)g=T(c),s(c),c=g;s(f)},$=(c,f,g,k,w,_,M,S,x)=>{if(f.type==="svg"?M="svg":f.type==="math"&&(M="mathml"),c==null)ee(f,g,k,w,_,M,S,x);else{const b=c.el&&c.el._isVueCE?c.el:null;try{b&&b._beginPatch(),B(c,f,w,_,M,S,x)}finally{b&&b._endPatch()}}},ee=(c,f,g,k,w,_,M,S)=>{let x,b;const{props:N,shapeFlag:A,transition:H,dirs:V}=c;if(x=c.el=o(c.type,_,N&&N.is,N),A&8?u(x,c.children):A&16&&ne(c.children,x,null,k,w,Ri(c,_),M,S),V&&Fn(c,null,k,"created"),ue(x,c,c.scopeId,M,k),N){for(const le in N)le!=="value"&&!mt(le)&&r(x,le,null,N[le],_,k);"value"in N&&r(x,"value",null,N.value,_),(b=N.onVnodeBeforeMount)&&rn(b,k,c)}V&&Fn(c,null,k,"beforeMount");const Q=Yl(w,H);Q&&H.beforeEnter(x),i(x,f,g),((b=N&&N.onVnodeMounted)||Q||V)&&De(()=>{b&&rn(b,k,c),Q&&H.enter(x),V&&Fn(c,null,k,"mounted")},w)},ue=(c,f,g,k,w)=>{if(g&&C(c,g),k)for(let _=0;_<k.length;_++)C(c,k[_]);if(w){let _=w.subTree;if(f===_||Fo(_.type)&&(_.ssContent===f||_.ssFallback===f)){const M=w.vnode;ue(c,M,M.scopeId,M.slotScopeIds,w.parent)}}},ne=(c,f,g,k,w,_,M,S,x=0)=>{for(let b=x;b<c.length;b++){const N=c[b]=S?Cn(c[b]):an(c[b]);O(null,N,f,g,k,w,_,M,S)}},B=(c,f,g,k,w,_,M)=>{const S=f.el=c.el;let{patchFlag:x,dynamicChildren:b,dirs:N}=f;x|=c.patchFlag&16;const A=c.props||fe,H=f.props||fe;let V;if(g&&Hn(g,!1),(V=H.onVnodeBeforeUpdate)&&rn(V,g,f,c),N&&Fn(f,c,g,"beforeUpdate"),g&&Hn(g,!0),(A.innerHTML&&H.innerHTML==null||A.textContent&&H.textContent==null)&&u(S,""),b?j(c.dynamicChildren,b,S,g,k,Ri(f,w),_):M||Y(c,f,S,null,g,k,Ri(f,w),_,!1),x>0){if(x&16)W(S,A,H,g,w);else if(x&2&&A.class!==H.class&&r(S,"class",null,H.class,w),x&4&&r(S,"style",A.style,H.style,w),x&8){const Q=f.dynamicProps;for(let le=0;le<Q.length;le++){const Z=Q[le],_e=A[Z],Se=H[Z];(Se!==_e||Z==="value")&&r(S,Z,_e,Se,w,g)}}x&1&&c.children!==f.children&&u(S,f.children)}else!M&&b==null&&W(S,A,H,g,w);((V=H.onVnodeUpdated)||N)&&De(()=>{V&&rn(V,g,f,c),N&&Fn(f,c,g,"updated")},k)},j=(c,f,g,k,w,_,M)=>{for(let S=0;S<f.length;S++){const x=c[S],b=f[S],N=x.el&&(x.type===Be||!Bn(x,b)||x.shapeFlag&198)?p(x.el):g;O(x,b,N,null,k,w,_,M,!0)}},W=(c,f,g,k,w)=>{if(f!==g){if(f!==fe)for(const _ in f)!mt(_)&&!(_ in g)&&r(c,_,f[_],null,w,k);for(const _ in g){if(mt(_))continue;const M=g[_],S=f[_];M!==S&&_!=="value"&&r(c,_,S,M,w,k)}"value"in g&&r(c,"value",f.value,g.value,w)}},y=(c,f,g,k,w,_,M,S,x)=>{const b=f.el=c?c.el:a(""),N=f.anchor=c?c.anchor:a("");let{patchFlag:A,dynamicChildren:H,slotScopeIds:V}=f;V&&(S=S?S.concat(V):V),c==null?(i(b,g,k),i(N,g,k),ne(f.children||[],g,N,w,_,M,S,x)):A>0&&A&64&&H&&c.dynamicChildren?(j(c.dynamicChildren,H,g,w,_,M,S),(f.key!=null||w&&f===w.subTree)&&Ro(c,f,!0)):Y(c,f,g,N,w,_,M,S,x)},I=(c,f,g,k,w,_,M,S,x)=>{f.slotScopeIds=S,c==null?f.shapeFlag&512?w.ctx.activate(f,g,k,M,x):J(f,g,k,w,_,M,x):de(c,f,x)},J=(c,f,g,k,w,_,M)=>{const S=c.component=lc(c,k,w);if(pi(c)&&(S.ctx.renderer=qe),cc(S,!1,M),S.asyncDep){if(w&&w.registerDep(S,U,M),!c.el){const x=S.subTree=Le(Fe);F(null,x,f,g),c.placeholder=x.el}}else U(S,c,f,g,w,_,M)},de=(c,f,g)=>{const k=f.component=c.component;if(Dl(c,f,g))if(k.asyncDep&&!k.asyncResolved){X(k,f,g);return}else k.next=f,k.update();else f.el=c.el,k.vnode=f},U=(c,f,g,k,w,_,M)=>{const S=()=>{if(c.isMounted){let{next:A,bu:H,u:V,parent:Q,vnode:le}=c;{const Ne=Io(c);if(Ne){A&&(A.el=le.el,X(c,A,M)),Ne.asyncDep.then(()=>{c.isUnmounted||S()});return}}let Z=A,_e;Hn(c,!1),A?(A.el=le.el,X(c,A,M)):A=le,H&&$t(H),(_e=A.props&&A.props.onVnodeBeforeUpdate)&&rn(_e,Q,A,le),Hn(c,!0);const Se=Js(c),be=c.subTree;c.subTree=Se,O(be,Se,p(be.el),Pn(be),c,w,_),A.el=Se.el,Z===null&&Kl(c,Se.el),V&&De(V,w),(_e=A.props&&A.props.onVnodeUpdated)&&De(()=>rn(_e,Q,A,le),w)}else{let A;const{el:H,props:V}=f,{bm:Q,m:le,parent:Z,root:_e,type:Se}=c,be=vt(f);Hn(c,!1),Q&&$t(Q),!be&&(A=V&&V.onVnodeBeforeMount)&&rn(A,Z,f),Hn(c,!0);{_e.ce&&_e.ce._def.shadowRoot!==!1&&_e.ce._injectChildStyle(Se);const Ne=c.subTree=Js(c);O(null,Ne,g,k,c,w,_),f.el=Ne.el}if(le&&De(le,w),!be&&(A=V&&V.onVnodeMounted)){const Ne=f;De(()=>rn(A,Z,Ne),w)}(f.shapeFlag&256||Z&&vt(Z.vnode)&&Z.vnode.shapeFlag&256)&&c.a&&De(c.a,w),c.isMounted=!0,f=g=k=null}};c.scope.on();const x=c.effect=new jr(S);c.scope.off();const b=c.update=x.run.bind(x),N=c.job=x.runIfDirty.bind(x);N.i=c,N.id=c.uid,x.scheduler=()=>vs(N),Hn(c,!0),b()},X=(c,f,g)=>{f.component=c;const k=c.vnode.props;c.vnode=f,c.next=null,Vl(c,f.props,k,g),Jl(c,f.children,g),bn(),Bs(c),vn()},Y=(c,f,g,k,w,_,M,S,x=!1)=>{const b=c&&c.children,N=c?c.shapeFlag:0,A=f.children,{patchFlag:H,shapeFlag:V}=f;if(H>0){if(H&128){Je(b,A,g,k,w,_,M,S,x);return}else if(H&256){Te(b,A,g,k,w,_,M,S,x);return}}V&8?(N&16&&nn(b,w,_),A!==b&&u(g,A)):N&16?V&16?Je(b,A,g,k,w,_,M,S,x):nn(b,w,_,!0):(N&8&&u(g,""),V&16&&ne(A,g,k,w,_,M,S,x))},Te=(c,f,g,k,w,_,M,S,x)=>{c=c||Yn,f=f||Yn;const b=c.length,N=f.length,A=Math.min(b,N);let H;for(H=0;H<A;H++){const V=f[H]=x?Cn(f[H]):an(f[H]);O(c[H],V,g,null,w,_,M,S,x)}b>N?nn(c,w,_,!0,!1,A):ne(f,g,k,w,_,M,S,x,A)},Je=(c,f,g,k,w,_,M,S,x)=>{let b=0;const N=f.length;let A=c.length-1,H=N-1;for(;b<=A&&b<=H;){const V=c[b],Q=f[b]=x?Cn(f[b]):an(f[b]);if(Bn(V,Q))O(V,Q,g,null,w,_,M,S,x);else break;b++}for(;b<=A&&b<=H;){const V=c[A],Q=f[H]=x?Cn(f[H]):an(f[H]);if(Bn(V,Q))O(V,Q,g,null,w,_,M,S,x);else break;A--,H--}if(b>A){if(b<=H){const V=H+1,Q=V<N?f[V].el:k;for(;b<=H;)O(null,f[b]=x?Cn(f[b]):an(f[b]),g,Q,w,_,M,S,x),b++}}else if(b>H)for(;b<=A;)ve(c[b],w,_,!0),b++;else{const V=b,Q=b,le=new Map;for(b=Q;b<=H;b++){const Ae=f[b]=x?Cn(f[b]):an(f[b]);Ae.key!=null&&le.set(Ae.key,b)}let Z,_e=0;const Se=H-Q+1;let be=!1,Ne=0;const kn=new Array(Se);for(b=0;b<Se;b++)kn[b]=0;for(b=V;b<=A;b++){const Ae=c[b];if(_e>=Se){ve(Ae,w,_,!0);continue}let je;if(Ae.key!=null)je=le.get(Ae.key);else for(Z=Q;Z<=H;Z++)if(kn[Z-Q]===0&&Bn(Ae,f[Z])){je=Z;break}je===void 0?ve(Ae,w,_,!0):(kn[je-Q]=b+1,je>=Ne?Ne=je:be=!0,O(Ae,f[je],g,null,w,_,M,S,x),_e++)}const It=be?Zl(kn):Yn;for(Z=It.length-1,b=Se-1;b>=0;b--){const Ae=Q+b,je=f[Ae],Ft=f[Ae+1],Ht=Ae+1<N?Ft.el||Ft.placeholder:k;kn[b]===0?O(null,je,g,Ht,w,_,M,S,x):be&&(Z<0||b!==It[Z]?ge(je,g,Ht,2):Z--)}}},ge=(c,f,g,k,w=null)=>{const{el:_,type:M,transition:S,children:x,shapeFlag:b}=c;if(b&6){ge(c.component.subTree,f,g,k);return}if(b&128){c.suspense.move(f,g,k);return}if(b&64){M.move(c,f,g,qe);return}if(M===Be){i(_,f,g);for(let A=0;A<x.length;A++)ge(x[A],f,g,k);i(c.anchor,f,g);return}if(M===Ii){G(c,f,g);return}if(k!==2&&b&1&&S)if(k===0)S.beforeEnter(_),i(_,f,g),De(()=>S.enter(_),w);else{const{leave:A,delayLeave:H,afterLeave:V}=S,Q=()=>{c.ctx.isUnmounted?s(_):i(_,f,g)},le=()=>{_._isLeaving&&_[mn](!0),A(_,()=>{Q(),V&&V()})};H?H(_,Q,le):le()}else i(_,f,g)},ve=(c,f,g,k=!1,w=!1)=>{const{type:_,props:M,ref:S,children:x,dynamicChildren:b,shapeFlag:N,patchFlag:A,dirs:H,cacheIndex:V}=c;if(A===-2&&(w=!1),S!=null&&(bn(),bt(S,null,g,c,!0),vn()),V!=null&&(f.renderCache[V]=void 0),N&256){f.ctx.deactivate(c);return}const Q=N&1&&H,le=!vt(c);let Z;if(le&&(Z=M&&M.onVnodeBeforeUnmount)&&rn(Z,f,c),N&6)ot(c.component,g,k);else{if(N&128){c.suspense.unmount(g,k);return}Q&&Fn(c,null,f,"beforeUnmount"),N&64?c.type.remove(c,f,g,qe,k):b&&!b.hasOnce&&(_!==Be||A>0&&A&64)?nn(b,f,g,!1,!0):(_===Be&&A&384||!w&&N&16)&&nn(x,f,g),k&&en(c)}(le&&(Z=M&&M.onVnodeUnmounted)||Q)&&De(()=>{Z&&rn(Z,f,c),Q&&Fn(c,null,f,"unmounted")},g)},en=c=>{const{type:f,el:g,anchor:k,transition:w}=c;if(f===Be){Gn(g,k);return}if(f===Ii){P(c);return}const _=()=>{s(g),w&&!w.persisted&&w.afterLeave&&w.afterLeave()};if(c.shapeFlag&1&&w&&!w.persisted){const{leave:M,delayLeave:S}=w,x=()=>M(g,_);S?S(c.el,_,x):x()}else _()},Gn=(c,f)=>{let g;for(;c!==f;)g=T(c),s(c),c=g;s(f)},ot=(c,f,g)=>{const{bum:k,scope:w,job:_,subTree:M,um:S,m:x,a:b}=c;Ys(x),Ys(b),k&&$t(k),w.stop(),_&&(_.flags|=8,ve(M,c,f,g)),S&&De(S,f),De(()=>{c.isUnmounted=!0},f)},nn=(c,f,g,k=!1,w=!1,_=0)=>{for(let M=_;M<c.length;M++)ve(c[M],f,g,k,w)},Pn=c=>{if(c.shapeFlag&6)return Pn(c.component.subTree);if(c.shapeFlag&128)return c.suspense.next();const f=T(c.anchor||c.el),g=f&&f[cl];return g?T(g):f};let at=!1;const lt=(c,f,g)=>{c==null?f._vnode&&ve(f._vnode,null,null,!0):O(f._vnode||null,c,f,null,null,null,g),f._vnode=c,at||(at=!0,Bs(),oo(),at=!1)},qe={p:O,um:ve,m:ge,r:en,mt:J,mc:ne,pc:Y,pbc:j,n:Pn,o:e};return{render:lt,hydrate:void 0,createApp:Al(lt)}}function Ri({type:e,props:n},t){return t==="svg"&&e==="foreignObject"||t==="mathml"&&e==="annotation-xml"&&n&&n.encoding&&n.encoding.includes("html")?void 0:t}function Hn({effect:e,job:n},t){t?(e.flags|=32,n.flags|=4):(e.flags&=-33,n.flags&=-5)}function Yl(e,n){return(!e||e&&!e.pendingBranch)&&n&&!n.persisted}function Ro(e,n,t=!1){const i=e.children,s=n.children;if(K(i)&&K(s))for(let r=0;r<i.length;r++){const o=i[r];let a=s[r];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=s[r]=Cn(s[r]),a.el=o.el),!t&&a.patchFlag!==-2&&Ro(o,a)),a.type===wi&&a.patchFlag!==-1&&(a.el=o.el),a.type===Fe&&!a.el&&(a.el=o.el)}}function Zl(e){const n=e.slice(),t=[0];let i,s,r,o,a;const l=e.length;for(i=0;i<l;i++){const h=e[i];if(h!==0){if(s=t[t.length-1],e[s]<h){n[i]=s,t.push(i);continue}for(r=0,o=t.length-1;r<o;)a=r+o>>1,e[t[a]]<h?r=a+1:o=a;h<e[t[r]]&&(r>0&&(n[i]=t[r-1]),t[r]=i)}}for(r=t.length,o=t[r-1];r-- >0;)t[r]=o,o=n[o];return t}function Io(e){const n=e.subTree.component;if(n)return n.asyncDep&&!n.asyncResolved?n:Io(n)}function Ys(e){if(e)for(let n=0;n<e.length;n++)e[n].flags|=8}const Fo=e=>e.__isSuspense;function Ql(e,n){n&&n.pendingBranch?K(e)?n.effects.push(...e):n.effects.push(e):ll(e)}const Be=Symbol.for("v-fgt"),wi=Symbol.for("v-txt"),Fe=Symbol.for("v-cmt"),Ii=Symbol.for("v-stc"),wt=[];let Ke=null;function he(e=!1){wt.push(Ke=e?null:[])}function ec(){wt.pop(),Ke=wt[wt.length-1]||null}let Ct=1;function si(e,n=!1){Ct+=e,e<0&&Ke&&n&&(Ke.hasOnce=!0)}function Ho(e){return e.dynamicChildren=Ct>0?Ke||Yn:null,ec(),Ct>0&&Ke&&Ke.push(e),e}function pe(e,n,t,i,s,r){return Ho(L(e,n,t,i,s,r,!0))}function nc(e,n,t,i,s){return Ho(Le(e,n,t,i,s,!0))}function ri(e){return e?e.__v_isVNode===!0:!1}function Bn(e,n){return e.type===n.type&&e.key===n.key}const No=({key:e})=>e??null,Jt=({ref:e,ref_key:n,ref_for:t})=>(typeof e=="number"&&(e=""+e),e!=null?we(e)||ze(e)||q(e)?{i:$e,r:e,k:n,f:!!t}:e:null);function L(e,n=null,t=null,i=0,s=null,r=e===Be?0:1,o=!1,a=!1){const l={__v_isVNode:!0,__v_skip:!0,type:e,props:n,key:n&&No(n),ref:n&&Jt(n),scopeId:lo,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:i,dynamicProps:s,dynamicChildren:null,appContext:null,ctx:$e};return a?(ks(l,t),r&128&&e.normalize(l)):t&&(l.shapeFlag|=we(t)?8:16),Ct>0&&!o&&Ke&&(l.patchFlag>0||r&6)&&l.patchFlag!==32&&Ke.push(l),l}const Le=tc;function tc(e,n=null,t=null,i=0,s=null,r=!1){if((!e||e===Sl)&&(e=Fe),ri(e)){const a=An(e,n,!0);return t&&ks(a,t),Ct>0&&!r&&Ke&&(a.shapeFlag&6?Ke[Ke.indexOf(e)]=a:Ke.push(a)),a.patchFlag=-2,a}if(hc(e)&&(e=e.__vccOpts),n){n=ic(n);let{class:a,style:l}=n;a&&!we(a)&&(n.class=Qn(a)),ce(l)&&(bs(l)&&!K(l)&&(l=xe({},l)),n.style=cs(l))}const o=we(e)?1:Fo(e)?128:co(e)?64:ce(e)?4:q(e)?2:0;return L(e,n,t,i,s,o,r,!0)}function ic(e){return e?bs(e)||xo(e)?xe({},e):e:null}function An(e,n,t=!1,i=!1){const{props:s,ref:r,patchFlag:o,children:a,transition:l}=e,h=n?rc(s||{},n):s,u={__v_isVNode:!0,__v_skip:!0,type:e.type,props:h,key:h&&No(h),ref:n&&n.ref?t&&r?K(r)?r.concat(Jt(n)):[r,Jt(n)]:Jt(n):r,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:a,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:n&&e.type!==Be?o===-1?16:o|16:o,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:l,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&An(e.ssContent),ssFallback:e.ssFallback&&An(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return l&&i&&Tt(u,l.clone(u)),u}function sc(e=" ",n=0){return Le(wi,null,e,n)}function Xe(e="",n=!1){return n?(he(),nc(Fe,null,e)):Le(Fe,null,e)}function an(e){return e==null||typeof e=="boolean"?Le(Fe):K(e)?Le(Be,null,e.slice()):ri(e)?Cn(e):Le(wi,null,String(e))}function Cn(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:An(e)}function ks(e,n){let t=0;const{shapeFlag:i}=e;if(n==null)n=null;else if(K(n))t=16;else if(typeof n=="object")if(i&65){const s=n.default;s&&(s._c&&(s._d=!1),ks(e,s()),s._c&&(s._d=!0));return}else{t=32;const s=n._;!s&&!xo(n)?n._ctx=$e:s===3&&$e&&($e.slots._===1?n._=1:(n._=2,e.patchFlag|=1024))}else q(n)?(n={default:n,_ctx:$e},t=32):(n=String(n),i&64?(t=16,n=[sc(n)]):t=8);e.children=n,e.shapeFlag|=t}function rc(...e){const n={};for(let t=0;t<e.length;t++){const i=e[t];for(const s in i)if(s==="class")n.class!==i.class&&(n.class=Qn([n.class,i.class]));else if(s==="style")n.style=cs([n.style,i.style]);else if(ci(s)){const r=n[s],o=i[s];o&&r!==o&&!(K(r)&&r.includes(o))&&(n[s]=r?[].concat(r,o):o)}else s!==""&&(n[s]=i[s])}return n}function rn(e,n,t,i=null){Qe(e,n,7,[t,i])}const oc=ko();let ac=0;function lc(e,n,t){const i=e.type,s=(n?n.appContext:e.appContext)||oc,r={uid:ac++,vnode:e,type:i,parent:n,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new za(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:n?n.provides:Object.create(s.provides),ids:n?n.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Lo(i,s),emitsOptions:To(i,s),emit:null,emitted:null,propsDefaults:fe,inheritAttrs:i.inheritAttrs,ctx:fe,data:fe,props:fe,attrs:fe,slots:fe,refs:fe,setupState:fe,setupContext:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=n?n.root:r,r.emit=Nl.bind(null,r),e.ce&&e.ce(r),r}let He=null;const Oo=()=>He||$e;let oi,es;{const e=di(),n=(t,i)=>{let s;return(s=e[t])||(s=e[t]=[]),s.push(i),r=>{s.length>1?s.forEach(o=>o(r)):s[0](r)}};oi=n("__VUE_INSTANCE_SETTERS__",t=>He=t),es=n("__VUE_SSR_SETTERS__",t=>Et=t)}const Pt=e=>{const n=He;return oi(e),e.scope.on(),()=>{e.scope.off(),oi(n)}},Zs=()=>{He&&He.scope.off(),oi(null)};function Wo(e){return e.vnode.shapeFlag&4}let Et=!1;function cc(e,n=!1,t=!1){n&&es(n);const{props:i,children:s}=e.vnode,r=Wo(e);jl(e,i,r,n),Ul(e,s,t||n);const o=r?uc(e,n):void 0;return n&&es(!1),o}function uc(e,n){const t=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,Tl);const{setup:i}=t;if(i){bn();const s=e.setupContext=i.length>1?fc(e):null,r=Pt(e),o=At(i,e,0,[e.props,s]),a=Ir(o);if(vn(),r(),(a||e.sp)&&!vt(e)&&go(e),a){if(o.then(Zs,Zs),n)return o.then(l=>{Qs(e,l)}).catch(l=>{mi(l,e,0)});e.asyncDep=o}else Qs(e,o)}else Bo(e)}function Qs(e,n,t){q(n)?e.type.__ssrInlineRender?e.ssrRender=n:e.render=n:ce(n)&&(e.setupState=io(n)),Bo(e)}function Bo(e,n,t){const i=e.type;e.render||(e.render=i.render||ln);{const s=Pt(e);bn();try{Cl(e)}finally{vn(),s()}}}const dc={get(e,n){return Me(e,"get",""),e[n]}};function fc(e){const n=t=>{e.exposed=t||{}};return{attrs:new Proxy(e.attrs,dc),slots:e.slots,emit:e.emit,expose:n}}function ki(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(io(Ya(e.exposed)),{get(n,t){if(t in n)return n[t];if(t in yt)return yt[t](e)},has(n,t){return t in n||t in yt}})):e.proxy}function hc(e){return q(e)&&"__vccOpts"in e}const te=(e,n)=>il(e,n,Et);function mc(e,n,t){try{si(-1);const i=arguments.length;return i===2?ce(n)&&!K(n)?ri(n)?Le(e,null,[n]):Le(e,n):Le(e,null,n):(i>3?t=Array.prototype.slice.call(arguments,2):i===3&&ri(t)&&(t=[t]),Le(e,n,t))}finally{si(1)}}const pc="3.5.25";let ns;const er=typeof window<"u"&&window.trustedTypes;if(er)try{ns=er.createPolicy("vue",{createHTML:e=>e})}catch{}const Do=ns?e=>ns.createHTML(e):e=>e,gc="http://www.w3.org/2000/svg",bc="http://www.w3.org/1998/Math/MathML",hn=typeof document<"u"?document:null,nr=hn&&hn.createElement("template"),vc={insert:(e,n,t)=>{n.insertBefore(e,t||null)},remove:e=>{const n=e.parentNode;n&&n.removeChild(e)},createElement:(e,n,t,i)=>{const s=n==="svg"?hn.createElementNS(gc,e):n==="mathml"?hn.createElementNS(bc,e):t?hn.createElement(e,{is:t}):hn.createElement(e);return e==="select"&&i&&i.multiple!=null&&s.setAttribute("multiple",i.multiple),s},createText:e=>hn.createTextNode(e),createComment:e=>hn.createComment(e),setText:(e,n)=>{e.nodeValue=n},setElementText:(e,n)=>{e.textContent=n},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>hn.querySelector(e),setScopeId(e,n){e.setAttribute(n,"")},insertStaticContent(e,n,t,i,s,r){const o=t?t.previousSibling:n.lastChild;if(s&&(s===r||s.nextSibling))for(;n.insertBefore(s.cloneNode(!0),t),!(s===r||!(s=s.nextSibling)););else{nr.innerHTML=Do(i==="svg"?`<svg>${e}</svg>`:i==="mathml"?`<math>${e}</math>`:e);const a=nr.content;if(i==="svg"||i==="mathml"){const l=a.firstChild;for(;l.firstChild;)a.appendChild(l.firstChild);a.removeChild(l)}n.insertBefore(a,t)}return[o?o.nextSibling:n.firstChild,t?t.previousSibling:n.lastChild]}},_n="transition",ut="animation",xt=Symbol("_vtc"),Ko={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},yc=xe({},uo,Ko),wc=e=>(e.displayName="Transition",e.props=yc,e),tr=wc((e,{slots:n})=>mc(fl,kc(e),n)),Nn=(e,n=[])=>{K(e)?e.forEach(t=>t(...n)):e&&e(...n)},ir=e=>e?K(e)?e.some(n=>n.length>1):e.length>1:!1;function kc(e){const n={};for(const y in e)y in Ko||(n[y]=e[y]);if(e.css===!1)return n;const{name:t="v",type:i,duration:s,enterFromClass:r=`${t}-enter-from`,enterActiveClass:o=`${t}-enter-active`,enterToClass:a=`${t}-enter-to`,appearFromClass:l=r,appearActiveClass:h=o,appearToClass:u=a,leaveFromClass:p=`${t}-leave-from`,leaveActiveClass:T=`${t}-leave-active`,leaveToClass:C=`${t}-leave-to`}=e,z=_c(s),O=z&&z[0],oe=z&&z[1],{onBeforeEnter:F,onEnter:R,onEnterCancelled:G,onLeave:P,onLeaveCancelled:$,onBeforeAppear:ee=F,onAppear:ue=R,onAppearCancelled:ne=G}=n,B=(y,I,J,de)=>{y._enterCancelled=de,On(y,I?u:a),On(y,I?h:o),J&&J()},j=(y,I)=>{y._isLeaving=!1,On(y,p),On(y,C),On(y,T),I&&I()},W=y=>(I,J)=>{const de=y?ue:R,U=()=>B(I,y,J);Nn(de,[I,U]),sr(()=>{On(I,y?l:r),fn(I,y?u:a),ir(de)||rr(I,i,O,U)})};return xe(n,{onBeforeEnter(y){Nn(F,[y]),fn(y,r),fn(y,o)},onBeforeAppear(y){Nn(ee,[y]),fn(y,l),fn(y,h)},onEnter:W(!1),onAppear:W(!0),onLeave(y,I){y._isLeaving=!0;const J=()=>j(y,I);fn(y,p),y._enterCancelled?(fn(y,T),lr(y)):(lr(y),fn(y,T)),sr(()=>{y._isLeaving&&(On(y,p),fn(y,C),ir(P)||rr(y,i,oe,J))}),Nn(P,[y,J])},onEnterCancelled(y){B(y,!1,void 0,!0),Nn(G,[y])},onAppearCancelled(y){B(y,!0,void 0,!0),Nn(ne,[y])},onLeaveCancelled(y){j(y),Nn($,[y])}})}function _c(e){if(e==null)return null;if(ce(e))return[Fi(e.enter),Fi(e.leave)];{const n=Fi(e);return[n,n]}}function Fi(e){return _a(e)}function fn(e,n){n.split(/\s+/).forEach(t=>t&&e.classList.add(t)),(e[xt]||(e[xt]=new Set)).add(n)}function On(e,n){n.split(/\s+/).forEach(i=>i&&e.classList.remove(i));const t=e[xt];t&&(t.delete(n),t.size||(e[xt]=void 0))}function sr(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let Sc=0;function rr(e,n,t,i){const s=e._endId=++Sc,r=()=>{s===e._endId&&i()};if(t!=null)return setTimeout(r,t);const{type:o,timeout:a,propCount:l}=Tc(e,n);if(!o)return i();const h=o+"end";let u=0;const p=()=>{e.removeEventListener(h,T),r()},T=C=>{C.target===e&&++u>=l&&p()};setTimeout(()=>{u<l&&p()},a+1),e.addEventListener(h,T)}function Tc(e,n){const t=window.getComputedStyle(e),i=z=>(t[z]||"").split(", "),s=i(`${_n}Delay`),r=i(`${_n}Duration`),o=or(s,r),a=i(`${ut}Delay`),l=i(`${ut}Duration`),h=or(a,l);let u=null,p=0,T=0;n===_n?o>0&&(u=_n,p=o,T=r.length):n===ut?h>0&&(u=ut,p=h,T=l.length):(p=Math.max(o,h),u=p>0?o>h?_n:ut:null,T=u?u===_n?r.length:l.length:0);const C=u===_n&&/\b(?:transform|all)(?:,|$)/.test(i(`${_n}Property`).toString());return{type:u,timeout:p,propCount:T,hasTransform:C}}function or(e,n){for(;e.length<n.length;)e=e.concat(e);return Math.max(...n.map((t,i)=>ar(t)+ar(e[i])))}function ar(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function lr(e){return(e?e.ownerDocument:document).body.offsetHeight}function Cc(e,n,t){const i=e[xt];i&&(n=(n?[n,...i]:[...i]).join(" ")),n==null?e.removeAttribute("class"):t?e.setAttribute("class",n):e.className=n}const cr=Symbol("_vod"),Ec=Symbol("_vsh"),xc=Symbol(""),Mc=/(?:^|;)\s*display\s*:/;function Lc(e,n,t){const i=e.style,s=we(t);let r=!1;if(t&&!s){if(n)if(we(n))for(const o of n.split(";")){const a=o.slice(0,o.indexOf(":")).trim();t[a]==null&&qt(i,a,"")}else for(const o in n)t[o]==null&&qt(i,o,"");for(const o in t)o==="display"&&(r=!0),qt(i,o,t[o])}else if(s){if(n!==t){const o=i[xc];o&&(t+=";"+o),i.cssText=t,r=Mc.test(t)}}else n&&e.removeAttribute("style");cr in e&&(e[cr]=r?i.display:"",e[Ec]&&(i.display="none"))}const ur=/\s*!important$/;function qt(e,n,t){if(K(t))t.forEach(i=>qt(e,n,i));else if(t==null&&(t=""),n.startsWith("--"))e.setProperty(n,t);else{const i=zc(e,n);ur.test(t)?e.setProperty(Vn(i),t.replace(ur,""),"important"):e[i]=t}}const dr=["Webkit","Moz","ms"],Hi={};function zc(e,n){const t=Hi[n];if(t)return t;let i=zn(n);if(i!=="filter"&&i in e)return Hi[n]=i;i=Nr(i);for(let s=0;s<dr.length;s++){const r=dr[s]+i;if(r in e)return Hi[n]=r}return n}const fr="http://www.w3.org/1999/xlink";function hr(e,n,t,i,s,r=Ma(n)){i&&n.startsWith("xlink:")?t==null?e.removeAttributeNS(fr,n.slice(6,n.length)):e.setAttributeNS(fr,n,t):t==null||r&&!Br(t)?e.removeAttribute(n):e.setAttribute(n,r?"":cn(t)?String(t):t)}function mr(e,n,t,i,s){if(n==="innerHTML"||n==="textContent"){t!=null&&(e[n]=n==="innerHTML"?Do(t):t);return}const r=e.tagName;if(n==="value"&&r!=="PROGRESS"&&!r.includes("-")){const a=r==="OPTION"?e.getAttribute("value")||"":e.value,l=t==null?e.type==="checkbox"?"on":"":String(t);(a!==l||!("_value"in e))&&(e.value=l),t==null&&e.removeAttribute(n),e._value=t;return}let o=!1;if(t===""||t==null){const a=typeof e[n];a==="boolean"?t=Br(t):t==null&&a==="string"?(t="",o=!0):a==="number"&&(t=0,o=!0)}try{e[n]=t}catch{}o&&e.removeAttribute(s||n)}function _s(e,n,t,i){e.addEventListener(n,t,i)}function Ac(e,n,t,i){e.removeEventListener(n,t,i)}const pr=Symbol("_vei");function Pc(e,n,t,i,s=null){const r=e[pr]||(e[pr]={}),o=r[n];if(i&&o)o.value=i;else{const[a,l]=Rc(n);if(i){const h=r[n]=Hc(i,s);_s(e,a,h,l)}else o&&(Ac(e,a,o,l),r[n]=void 0)}}const gr=/(?:Once|Passive|Capture)$/;function Rc(e){let n;if(gr.test(e)){n={};let i;for(;i=e.match(gr);)e=e.slice(0,e.length-i[0].length),n[i[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):Vn(e.slice(2)),n]}let Ni=0;const Ic=Promise.resolve(),Fc=()=>Ni||(Ic.then(()=>Ni=0),Ni=Date.now());function Hc(e,n){const t=i=>{if(!i._vts)i._vts=Date.now();else if(i._vts<=t.attached)return;Qe(Nc(i,t.value),n,5,[i])};return t.value=e,t.attached=Fc(),t}function Nc(e,n){if(K(n)){const t=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{t.call(e),e._stopped=!0},n.map(i=>s=>!s._stopped&&i&&i(s))}else return n}const br=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,Oc=(e,n,t,i,s,r)=>{const o=s==="svg";n==="class"?Cc(e,i,o):n==="style"?Lc(e,t,i):ci(n)?os(n)||Pc(e,n,t,i,r):(n[0]==="."?(n=n.slice(1),!0):n[0]==="^"?(n=n.slice(1),!1):Wc(e,n,i,o))?(mr(e,n,i),!e.tagName.includes("-")&&(n==="value"||n==="checked"||n==="selected")&&hr(e,n,i,o,r,n!=="value")):e._isVueCE&&(/[A-Z]/.test(n)||!we(i))?mr(e,zn(n),i,r,n):(n==="true-value"?e._trueValue=i:n==="false-value"&&(e._falseValue=i),hr(e,n,i,o))};function Wc(e,n,t,i){if(i)return!!(n==="innerHTML"||n==="textContent"||n in e&&br(n)&&q(t));if(n==="spellcheck"||n==="draggable"||n==="translate"||n==="autocorrect"||n==="sandbox"&&e.tagName==="IFRAME"||n==="form"||n==="list"&&e.tagName==="INPUT"||n==="type"&&e.tagName==="TEXTAREA")return!1;if(n==="width"||n==="height"){const s=e.tagName;if(s==="IMG"||s==="VIDEO"||s==="CANVAS"||s==="SOURCE")return!1}return br(n)&&we(t)?!1:n in e}const ai=e=>{const n=e.props["onUpdate:modelValue"]||!1;return K(n)?t=>$t(n,t):n},tt=Symbol("_assign"),Bc={deep:!0,created(e,n,t){e[tt]=ai(t),_s(e,"change",()=>{const i=e._modelValue,s=Mt(e),r=e.checked,o=e[tt];if(K(i)){const a=us(i,s),l=a!==-1;if(r&&!l)o(i.concat(s));else if(!r&&l){const h=[...i];h.splice(a,1),o(h)}}else if(st(i)){const a=new Set(i);r?a.add(s):a.delete(s),o(a)}else o(jo(e,r))})},mounted:vr,beforeUpdate(e,n,t){e[tt]=ai(t),vr(e,n,t)}};function vr(e,{value:n,oldValue:t},i){e._modelValue=n;let s;if(K(n))s=us(n,i.props.value)>-1;else if(st(n))s=n.has(i.props.value);else{if(n===t)return;s=zt(n,jo(e,!0))}e.checked!==s&&(e.checked=s)}const Dc={deep:!0,created(e,{value:n,modifiers:{number:t}},i){const s=st(n);_s(e,"change",()=>{const r=Array.prototype.filter.call(e.options,o=>o.selected).map(o=>t?Wr(Mt(o)):Mt(o));e[tt](e.multiple?s?new Set(r):r:r[0]),e._assigning=!0,ei(()=>{e._assigning=!1})}),e[tt]=ai(i)},mounted(e,{value:n}){yr(e,n)},beforeUpdate(e,n,t){e[tt]=ai(t)},updated(e,{value:n}){e._assigning||yr(e,n)}};function yr(e,n){const t=e.multiple,i=K(n);if(!(t&&!i&&!st(n))){for(let s=0,r=e.options.length;s<r;s++){const o=e.options[s],a=Mt(o);if(t)if(i){const l=typeof a;l==="string"||l==="number"?o.selected=n.some(h=>String(h)===String(a)):o.selected=us(n,a)>-1}else o.selected=n.has(a);else if(zt(Mt(o),n)){e.selectedIndex!==s&&(e.selectedIndex=s);return}}!t&&e.selectedIndex!==-1&&(e.selectedIndex=-1)}}function Mt(e){return"_value"in e?e._value:e.value}function jo(e,n){const t=n?"_trueValue":"_falseValue";return t in e?e[t]:n}const Kc=["ctrl","shift","alt","meta"],jc={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,n)=>Kc.some(t=>e[`${t}Key`]&&!n.includes(t))},Vc=(e,n)=>{const t=e._withMods||(e._withMods={}),i=n.join(".");return t[i]||(t[i]=((s,...r)=>{for(let o=0;o<n.length;o++){const a=jc[n[o]];if(a&&a(s,n))return}return e(s,...r)}))},Gc=xe({patchProp:Oc},vc);let wr;function $c(){return wr||(wr=ql(Gc))}const Uc=((...e)=>{const n=$c().createApp(...e),{mount:t}=n;return n.mount=i=>{const s=qc(i);if(!s)return;const r=n._component;!q(r)&&!r.render&&!r.template&&(r.template=s.innerHTML),s.nodeType===1&&(s.textContent="");const o=t(s,!1,Jc(s));return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),o},n});function Jc(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function qc(e){return we(e)?document.querySelector(e):e}const Xc="/favicon.png",Yc="/images/about_music_logo.png",Zc="/images/dk3-min.jpg",Qc="/images/powered_by_black-4339b4c3c9cf88da9bfb15a16c4f6914.png",rt=[{name:"Antonio Vivaldi",birth:1678,death:1741},{name:"Johann Sebastian Bach",birth:1685,death:1750},{name:"Domenico Scarlatti",birth:1685,death:1757},{name:"George Frideric Handel",birth:1685,death:1759},{name:"Joseph Haydn",birth:1732,death:1809},{name:"Wolfgang Amadeus Mozart",birth:1756,death:1791},{name:"Ludwig van Beethoven",birth:1770,death:1827},{name:"Niccolò Paganini",birth:1782,death:1840},{name:"Franz Schubert",birth:1797,death:1828},{name:"Hector Berlioz",birth:1803,death:1869},{name:"Mikhail Glinka",birth:1804,death:1857},{name:"Felix Mendelssohn",birth:1809,death:1847},{name:"Frédéric Chopin",birth:1810,death:1849},{name:"Robert Schumann",birth:1810,death:1856},{name:"Franz Liszt",birth:1811,death:1886},{name:"Giuseppe Verdi",birth:1813,death:1901},{name:"Johann Strauss II",birth:1825,death:1899},{name:"Johannes Brahms",birth:1833,death:1897},{name:"Alexander Borodin",birth:1833,death:1887},{name:"Camille Saint-Saëns",birth:1835,death:1921},{name:"Jacques Offenbach",birth:1819,death:1880},{name:"Georges Bizet",birth:1838,death:1875},{name:"Modest Mussorgsky",birth:1839,death:1881},{name:"Pyotr Ilyich Tchaikovsky",birth:1840,death:1893},{name:"Antonín Dvořák",birth:1841,death:1904},{name:"Edvard Grieg",birth:1843,death:1907},{name:"Nikolai Rimsky-Korsakov",birth:1844,death:1908},{name:"Giacomo Puccini",birth:1858,death:1924},{name:"Gustav Mahler",birth:1860,death:1911},{name:"Claude Debussy",birth:1862,death:1918},{name:"Erik Satie",birth:1866,death:1925},{name:"Alexander Scriabin",birth:1872,death:1915},{name:"Sergei Rachmaninoff",birth:1873,death:1943},{name:"Maurice Ravel",birth:1875,death:1937},{name:"Sergei Prokofiev",birth:1891,death:1953},{name:"Dmitri Shostakovich",birth:1906,death:1975}],eu={"Richard Wagner":"comp/wagner.jpg","Igor Stravinsky":"comp/stravinsky.jpg","Antonio Vivaldi":"comp/vivaldi.jpg","Johann Sebastian Bach":"comp/bach.png","Domenico Scarlatti":"comp/scarlatti.jpg","George Frideric Handel":"comp/handel.jpg","Joseph Haydn":"comp/haydn.jpg","Wolfgang Amadeus Mozart":"comp/mozart.jpg","Ludwig van Beethoven":"comp/beethoven.jpg","Niccolò Paganini":"comp/paganini.jpeg","Franz Schubert":"comp/schubert.jpg","Hector Berlioz":"comp/berlioz.jpg","Mikhail Glinka":"comp/glinka.jpg","Felix Mendelssohn":"comp/mendelssohn.jpg","Frédéric Chopin":"comp/chopin.jpeg","Robert Schumann":"comp/schumann.jpg","Franz Liszt":"comp/liszt.jpg","Giuseppe Verdi":"comp/verdi.jpg","Johann Strauss II":"comp/strauss.jpg","Johannes Brahms":"comp/brahms.jpg","Alexander Borodin":"comp/borodin.jpg","Camille Saint-Saëns":"comp/saint-saens.jpg","Jacques Offenbach":"comp/offenbach.jpg","Georges Bizet":"comp/bizet.jpg","Modest Mussorgsky":"comp/musorgskiy.jpg","Pyotr Ilyich Tchaikovsky":"comp/tchaikovsky.jpg","Antonín Dvořák":"comp/dvorak.jpg","Edvard Grieg":"comp/grieg.jpg","Nikolai Rimsky-Korsakov":"comp/rimsky-korsakov.jpg","Gustav Mahler":"comp/mahler.jpg","Claude Debussy":"comp/debussy.jpg","Erik Satie":"comp/satie.jpg","Alexander Scriabin":"comp/scriabin.jpg","Sergei Rachmaninoff":"comp/rachmaninoff.jpg","Maurice Ravel":"comp/ravel.jpg","Béla Bartók":"comp/bartok.jpg","Sergei Prokofiev":"comp/prokofiev.jpg","Dmitri Shostakovich":"comp/shostakovich.jpg","Carl Maria von Weber":"comp/weber.jpg","Giacomo Puccini":"comp/puccini.jpg","Jean Sibelius":"comp/sibelius.jpg","Christoph Willibald Gluck":"comp/gluck.jpg","Gioachino Rossini":"comp/rossini.jpg","Jean-Philippe Rameau":"comp/rameau.jpg"};function Vo(e){return eu[e]||null}function nu(e){const n=String(e||"").trim().split(/\s+/).filter(Boolean);if(n.length<=1)return e;const t=n[n.length-1];return/^(?:[IVX]+|\d+|Jr\.?|Sr\.?)$/i.test(t)&&n.length>=2?n[n.length-2]+" "+t:t}function tu(e){const n=String(e||"").trim().split(/\s+/).filter(Boolean);if(n.length<=1)return e;const t=n[n.length-1],s=/^(?:[IVX]+|\d+|Jr\.?|Sr\.?)$/i.test(t)&&n.length>=2?2:1,r=n.slice(n.length-s),a=n.slice(0,n.length-s).map(h=>h.trim()).filter(Boolean).map(h=>h[0]?h[0].toUpperCase()+".":"").filter(Boolean).join(" "),l=r.join(" ");return a?`${a} ${l}`:l}const Rt=[{id:"baroque",label:"Baroque",from:1600,to:1750},{id:"classical",label:"Classical",from:1750,to:1820},{id:"romantic",label:"Romantic",from:1820,to:1900},{id:"twentieth",label:"20th Century",from:1900,to:2e3}];let ts=Rt.reduce((e,n)=>(e[n.id]=n.label,e),{});const kr=Math.min(...rt.map(e=>e.birth)),iu=Math.max(...rt.map(e=>e.birth));let is=[...rt],En=null,xn=null;const su={r:255,g:255,b:255},ru={r:37,g:99,b:235};ht("#f3f4f6"),Tr(1750),ht("#e6eef8"),Tr(1820),ht("#e8f4ff"),ht("#eef2f7");const li=1677.5,Xt=1980,Go=Xt-li,ou=6,au=2,lu=0,Yt={barHeight:50,widthScale:1,fontScale:1},qn={barHeight:{min:25,max:150},widthScale:{min:.05,max:2},fontScale:{min:.9,max:1.8}};let Mn={...Yt};function Oi(e,n,t){return Number.isNaN(e)?n:Math.min(t,Math.max(n,e))}function _r(e={}){Mn={barHeight:Oi(e.barHeight??Mn.barHeight??Yt.barHeight,qn.barHeight.min,qn.barHeight.max),widthScale:Oi(e.widthScale??Mn.widthScale??Yt.widthScale,qn.widthScale.min,qn.widthScale.max),fontScale:Oi(e.fontScale??Mn.fontScale??Yt.fontScale,qn.fontScale.min,qn.fontScale.max)}}function cu(){return ou*Mn.widthScale}function Kt(){const e=document.querySelector(".timeline-inner"),n=document.getElementById("timeline");if(!e||!n)return;const t=Go*cu()+lu,i=(n.clientWidth||window.innerWidth)*au*Mn.widthScale,s=Math.max(t,i);e.style.width=s+"px",e.style.minWidth=s+"px"}function Dn(e){return(e-li)/Go*100}function $o(e){return Number.isNaN(e)?0:Math.min(1,Math.max(0,e))}function ht(e){const n=e.replace("#",""),t=n.length===3?n.split("").map(s=>s+s).join(""):n,i=parseInt(t,16);return{r:i>>16&255,g:i>>8&255,b:i&255}}function Wi({r:e,g:n,b:t}){const i=s=>Math.round(s).toString(16).padStart(2,"0");return`#${i(e)}${i(n)}${i(t)}`}function Sr(e,n,t){const i=$o(t);return{r:e.r+(n.r-e.r)*i,g:e.g+(n.g-e.g)*i,b:e.b+(n.b-e.b)*i}}function Tr(e){const n=iu-kr;return n<=0?0:$o((e-kr)/n)}const uu={baroque:"#f3f4f6",classical:"#eef5ff",romantic:"#e3f0ff",twentieth:"#dfdfdf"};function Ss(e){return uu[e]||"#f3f4f6"}function du(e){return e?ts[e]||Rt.find(n=>n.id===e)?.label||e:""}function Cr(e={}){!e||typeof e!="object"||(ts={...ts,...e})}function fu(e){const n=Rt.find(t=>e>=t.from&&e<t.to);return n?n.id:null}function hu(e,n){const t=Number(e),i=Number(n),s=fu(t);if(!Number.isFinite(t)||!Number.isFinite(i)||i<=t)return s;const r=i-t;let o=null,a=0;return Rt.forEach(l=>{const h=Math.max(0,Math.min(i,l.to)-Math.max(t,l.from));h>a&&(a=h,o=l.id)}),o&&a>r/2?o:s}function mu(e){const n=Ss(e),t=ht(n),i=Sr(t,su,.12),s=Sr(t,ru,.04);return`linear-gradient(145deg, ${Wi(i)} 0%, ${Wi(t)} 58%, ${Wi(s)} 100%)`}function Er(e){Array.isArray(e)?is=[...e]:is=[...rt]}function Ts(){const e=document.getElementById("gantt");if(!e)return;const n=i=>Number.isInteger(En)&&i===En,t=i=>Number.isInteger(xn)&&i===xn;e.querySelectorAll(".bar").forEach(i=>{const s=Number(i.getAttribute("data-lane-index"));i.classList.toggle("bar--selected",n(s)),i.classList.toggle("bar--hovered",t(s))}),e.querySelectorAll(".bar-connector").forEach(i=>{const s=Number(i.getAttribute("data-lane-index")),r=n(s),o=t(s);i.classList.toggle("bar-connector--selected",r),i.classList.toggle("bar-connector--hover",o)})}function Uo(e){Number.isInteger(e)?En=e:En=null,Ts()}function ss(e){Number.isInteger(e)?xn=e:xn=null,Ts()}function xr(){const e=document.getElementById("axis");if(!e)return;e.innerHTML="";const n=Math.ceil(li/10)*10,t=Math.ceil(Xt/10)*10;Rt.forEach(i=>{const s=Math.max(i.from,li),r=Math.min(i.to,Xt);if(r<=s)return;const o=document.createElement("div");o.className="era-band",o.style.left=Dn(s)+"%",o.style.width=Dn(r)-Dn(s)+"%",o.style.backgroundImage="none",o.style.backgroundColor=Ss(i.id),o.textContent=du(i.id)||i.label,i.id==="baroque"&&(o.style.justifyContent="flex-end",o.style.paddingLeft="6px",o.style.paddingRight="26px",o.style.textAlign="right"),r===Xt&&(o.style.borderRight="none"),e.appendChild(o)});for(let i=n;i<=t;i+=10){const s=document.createElement("div"),r=i%50===0;s.className="axis-tick "+(r?"major":"minor"),s.style.left=Dn(i)+"%",e.appendChild(s);const o=document.createElement("div");o.className="axis-label "+(r?"axis-label-major":"axis-label-minor"),o.style.left=Dn(i)+"%",o.textContent=i,e.appendChild(o)}}function Bi(){const e=document.getElementById("gantt"),n=document.getElementById("axis"),t=document.getElementById("timeline");if(!e)return;e.innerHTML="";const i=parseFloat(window.getComputedStyle(e).marginTop||"0")||0,s=document.createDocumentFragment(),r=is||[];e&&e.clientWidth||n&&n.clientWidth||t&&t.clientWidth||window.innerWidth;const o=[...r].sort((C,z)=>C.birth-z.birth),a=o.length,l=o.map((C,z)=>({composer:C,laneIndex:z}));Number.isInteger(En)&&(En<0||En>=a)&&(En=null),Number.isInteger(xn)&&(xn<0||xn>=a)&&(xn=null);const h=2,u=Mn.barHeight,p=u+h,T=a*u+Math.max(0,a-1)*h;e.style.height=T+"px",a&&(l.forEach(({composer:C,laneIndex:z})=>{const O=C.displayName||C.name,oe=Dn(C.birth),F=Dn(C.death),R=document.createElement("div");R.className="bar",R.setAttribute("data-lane-index",z),R.setAttribute("data-name",C.name);const G=hu(C.birth,C.death);R.style.backgroundImage=mu(G),R.style.backgroundColor=Ss(G);const P=oe,$=F-oe,ue=z*p+u*.5+i,ne=(W,y)=>{const I=document.createElement("div");I.className="bar-connector",I.setAttribute("data-lane-index",z),I.setAttribute("data-side",y),I.style.left=W+"%",I.style.top=-i+"px",I.style.height=ue+"px",s.appendChild(I)};ne(P,"start"),ne(P+$,"end"),R.style.left=P+"%",R.style.width=$+"%",R.style.top=z*p+"px",R.style.height=u+"px",R.style.lineHeight=u+"px",R.style.fontSize=u*.25*Mn.fontScale+"px";const B=Vo(C.name);if(B){const W=document.createElement("img");W.className="bar-avatar";const y=Math.max(10,Math.round(u*.9));W.style.width=y+"px",W.style.height=y+"px",W.src=B,W.alt=O||C.name,R.appendChild(W)}const j=document.createElement("span");j.className="bar-label",j.textContent=O,R.appendChild(j),e.appendChild(R),R.addEventListener("click",W=>{W.stopPropagation(),Uo(z),window.dispatchEvent(new CustomEvent("composer-select",{detail:{composer:C,laneIndex:z}}))}),R.addEventListener("mouseenter",()=>ss(z)),R.addEventListener("mouseleave",()=>ss(null)),j.scrollWidth>j.clientWidth&&(j.textContent=tu(O),j.scrollWidth>j.clientWidth&&(j.textContent=nu(O)))}),e.appendChild(s),Ts())}function pu(){const e=document.getElementById("timeline");if(!e)return;let n=!1,t=!1;const i=4,s=1,r=(y,I,J)=>{const de=Math.abs(y)>=Math.abs(I)?"horizontal":"vertical";console.log(`[timeline] touch pan (${J||de}) dx=${y.toFixed(1)} dy=${I.toFixed(1)} scrollLeft=${e.scrollLeft.toFixed(1)} scrollTop=${e.scrollTop.toFixed(1)}`)};let o=0,a=0,l=0,h=0,u=0,p=0,T=null;const C=()=>{e.dispatchEvent(new CustomEvent("timeline-pan-end"))},z=()=>{t||(t=!0,e.classList.add("panning"),e.dataset.panning="true")},O=()=>{t&&(t=!1,e.classList.remove("panning"),e.dataset.panning="false",C())};function oe(){if(T=null,!n||!t)return;const y=u-o,I=p-a;e.scrollLeft=l-y,e.scrollTop=h-I}const F=y=>{y.button===0&&(n=!0,t=!1,e.classList.remove("panning"),o=y.clientX,a=y.clientY,u=y.clientX,p=y.clientY,l=e.scrollLeft,h=e.scrollTop,y.preventDefault())},R=y=>{if(n){if(u=y.clientX,p=y.clientY,!t){const I=Math.abs(u-o),J=Math.abs(p-a),U=J>I?s:i;if(I>U||J>U)z();else return}T===null&&(T=window.requestAnimationFrame(oe)),y.preventDefault()}},G=()=>{n&&(n=!1,O(),T!==null&&(cancelAnimationFrame(T),T=null))};e.addEventListener("mousedown",F),window.addEventListener("mousemove",R),window.addEventListener("mouseup",G);let P=null,$=!1,ee=null;const ue=10,ne=y=>{ee!==y&&(ee==="horizontal"&&O(),ee=y,y==="horizontal"&&z())},B=y=>{if(P!==null||y.touches.length!==1)return;const I=y.touches[0];P=I.identifier,$=!1,ee=null,o=I.clientX,a=I.clientY,u=I.clientX,p=I.clientY,I.clientX,I.clientY,l=e.scrollLeft,h=e.scrollTop,O()},j=y=>{if(P===null)return;const I=Array.from(y.touches).find(Te=>Te.identifier===P);if(!I)return;const J=I.clientX-o,de=I.clientY-a,U=Math.abs(J),X=Math.abs(de),Y=U>=X?"horizontal":"vertical";if($)ee&&Y!==ee&&Math.abs(U-X)>ue&&ne(Y);else if(U>i||X>s)$=!0,ne(Y);else{I.clientX,I.clientY;return}ee==="horizontal"?(e.scrollLeft=l-J,y.preventDefault()):ee==="vertical"&&(e.scrollTop=h-de,y.preventDefault()),I.clientX,I.clientY,r(J,de,ee)},W=y=>{P===null||!Array.from(y.changedTouches).some(J=>J.identifier===P)||(P=null,$=!1,ee=null,O())};e.addEventListener("touchstart",B,{passive:!0}),e.addEventListener("touchmove",j,{passive:!1}),e.addEventListener("touchend",W,{passive:!0}),e.addEventListener("touchcancel",W,{passive:!0})}function gu(){const e=document.getElementById("timeline"),n=document.getElementById("gantt"),t=document.getElementById("axis");if(!e||!n)return()=>{};let i=e.scrollLeft,s=!1,r=null,o=null;const a=.5,l=5,h=()=>{o!==null&&(clearTimeout(o),o=null)},u=()=>{r!==null&&(clearTimeout(r),r=null)},p=(F,R)=>{u();const G=window.matchMedia?.("(prefers-reduced-motion: reduce)").matches;s=!0,e.scrollTo&&!G?(e.scrollTo({left:F,top:R,behavior:"smooth"}),r=setTimeout(()=>{s=!1,r=null},320)):(e.scrollLeft=F,e.scrollTop=R,s=!1)},T=F=>{h(),o=setTimeout(()=>{o=null,O(F)},90)},C=(F,R,G)=>{const P=F.getBoundingClientRect();return P.bottom>R&&P.top<G},z=F=>Number(F.getAttribute("data-lane-index"))||0,O=F=>{const R=Array.from(n.querySelectorAll(".bar"));if(!R.length)return;const G=e.getBoundingClientRect(),$=(t?.getBoundingClientRect()?.bottom??G.top)+1,ee=G.bottom,ue=R.find(W=>C(W,$,ee));if(!ue)return;const ne=e.scrollLeft;ne+e.clientWidth;const B=z(ue),j=R.reduce((W,y)=>{const I=z(y);if(!W)return y;const J=z(W);return I<J?y:W},null)||ue;if(F==="right"){if(!(ue.offsetLeft<ne-l))return;let y=R.find(U=>z(U)>B&&U.offsetLeft>=ne-a&&C(U,$,ee))||null;if(y||(y=R.reduce((U,X)=>z(X)<=B?U:U?X.offsetLeft>U.offsetLeft?X:U:X,null)),!y)return;const I=y.getBoundingClientRect(),J=$+1,de=I.top-J;Math.abs(de)>a&&p(e.scrollLeft,e.scrollTop+de);return}if(F==="left"){const y=ue.getBoundingClientRect().right>G.right+a,I=ne<=a;let J=null;const de=R.filter(ge=>z(ge)>=B?!1:ge.offsetLeft>=ne-a);if(!I&&!y&&!de.length||(I?J=j:de.length&&(J=de.reduce((ge,ve)=>{if(!ge)return ve;const en=z(ve),Gn=z(ge);if(en>Gn)return ve;if(en===Gn){const ot=Math.abs(ve.offsetLeft-ne),nn=Math.abs(ge.offsetLeft-ne);return ot<nn?ve:ge}return ge},null)),J||(J=j),!J))return;const U=J.getBoundingClientRect(),X=$+1,Y=U.top-X,Te=Math.max(0,J.offsetLeft),Je=Te-e.scrollLeft;(Math.abs(Y)>a||Math.abs(Je)>a)&&p(Math.abs(Je)>a?Te:e.scrollLeft,Math.abs(Y)>a?e.scrollTop+Y:e.scrollTop)}},oe=()=>{if(s)return;const F=e.scrollLeft,R=e.dataset.panning==="true",G=e.scrollTop+e.clientHeight>=e.scrollHeight-a;if(R||G){i=F;return}const P=F>i+a,$=F<i-a;P?T("right"):$&&T("left"),F<=a&&T("left"),i=F};return e.addEventListener("scroll",oe,{passive:!0}),()=>{e.removeEventListener("scroll",oe),h(),u()}}function Mr(e,{left:n=0,top:t=0}){const i=window.matchMedia?.("(prefers-reduced-motion: reduce)").matches;if(e.scrollTo&&!i){e.scrollTo({left:n,top:t,behavior:"smooth"});return}e.scrollLeft=n,e.scrollTop=t}function bu(e={}){_r(e.settings||{});const n=Object.prototype.hasOwnProperty.call(e,"composers")?e.composers:rt;Er(n),Cr(e.eraLabels||{}),Kt(),xr(),Bi(),pu();const t=gu(),i=()=>Kt();window.addEventListener("resize",i);const s=document.getElementById("timeline");s&&(s.style.visibility="visible");function r(){const a=document.getElementById("timeline");a&&Mr(a,{left:0,top:0})}function o(){const a=document.getElementById("timeline");a&&Mr(a,{left:Math.max(0,a.scrollWidth-a.clientWidth),top:Math.max(0,a.scrollHeight-a.clientHeight)})}return{goToStart:r,goToEnd:o,setComposers(a){Er(a),Bi()},updateSettings(a){_r(a||{}),Kt(),Bi()},updateEraLabels(a){Cr(a||{}),Kt(),xr()},setSelectedLane:Uo,setHoveredLane:ss,destroy(){window.removeEventListener("resize",i),t()}}}const Jo=(e,n)=>{const t=e.__vccOpts||e;for(const[i,s]of n)t[i]=s;return t},vu={class:"timeline-wrapper"},yu={__name:"ComposersTimeline",props:{composers:{type:Array,default:()=>[]},settings:{type:Object,default:()=>({})},eraLabels:{type:Object,default:()=>({})}},setup(e){const n=e;let t=null;const i=s=>{const r=s.target?.closest?.(".bar");if(!r)return;const o=r.getAttribute("data-name"),a=Number(r.getAttribute("data-lane-index"));window.dispatchEvent(new CustomEvent("composer-select",{detail:{composer:o?{name:o}:null,laneIndex:Number.isNaN(a)?null:a}}))};return bi(()=>{const s=document.getElementById("timeline");s&&s.addEventListener("click",i),t=bu({composers:n.composers,settings:n.settings,eraLabels:n.eraLabels}),window.timeline=t}),vi(()=>{const s=document.getElementById("timeline");s&&s.removeEventListener("click",i),t?.destroy?.(),t=null}),Ge(()=>n.composers,s=>{t&&t.setComposers(s)},{deep:!0}),Ge(()=>n.settings,s=>{!t||!t.updateSettings||t.updateSettings(s)},{deep:!0}),Ge(()=>n.eraLabels,s=>{!t||!t.updateEraLabels||t.updateEraLabels(s)},{deep:!0}),(s,r)=>(he(),pe("div",vu,[...r[0]||(r[0]=[L("div",{id:"timeline"},[L("div",{class:"timeline-inner"},[L("div",{id:"axis",class:"axis"}),L("div",{id:"gantt"})])],-1)])]))}},wu=Jo(yu,[["__scopeId","data-v-095e97d5"]]),ku=`# Composer fact sheets
...
`,_u={class:"app"},Su={class:"topbar"},Tu={class:"language-switcher"},Cu={class:"visually-hidden",for:"language-select"},Eu=["aria-label"],xu=["value"],Mu={class:"menu-nav"},Lu={class:"content"},zu={key:0},Au={class:"filter-dock"},Pu={class:"control-stack control-pill",role:"group","aria-label":"Timeline controls"},Ru={key:0,class:"nav-controls",role:"group","aria-label":"Timeline navigation"},Iu=["disabled"],Fu=["disabled"],Hu={key:1,class:"scale-controls",role:"group","aria-label":"Adjust timeline size"},Nu=["disabled"],Ou=["disabled"],Wu=["aria-expanded"],Bu={key:0,id:"filter-panel",class:"filter-panel",role:"dialog","aria-label":"Composer filters"},Du={class:"filter-panel__options"},Ku=["onUpdate:modelValue","aria-label"],ju={class:"filter-panel__label"},Vu={class:"filter-panel__actions"},Gu={key:1,class:"about"},$u={class:"about__card"},Uu={class:"about__title"},Ju={class:"about__text"},qu={class:"about__text"},Xu={class:"about__author"},Yu={class:"about__author-body"},Zu={class:"about__author-label"},Qu={class:"about__author-name"},ed={class:"about__contributors"},nd={class:"about__contributors-title"},td={class:"about__contributors-list"},id={class:"about__contributors-name"},sd=["href"],rd={class:"composer-modal__content"},od={class:"composer-modal__header"},ad={class:"composer-modal__titles"},ld={class:"composer-modal__name"},cd={key:0,class:"composer-modal__dates"},ud={class:"composer-modal__nav composer-modal__nav--header","aria-label":"Composer navigation"},dd=["disabled"],fd={class:"composer-modal__position"},hd=["disabled"],md={class:"composer-modal__body"},pd={key:0,class:"composer-modal__hero"},gd=["src","alt"],bd={class:"composer-modal__nav composer-modal__nav--mobile","aria-label":"Composer navigation"},vd=["disabled"],yd={class:"composer-modal__position"},wd=["disabled"],kd={class:"composer-modal__hero-meta"},_d={class:"composer-modal__name-small"},Sd={key:0,class:"composer-modal__dates-small"},Td={class:"composer-modal__playlist"},Cd={class:"composer-modal__playlist-header"},Ed={class:"composer-modal__playlist-title"},xd={key:0,class:"sc-powered",href:"https://soundcloud.com",target:"_blank",rel:"noopener noreferrer","aria-label":"Powered by SoundCloud"},Md=["data-soundcloud-playlist","data-soundcloud-playlist-alt"],Ld={key:1,class:"composer-modal__playlist-box composer-modal__playlist-box--empty"},zd={class:"composer-modal__description"},Ad={key:0,class:"composer-modal__facts-title"},Pd={key:1,class:"composer-modal__facts"},Rd={class:"composer-modal__fact-text"},Id={key:2,class:"composer-modal__muted"},dt="en",Lr="timeline-language",jt=25,zr=150,Di=.2,Ar=1.5,Fd=.35,Ki=1.7,Pr=.95,Hd=.6,Vt=2,Gt=6,Nd={__name:"App",setup(e){const n={en:{label:"En",appTitle:"The Story of Classical Music in Time",languageLabel:"Language",navigation:{composers:"Composers Timeline",about:"About"},modal:{keyWorks:"Key works to know"},about:{title:"Understand classical music by ear",intro:"Sometimes you hear a familiar melody and know it is classical music. But whose? Bach, Beethoven, or Mozart - it can be hard to tell immediately.",goal:"This site is designed to help you hear the character of each era and each composer, compare their stories and musical voices, and never get lost in the names again.",authorLabel:"Project creator and author",authorName:"Dmitrii Kotikov",contributorsTitle:"Project collaborators",contributors:[{name:"Timofey Muhortov",url:"https://timofeymuhortov.ru",linkText:"timofeymuhortov.ru"},{name:"Olga Shibanova",url:"https://facebook.com/olga.shibanova",linkText:"facebook.com/olga.shibanova"}]},eras:{baroque:"Baroque",classical:"Classical",romantic:"Romantic",twentieth:"20th Century"},composers:{},filter:{groups:{essentials:"Essential Icons",core:"Core Classics",expanded:"Extended Classics"},apply:"Apply"}},de:{label:"De",appTitle:"Die Geschichte der klassischen Musik",languageLabel:"Sprache",navigation:{composers:"Zeitstrahl der Komponisten",about:"Über das Projekt"},modal:{keyWorks:"Wichtige Werke zum Kennenlernen"},about:{title:"Klassische Musik mit dem Ohr verstehen",intro:"Manchmal hört man eine vertraute Melodie und weiß: Das ist klassische Musik. Aber von wem? Bach, Beethoven oder Mozart – das erkennt man nicht immer sofort.",goal:"Diese Seite soll helfen, den Charakter jeder Epoche und jedes Komponisten zu hören, ihre Geschichten und Klangfarben zu vergleichen und sich in all den Namen nicht mehr zu verlieren.",authorLabel:"Initiator und Autor des Projekts",authorName:"Dmitrii Kotikov",contributorsTitle:"Projektpartner",contributors:[{name:"Timofey Muhortov",url:"https://timofeymuhortov.ru",linkText:"timofeymuhortov.ru"},{name:"Olga Shibanova",url:"https://facebook.com/olga.shibanova",linkText:"facebook.com/olga.shibanova"}]},eras:{baroque:"Barock",classical:"Klassik",romantic:"Romantik",twentieth:"20. Jahrhundert"},composers:{},filter:{groups:{essentials:"Essenzielle Ikonen",core:"Kernklassiker",expanded:"Erweiterte Klassiker"},apply:"Anwenden"}},ru:{label:"Ru",appTitle:"История классической музыки",languageLabel:"Язык",navigation:{composers:"Таймлайн композиторов",about:"О проекте"},modal:{keyWorks:"Ключевые произведения"},about:{title:"Понимать классическую музыку на слух",intro:"Иногда слышишь знакомую мелодию и понимаешь: это классическая музыка. Но чья? Баха, Бетховена или Моцарта - сразу не всегда понятно.",goal:"Этот сайт помогает услышать характер каждой эпохи и каждого композитора, сравнивать их истории и музыкальные голоса - и больше не теряться в именах.",authorLabel:"Автор и создатель проекта",authorName:"Дмитрий Котиков",contributorsTitle:"Соавторы проекта",contributors:[{name:"Тимофей Мухортов",url:"https://timofeymuhortov.ru",linkText:"timofeymuhortov.ru"},{name:"Ольга Шибанова",url:"https://facebook.com/olga.shibanova",linkText:"facebook.com/olga.shibanova"}]},eras:{baroque:"Барокко",classical:"Классицизм",romantic:"Романтизм",twentieth:"XX век"},composers:{},filter:{groups:{essentials:"Ключевые фигуры",core:"Основа классики",expanded:"Расширенный канон"},apply:"Применить"}}},t=Object.keys(n),i=sn(!1),s={en:"essentials",de:"- Kurzprofil",ru:"ключевые факты"},r=sn(dt),o=te(()=>n[r.value]||n.en),a=te(()=>t.map(d=>({value:d,label:n[d]?.label||d.toUpperCase()}))),l=te(()=>o.value.appTitle),h=te(()=>o.value.languageLabel||"Language"),u=te(()=>o.value.navigation||n.en.navigation),p=te(()=>o.value.about||n.en.about),T=te(()=>p.value.contributors||n.en.about.contributors||[]),C=te(()=>o.value.eras||n.en.eras),z=te(()=>o.value.composers||{}),O=te(()=>{const d=z.value.names||{},m={};return Object.entries(d).forEach(([v,E])=>{m[be(v)]=E}),m}),oe=te(()=>{const d={};return Object.entries(M||{}).forEach(([m,v])=>{const E=be(m),D=v?.[r.value];if(D){d[E]=D;return}r.value==="en"&&v?.en&&(d[E]=v.en)}),d}),F=te(()=>({...oe.value,...O.value})),R=te(()=>o.value.filter||n.en.filter),G=te(()=>({essentials:R.value.groups?.essentials||"Essential Icons",core:R.value.groups?.core||"Core Classics",expanded:R.value.groups?.expanded||"Extended Classics"})),P=te(()=>R.value.apply||"Apply"),$=te(()=>{const d=z.value.descriptions||{},m={};return Object.entries(d).forEach(([v,E])=>{m[be(v)]=E}),m}),ee=te(()=>{const d=z.value.factsTitles||{},m={};return Object.entries(d).forEach(([v,E])=>{m[be(v)]=E}),m}),ue=te(()=>o.value.modal||n.en.modal),ne=sn(!1),B=sn("composers"),j=[30,40,50,70,100],W="".replace(/\/$/,""),I="https://soundcloud.com/dmitry-kotikov/sets/",J="https://soundcloud.com/dmitry-kotikov/sets/antonio-vivaldi",de=new Set;function U(d,m,v){return Number.isNaN(d)?m:Math.min(v,Math.max(m,d))}function X(d){const m=U((d-jt)/(zr-jt),0,1),v=Math.pow(m,Fd),E=Di+(Ar-Di)*v;return U(E,Di,Ar)}function Y(d){const m=U((d-jt)/(zr-jt),0,1),v=Math.pow(m,Hd),E=Ki-(Ki-Pr)*v;return U(E,Pr,Ki)}const Te=[{id:"essentials",label:"Essential Icons",composers:["Johann Sebastian Bach","Wolfgang Amadeus Mozart","Ludwig van Beethoven","Pyotr Ilyich Tchaikovsky","Frédéric Chopin","Antonio Vivaldi","Johannes Brahms","Giuseppe Verdi","Claude Debussy"]},{id:"core",label:"Core Classics",composers:["Joseph Haydn","George Frideric Handel","Franz Schubert","Felix Mendelssohn","Robert Schumann","Franz Liszt","Antonín Dvořák","Edvard Grieg","Maurice Ravel","Giacomo Puccini","Gustav Mahler","Sergei Rachmaninoff","Domenico Scarlatti","Camille Saint-Saëns","Georges Bizet"]},{id:"expanded",label:"Extended Classics",composers:["Niccolò Paganini","Hector Berlioz","Mikhail Glinka","Johann Strauss II","Alexander Borodin","Jacques Offenbach","Modest Mussorgsky","Nikolai Rimsky-Korsakov","Alexander Scriabin","Erik Satie","Sergei Prokofiev","Dmitri Shostakovich"]}],Je=sn(Te.reduce((d,m)=>(d[m.id]=!0,d),{})),ge=sn(!1),ve=hi({barHeight:j[Vt],widthScale:X(j[Vt]),fontScale:Y(j[Vt])}),en=sn(Vt),Gn=te(()=>en.value<=0),ot=te(()=>en.value>=j.length-1),nn=sn(!0),Pn=sn(!1);function at(d){const m=U(d,0,j.length-1);en.value=m;const v=j[m];ve.barHeight=v,ve.widthScale=X(v),ve.fontScale=Y(v)}function lt(d){const m=d>0?1:-1;at(en.value+m)}function qe(){const d=document.getElementById("timeline");if(!d)return;const m=Math.max(0,d.scrollWidth-d.clientWidth),v=Math.max(0,d.scrollHeight-d.clientHeight);nn.value=d.scrollLeft<=Gt&&d.scrollTop<=Gt,Pn.value=d.scrollLeft>=m-Gt&&d.scrollTop>=v-Gt}function Cs(){window.timeline&&typeof window.timeline.goToStart=="function"&&window.timeline.goToStart(),qe()}function c(){window.timeline&&typeof window.timeline.goToEnd=="function"&&window.timeline.goToEnd(),qe()}const f=te(()=>{const d=Te.map(v=>v.id).filter(v=>Je.value[v]),m=new Set;return d.forEach(v=>{Te.find(D=>D.id===v)?.composers?.forEach(D=>m.add(D))}),m}),g=te(()=>{const d=f.value;return d.size?rt.filter(m=>d.has(m.name)):[]}),k=te(()=>[...g.value].sort((d,m)=>d.birth-m.birth).map(d=>({...d,displayName:Ne(d.name)}))),{descriptionsByLocale:w,playlistIdsByKey:_,namesByLocale:M}=It(ku),S=sn(null),x=te(()=>S.value!==null),b=te(()=>S.value===null?null:k.value[S.value]),N=te(()=>b.value?Ne(b.value.name):""),A=te(()=>b.value?Vo(b.value.name):null),H=te(()=>b.value?Ae(b.value.name):""),V=te(()=>b.value?je(b.value.name):""),Q=te(()=>b.value?Yo(b.value.name):[]),le=te(()=>Q.value.map(d=>ca(d)).filter(Boolean)),Z=te(()=>{const d=le.value.filter(Boolean);return d.length?d:[J]}),_e=te(()=>(S.value??0)>0),Se=te(()=>S.value!==null&&S.value<k.value.length-1);function be(d){return d.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g," ").trim()}function Ne(d){const m=be(d);return F.value[m]||d}function kn(d){return G.value[d]||d}function It(d){const m=d.split(`
`),v={},E={},D={};let ie=null,ye=null,tn=null,Oe="en",ke=[];const Rn=()=>{(ie||ye)&&[ie,ye].filter(Boolean).forEach(Pe=>{v[Pe]=v[Pe]||{},v[Pe][Oe]=ke.join(`
`).trim(),tn&&(D[Pe]=tn)}),ke=[],tn=null,ye=null};for(const Ce of m){const Pe=Ce.match(/^##\s+(.+?)\s+essentials(?:\s*\((\w{2})\))?(?:\s*\{#([a-z0-9_-]+)\})?/i);if(Pe){Rn();const[,Ee,In,un]=Pe;ie=be(un||Ee),ye=be(Ee),Oe=(In||"en").toLowerCase(),tn=un||null;continue}const Un=ie?Ce.match(/^name\s*(?:\((\w{2})\))?\s*:\s*(.+)$/i):null;if(Un){const[,Ee,In]=Un,un=(Ee||Oe||"en").toLowerCase(),ba=In.trim();[ie,ye].filter(Boolean).forEach(Ci=>{E[Ci]=E[Ci]||{},E[Ci][un]=ba});continue}ie&&Ce.startsWith("- ")&&ke.push(Ce.replace(/^- /,"").trim())}return Rn(),{descriptionsByLocale:v,playlistIdsByKey:D,namesByLocale:E}}function Ae(d){const m=Ht(d),v=be(d),E=$.value[v];if(E)return E;const D=m[r.value];return D||(m.en?m.en:Object.values(m)[0]||"")}function je(d){const m=ee.value[be(d)];return m||Xo(d)}function Ft(d,m){const v=be(m);if(d[v])return d[v];const E=v.split(" ").filter(Boolean),D=E[E.length-1];return D&&d[D]?d[D]:""}function Ht(d){const m=be(d),v=m.split(" ").filter(Boolean),E=[m],D=v[v.length-1];D&&D!==m&&E.push(D);for(const ie of E)if(w[ie])return w[ie];return{}}function qo(d){return be(d).replace(/\s+/g,"-").replace(/-+/g,"-")}function Xo(d){const m=s[r.value]||s.en,v=r.value==="ru"?Ne(d):"";if(r.value==="ru"&&v)return`${v} - ${m}`;const E=String(d||"").trim().split(/\s+/).filter(Boolean);if(!E.length)return"";const D=E[E.length-1];return`${/^(?:[IVX]+|\d+|Jr\.?|Sr\.?)$/i.test(D)&&E.length>=2?E[E.length-2]:D} ${m}`}function Yo(d){const m=[],v=qo(d);v&&!m.includes(v)&&m.push(v);const E=Ft(_,d);return E&&!m.includes(E)&&m.push(E),m}function _i(d=window.location.pathname){B.value=d==="/about"?"about":"composers"}const Es=()=>_i();function xs(d){window.location.pathname!==d&&(history.pushState({},"",d),_i(d)),ne.value=!1}function Ms(d){xs(d==="about"?"/about":"/")}function Zo(){ne.value=!ne.value}function Qo(){ne.value=!1}function ea(){ge.value=!ge.value}function na(){ge.value=!1}function $n(d,{persist:m=!1}={}){const v=t.includes(d)?d:dt;if(r.value=v,m)try{localStorage.setItem(Lr,v)}catch{}}function ta(d){i.value=!0,$n(d,{persist:!0})}function ia(d){const m=d?.target?.value;m&&ta(m)}function sa(){try{return localStorage.getItem(Lr)}catch{return null}}function ra(){const d=sa();if(d&&t.includes(d)){i.value=!0,$n(d);return}oa()}async function oa(){if(i.value){r.value;return}const d=[aa,la];for(const v of d){const E=await v();if(E){const D=String(E).toUpperCase(),ie=D==="RU"?"ru":["DE","AT","CH"].includes(D)?"de":dt;$n(ie);return}}const m=(navigator.language||"").toLowerCase();if(m.startsWith("de")){$n("de");return}if(m.startsWith("ru")){$n("ru");return}$n(dt)}async function aa(){try{const d=await fetch("https://ipapi.co/json/");return d.ok&&(await d.json())?.country_code||null}catch(d){console.warn("ipapi lookup failed:",d)}return null}async function la(){try{const d=await fetch("https://ipwho.is/");return d.ok&&(await d.json())?.country_code||null}catch(d){console.warn("ipwho.is lookup failed:",d)}return null}function Wd(d,m){}function Ls(){xs("/"),window.timeline&&typeof window.timeline.goToStart=="function"&&window.timeline.goToStart()}function Si(d){const m=d.detail,v=m?.laneIndex;if(Number.isInteger(v)&&k.value[v]){S.value=v;return}const E=m?.composer?.name;if(!E)return;const D=k.value.findIndex(ie=>ie.name===E);D>=0&&(S.value=D)}function zs(){S.value=null}function As(){!_e.value||S.value===null||(S.value-=1)}function Ps(){!Se.value||S.value===null||(S.value+=1)}bi(()=>{ra(),_i(),window.timeline&&typeof window.timeline.onBarClick=="function"&&window.timeline.onBarClick(Si),window.addEventListener("popstate",Es),window.addEventListener("composer-select",Si);const d=document.getElementById("timeline");d&&(d.addEventListener("scroll",qe,{passive:!0}),qe())}),vi(()=>{window.removeEventListener("popstate",Es),window.removeEventListener("composer-select",Si);const d=document.getElementById("timeline");d&&d.removeEventListener("scroll",qe)}),Ge(l,d=>{d&&(document.title=d)},{immediate:!0}),Ge(r,d=>{const m=t.includes(d)?d:dt;if(m!==d){r.value=m;return}try{document.documentElement.setAttribute("data-lang",m)}catch{}window.timeline&&typeof window.timeline.updateEraLabels=="function"&&window.timeline.updateEraLabels(C.value)}),Ge(x,async d=>{d?(document.documentElement.style.overscrollBehavior="none",document.body.style.overscrollBehavior="none",document.body.style.overflow="hidden",document.body.style.touchAction="none",await ei(),Z.value.length&&Is()):(document.documentElement.style.overscrollBehavior="",document.body.style.overscrollBehavior="",document.body.style.overflow="",document.body.style.touchAction="",Rs())}),Ge(S,d=>{const m=window.timeline;!m||typeof m.setSelectedLane!="function"||(Number.isInteger(d)?m.setSelectedLane(d):m.setSelectedLane(null))}),Ge(Z,async d=>{x.value&&(Rs(),await ei(),d.length&&Is())}),Ge(()=>k.value.map(d=>d.name),d=>{if(S.value===null)return;const m=b.value;if(!m){S.value=null;return}const v=d.findIndex(E=>E===m.name);v===-1?S.value=null:S.value=v});function Ti(d){return d?W?W.endsWith("/")&&d.startsWith("/")?W+d.slice(1):!W.endsWith("/")&&!d.startsWith("/")?`${W}/${d}`:W+d:d:W}function ca(d){if(!d)return"";const m=I;if(!m)return"";const v=m.endsWith("/");return`${m}${v?"":"/"}${d}`}function Rs(){de.forEach(d=>{try{d.pause(),d.currentTime=0}catch(m){console.error("Failed to stop SoundCloud audio",m)}}),de.clear()}function Is(d,m=document){const E=(m||document).querySelectorAll("[data-soundcloud-playlist]");E.length&&(E.length,E.forEach(D=>{ua(D,()=>{})}))}async function ua(d,m){const v=()=>{typeof m=="function"&&setTimeout(()=>m(),0)};if(!d||d.dataset.soundcloudReady==="true"||d.dataset.soundcloudReady==="loading"||d.dataset.soundcloudReady==="error"){v();return}const E=d.getAttribute("data-soundcloud-playlist"),D=d.getAttribute("data-soundcloud-playlist-alt")||"",ie=[E,...D.split("|")].map(Oe=>(Oe||"").trim()).filter(Boolean);if(!ie.length){v();return}d.dataset.soundcloudReady="loading",d.innerHTML='<div class="sc-player__status">Loading tracks from SoundCloud...</div>';let ye=null;for(const Oe of ie)try{const ke=await fa(Oe),Rn=Array.isArray(ke.tracks)&&ke.tracks.length?ke.tracks:ke&&ke.kind==="track"?[ke]:[],Ce=ha(Rn);ga(d,Ce,Oe),v();return}catch(ke){if(ye=ke,ke&&ke.status===429){Fs(d,Oe),v();return}}console.error("Failed to build SoundCloud player",ye);const tn=ie[0]||J;Fs(d,tn),v()}async function da(d){if(!d)throw new Error("No track provided");const m=d.media&&Array.isArray(d.media.transcodings)?d.media.transcodings:[];if(m.length){let v=m.find(E=>E&&E.format&&E.format.protocol==="progressive");if(v||(v=m[0]),v&&v.url)try{const E=await ma(v.url,d.track_authorization);return console.debug("[SC] Using transcoding URL",{trackId:d.id,transcodingUrl:v.url,finalUrl:E}),E}catch(E){console.error("[SC] Transcoding proxy failed, falling back to streams endpoint",E)}}if(!d.id)throw new Error("No track id provided");return pa(d.id,d.track_authorization)}async function fa(d){const m=Ti("/api/soundcloud/playlist")+`?url=${encodeURIComponent(d)}`,v=await fetch(m);if(!v.ok){const E=new Error(`SoundCloud playlist error: ${v.status}`);throw E.status=v.status,E.retryAfter=Number(v.headers?.get("Retry-After"))||void 0,E}return v.json()}function ha(d=[]){return Array.isArray(d)?d.map((m,v)=>{if(!m)return null;const E=`Track ${v+1}`,ie=[m.title,m.publisher_metadata?.release_title,m.permalink,m.permalink_url,m.id?String(m.id):null].map(ye=>typeof ye=="string"?ye.trim():"").filter(Boolean)[0]||E;return{...m,title:ie}}).filter(Boolean):[]}async function ma(d,m){const v=Ti("/api/soundcloud/transcoding")+`?url=${encodeURIComponent(d)}${m?`&track_authorization=${encodeURIComponent(m)}`:""}`,E=await fetch(v);if(!E.ok){const ie=new Error(`SoundCloud transcoding error: ${E.status}`);throw ie.status=E.status,ie.retryAfter=Number(E.headers?.get("Retry-After"))||void 0,ie}const D=await E.json();if(!D?.url)throw new Error("Transcoding response missing url");return D.url}async function pa(d,m){const v=Ti(`/api/soundcloud/streams/${d}`)+(m?`?track_authorization=${encodeURIComponent(m)}`:""),E=await fetch(v);if(!E.ok){const ie=new Error(`SoundCloud stream error: ${E.status}`);throw ie.status=E.status,ie.retryAfter=Number(E.headers?.get("Retry-After"))||void 0,ie}const D=await E.json();if(!D?.url)throw new Error("Stream response missing url");return D.url}function Fs(d,m){const v=`https://w.soundcloud.com/player/?url=${encodeURIComponent(m)}&auto_play=false&show_user=false&hide_related=true&show_comments=false&show_reposts=false&show_teaser=false&show_playcount=false&sharing=false&show_artwork=false&buying=false&liking=false&download=false&visual=false`;d.innerHTML=`
    <iframe
      show_user="false"
      ...
      src="${v}"
    ></iframe>
  `,d.dataset.soundcloudReady="true"}function ga(d,m,v){if(!Array.isArray(m)||!m.length){d.innerHTML='<div class="sc-player__status sc-player__status--error">No tracks found for this playlist.</div>',d.dataset.soundcloudReady="error";return}d.classList.add("sc-player");const E=document.createElement("div");E.className="sc-track-list";const D=document.createElement("audio");D.preload="none",de.add(D);let ie=null,ye=null,tn=!1;const Oe=(Ce,Pe)=>{Ce.dataset.state=Pe,Ce.textContent=Pe==="playing"?"⏸":Pe==="loading"?"...":"▶"},ke=Ce=>Oe(Ce,"idle"),Rn=()=>{ye&&ke(ye),ie=null,ye=null};D.addEventListener("ended",Rn),D.addEventListener("pause",()=>{ye&&D.currentTime<(D.duration||1/0)&&ke(ye)}),m.forEach((Ce,Pe)=>{const Un=document.createElement("div");Un.className="sc-track";const Ee=document.createElement("button");Ee.type="button",Ee.className="sc-track__button",Ee.setAttribute("aria-label","Play track"),Oe(Ee,"idle");const In=document.createElement("div");In.className="sc-track__title",In.textContent=Ce?.title||`Track ${Pe+1}`,Un.append(Ee,In),E.append(Un),Ee.addEventListener("click",async()=>{if(!tn){if(ie===(Ce?.id??Pe)&&!D.paused){D.pause(),ke(Ee);return}tn=!0,Oe(Ee,"loading");try{const un=await da(Ce);if(!un)throw new Error("No stream URL returned");D.src=un,await D.play(),ye&&ye!==Ee&&ke(ye),ye=Ee,ie=Ce?.id??Pe,Oe(Ee,"playing")}catch(un){console.error("Failed to play SoundCloud track",un),ke(Ee),d.dataset.soundcloudReady="error"}finally{tn=!1}}})}),d.innerHTML="",d.append(E,D),d.dataset.soundcloudReady="true"}return(d,m)=>(he(),pe("div",_u,[L("header",Su,[L("button",{class:"menu-button",onClick:Zo,"aria-label":"Toggle navigation menu"},[...m[5]||(m[5]=[L("span",{class:"menu-icon"},null,-1)])]),L("img",{class:"logo",src:Xc,alt:"Logo",onClick:Ls}),L("div",{class:"app-title",role:"button",onClick:Ls},ae(l.value),1),L("div",Tu,[L("label",Cu,ae(h.value),1),Ds(L("select",{id:"language-select",class:"language-select","onUpdate:modelValue":m[0]||(m[0]=v=>r.value=v),"aria-label":h.value,onChange:ia},[(he(!0),pe(Be,null,Dt(a.value,v=>(he(),pe("option",{key:v.value,value:v.value},ae(v.label),9,xu))),128))],40,Eu),[[Dc,r.value]])])]),L("aside",{class:Qn(["side-menu",{"side-menu--open":ne.value}])},[L("nav",Mu,[L("button",{class:Qn(["menu-item",{"menu-item--active":B.value==="composers"}]),onClick:m[1]||(m[1]=v=>Ms("composers"))},ae(u.value.composers),3),L("button",{class:Qn(["menu-item",{"menu-item--active":B.value==="about"}]),onClick:m[2]||(m[2]=v=>Ms("about"))},ae(u.value.about),3)])],2),ne.value?(he(),pe("div",{key:0,class:"backdrop",onClick:Qo})):Xe("",!0),L("main",Lu,[B.value==="composers"?(he(),pe("section",zu,[L("div",Au,[L("div",Pu,[ge.value?Xe("",!0):(he(),pe("div",Ru,[L("button",{type:"button",class:"control-btn",disabled:nn.value,onClick:Cs,"aria-label":"Jump to start of timeline"}," ⇤ ",8,Iu),L("button",{type:"button",class:"control-btn",disabled:Pn.value,onClick:c,"aria-label":"Jump to end of timeline"}," ⇥ ",8,Fu)])),ge.value?Xe("",!0):(he(),pe("div",Hu,[L("button",{type:"button",class:"control-btn",disabled:Gn.value,onClick:m[3]||(m[3]=v=>lt(-1)),"aria-label":"Make timeline blocks smaller"}," − ",8,Nu),L("button",{type:"button",class:"control-btn",disabled:ot.value,onClick:m[4]||(m[4]=v=>lt(1)),"aria-label":"Make timeline blocks larger"}," + ",8,Ou)])),L("button",{class:"filter-dock__toggle control-btn control-primary","aria-expanded":ge.value,"aria-controls":"filter-panel",onClick:ea,"aria-label":"Filter composers"},[...m[6]||(m[6]=[L("svg",{class:"filter-icon",viewBox:"0 0 24 24","aria-hidden":"true",focusable:"false"},[L("path",{d:"M3 5h18l-7 8v5l-4 2v-7L3 5z"})],-1)])],8,Wu),Le(tr,{name:"filter-fade"},{default:Ji(()=>[ge.value?(he(),pe("div",Bu,[L("div",Du,[(he(),pe(Be,null,Dt(Te,v=>L("label",{key:v.id,class:"filter-panel__item"},[Ds(L("input",{"onUpdate:modelValue":E=>Je.value[v.id]=E,type:"checkbox",class:"filter-panel__checkbox","aria-label":`Toggle ${kn(v.id)}`},null,8,Ku),[[Bc,Je.value[v.id]]]),L("span",ju,ae(kn(v.id)),1)])),64))]),L("div",Vu,[L("button",{type:"button",class:"filter-panel__ok control-btn",onClick:na,"aria-label":"Close filters"},ae(P.value),1)])])):Xe("",!0)]),_:1})])]),Le(wu,{composers:k.value,settings:ve,"era-labels":C.value},null,8,["composers","settings","era-labels"])])):B.value==="about"?(he(),pe("section",Gu,[L("div",$u,[m[10]||(m[10]=L("img",{class:"about__logo",src:Yc,alt:"Music logo",loading:"lazy"},null,-1)),L("h1",Uu,ae(p.value.title),1),L("p",Ju,ae(p.value.intro),1),L("p",qu,ae(p.value.goal),1),L("div",Xu,[m[9]||(m[9]=L("img",{class:"about__photo",src:Zc,alt:"Dmitrii Kotikov",loading:"lazy"},null,-1)),L("div",Yu,[L("div",Zu,ae(p.value.authorLabel),1),L("div",Qu,ae(p.value.authorName),1),m[7]||(m[7]=L("a",{class:"about__link",href:"https://www.linkedin.com/in/dmitrykotikov/",target:"_blank",rel:"noreferrer"}," LinkedIn ",-1)),m[8]||(m[8]=L("a",{class:"about__link",href:"https://thequot.es/",target:"_blank",rel:"noreferrer"}," thequot.es ",-1))])]),L("div",ed,[L("div",nd,ae(p.value.contributorsTitle),1),L("ul",td,[(he(!0),pe(Be,null,Dt(T.value,v=>(he(),pe("li",{key:v.url,class:"about__contributors-item"},[L("span",id,ae(v.name),1),L("a",{class:"about__contributors-link",href:v.url,target:"_blank",rel:"noreferrer"},ae(v.linkText),9,sd)]))),128))])])])])):Xe("",!0)]),Le(tr,{name:"fade"},{default:Ji(()=>[x.value?(he(),pe("div",{key:0,class:"composer-modal",onClick:Vc(zs,["self"])},[L("div",rd,[L("header",od,[L("div",ad,[L("h2",ld,ae(N.value),1),b.value?(he(),pe("p",cd,ae(b.value.birth)+" — "+ae(b.value.death),1)):Xe("",!0)]),L("div",ud,[L("button",{class:"composer-modal__arrow",onClick:As,disabled:!_e.value,"aria-label":"Previous"}," ← ",8,dd),L("span",fd,ae((S.value??0)+1)+" / "+ae(k.value.length),1),L("button",{class:"composer-modal__arrow",onClick:Ps,disabled:!Se.value,"aria-label":"Next"}," → ",8,hd)]),L("button",{class:"composer-modal__close",onClick:zs,"aria-label":"Close composer details"},"×")]),L("div",md,[A.value?(he(),pe("div",pd,[L("img",{class:"composer-modal__photo",src:A.value,alt:N.value},null,8,gd),L("div",bd,[L("button",{class:"composer-modal__arrow",onClick:As,disabled:!_e.value,"aria-label":"Previous"}," ← ",8,vd),L("span",yd,ae((S.value??0)+1)+" / "+ae(k.value.length),1),L("button",{class:"composer-modal__arrow",onClick:Ps,disabled:!Se.value,"aria-label":"Next"}," → ",8,wd)]),L("div",kd,[L("div",_d,ae(N.value),1),b.value?(he(),pe("div",Sd,ae(b.value.birth)+" — "+ae(b.value.death),1)):Xe("",!0)])])):Xe("",!0),L("div",Td,[L("div",Cd,[L("div",Ed,ae(ue.value.keyWorks),1),Z.value.length?(he(),pe("a",xd,[...m[11]||(m[11]=[L("img",{class:"sc-powered__img",src:Qc,alt:"Powered by SoundCloud"},null,-1)])])):Xe("",!0)]),Z.value.length?(he(),pe("div",{key:Z.value[0],class:"composer-modal__playlist-box sc-player","data-soundcloud-playlist":Z.value[0],"data-soundcloud-playlist-alt":Z.value.slice(1).join("|")},[...m[12]||(m[12]=[L("div",{class:"sc-player__status"},"Loading tracks...",-1)])],8,Md)):(he(),pe("div",Ld," Playlist will appear here soon. "))]),L("div",zd,[V.value?(he(),pe("div",Ad,ae(V.value),1)):Xe("",!0),H.value?(he(),pe("ul",Pd,[(he(!0),pe(Be,null,Dt(H.value.split(`
`),(v,E)=>(he(),pe("li",{key:E},[L("span",Rd,ae(v),1)]))),128))])):(he(),pe("p",Id,"No description yet."))])])])])):Xe("",!0)]),_:1})]))}},Od=Jo(Nd,[["__scopeId","data-v-0d0cabf6"]]);Uc(Od).mount("#app");
