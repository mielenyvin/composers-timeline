(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();function As(e){const n=Object.create(null);for(const t of e.split(","))n[t]=1;return t=>t in n}const me={},ft=[],vn=()=>{},bo=()=>!1,zi=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Ps=e=>e.startsWith("onUpdate:"),Ce=Object.assign,Fs=(e,n)=>{const t=e.indexOf(n);t>-1&&e.splice(t,1)},_l=Object.prototype.hasOwnProperty,se=(e,n)=>_l.call(e,n),N=Array.isArray,ht=e=>Ut(e)==="[object Map]",wt=e=>Ut(e)==="[object Set]",yr=e=>Ut(e)==="[object Date]",G=e=>typeof e=="function",ye=e=>typeof e=="string",yn=e=>typeof e=="symbol",fe=e=>e!==null&&typeof e=="object",vo=e=>(fe(e)||G(e))&&G(e.then)&&G(e.catch),yo=Object.prototype.toString,Ut=e=>yo.call(e),Sl=e=>Ut(e).slice(8,-1),wo=e=>Ut(e)==="[object Object]",Rs=e=>ye(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,At=As(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Ai=e=>{const n=Object.create(null);return(t=>n[t]||(n[t]=e(t)))},Tl=/-\w/g,Bn=Ai(e=>e.replace(Tl,n=>n.slice(1).toUpperCase())),Cl=/\B([A-Z])/g,rt=Ai(e=>e.replace(Cl,"-$1").toLowerCase()),ko=Ai(e=>e.charAt(0).toUpperCase()+e.slice(1)),Xi=Ai(e=>e?`on${ko(e)}`:""),Wn=(e,n)=>!Object.is(e,n),mi=(e,...n)=>{for(let t=0;t<e.length;t++)e[t](...n)},_o=(e,n,t,i=!1)=>{Object.defineProperty(e,n,{configurable:!0,enumerable:!1,writable:i,value:t})},So=e=>{const n=parseFloat(e);return isNaN(n)?e:n},El=e=>{const n=ye(e)?Number(e):NaN;return isNaN(n)?e:n};let wr;const Pi=()=>wr||(wr=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Fi(e){if(N(e)){const n={};for(let t=0;t<e.length;t++){const i=e[t],s=ye(i)?zl(i):Fi(i);if(s)for(const r in s)n[r]=s[r]}return n}else if(ye(e)||fe(e))return e}const xl=/;(?![^(]*\))/g,Ml=/:([^]+)/,Ll=/\/\*[^]*?\*\//g;function zl(e){const n={};return e.replace(Ll,"").split(xl).forEach(t=>{if(t){const i=t.split(Ml);i.length>1&&(n[i[0].trim()]=i[1].trim())}}),n}function mt(e){let n="";if(ye(e))n=e;else if(N(e))for(let t=0;t<e.length;t++){const i=mt(e[t]);i&&(n+=i+" ")}else if(fe(e))for(const t in e)e[t]&&(n+=t+" ");return n.trim()}const Al="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Pl=As(Al);function To(e){return!!e||e===""}function Fl(e,n){if(e.length!==n.length)return!1;let t=!0;for(let i=0;t&&i<e.length;i++)t=$t(e[i],n[i]);return t}function $t(e,n){if(e===n)return!0;let t=yr(e),i=yr(n);if(t||i)return t&&i?e.getTime()===n.getTime():!1;if(t=yn(e),i=yn(n),t||i)return e===n;if(t=N(e),i=N(n),t||i)return t&&i?Fl(e,n):!1;if(t=fe(e),i=fe(n),t||i){if(!t||!i)return!1;const s=Object.keys(e).length,r=Object.keys(n).length;if(s!==r)return!1;for(const o in e){const l=e.hasOwnProperty(o),c=n.hasOwnProperty(o);if(l&&!c||!l&&c||!$t(e[o],n[o]))return!1}}return String(e)===String(n)}function Is(e,n){return e.findIndex(t=>$t(t,n))}const Co=e=>!!(e&&e.__v_isRef===!0),ee=e=>ye(e)?e:e==null?"":N(e)||fe(e)&&(e.toString===yo||!G(e.toString))?Co(e)?ee(e.value):JSON.stringify(e,Eo,2):String(e),Eo=(e,n)=>Co(n)?Eo(e,n.value):ht(n)?{[`Map(${n.size})`]:[...n.entries()].reduce((t,[i,s],r)=>(t[Yi(i,r)+" =>"]=s,t),{})}:wt(n)?{[`Set(${n.size})`]:[...n.values()].map(t=>Yi(t))}:yn(n)?Yi(n):fe(n)&&!N(n)&&!wo(n)?String(n):n,Yi=(e,n="")=>{var t;return yn(e)?`Symbol(${(t=e.description)!=null?t:n})`:e};let je;class Rl{constructor(n=!1){this.detached=n,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.parent=je,!n&&je&&(this.index=(je.scopes||(je.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let n,t;if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].pause();for(n=0,t=this.effects.length;n<t;n++)this.effects[n].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let n,t;if(this.scopes)for(n=0,t=this.scopes.length;n<t;n++)this.scopes[n].resume();for(n=0,t=this.effects.length;n<t;n++)this.effects[n].resume()}}run(n){if(this._active){const t=je;try{return je=this,n()}finally{je=t}}}on(){++this._on===1&&(this.prevScope=je,je=this)}off(){this._on>0&&--this._on===0&&(je=this.prevScope,this.prevScope=void 0)}stop(n){if(this._active){this._active=!1;let t,i;for(t=0,i=this.effects.length;t<i;t++)this.effects[t].stop();for(this.effects.length=0,t=0,i=this.cleanups.length;t<i;t++)this.cleanups[t]();if(this.cleanups.length=0,this.scopes){for(t=0,i=this.scopes.length;t<i;t++)this.scopes[t].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!n){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0}}}function Il(){return je}let pe;const Zi=new WeakSet;class xo{constructor(n){this.fn=n,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,je&&je.active&&je.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Zi.has(this)&&(Zi.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Lo(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,kr(this),zo(this);const n=pe,t=cn;pe=this,cn=!0;try{return this.fn()}finally{Ao(this),pe=n,cn=t,this.flags&=-3}}stop(){if(this.flags&1){for(let n=this.deps;n;n=n.nextDep)Ds(n);this.deps=this.depsTail=void 0,kr(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Zi.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){ms(this)&&this.run()}get dirty(){return ms(this)}}let Mo=0,Pt,Ft;function Lo(e,n=!1){if(e.flags|=8,n){e.next=Ft,Ft=e;return}e.next=Pt,Pt=e}function Hs(){Mo++}function Ns(){if(--Mo>0)return;if(Ft){let n=Ft;for(Ft=void 0;n;){const t=n.next;n.next=void 0,n.flags&=-9,n=t}}let e;for(;Pt;){let n=Pt;for(Pt=void 0;n;){const t=n.next;if(n.next=void 0,n.flags&=-9,n.flags&1)try{n.trigger()}catch(i){e||(e=i)}n=t}}if(e)throw e}function zo(e){for(let n=e.deps;n;n=n.nextDep)n.version=-1,n.prevActiveLink=n.dep.activeLink,n.dep.activeLink=n}function Ao(e){let n,t=e.depsTail,i=t;for(;i;){const s=i.prevDep;i.version===-1?(i===t&&(t=s),Ds(i),Hl(i)):n=i,i.dep.activeLink=i.prevActiveLink,i.prevActiveLink=void 0,i=s}e.deps=n,e.depsTail=t}function ms(e){for(let n=e.deps;n;n=n.nextDep)if(n.dep.version!==n.version||n.dep.computed&&(Po(n.dep.computed)||n.dep.version!==n.version))return!0;return!!e._dirty}function Po(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===Dt)||(e.globalVersion=Dt,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!ms(e))))return;e.flags|=2;const n=e.dep,t=pe,i=cn;pe=e,cn=!0;try{zo(e);const s=e.fn(e._value);(n.version===0||Wn(s,e._value))&&(e.flags|=128,e._value=s,n.version++)}catch(s){throw n.version++,s}finally{pe=t,cn=i,Ao(e),e.flags&=-3}}function Ds(e,n=!1){const{dep:t,prevSub:i,nextSub:s}=e;if(i&&(i.nextSub=s,e.prevSub=void 0),s&&(s.prevSub=i,e.nextSub=void 0),t.subs===e&&(t.subs=i,!i&&t.computed)){t.computed.flags&=-5;for(let r=t.computed.deps;r;r=r.nextDep)Ds(r,!0)}!n&&!--t.sc&&t.map&&t.map.delete(t.key)}function Hl(e){const{prevDep:n,nextDep:t}=e;n&&(n.nextDep=t,e.prevDep=void 0),t&&(t.prevDep=n,e.nextDep=void 0)}let cn=!0;const Fo=[];function Ln(){Fo.push(cn),cn=!1}function zn(){const e=Fo.pop();cn=e===void 0?!0:e}function kr(e){const{cleanup:n}=e;if(e.cleanup=void 0,n){const t=pe;pe=void 0;try{n()}finally{pe=t}}}let Dt=0;class Nl{constructor(n,t){this.sub=n,this.dep=t,this.version=t.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Os{constructor(n){this.computed=n,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(n){if(!pe||!cn||pe===this.computed)return;let t=this.activeLink;if(t===void 0||t.sub!==pe)t=this.activeLink=new Nl(pe,this),pe.deps?(t.prevDep=pe.depsTail,pe.depsTail.nextDep=t,pe.depsTail=t):pe.deps=pe.depsTail=t,Ro(t);else if(t.version===-1&&(t.version=this.version,t.nextDep)){const i=t.nextDep;i.prevDep=t.prevDep,t.prevDep&&(t.prevDep.nextDep=i),t.prevDep=pe.depsTail,t.nextDep=void 0,pe.depsTail.nextDep=t,pe.depsTail=t,pe.deps===t&&(pe.deps=i)}return t}trigger(n){this.version++,Dt++,this.notify(n)}notify(n){Hs();try{for(let t=this.subs;t;t=t.prevSub)t.sub.notify()&&t.sub.dep.notify()}finally{Ns()}}}function Ro(e){if(e.dep.sc++,e.sub.flags&4){const n=e.dep.computed;if(n&&!e.dep.subs){n.flags|=20;for(let i=n.deps;i;i=i.nextDep)Ro(i)}const t=e.dep.subs;t!==e&&(e.prevSub=t,t&&(t.nextSub=e)),e.dep.subs=e}}const ps=new WeakMap,tt=Symbol(""),gs=Symbol(""),Ot=Symbol("");function Pe(e,n,t){if(cn&&pe){let i=ps.get(e);i||ps.set(e,i=new Map);let s=i.get(t);s||(i.set(t,s=new Os),s.map=i,s.key=t),s.track()}}function xn(e,n,t,i,s,r){const o=ps.get(e);if(!o){Dt++;return}const l=c=>{c&&c.trigger()};if(Hs(),n==="clear")o.forEach(l);else{const c=N(e),m=c&&Rs(t);if(c&&t==="length"){const f=Number(i);o.forEach((g,T)=>{(T==="length"||T===Ot||!yn(T)&&T>=f)&&l(g)})}else switch((t!==void 0||o.has(void 0))&&l(o.get(t)),m&&l(o.get(Ot)),n){case"add":c?m&&l(o.get("length")):(l(o.get(tt)),ht(e)&&l(o.get(gs)));break;case"delete":c||(l(o.get(tt)),ht(e)&&l(o.get(gs)));break;case"set":ht(e)&&l(o.get(tt));break}}Ns()}function lt(e){const n=ie(e);return n===e?n:(Pe(n,"iterate",Ot),on(e)?n:n.map(un))}function Ri(e){return Pe(e=ie(e),"iterate",Ot),e}function Rn(e,n){return An(e)?it(e)?yt(un(n)):yt(n):un(n)}const Dl={__proto__:null,[Symbol.iterator](){return Qi(this,Symbol.iterator,e=>Rn(this,e))},concat(...e){return lt(this).concat(...e.map(n=>N(n)?lt(n):n))},entries(){return Qi(this,"entries",e=>(e[1]=Rn(this,e[1]),e))},every(e,n){return Sn(this,"every",e,n,void 0,arguments)},filter(e,n){return Sn(this,"filter",e,n,t=>t.map(i=>Rn(this,i)),arguments)},find(e,n){return Sn(this,"find",e,n,t=>Rn(this,t),arguments)},findIndex(e,n){return Sn(this,"findIndex",e,n,void 0,arguments)},findLast(e,n){return Sn(this,"findLast",e,n,t=>Rn(this,t),arguments)},findLastIndex(e,n){return Sn(this,"findLastIndex",e,n,void 0,arguments)},forEach(e,n){return Sn(this,"forEach",e,n,void 0,arguments)},includes(...e){return es(this,"includes",e)},indexOf(...e){return es(this,"indexOf",e)},join(e){return lt(this).join(e)},lastIndexOf(...e){return es(this,"lastIndexOf",e)},map(e,n){return Sn(this,"map",e,n,void 0,arguments)},pop(){return xt(this,"pop")},push(...e){return xt(this,"push",e)},reduce(e,...n){return _r(this,"reduce",e,n)},reduceRight(e,...n){return _r(this,"reduceRight",e,n)},shift(){return xt(this,"shift")},some(e,n){return Sn(this,"some",e,n,void 0,arguments)},splice(...e){return xt(this,"splice",e)},toReversed(){return lt(this).toReversed()},toSorted(e){return lt(this).toSorted(e)},toSpliced(...e){return lt(this).toSpliced(...e)},unshift(...e){return xt(this,"unshift",e)},values(){return Qi(this,"values",e=>Rn(this,e))}};function Qi(e,n,t){const i=Ri(e),s=i[n]();return i!==e&&!on(e)&&(s._next=s.next,s.next=()=>{const r=s._next();return r.done||(r.value=t(r.value)),r}),s}const Ol=Array.prototype;function Sn(e,n,t,i,s,r){const o=Ri(e),l=o!==e&&!on(e),c=o[n];if(c!==Ol[n]){const g=c.apply(e,r);return l?un(g):g}let m=t;o!==e&&(l?m=function(g,T){return t.call(this,Rn(e,g),T,e)}:t.length>2&&(m=function(g,T){return t.call(this,g,T,e)}));const f=c.call(o,m,i);return l&&s?s(f):f}function _r(e,n,t,i){const s=Ri(e);let r=t;return s!==e&&(on(e)?t.length>3&&(r=function(o,l,c){return t.call(this,o,l,c,e)}):r=function(o,l,c){return t.call(this,o,Rn(e,l),c,e)}),s[n](r,...i)}function es(e,n,t){const i=ie(e);Pe(i,"iterate",Ot);const s=i[n](...t);return(s===-1||s===!1)&&Ks(t[0])?(t[0]=ie(t[0]),i[n](...t)):s}function xt(e,n,t=[]){Ln(),Hs();const i=ie(e)[n].apply(e,t);return Ns(),zn(),i}const Wl=As("__proto__,__v_isRef,__isVue"),Io=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(yn));function Bl(e){yn(e)||(e=String(e));const n=ie(this);return Pe(n,"has",e),n.hasOwnProperty(e)}class Ho{constructor(n=!1,t=!1){this._isReadonly=n,this._isShallow=t}get(n,t,i){if(t==="__v_skip")return n.__v_skip;const s=this._isReadonly,r=this._isShallow;if(t==="__v_isReactive")return!s;if(t==="__v_isReadonly")return s;if(t==="__v_isShallow")return r;if(t==="__v_raw")return i===(s?r?Yl:Wo:r?Oo:Do).get(n)||Object.getPrototypeOf(n)===Object.getPrototypeOf(i)?n:void 0;const o=N(n);if(!s){let c;if(o&&(c=Dl[t]))return c;if(t==="hasOwnProperty")return Bl}const l=Reflect.get(n,t,Re(n)?n:i);if((yn(t)?Io.has(t):Wl(t))||(s||Pe(n,"get",t),r))return l;if(Re(l)){const c=o&&Rs(t)?l:l.value;return s&&fe(c)?vs(c):c}return fe(l)?s?vs(l):pt(l):l}}class No extends Ho{constructor(n=!1){super(!1,n)}set(n,t,i,s){let r=n[t];const o=N(n)&&Rs(t);if(!this._isShallow){const m=An(r);if(!on(i)&&!An(i)&&(r=ie(r),i=ie(i)),!o&&Re(r)&&!Re(i))return m||(r.value=i),!0}const l=o?Number(t)<n.length:se(n,t),c=Reflect.set(n,t,i,Re(n)?n:s);return n===ie(s)&&(l?Wn(i,r)&&xn(n,"set",t,i):xn(n,"add",t,i)),c}deleteProperty(n,t){const i=se(n,t);n[t];const s=Reflect.deleteProperty(n,t);return s&&i&&xn(n,"delete",t,void 0),s}has(n,t){const i=Reflect.has(n,t);return(!yn(t)||!Io.has(t))&&Pe(n,"has",t),i}ownKeys(n){return Pe(n,"iterate",N(n)?"length":tt),Reflect.ownKeys(n)}}class Kl extends Ho{constructor(n=!1){super(!0,n)}set(n,t){return!0}deleteProperty(n,t){return!0}}const jl=new No,Vl=new Kl,Gl=new No(!0);const bs=e=>e,si=e=>Reflect.getPrototypeOf(e);function Ul(e,n,t){return function(...i){const s=this.__v_raw,r=ie(s),o=ht(r),l=e==="entries"||e===Symbol.iterator&&o,c=e==="keys"&&o,m=s[e](...i),f=t?bs:n?yt:un;return!n&&Pe(r,"iterate",c?gs:tt),{next(){const{value:g,done:T}=m.next();return T?{value:g,done:T}:{value:l?[f(g[0]),f(g[1])]:f(g),done:T}},[Symbol.iterator](){return this}}}}function ri(e){return function(...n){return e==="delete"?!1:e==="clear"?void 0:this}}function $l(e,n){const t={get(s){const r=this.__v_raw,o=ie(r),l=ie(s);e||(Wn(s,l)&&Pe(o,"get",s),Pe(o,"get",l));const{has:c}=si(o),m=n?bs:e?yt:un;if(c.call(o,s))return m(r.get(s));if(c.call(o,l))return m(r.get(l));r!==o&&r.get(s)},get size(){const s=this.__v_raw;return!e&&Pe(ie(s),"iterate",tt),s.size},has(s){const r=this.__v_raw,o=ie(r),l=ie(s);return e||(Wn(s,l)&&Pe(o,"has",s),Pe(o,"has",l)),s===l?r.has(s):r.has(s)||r.has(l)},forEach(s,r){const o=this,l=o.__v_raw,c=ie(l),m=n?bs:e?yt:un;return!e&&Pe(c,"iterate",tt),l.forEach((f,g)=>s.call(r,m(f),m(g),o))}};return Ce(t,e?{add:ri("add"),set:ri("set"),delete:ri("delete"),clear:ri("clear")}:{add(s){!n&&!on(s)&&!An(s)&&(s=ie(s));const r=ie(this);return si(r).has.call(r,s)||(r.add(s),xn(r,"add",s,s)),this},set(s,r){!n&&!on(r)&&!An(r)&&(r=ie(r));const o=ie(this),{has:l,get:c}=si(o);let m=l.call(o,s);m||(s=ie(s),m=l.call(o,s));const f=c.call(o,s);return o.set(s,r),m?Wn(r,f)&&xn(o,"set",s,r):xn(o,"add",s,r),this},delete(s){const r=ie(this),{has:o,get:l}=si(r);let c=o.call(r,s);c||(s=ie(s),c=o.call(r,s)),l&&l.call(r,s);const m=r.delete(s);return c&&xn(r,"delete",s,void 0),m},clear(){const s=ie(this),r=s.size!==0,o=s.clear();return r&&xn(s,"clear",void 0,void 0),o}}),["keys","values","entries",Symbol.iterator].forEach(s=>{t[s]=Ul(s,e,n)}),t}function Ws(e,n){const t=$l(e,n);return(i,s,r)=>s==="__v_isReactive"?!e:s==="__v_isReadonly"?e:s==="__v_raw"?i:Reflect.get(se(t,s)&&s in i?t:i,s,r)}const Jl={get:Ws(!1,!1)},ql={get:Ws(!1,!0)},Xl={get:Ws(!0,!1)};const Do=new WeakMap,Oo=new WeakMap,Wo=new WeakMap,Yl=new WeakMap;function Zl(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Ql(e){return e.__v_skip||!Object.isExtensible(e)?0:Zl(Sl(e))}function pt(e){return An(e)?e:Bs(e,!1,jl,Jl,Do)}function ec(e){return Bs(e,!1,Gl,ql,Oo)}function vs(e){return Bs(e,!0,Vl,Xl,Wo)}function Bs(e,n,t,i,s){if(!fe(e)||e.__v_raw&&!(n&&e.__v_isReactive))return e;const r=Ql(e);if(r===0)return e;const o=s.get(e);if(o)return o;const l=new Proxy(e,r===2?i:t);return s.set(e,l),l}function it(e){return An(e)?it(e.__v_raw):!!(e&&e.__v_isReactive)}function An(e){return!!(e&&e.__v_isReadonly)}function on(e){return!!(e&&e.__v_isShallow)}function Ks(e){return e?!!e.__v_raw:!1}function ie(e){const n=e&&e.__v_raw;return n?ie(n):e}function nc(e){return!se(e,"__v_skip")&&Object.isExtensible(e)&&_o(e,"__v_skip",!0),e}const un=e=>fe(e)?pt(e):e,yt=e=>fe(e)?vs(e):e;function Re(e){return e?e.__v_isRef===!0:!1}function ke(e){return tc(e,!1)}function tc(e,n){return Re(e)?e:new ic(e,n)}class ic{constructor(n,t){this.dep=new Os,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=t?n:ie(n),this._value=t?n:un(n),this.__v_isShallow=t}get value(){return this.dep.track(),this._value}set value(n){const t=this._rawValue,i=this.__v_isShallow||on(n)||An(n);n=i?n:ie(n),Wn(n,t)&&(this._rawValue=n,this._value=i?n:un(n),this.dep.trigger())}}function sc(e){return Re(e)?e.value:e}const rc={get:(e,n,t)=>n==="__v_raw"?e:sc(Reflect.get(e,n,t)),set:(e,n,t,i)=>{const s=e[n];return Re(s)&&!Re(t)?(s.value=t,!0):Reflect.set(e,n,t,i)}};function Bo(e){return it(e)?e:new Proxy(e,rc)}class oc{constructor(n,t,i){this.fn=n,this.setter=t,this._value=void 0,this.dep=new Os(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Dt-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!t,this.isSSR=i}notify(){if(this.flags|=16,!(this.flags&8)&&pe!==this)return Lo(this,!0),!0}get value(){const n=this.dep.track();return Po(this),n&&(n.version=this.dep.version),this._value}set value(n){this.setter&&this.setter(n)}}function ac(e,n,t=!1){let i,s;return G(e)?i=e:(i=e.get,s=e.set),new oc(i,s,t)}const oi={},wi=new WeakMap;let Qn;function lc(e,n=!1,t=Qn){if(t){let i=wi.get(t);i||wi.set(t,i=[]),i.push(e)}}function cc(e,n,t=me){const{immediate:i,deep:s,once:r,scheduler:o,augmentJob:l,call:c}=t,m=R=>s?R:on(R)||s===!1||s===0?Mn(R,1):Mn(R);let f,g,T,S,A=!1,D=!1;if(Re(e)?(g=()=>e.value,A=on(e)):it(e)?(g=()=>m(e),A=!0):N(e)?(D=!0,A=e.some(R=>it(R)||on(R)),g=()=>e.map(R=>{if(Re(R))return R.value;if(it(R))return m(R);if(G(R))return c?c(R,2):R()})):G(e)?n?g=c?()=>c(e,2):e:g=()=>{if(T){Ln();try{T()}finally{zn()}}const R=Qn;Qn=f;try{return c?c(e,3,[S]):e(S)}finally{Qn=R}}:g=vn,n&&s){const R=g,Q=s===!0?1/0:s;g=()=>Mn(R(),Q)}const re=Il(),B=()=>{f.stop(),re&&re.active&&Fs(re.effects,f)};if(r&&n){const R=n;n=(...Q)=>{R(...Q),B()}}let P=D?new Array(e.length).fill(oi):oi;const U=R=>{if(!(!(f.flags&1)||!f.dirty&&!R))if(n){const Q=f.run();if(s||A||(D?Q.some((ge,K)=>Wn(ge,P[K])):Wn(Q,P))){T&&T();const ge=Qn;Qn=f;try{const K=[Q,P===oi?void 0:D&&P[0]===oi?[]:P,S];P=Q,c?c(n,3,K):n(...K)}finally{Qn=ge}}}else f.run()};return l&&l(U),f=new xo(g),f.scheduler=o?()=>o(U,!1):U,S=R=>lc(R,!1,f),T=f.onStop=()=>{const R=wi.get(f);if(R){if(c)c(R,4);else for(const Q of R)Q();wi.delete(f)}},n?i?U(!0):P=f.run():o?o(U.bind(null,!0),!0):f.run(),B.pause=f.pause.bind(f),B.resume=f.resume.bind(f),B.stop=B,B}function Mn(e,n=1/0,t){if(n<=0||!fe(e)||e.__v_skip||(t=t||new Map,(t.get(e)||0)>=n))return e;if(t.set(e,n),n--,Re(e))Mn(e.value,n,t);else if(N(e))for(let i=0;i<e.length;i++)Mn(e[i],n,t);else if(wt(e)||ht(e))e.forEach(i=>{Mn(i,n,t)});else if(wo(e)){for(const i in e)Mn(e[i],n,t);for(const i of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,i)&&Mn(e[i],n,t)}return e}function Jt(e,n,t,i){try{return i?e(...i):e()}catch(s){Ii(s,n,t)}}function dn(e,n,t,i){if(G(e)){const s=Jt(e,n,t,i);return s&&vo(s)&&s.catch(r=>{Ii(r,n,t)}),s}if(N(e)){const s=[];for(let r=0;r<e.length;r++)s.push(dn(e[r],n,t,i));return s}}function Ii(e,n,t,i=!0){const s=n?n.vnode:null,{errorHandler:r,throwUnhandledErrorInProduction:o}=n&&n.appContext.config||me;if(n){let l=n.parent;const c=n.proxy,m=`https://vuejs.org/error-reference/#runtime-${t}`;for(;l;){const f=l.ec;if(f){for(let g=0;g<f.length;g++)if(f[g](e,c,m)===!1)return}l=l.parent}if(r){Ln(),Jt(r,null,10,[e,c,m]),zn();return}}uc(e,t,s,i,o)}function uc(e,n,t,i=!0,s=!1){if(s)throw e;console.error(e)}const De=[];let gn=-1;const gt=[];let In=null,dt=0;const Ko=Promise.resolve();let ki=null;function Je(e){const n=ki||Ko;return e?n.then(this?e.bind(this):e):n}function dc(e){let n=gn+1,t=De.length;for(;n<t;){const i=n+t>>>1,s=De[i],r=Wt(s);r<e||r===e&&s.flags&2?n=i+1:t=i}return n}function js(e){if(!(e.flags&1)){const n=Wt(e),t=De[De.length-1];!t||!(e.flags&2)&&n>=Wt(t)?De.push(e):De.splice(dc(n),0,e),e.flags|=1,jo()}}function jo(){ki||(ki=Ko.then(Go))}function fc(e){N(e)?gt.push(...e):In&&e.id===-1?In.splice(dt+1,0,e):e.flags&1||(gt.push(e),e.flags|=1),jo()}function Sr(e,n,t=gn+1){for(;t<De.length;t++){const i=De[t];if(i&&i.flags&2){if(e&&i.id!==e.uid)continue;De.splice(t,1),t--,i.flags&4&&(i.flags&=-2),i(),i.flags&4||(i.flags&=-2)}}}function Vo(e){if(gt.length){const n=[...new Set(gt)].sort((t,i)=>Wt(t)-Wt(i));if(gt.length=0,In){In.push(...n);return}for(In=n,dt=0;dt<In.length;dt++){const t=In[dt];t.flags&4&&(t.flags&=-2),t.flags&8||t(),t.flags&=-2}In=null,dt=0}}const Wt=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Go(e){try{for(gn=0;gn<De.length;gn++){const n=De[gn];n&&!(n.flags&8)&&(n.flags&4&&(n.flags&=-2),Jt(n,n.i,n.i?15:14),n.flags&4||(n.flags&=-2))}}finally{for(;gn<De.length;gn++){const n=De[gn];n&&(n.flags&=-2)}gn=-1,De.length=0,Vo(),ki=null,(De.length||gt.length)&&Go()}}let rn=null,Uo=null;function _i(e){const n=rn;return rn=e,Uo=e&&e.type.__scopeId||null,n}function ys(e,n=rn,t){if(!n||e._n)return e;const i=(...s)=>{i._d&&Ci(-1);const r=_i(n);let o;try{o=e(...s)}finally{_i(r),i._d&&Ci(1)}return o};return i._n=!0,i._c=!0,i._d=!0,i}function ns(e,n){if(rn===null)return e;const t=Ki(rn),i=e.dirs||(e.dirs=[]);for(let s=0;s<n.length;s++){let[r,o,l,c=me]=n[s];r&&(G(r)&&(r={mounted:r,updated:r}),r.deep&&Mn(o),i.push({dir:r,instance:t,value:o,oldValue:void 0,arg:l,modifiers:c}))}return e}function qn(e,n,t,i){const s=e.dirs,r=n&&n.dirs;for(let o=0;o<s.length;o++){const l=s[o];r&&(l.oldValue=r[o].value);let c=l.dir[i];c&&(Ln(),dn(c,t,8,[e.el,l,e,n]),zn())}}const hc=Symbol("_vte"),$o=e=>e.__isTeleport,En=Symbol("_leaveCb"),ai=Symbol("_enterCb");function mc(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return Di(()=>{e.isMounted=!0}),Oi(()=>{e.isUnmounting=!0}),e}const sn=[Function,Array],Jo={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:sn,onEnter:sn,onAfterEnter:sn,onEnterCancelled:sn,onBeforeLeave:sn,onLeave:sn,onAfterLeave:sn,onLeaveCancelled:sn,onBeforeAppear:sn,onAppear:sn,onAfterAppear:sn,onAppearCancelled:sn},qo=e=>{const n=e.subTree;return n.component?qo(n.component):n},pc={name:"BaseTransition",props:Jo,setup(e,{slots:n}){const t=ka(),i=mc();return()=>{const s=n.default&&Zo(n.default(),!0);if(!s||!s.length)return;const r=Xo(s),o=ie(e),{mode:l}=o;if(i.isLeaving)return ts(r);const c=Tr(r);if(!c)return ts(r);let m=ws(c,o,i,t,g=>m=g);c.type!==Oe&&Bt(c,m);let f=t.subTree&&Tr(t.subTree);if(f&&f.type!==Oe&&!et(f,c)&&qo(t).type!==Oe){let g=ws(f,o,i,t);if(Bt(f,g),l==="out-in"&&c.type!==Oe)return i.isLeaving=!0,g.afterLeave=()=>{i.isLeaving=!1,t.job.flags&8||t.update(),delete g.afterLeave,f=void 0},ts(r);l==="in-out"&&c.type!==Oe?g.delayLeave=(T,S,A)=>{const D=Yo(i,f);D[String(f.key)]=f,T[En]=()=>{S(),T[En]=void 0,delete m.delayedLeave,f=void 0},m.delayedLeave=()=>{A(),delete m.delayedLeave,f=void 0}}:f=void 0}else f&&(f=void 0);return r}}};function Xo(e){let n=e[0];if(e.length>1){for(const t of e)if(t.type!==Oe){n=t;break}}return n}const gc=pc;function Yo(e,n){const{leavingVNodes:t}=e;let i=t.get(n.type);return i||(i=Object.create(null),t.set(n.type,i)),i}function ws(e,n,t,i,s){const{appear:r,mode:o,persisted:l=!1,onBeforeEnter:c,onEnter:m,onAfterEnter:f,onEnterCancelled:g,onBeforeLeave:T,onLeave:S,onAfterLeave:A,onLeaveCancelled:D,onBeforeAppear:re,onAppear:B,onAfterAppear:P,onAppearCancelled:U}=n,R=String(e.key),Q=Yo(t,e),ge=(O,$)=>{O&&dn(O,i,9,$)},K=(O,$)=>{const q=$[1];ge(O,$),N(O)?O.every(L=>L.length<=1)&&q():O.length<=1&&q()},Z={mode:o,persisted:l,beforeEnter(O){let $=c;if(!t.isMounted)if(r)$=re||c;else return;O[En]&&O[En](!0);const q=Q[R];q&&et(e,q)&&q.el[En]&&q.el[En](),ge($,[O])},enter(O){let $=m,q=f,L=g;if(!t.isMounted)if(r)$=B||m,q=P||f,L=U||g;else return;let ne=!1;const be=O[ai]=oe=>{ne||(ne=!0,oe?ge(L,[O]):ge(q,[O]),Z.delayedLeave&&Z.delayedLeave(),O[ai]=void 0)};$?K($,[O,be]):be()},leave(O,$){const q=String(e.key);if(O[ai]&&O[ai](!0),t.isUnmounting)return $();ge(T,[O]);let L=!1;const ne=O[En]=be=>{L||(L=!0,$(),be?ge(D,[O]):ge(A,[O]),O[En]=void 0,Q[q]===e&&delete Q[q])};Q[q]=e,S?K(S,[O,ne]):ne()},clone(O){const $=ws(O,n,t,i,s);return s&&s($),$}};return Z}function ts(e){if(Hi(e))return e=Kn(e),e.children=null,e}function Tr(e){if(!Hi(e))return $o(e.type)&&e.children?Xo(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:n,children:t}=e;if(t){if(n&16)return t[0];if(n&32&&G(t.default))return t.default()}}function Bt(e,n){e.shapeFlag&6&&e.component?(e.transition=n,Bt(e.component.subTree,n)):e.shapeFlag&128?(e.ssContent.transition=n.clone(e.ssContent),e.ssFallback.transition=n.clone(e.ssFallback)):e.transition=n}function Zo(e,n=!1,t){let i=[],s=0;for(let r=0;r<e.length;r++){let o=e[r];const l=t==null?o.key:String(t)+String(o.key!=null?o.key:r);o.type===Ve?(o.patchFlag&128&&s++,i=i.concat(Zo(o.children,n,l))):(n||o.type!==Oe)&&i.push(l!=null?Kn(o,{key:l}):o)}if(s>1)for(let r=0;r<i.length;r++)i[r].patchFlag=-2;return i}function Qo(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}const Si=new WeakMap;function Rt(e,n,t,i,s=!1){if(N(e)){e.forEach((A,D)=>Rt(A,n&&(N(n)?n[D]:n),t,i,s));return}if(It(i)&&!s){i.shapeFlag&512&&i.type.__asyncResolved&&i.component.subTree.component&&Rt(e,n,t,i.component.subTree);return}const r=i.shapeFlag&4?Ki(i.component):i.el,o=s?null:r,{i:l,r:c}=e,m=n&&n.r,f=l.refs===me?l.refs={}:l.refs,g=l.setupState,T=ie(g),S=g===me?bo:A=>se(T,A);if(m!=null&&m!==c){if(Cr(n),ye(m))f[m]=null,S(m)&&(g[m]=null);else if(Re(m)){m.value=null;const A=n;A.k&&(f[A.k]=null)}}if(G(c))Jt(c,l,12,[o,f]);else{const A=ye(c),D=Re(c);if(A||D){const re=()=>{if(e.f){const B=A?S(c)?g[c]:f[c]:c.value;if(s)N(B)&&Fs(B,r);else if(N(B))B.includes(r)||B.push(r);else if(A)f[c]=[r],S(c)&&(g[c]=f[c]);else{const P=[r];c.value=P,e.k&&(f[e.k]=P)}}else A?(f[c]=o,S(c)&&(g[c]=o)):D&&(c.value=o,e.k&&(f[e.k]=o))};if(o){const B=()=>{re(),Si.delete(e)};B.id=-1,Si.set(e,B),qe(B,t)}else Cr(e),re()}}}function Cr(e){const n=Si.get(e);n&&(n.flags|=8,Si.delete(e))}Pi().requestIdleCallback;Pi().cancelIdleCallback;const It=e=>!!e.type.__asyncLoader,Hi=e=>e.type.__isKeepAlive;function bc(e,n){ea(e,"a",n)}function vc(e,n){ea(e,"da",n)}function ea(e,n,t=We){const i=e.__wdc||(e.__wdc=()=>{let s=t;for(;s;){if(s.isDeactivated)return;s=s.parent}return e()});if(Ni(n,i,t),t){let s=t.parent;for(;s&&s.parent;)Hi(s.parent.vnode)&&yc(i,n,t,s),s=s.parent}}function yc(e,n,t,i){const s=Ni(n,e,i,!0);na(()=>{Fs(i[n],s)},t)}function Ni(e,n,t=We,i=!1){if(t){const s=t[e]||(t[e]=[]),r=n.__weh||(n.__weh=(...o)=>{Ln();const l=qt(t),c=dn(n,t,e,o);return l(),zn(),c});return i?s.unshift(r):s.push(r),r}}const Pn=e=>(n,t=We)=>{(!jt||e==="sp")&&Ni(e,(...i)=>n(...i),t)},wc=Pn("bm"),Di=Pn("m"),kc=Pn("bu"),_c=Pn("u"),Oi=Pn("bum"),na=Pn("um"),Sc=Pn("sp"),Tc=Pn("rtg"),Cc=Pn("rtc");function Ec(e,n=We){Ni("ec",e,n)}const xc=Symbol.for("v-ndc");function li(e,n,t,i){let s;const r=t,o=N(e);if(o||ye(e)){const l=o&&it(e);let c=!1,m=!1;l&&(c=!on(e),m=An(e),e=Ri(e)),s=new Array(e.length);for(let f=0,g=e.length;f<g;f++)s[f]=n(c?m?yt(un(e[f])):un(e[f]):e[f],f,void 0,r)}else if(typeof e=="number"){s=new Array(e);for(let l=0;l<e;l++)s[l]=n(l+1,l,void 0,r)}else if(fe(e))if(e[Symbol.iterator])s=Array.from(e,(l,c)=>n(l,c,void 0,r));else{const l=Object.keys(e);s=new Array(l.length);for(let c=0,m=l.length;c<m;c++){const f=l[c];s[c]=n(e[f],f,c,r)}}else s=[];return s}const ks=e=>e?_a(e)?Ki(e):ks(e.parent):null,Ht=Ce(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>ks(e.parent),$root:e=>ks(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>ia(e),$forceUpdate:e=>e.f||(e.f=()=>{js(e.update)}),$nextTick:e=>e.n||(e.n=Je.bind(e.proxy)),$watch:e=>Oc.bind(e)}),is=(e,n)=>e!==me&&!e.__isScriptSetup&&se(e,n),Mc={get({_:e},n){if(n==="__v_skip")return!0;const{ctx:t,setupState:i,data:s,props:r,accessCache:o,type:l,appContext:c}=e;if(n[0]!=="$"){const T=o[n];if(T!==void 0)switch(T){case 1:return i[n];case 2:return s[n];case 4:return t[n];case 3:return r[n]}else{if(is(i,n))return o[n]=1,i[n];if(s!==me&&se(s,n))return o[n]=2,s[n];if(se(r,n))return o[n]=3,r[n];if(t!==me&&se(t,n))return o[n]=4,t[n];_s&&(o[n]=0)}}const m=Ht[n];let f,g;if(m)return n==="$attrs"&&Pe(e.attrs,"get",""),m(e);if((f=l.__cssModules)&&(f=f[n]))return f;if(t!==me&&se(t,n))return o[n]=4,t[n];if(g=c.config.globalProperties,se(g,n))return g[n]},set({_:e},n,t){const{data:i,setupState:s,ctx:r}=e;return is(s,n)?(s[n]=t,!0):i!==me&&se(i,n)?(i[n]=t,!0):se(e.props,n)||n[0]==="$"&&n.slice(1)in e?!1:(r[n]=t,!0)},has({_:{data:e,setupState:n,accessCache:t,ctx:i,appContext:s,props:r,type:o}},l){let c;return!!(t[l]||e!==me&&l[0]!=="$"&&se(e,l)||is(n,l)||se(r,l)||se(i,l)||se(Ht,l)||se(s.config.globalProperties,l)||(c=o.__cssModules)&&c[l])},defineProperty(e,n,t){return t.get!=null?e._.accessCache[n]=0:se(t,"value")&&this.set(e,n,t.value,null),Reflect.defineProperty(e,n,t)}};function Er(e){return N(e)?e.reduce((n,t)=>(n[t]=null,n),{}):e}let _s=!0;function Lc(e){const n=ia(e),t=e.proxy,i=e.ctx;_s=!1,n.beforeCreate&&xr(n.beforeCreate,e,"bc");const{data:s,computed:r,methods:o,watch:l,provide:c,inject:m,created:f,beforeMount:g,mounted:T,beforeUpdate:S,updated:A,activated:D,deactivated:re,beforeDestroy:B,beforeUnmount:P,destroyed:U,unmounted:R,render:Q,renderTracked:ge,renderTriggered:K,errorCaptured:Z,serverPrefetch:O,expose:$,inheritAttrs:q,components:L,directives:ne,filters:be}=n;if(m&&zc(m,i,null),o)for(const j in o){const ue=o[j];G(ue)&&(i[j]=ue.bind(t))}if(s){const j=s.call(t,t);fe(j)&&(e.data=pt(j))}if(_s=!0,r)for(const j in r){const ue=r[j],wn=G(ue)?ue.bind(t,t):G(ue.get)?ue.get.bind(t,t):vn,jn=!G(ue)&&G(ue.set)?ue.set.bind(t):vn,an=V({get:wn,set:jn});Object.defineProperty(i,j,{enumerable:!0,configurable:!0,get:()=>an.value,set:Ee=>an.value=Ee})}if(l)for(const j in l)ta(l[j],i,t,j);if(c){const j=G(c)?c.call(t):c;Reflect.ownKeys(j).forEach(ue=>{Hc(ue,j[ue])})}f&&xr(f,e,"c");function ce(j,ue){N(ue)?ue.forEach(wn=>j(wn.bind(t))):ue&&j(ue.bind(t))}if(ce(wc,g),ce(Di,T),ce(kc,S),ce(_c,A),ce(bc,D),ce(vc,re),ce(Ec,Z),ce(Cc,ge),ce(Tc,K),ce(Oi,P),ce(na,R),ce(Sc,O),N($))if($.length){const j=e.exposed||(e.exposed={});$.forEach(ue=>{Object.defineProperty(j,ue,{get:()=>t[ue],set:wn=>t[ue]=wn,enumerable:!0})})}else e.exposed||(e.exposed={});Q&&e.render===vn&&(e.render=Q),q!=null&&(e.inheritAttrs=q),L&&(e.components=L),ne&&(e.directives=ne),O&&Qo(e)}function zc(e,n,t=vn){N(e)&&(e=Ss(e));for(const i in e){const s=e[i];let r;fe(s)?"default"in s?r=pi(s.from||i,s.default,!0):r=pi(s.from||i):r=pi(s),Re(r)?Object.defineProperty(n,i,{enumerable:!0,configurable:!0,get:()=>r.value,set:o=>r.value=o}):n[i]=r}}function xr(e,n,t){dn(N(e)?e.map(i=>i.bind(n.proxy)):e.bind(n.proxy),n,t)}function ta(e,n,t,i){let s=i.includes(".")?oa(t,i):()=>t[i];if(ye(e)){const r=n[e];G(r)&&Xe(s,r)}else if(G(e))Xe(s,e.bind(t));else if(fe(e))if(N(e))e.forEach(r=>ta(r,n,t,i));else{const r=G(e.handler)?e.handler.bind(t):n[e.handler];G(r)&&Xe(s,r,e)}}function ia(e){const n=e.type,{mixins:t,extends:i}=n,{mixins:s,optionsCache:r,config:{optionMergeStrategies:o}}=e.appContext,l=r.get(n);let c;return l?c=l:!s.length&&!t&&!i?c=n:(c={},s.length&&s.forEach(m=>Ti(c,m,o,!0)),Ti(c,n,o)),fe(n)&&r.set(n,c),c}function Ti(e,n,t,i=!1){const{mixins:s,extends:r}=n;r&&Ti(e,r,t,!0),s&&s.forEach(o=>Ti(e,o,t,!0));for(const o in n)if(!(i&&o==="expose")){const l=Ac[o]||t&&t[o];e[o]=l?l(e[o],n[o]):n[o]}return e}const Ac={data:Mr,props:Lr,emits:Lr,methods:Lt,computed:Lt,beforeCreate:Ne,created:Ne,beforeMount:Ne,mounted:Ne,beforeUpdate:Ne,updated:Ne,beforeDestroy:Ne,beforeUnmount:Ne,destroyed:Ne,unmounted:Ne,activated:Ne,deactivated:Ne,errorCaptured:Ne,serverPrefetch:Ne,components:Lt,directives:Lt,watch:Fc,provide:Mr,inject:Pc};function Mr(e,n){return n?e?function(){return Ce(G(e)?e.call(this,this):e,G(n)?n.call(this,this):n)}:n:e}function Pc(e,n){return Lt(Ss(e),Ss(n))}function Ss(e){if(N(e)){const n={};for(let t=0;t<e.length;t++)n[e[t]]=e[t];return n}return e}function Ne(e,n){return e?[...new Set([].concat(e,n))]:n}function Lt(e,n){return e?Ce(Object.create(null),e,n):n}function Lr(e,n){return e?N(e)&&N(n)?[...new Set([...e,...n])]:Ce(Object.create(null),Er(e),Er(n??{})):n}function Fc(e,n){if(!e)return n;if(!n)return e;const t=Ce(Object.create(null),e);for(const i in n)t[i]=Ne(e[i],n[i]);return t}function sa(){return{app:null,config:{isNativeTag:bo,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Rc=0;function Ic(e,n){return function(i,s=null){G(i)||(i=Ce({},i)),s!=null&&!fe(s)&&(s=null);const r=sa(),o=new WeakSet,l=[];let c=!1;const m=r.app={_uid:Rc++,_component:i,_props:s,_container:null,_context:r,_instance:null,version:yu,get config(){return r.config},set config(f){},use(f,...g){return o.has(f)||(f&&G(f.install)?(o.add(f),f.install(m,...g)):G(f)&&(o.add(f),f(m,...g))),m},mixin(f){return r.mixins.includes(f)||r.mixins.push(f),m},component(f,g){return g?(r.components[f]=g,m):r.components[f]},directive(f,g){return g?(r.directives[f]=g,m):r.directives[f]},mount(f,g,T){if(!c){const S=m._ceVNode||Fe(i,s);return S.appContext=r,T===!0?T="svg":T===!1&&(T=void 0),e(S,f,T),c=!0,m._container=f,f.__vue_app__=m,Ki(S.component)}},onUnmount(f){l.push(f)},unmount(){c&&(dn(l,m._instance,16),e(null,m._container),delete m._container.__vue_app__)},provide(f,g){return r.provides[f]=g,m},runWithContext(f){const g=bt;bt=m;try{return f()}finally{bt=g}}};return m}}let bt=null;function Hc(e,n){if(We){let t=We.provides;const i=We.parent&&We.parent.provides;i===t&&(t=We.provides=Object.create(i)),t[e]=n}}function pi(e,n,t=!1){const i=ka();if(i||bt){let s=bt?bt._context.provides:i?i.parent==null||i.ce?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides:void 0;if(s&&e in s)return s[e];if(arguments.length>1)return t&&G(n)?n.call(i&&i.proxy):n}}const Nc=Symbol.for("v-scx"),Dc=()=>pi(Nc);function Xe(e,n,t){return ra(e,n,t)}function ra(e,n,t=me){const{immediate:i,deep:s,flush:r,once:o}=t,l=Ce({},t),c=n&&i||!n&&r!=="post";let m;if(jt){if(r==="sync"){const S=Dc();m=S.__watcherHandles||(S.__watcherHandles=[])}else if(!c){const S=()=>{};return S.stop=vn,S.resume=vn,S.pause=vn,S}}const f=We;l.call=(S,A,D)=>dn(S,f,A,D);let g=!1;r==="post"?l.scheduler=S=>{qe(S,f&&f.suspense)}:r!=="sync"&&(g=!0,l.scheduler=(S,A)=>{A?S():js(S)}),l.augmentJob=S=>{n&&(S.flags|=4),g&&(S.flags|=2,f&&(S.id=f.uid,S.i=f))};const T=cc(e,n,l);return jt&&(m?m.push(T):c&&T()),T}function Oc(e,n,t){const i=this.proxy,s=ye(e)?e.includes(".")?oa(i,e):()=>i[e]:e.bind(i,i);let r;G(n)?r=n:(r=n.handler,t=n);const o=qt(this),l=ra(s,r.bind(i),t);return o(),l}function oa(e,n){const t=n.split(".");return()=>{let i=e;for(let s=0;s<t.length&&i;s++)i=i[t[s]];return i}}const Wc=(e,n)=>n==="modelValue"||n==="model-value"?e.modelModifiers:e[`${n}Modifiers`]||e[`${Bn(n)}Modifiers`]||e[`${rt(n)}Modifiers`];function Bc(e,n,...t){if(e.isUnmounted)return;const i=e.vnode.props||me;let s=t;const r=n.startsWith("update:"),o=r&&Wc(i,n.slice(7));o&&(o.trim&&(s=t.map(f=>ye(f)?f.trim():f)),o.number&&(s=t.map(So)));let l,c=i[l=Xi(n)]||i[l=Xi(Bn(n))];!c&&r&&(c=i[l=Xi(rt(n))]),c&&dn(c,e,6,s);const m=i[l+"Once"];if(m){if(!e.emitted)e.emitted={};else if(e.emitted[l])return;e.emitted[l]=!0,dn(m,e,6,s)}}const Kc=new WeakMap;function aa(e,n,t=!1){const i=t?Kc:n.emitsCache,s=i.get(e);if(s!==void 0)return s;const r=e.emits;let o={},l=!1;if(!G(e)){const c=m=>{const f=aa(m,n,!0);f&&(l=!0,Ce(o,f))};!t&&n.mixins.length&&n.mixins.forEach(c),e.extends&&c(e.extends),e.mixins&&e.mixins.forEach(c)}return!r&&!l?(fe(e)&&i.set(e,null),null):(N(r)?r.forEach(c=>o[c]=null):Ce(o,r),fe(e)&&i.set(e,o),o)}function Wi(e,n){return!e||!zi(n)?!1:(n=n.slice(2).replace(/Once$/,""),se(e,n[0].toLowerCase()+n.slice(1))||se(e,rt(n))||se(e,n))}function zr(e){const{type:n,vnode:t,proxy:i,withProxy:s,propsOptions:[r],slots:o,attrs:l,emit:c,render:m,renderCache:f,props:g,data:T,setupState:S,ctx:A,inheritAttrs:D}=e,re=_i(e);let B,P;try{if(t.shapeFlag&4){const R=s||i,Q=R;B=bn(m.call(Q,R,f,g,S,T,A)),P=l}else{const R=n;B=bn(R.length>1?R(g,{attrs:l,slots:o,emit:c}):R(g,null)),P=n.props?l:jc(l)}}catch(R){Nt.length=0,Ii(R,e,1),B=Fe(Oe)}let U=B;if(P&&D!==!1){const R=Object.keys(P),{shapeFlag:Q}=U;R.length&&Q&7&&(r&&R.some(Ps)&&(P=Vc(P,r)),U=Kn(U,P,!1,!0))}return t.dirs&&(U=Kn(U,null,!1,!0),U.dirs=U.dirs?U.dirs.concat(t.dirs):t.dirs),t.transition&&Bt(U,t.transition),B=U,_i(re),B}const jc=e=>{let n;for(const t in e)(t==="class"||t==="style"||zi(t))&&((n||(n={}))[t]=e[t]);return n},Vc=(e,n)=>{const t={};for(const i in e)(!Ps(i)||!(i.slice(9)in n))&&(t[i]=e[i]);return t};function Gc(e,n,t){const{props:i,children:s,component:r}=e,{props:o,children:l,patchFlag:c}=n,m=r.emitsOptions;if(n.dirs||n.transition)return!0;if(t&&c>=0){if(c&1024)return!0;if(c&16)return i?Ar(i,o,m):!!o;if(c&8){const f=n.dynamicProps;for(let g=0;g<f.length;g++){const T=f[g];if(o[T]!==i[T]&&!Wi(m,T))return!0}}}else return(s||l)&&(!l||!l.$stable)?!0:i===o?!1:i?o?Ar(i,o,m):!0:!!o;return!1}function Ar(e,n,t){const i=Object.keys(n);if(i.length!==Object.keys(e).length)return!0;for(let s=0;s<i.length;s++){const r=i[s];if(n[r]!==e[r]&&!Wi(t,r))return!0}return!1}function Uc({vnode:e,parent:n},t){for(;n;){const i=n.subTree;if(i.suspense&&i.suspense.activeBranch===e&&(i.el=e.el),i===e)(e=n.vnode).el=t,n=n.parent;else break}}const la={},ca=()=>Object.create(la),ua=e=>Object.getPrototypeOf(e)===la;function $c(e,n,t,i=!1){const s={},r=ca();e.propsDefaults=Object.create(null),da(e,n,s,r);for(const o in e.propsOptions[0])o in s||(s[o]=void 0);t?e.props=i?s:ec(s):e.type.props?e.props=s:e.props=r,e.attrs=r}function Jc(e,n,t,i){const{props:s,attrs:r,vnode:{patchFlag:o}}=e,l=ie(s),[c]=e.propsOptions;let m=!1;if((i||o>0)&&!(o&16)){if(o&8){const f=e.vnode.dynamicProps;for(let g=0;g<f.length;g++){let T=f[g];if(Wi(e.emitsOptions,T))continue;const S=n[T];if(c)if(se(r,T))S!==r[T]&&(r[T]=S,m=!0);else{const A=Bn(T);s[A]=Ts(c,l,A,S,e,!1)}else S!==r[T]&&(r[T]=S,m=!0)}}}else{da(e,n,s,r)&&(m=!0);let f;for(const g in l)(!n||!se(n,g)&&((f=rt(g))===g||!se(n,f)))&&(c?t&&(t[g]!==void 0||t[f]!==void 0)&&(s[g]=Ts(c,l,g,void 0,e,!0)):delete s[g]);if(r!==l)for(const g in r)(!n||!se(n,g))&&(delete r[g],m=!0)}m&&xn(e.attrs,"set","")}function da(e,n,t,i){const[s,r]=e.propsOptions;let o=!1,l;if(n)for(let c in n){if(At(c))continue;const m=n[c];let f;s&&se(s,f=Bn(c))?!r||!r.includes(f)?t[f]=m:(l||(l={}))[f]=m:Wi(e.emitsOptions,c)||(!(c in i)||m!==i[c])&&(i[c]=m,o=!0)}if(r){const c=ie(t),m=l||me;for(let f=0;f<r.length;f++){const g=r[f];t[g]=Ts(s,c,g,m[g],e,!se(m,g))}}return o}function Ts(e,n,t,i,s,r){const o=e[t];if(o!=null){const l=se(o,"default");if(l&&i===void 0){const c=o.default;if(o.type!==Function&&!o.skipFactory&&G(c)){const{propsDefaults:m}=s;if(t in m)i=m[t];else{const f=qt(s);i=m[t]=c.call(null,n),f()}}else i=c;s.ce&&s.ce._setProp(t,i)}o[0]&&(r&&!l?i=!1:o[1]&&(i===""||i===rt(t))&&(i=!0))}return i}const qc=new WeakMap;function fa(e,n,t=!1){const i=t?qc:n.propsCache,s=i.get(e);if(s)return s;const r=e.props,o={},l=[];let c=!1;if(!G(e)){const f=g=>{c=!0;const[T,S]=fa(g,n,!0);Ce(o,T),S&&l.push(...S)};!t&&n.mixins.length&&n.mixins.forEach(f),e.extends&&f(e.extends),e.mixins&&e.mixins.forEach(f)}if(!r&&!c)return fe(e)&&i.set(e,ft),ft;if(N(r))for(let f=0;f<r.length;f++){const g=Bn(r[f]);Pr(g)&&(o[g]=me)}else if(r)for(const f in r){const g=Bn(f);if(Pr(g)){const T=r[f],S=o[g]=N(T)||G(T)?{type:T}:Ce({},T),A=S.type;let D=!1,re=!0;if(N(A))for(let B=0;B<A.length;++B){const P=A[B],U=G(P)&&P.name;if(U==="Boolean"){D=!0;break}else U==="String"&&(re=!1)}else D=G(A)&&A.name==="Boolean";S[0]=D,S[1]=re,(D||se(S,"default"))&&l.push(g)}}const m=[o,l];return fe(e)&&i.set(e,m),m}function Pr(e){return e[0]!=="$"&&!At(e)}const Vs=e=>e==="_"||e==="_ctx"||e==="$stable",Gs=e=>N(e)?e.map(bn):[bn(e)],Xc=(e,n,t)=>{if(n._n)return n;const i=ys((...s)=>Gs(n(...s)),t);return i._c=!1,i},ha=(e,n,t)=>{const i=e._ctx;for(const s in e){if(Vs(s))continue;const r=e[s];if(G(r))n[s]=Xc(s,r,i);else if(r!=null){const o=Gs(r);n[s]=()=>o}}},ma=(e,n)=>{const t=Gs(n);e.slots.default=()=>t},pa=(e,n,t)=>{for(const i in n)(t||!Vs(i))&&(e[i]=n[i])},Yc=(e,n,t)=>{const i=e.slots=ca();if(e.vnode.shapeFlag&32){const s=n._;s?(pa(i,n,t),t&&_o(i,"_",s,!0)):ha(n,i)}else n&&ma(e,n)},Zc=(e,n,t)=>{const{vnode:i,slots:s}=e;let r=!0,o=me;if(i.shapeFlag&32){const l=n._;l?t&&l===1?r=!1:pa(s,n,t):(r=!n.$stable,ha(n,s)),o=n}else n&&(ma(e,n),o={default:1});if(r)for(const l in s)!Vs(l)&&o[l]==null&&delete s[l]},qe=iu;function Qc(e){return eu(e)}function eu(e,n){const t=Pi();t.__VUE__=!0;const{insert:i,remove:s,patchProp:r,createElement:o,createText:l,createComment:c,setText:m,setElementText:f,parentNode:g,nextSibling:T,setScopeId:S=vn,insertStaticContent:A}=e,D=(u,h,b,_=null,k=null,v=null,x=void 0,M=null,C=!!h.dynamicChildren)=>{if(u===h)return;u&&!et(u,h)&&(_=Gn(u),Ee(u,k,v,!0),u=null),h.patchFlag===-2&&(C=!1,h.dynamicChildren=null);const{type:w,ref:H,shapeFlag:z}=h;switch(w){case Bi:re(u,h,b,_);break;case Oe:B(u,h,b,_);break;case rs:u==null&&P(h,b,_,x);break;case Ve:L(u,h,b,_,k,v,x,M,C);break;default:z&1?Q(u,h,b,_,k,v,x,M,C):z&6?ne(u,h,b,_,k,v,x,M,C):(z&64||z&128)&&w.process(u,h,b,_,k,v,x,M,C,xe)}H!=null&&k?Rt(H,u&&u.ref,v,h||u,!h):H==null&&u&&u.ref!=null&&Rt(u.ref,null,v,u,!0)},re=(u,h,b,_)=>{if(u==null)i(h.el=l(h.children),b,_);else{const k=h.el=u.el;h.children!==u.children&&m(k,h.children)}},B=(u,h,b,_)=>{u==null?i(h.el=c(h.children||""),b,_):h.el=u.el},P=(u,h,b,_)=>{[u.el,u.anchor]=A(u.children,h,b,_,u.el,u.anchor)},U=({el:u,anchor:h},b,_)=>{let k;for(;u&&u!==h;)k=T(u),i(u,b,_),u=k;i(h,b,_)},R=({el:u,anchor:h})=>{let b;for(;u&&u!==h;)b=T(u),s(u),u=b;s(h)},Q=(u,h,b,_,k,v,x,M,C)=>{if(h.type==="svg"?x="svg":h.type==="math"&&(x="mathml"),u==null)ge(h,b,_,k,v,x,M,C);else{const w=u.el&&u.el._isVueCE?u.el:null;try{w&&w._beginPatch(),O(u,h,k,v,x,M,C)}finally{w&&w._endPatch()}}},ge=(u,h,b,_,k,v,x,M)=>{let C,w;const{props:H,shapeFlag:z,transition:I,dirs:W}=u;if(C=u.el=o(u.type,v,H&&H.is,H),z&8?f(C,u.children):z&16&&Z(u.children,C,null,_,k,ss(u,v),x,M),W&&qn(u,null,_,"created"),K(C,u,u.scopeId,x,_),H){for(const te in H)te!=="value"&&!At(te)&&r(C,te,null,H[te],v,_);"value"in H&&r(C,"value",null,H.value,v),(w=H.onVnodeBeforeMount)&&mn(w,_,u)}W&&qn(u,null,_,"beforeMount");const X=nu(k,I);X&&I.beforeEnter(C),i(C,h,b),((w=H&&H.onVnodeMounted)||X||W)&&qe(()=>{w&&mn(w,_,u),X&&I.enter(C),W&&qn(u,null,_,"mounted")},k)},K=(u,h,b,_,k)=>{if(b&&S(u,b),_)for(let v=0;v<_.length;v++)S(u,_[v]);if(k){let v=k.subTree;if(h===v||va(v.type)&&(v.ssContent===h||v.ssFallback===h)){const x=k.vnode;K(u,x,x.scopeId,x.slotScopeIds,k.parent)}}},Z=(u,h,b,_,k,v,x,M,C=0)=>{for(let w=C;w<u.length;w++){const H=u[w]=M?Hn(u[w]):bn(u[w]);D(null,H,h,b,_,k,v,x,M)}},O=(u,h,b,_,k,v,x)=>{const M=h.el=u.el;let{patchFlag:C,dynamicChildren:w,dirs:H}=h;C|=u.patchFlag&16;const z=u.props||me,I=h.props||me;let W;if(b&&Xn(b,!1),(W=I.onVnodeBeforeUpdate)&&mn(W,b,h,u),H&&qn(h,u,b,"beforeUpdate"),b&&Xn(b,!0),(z.innerHTML&&I.innerHTML==null||z.textContent&&I.textContent==null)&&f(M,""),w?$(u.dynamicChildren,w,M,b,_,ss(h,k),v):x||ue(u,h,M,null,b,_,ss(h,k),v,!1),C>0){if(C&16)q(M,z,I,b,k);else if(C&2&&z.class!==I.class&&r(M,"class",null,I.class,k),C&4&&r(M,"style",z.style,I.style,k),C&8){const X=h.dynamicProps;for(let te=0;te<X.length;te++){const Y=X[te],Le=z[Y],ze=I[Y];(ze!==Le||Y==="value")&&r(M,Y,Le,ze,k,b)}}C&1&&u.children!==h.children&&f(M,h.children)}else!x&&w==null&&q(M,z,I,b,k);((W=I.onVnodeUpdated)||H)&&qe(()=>{W&&mn(W,b,h,u),H&&qn(h,u,b,"updated")},_)},$=(u,h,b,_,k,v,x)=>{for(let M=0;M<h.length;M++){const C=u[M],w=h[M],H=C.el&&(C.type===Ve||!et(C,w)||C.shapeFlag&198)?g(C.el):b;D(C,w,H,null,_,k,v,x,!0)}},q=(u,h,b,_,k)=>{if(h!==b){if(h!==me)for(const v in h)!At(v)&&!(v in b)&&r(u,v,h[v],null,k,_);for(const v in b){if(At(v))continue;const x=b[v],M=h[v];x!==M&&v!=="value"&&r(u,v,M,x,k,_)}"value"in b&&r(u,"value",h.value,b.value,k)}},L=(u,h,b,_,k,v,x,M,C)=>{const w=h.el=u?u.el:l(""),H=h.anchor=u?u.anchor:l("");let{patchFlag:z,dynamicChildren:I,slotScopeIds:W}=h;W&&(M=M?M.concat(W):W),u==null?(i(w,b,_),i(H,b,_),Z(h.children||[],b,H,k,v,x,M,C)):z>0&&z&64&&I&&u.dynamicChildren?($(u.dynamicChildren,I,b,k,v,x,M),(h.key!=null||k&&h===k.subTree)&&ga(u,h,!0)):ue(u,h,b,H,k,v,x,M,C)},ne=(u,h,b,_,k,v,x,M,C)=>{h.slotScopeIds=M,u==null?h.shapeFlag&512?k.ctx.activate(h,b,_,x,C):be(h,b,_,k,v,x,C):oe(u,h,C)},be=(u,h,b,_,k,v,x)=>{const M=u.component=fu(u,_,k);if(Hi(u)&&(M.ctx.renderer=xe),hu(M,!1,x),M.asyncDep){if(k&&k.registerDep(M,ce,x),!u.el){const C=M.subTree=Fe(Oe);B(null,C,h,b),u.placeholder=C.el}}else ce(M,u,h,b,k,v,x)},oe=(u,h,b)=>{const _=h.component=u.component;if(Gc(u,h,b))if(_.asyncDep&&!_.asyncResolved){j(_,h,b);return}else _.next=h,_.update();else h.el=u.el,_.vnode=h},ce=(u,h,b,_,k,v,x)=>{const M=()=>{if(u.isMounted){let{next:z,bu:I,u:W,parent:X,vnode:te}=u;{const en=ba(u);if(en){z&&(z.el=te.el,j(u,z,x)),en.asyncDep.then(()=>{u.isUnmounted||M()});return}}let Y=z,Le;Xn(u,!1),z?(z.el=te.el,j(u,z,x)):z=te,I&&mi(I),(Le=z.props&&z.props.onVnodeBeforeUpdate)&&mn(Le,X,z,te),Xn(u,!0);const ze=zr(u),Qe=u.subTree;u.subTree=ze,D(Qe,ze,g(Qe.el),Gn(Qe),u,k,v),z.el=ze.el,Y===null&&Uc(u,ze.el),W&&qe(W,k),(Le=z.props&&z.props.onVnodeUpdated)&&qe(()=>mn(Le,X,z,te),k)}else{let z;const{el:I,props:W}=h,{bm:X,m:te,parent:Y,root:Le,type:ze}=u,Qe=It(h);Xn(u,!1),X&&mi(X),!Qe&&(z=W&&W.onVnodeBeforeMount)&&mn(z,Y,h),Xn(u,!0);{Le.ce&&Le.ce._def.shadowRoot!==!1&&Le.ce._injectChildStyle(ze);const en=u.subTree=zr(u);D(null,en,b,_,u,k,v),h.el=en.el}if(te&&qe(te,k),!Qe&&(z=W&&W.onVnodeMounted)){const en=h;qe(()=>mn(z,Y,en),k)}(h.shapeFlag&256||Y&&It(Y.vnode)&&Y.vnode.shapeFlag&256)&&u.a&&qe(u.a,k),u.isMounted=!0,h=b=_=null}};u.scope.on();const C=u.effect=new xo(M);u.scope.off();const w=u.update=C.run.bind(C),H=u.job=C.runIfDirty.bind(C);H.i=u,H.id=u.uid,C.scheduler=()=>js(H),Xn(u,!0),w()},j=(u,h,b)=>{h.component=u;const _=u.vnode.props;u.vnode=h,u.next=null,Jc(u,h.props,_,b),Zc(u,h.children,b),Ln(),Sr(u),zn()},ue=(u,h,b,_,k,v,x,M,C=!1)=>{const w=u&&u.children,H=u?u.shapeFlag:0,z=h.children,{patchFlag:I,shapeFlag:W}=h;if(I>0){if(I&128){jn(w,z,b,_,k,v,x,M,C);return}else if(I&256){wn(w,z,b,_,k,v,x,M,C);return}}W&8?(H&16&&Ze(w,k,v),z!==w&&f(b,z)):H&16?W&16?jn(w,z,b,_,k,v,x,M,C):Ze(w,k,v,!0):(H&8&&f(b,""),W&16&&Z(z,b,_,k,v,x,M,C))},wn=(u,h,b,_,k,v,x,M,C)=>{u=u||ft,h=h||ft;const w=u.length,H=h.length,z=Math.min(w,H);let I;for(I=0;I<z;I++){const W=h[I]=C?Hn(h[I]):bn(h[I]);D(u[I],W,b,null,k,v,x,M,C)}w>H?Ze(u,k,v,!0,!1,z):Z(h,b,_,k,v,x,M,C,z)},jn=(u,h,b,_,k,v,x,M,C)=>{let w=0;const H=h.length;let z=u.length-1,I=H-1;for(;w<=z&&w<=I;){const W=u[w],X=h[w]=C?Hn(h[w]):bn(h[w]);if(et(W,X))D(W,X,b,null,k,v,x,M,C);else break;w++}for(;w<=z&&w<=I;){const W=u[z],X=h[I]=C?Hn(h[I]):bn(h[I]);if(et(W,X))D(W,X,b,null,k,v,x,M,C);else break;z--,I--}if(w>z){if(w<=I){const W=I+1,X=W<H?h[W].el:_;for(;w<=I;)D(null,h[w]=C?Hn(h[w]):bn(h[w]),b,X,k,v,x,M,C),w++}}else if(w>I)for(;w<=z;)Ee(u[w],k,v,!0),w++;else{const W=w,X=w,te=new Map;for(w=X;w<=I;w++){const Ie=h[w]=C?Hn(h[w]):bn(h[w]);Ie.key!=null&&te.set(Ie.key,w)}let Y,Le=0;const ze=I-X+1;let Qe=!1,en=0;const _e=new Array(ze);for(w=0;w<ze;w++)_e[w]=0;for(w=W;w<=z;w++){const Ie=u[w];if(Le>=ze){Ee(Ie,k,v,!0);continue}let nn;if(Ie.key!=null)nn=te.get(Ie.key);else for(Y=X;Y<=I;Y++)if(_e[Y-X]===0&&et(Ie,h[Y])){nn=Y;break}nn===void 0?Ee(Ie,k,v,!0):(_e[nn-X]=w+1,nn>=en?en=nn:Qe=!0,D(Ie,h[nn],b,null,k,v,x,M,C),Le++)}const _t=Qe?tu(_e):ft;for(Y=_t.length-1,w=ze-1;w>=0;w--){const Ie=X+w,nn=h[Ie],he=h[Ie+1],ot=Ie+1<H?he.el||he.placeholder:_;_e[w]===0?D(null,nn,b,ot,k,v,x,M,C):Qe&&(Y<0||w!==_t[Y]?an(nn,b,ot,2):Y--)}}},an=(u,h,b,_,k=null)=>{const{el:v,type:x,transition:M,children:C,shapeFlag:w}=u;if(w&6){an(u.component.subTree,h,b,_);return}if(w&128){u.suspense.move(h,b,_);return}if(w&64){x.move(u,h,b,xe);return}if(x===Ve){i(v,h,b);for(let z=0;z<C.length;z++)an(C[z],h,b,_);i(u.anchor,h,b);return}if(x===rs){U(u,h,b);return}if(_!==2&&w&1&&M)if(_===0)M.beforeEnter(v),i(v,h,b),qe(()=>M.enter(v),k);else{const{leave:z,delayLeave:I,afterLeave:W}=M,X=()=>{u.ctx.isUnmounted?s(v):i(v,h,b)},te=()=>{v._isLeaving&&v[En](!0),z(v,()=>{X(),W&&W()})};I?I(v,X,te):te()}else i(v,h,b)},Ee=(u,h,b,_=!1,k=!1)=>{const{type:v,props:x,ref:M,children:C,dynamicChildren:w,shapeFlag:H,patchFlag:z,dirs:I,cacheIndex:W}=u;if(z===-2&&(k=!1),M!=null&&(Ln(),Rt(M,null,b,u,!0),zn()),W!=null&&(h.renderCache[W]=void 0),H&256){h.ctx.deactivate(u);return}const X=H&1&&I,te=!It(u);let Y;if(te&&(Y=x&&x.onVnodeBeforeUnmount)&&mn(Y,h,u),H&6)Vn(u.component,b,_);else{if(H&128){u.suspense.unmount(b,_);return}X&&qn(u,null,h,"beforeUnmount"),H&64?u.type.remove(u,h,b,xe,_):w&&!w.hasOnce&&(v!==Ve||z>0&&z&64)?Ze(w,h,b,!1,!0):(v===Ve&&z&384||!k&&H&16)&&Ze(C,h,b),_&&kt(u)}(te&&(Y=x&&x.onVnodeUnmounted)||X)&&qe(()=>{Y&&mn(Y,h,u),X&&qn(u,null,h,"unmounted")},b)},kt=u=>{const{type:h,el:b,anchor:_,transition:k}=u;if(h===Ve){Yt(b,_);return}if(h===rs){R(u);return}const v=()=>{s(b),k&&!k.persisted&&k.afterLeave&&k.afterLeave()};if(u.shapeFlag&1&&k&&!k.persisted){const{leave:x,delayLeave:M}=k,C=()=>x(b,v);M?M(u.el,v,C):C()}else v()},Yt=(u,h)=>{let b;for(;u!==h;)b=T(u),s(u),u=b;s(h)},Vn=(u,h,b)=>{const{bum:_,scope:k,job:v,subTree:x,um:M,m:C,a:w}=u;Fr(C),Fr(w),_&&mi(_),k.stop(),v&&(v.flags|=8,Ee(x,u,h,b)),M&&qe(M,h),qe(()=>{u.isUnmounted=!0},h)},Ze=(u,h,b,_=!1,k=!1,v=0)=>{for(let x=v;x<u.length;x++)Ee(u[x],h,b,_,k)},Gn=u=>{if(u.shapeFlag&6)return Gn(u.component.subTree);if(u.shapeFlag&128)return u.suspense.next();const h=T(u.anchor||u.el),b=h&&h[hc];return b?T(b):h};let Be=!1;const ln=(u,h,b)=>{u==null?h._vnode&&Ee(h._vnode,null,null,!0):D(h._vnode||null,u,h,null,null,null,b),h._vnode=u,Be||(Be=!0,Sr(),Vo(),Be=!1)},xe={p:D,um:Ee,m:an,r:kt,mt:be,mc:Z,pc:ue,pbc:$,n:Gn,o:e};return{render:ln,hydrate:void 0,createApp:Ic(ln)}}function ss({type:e,props:n},t){return t==="svg"&&e==="foreignObject"||t==="mathml"&&e==="annotation-xml"&&n&&n.encoding&&n.encoding.includes("html")?void 0:t}function Xn({effect:e,job:n},t){t?(e.flags|=32,n.flags|=4):(e.flags&=-33,n.flags&=-5)}function nu(e,n){return(!e||e&&!e.pendingBranch)&&n&&!n.persisted}function ga(e,n,t=!1){const i=e.children,s=n.children;if(N(i)&&N(s))for(let r=0;r<i.length;r++){const o=i[r];let l=s[r];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=s[r]=Hn(s[r]),l.el=o.el),!t&&l.patchFlag!==-2&&ga(o,l)),l.type===Bi&&l.patchFlag!==-1&&(l.el=o.el),l.type===Oe&&!l.el&&(l.el=o.el)}}function tu(e){const n=e.slice(),t=[0];let i,s,r,o,l;const c=e.length;for(i=0;i<c;i++){const m=e[i];if(m!==0){if(s=t[t.length-1],e[s]<m){n[i]=s,t.push(i);continue}for(r=0,o=t.length-1;r<o;)l=r+o>>1,e[t[l]]<m?r=l+1:o=l;m<e[t[r]]&&(r>0&&(n[i]=t[r-1]),t[r]=i)}}for(r=t.length,o=t[r-1];r-- >0;)t[r]=o,o=n[o];return t}function ba(e){const n=e.subTree.component;if(n)return n.asyncDep&&!n.asyncResolved?n:ba(n)}function Fr(e){if(e)for(let n=0;n<e.length;n++)e[n].flags|=8}const va=e=>e.__isSuspense;function iu(e,n){n&&n.pendingBranch?N(e)?n.effects.push(...e):n.effects.push(e):fc(e)}const Ve=Symbol.for("v-fgt"),Bi=Symbol.for("v-txt"),Oe=Symbol.for("v-cmt"),rs=Symbol.for("v-stc"),Nt=[];let Ye=null;function le(e=!1){Nt.push(Ye=e?null:[])}function su(){Nt.pop(),Ye=Nt[Nt.length-1]||null}let Kt=1;function Ci(e,n=!1){Kt+=e,e<0&&Ye&&n&&(Ye.hasOnce=!0)}function ya(e){return e.dynamicChildren=Kt>0?Ye||ft:null,su(),Kt>0&&Ye&&Ye.push(e),e}function de(e,n,t,i,s,r){return ya(E(e,n,t,i,s,r,!0))}function ru(e,n,t,i,s){return ya(Fe(e,n,t,i,s,!0))}function Ei(e){return e?e.__v_isVNode===!0:!1}function et(e,n){return e.type===n.type&&e.key===n.key}const wa=({key:e})=>e??null,gi=({ref:e,ref_key:n,ref_for:t})=>(typeof e=="number"&&(e=""+e),e!=null?ye(e)||Re(e)||G(e)?{i:rn,r:e,k:n,f:!!t}:e:null);function E(e,n=null,t=null,i=0,s=null,r=e===Ve?0:1,o=!1,l=!1){const c={__v_isVNode:!0,__v_skip:!0,type:e,props:n,key:n&&wa(n),ref:n&&gi(n),scopeId:Uo,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:i,dynamicProps:s,dynamicChildren:null,appContext:null,ctx:rn};return l?(Us(c,t),r&128&&e.normalize(c)):t&&(c.shapeFlag|=ye(t)?8:16),Kt>0&&!o&&Ye&&(c.patchFlag>0||r&6)&&c.patchFlag!==32&&Ye.push(c),c}const Fe=ou;function ou(e,n=null,t=null,i=0,s=null,r=!1){if((!e||e===xc)&&(e=Oe),Ei(e)){const l=Kn(e,n,!0);return t&&Us(l,t),Kt>0&&!r&&Ye&&(l.shapeFlag&6?Ye[Ye.indexOf(e)]=l:Ye.push(l)),l.patchFlag=-2,l}if(bu(e)&&(e=e.__vccOpts),n){n=au(n);let{class:l,style:c}=n;l&&!ye(l)&&(n.class=mt(l)),fe(c)&&(Ks(c)&&!N(c)&&(c=Ce({},c)),n.style=Fi(c))}const o=ye(e)?1:va(e)?128:$o(e)?64:fe(e)?4:G(e)?2:0;return E(e,n,t,i,s,o,r,!0)}function au(e){return e?Ks(e)||ua(e)?Ce({},e):e:null}function Kn(e,n,t=!1,i=!1){const{props:s,ref:r,patchFlag:o,children:l,transition:c}=e,m=n?cu(s||{},n):s,f={__v_isVNode:!0,__v_skip:!0,type:e.type,props:m,key:m&&wa(m),ref:n&&n.ref?t&&r?N(r)?r.concat(gi(n)):[r,gi(n)]:gi(n):r,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:l,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:n&&e.type!==Ve?o===-1?16:o|16:o,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:c,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Kn(e.ssContent),ssFallback:e.ssFallback&&Kn(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return c&&i&&Bt(f,c.clone(f)),f}function lu(e=" ",n=0){return Fe(Bi,null,e,n)}function Ke(e="",n=!1){return n?(le(),ru(Oe,null,e)):Fe(Oe,null,e)}function bn(e){return e==null||typeof e=="boolean"?Fe(Oe):N(e)?Fe(Ve,null,e.slice()):Ei(e)?Hn(e):Fe(Bi,null,String(e))}function Hn(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Kn(e)}function Us(e,n){let t=0;const{shapeFlag:i}=e;if(n==null)n=null;else if(N(n))t=16;else if(typeof n=="object")if(i&65){const s=n.default;s&&(s._c&&(s._d=!1),Us(e,s()),s._c&&(s._d=!0));return}else{t=32;const s=n._;!s&&!ua(n)?n._ctx=rn:s===3&&rn&&(rn.slots._===1?n._=1:(n._=2,e.patchFlag|=1024))}else G(n)?(n={default:n,_ctx:rn},t=32):(n=String(n),i&64?(t=16,n=[lu(n)]):t=8);e.children=n,e.shapeFlag|=t}function cu(...e){const n={};for(let t=0;t<e.length;t++){const i=e[t];for(const s in i)if(s==="class")n.class!==i.class&&(n.class=mt([n.class,i.class]));else if(s==="style")n.style=Fi([n.style,i.style]);else if(zi(s)){const r=n[s],o=i[s];o&&r!==o&&!(N(r)&&r.includes(o))&&(n[s]=r?[].concat(r,o):o)}else s!==""&&(n[s]=i[s])}return n}function mn(e,n,t,i=null){dn(e,n,7,[t,i])}const uu=sa();let du=0;function fu(e,n,t){const i=e.type,s=(n?n.appContext:e.appContext)||uu,r={uid:du++,vnode:e,type:i,parent:n,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Rl(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:n?n.provides:Object.create(s.provides),ids:n?n.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:fa(i,s),emitsOptions:aa(i,s),emit:null,emitted:null,propsDefaults:me,inheritAttrs:i.inheritAttrs,ctx:me,data:me,props:me,attrs:me,slots:me,refs:me,setupState:me,setupContext:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=n?n.root:r,r.emit=Bc.bind(null,r),e.ce&&e.ce(r),r}let We=null;const ka=()=>We||rn;let xi,Cs;{const e=Pi(),n=(t,i)=>{let s;return(s=e[t])||(s=e[t]=[]),s.push(i),r=>{s.length>1?s.forEach(o=>o(r)):s[0](r)}};xi=n("__VUE_INSTANCE_SETTERS__",t=>We=t),Cs=n("__VUE_SSR_SETTERS__",t=>jt=t)}const qt=e=>{const n=We;return xi(e),e.scope.on(),()=>{e.scope.off(),xi(n)}},Rr=()=>{We&&We.scope.off(),xi(null)};function _a(e){return e.vnode.shapeFlag&4}let jt=!1;function hu(e,n=!1,t=!1){n&&Cs(n);const{props:i,children:s}=e.vnode,r=_a(e);$c(e,i,r,n),Yc(e,s,t||n);const o=r?mu(e,n):void 0;return n&&Cs(!1),o}function mu(e,n){const t=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,Mc);const{setup:i}=t;if(i){Ln();const s=e.setupContext=i.length>1?gu(e):null,r=qt(e),o=Jt(i,e,0,[e.props,s]),l=vo(o);if(zn(),r(),(l||e.sp)&&!It(e)&&Qo(e),l){if(o.then(Rr,Rr),n)return o.then(c=>{Ir(e,c)}).catch(c=>{Ii(c,e,0)});e.asyncDep=o}else Ir(e,o)}else Sa(e)}function Ir(e,n,t){G(n)?e.type.__ssrInlineRender?e.ssrRender=n:e.render=n:fe(n)&&(e.setupState=Bo(n)),Sa(e)}function Sa(e,n,t){const i=e.type;e.render||(e.render=i.render||vn);{const s=qt(e);Ln();try{Lc(e)}finally{zn(),s()}}}const pu={get(e,n){return Pe(e,"get",""),e[n]}};function gu(e){const n=t=>{e.exposed=t||{}};return{attrs:new Proxy(e.attrs,pu),slots:e.slots,emit:e.emit,expose:n}}function Ki(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(Bo(nc(e.exposed)),{get(n,t){if(t in n)return n[t];if(t in Ht)return Ht[t](e)},has(n,t){return t in n||t in Ht}})):e.proxy}function bu(e){return G(e)&&"__vccOpts"in e}const V=(e,n)=>ac(e,n,jt);function vu(e,n,t){try{Ci(-1);const i=arguments.length;return i===2?fe(n)&&!N(n)?Ei(n)?Fe(e,null,[n]):Fe(e,n):Fe(e,null,n):(i>3?t=Array.prototype.slice.call(arguments,2):i===3&&Ei(t)&&(t=[t]),Fe(e,n,t))}finally{Ci(1)}}const yu="3.5.25";let Es;const Hr=typeof window<"u"&&window.trustedTypes;if(Hr)try{Es=Hr.createPolicy("vue",{createHTML:e=>e})}catch{}const Ta=Es?e=>Es.createHTML(e):e=>e,wu="http://www.w3.org/2000/svg",ku="http://www.w3.org/1998/Math/MathML",Cn=typeof document<"u"?document:null,Nr=Cn&&Cn.createElement("template"),_u={insert:(e,n,t)=>{n.insertBefore(e,t||null)},remove:e=>{const n=e.parentNode;n&&n.removeChild(e)},createElement:(e,n,t,i)=>{const s=n==="svg"?Cn.createElementNS(wu,e):n==="mathml"?Cn.createElementNS(ku,e):t?Cn.createElement(e,{is:t}):Cn.createElement(e);return e==="select"&&i&&i.multiple!=null&&s.setAttribute("multiple",i.multiple),s},createText:e=>Cn.createTextNode(e),createComment:e=>Cn.createComment(e),setText:(e,n)=>{e.nodeValue=n},setElementText:(e,n)=>{e.textContent=n},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Cn.querySelector(e),setScopeId(e,n){e.setAttribute(n,"")},insertStaticContent(e,n,t,i,s,r){const o=t?t.previousSibling:n.lastChild;if(s&&(s===r||s.nextSibling))for(;n.insertBefore(s.cloneNode(!0),t),!(s===r||!(s=s.nextSibling)););else{Nr.innerHTML=Ta(i==="svg"?`<svg>${e}</svg>`:i==="mathml"?`<math>${e}</math>`:e);const l=Nr.content;if(i==="svg"||i==="mathml"){const c=l.firstChild;for(;c.firstChild;)l.appendChild(c.firstChild);l.removeChild(c)}n.insertBefore(l,t)}return[o?o.nextSibling:n.firstChild,t?t.previousSibling:n.lastChild]}},Fn="transition",Mt="animation",Vt=Symbol("_vtc"),Ca={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},Su=Ce({},Jo,Ca),Tu=e=>(e.displayName="Transition",e.props=Su,e),Dr=Tu((e,{slots:n})=>vu(gc,Cu(e),n)),Yn=(e,n=[])=>{N(e)?e.forEach(t=>t(...n)):e&&e(...n)},Or=e=>e?N(e)?e.some(n=>n.length>1):e.length>1:!1;function Cu(e){const n={};for(const L in e)L in Ca||(n[L]=e[L]);if(e.css===!1)return n;const{name:t="v",type:i,duration:s,enterFromClass:r=`${t}-enter-from`,enterActiveClass:o=`${t}-enter-active`,enterToClass:l=`${t}-enter-to`,appearFromClass:c=r,appearActiveClass:m=o,appearToClass:f=l,leaveFromClass:g=`${t}-leave-from`,leaveActiveClass:T=`${t}-leave-active`,leaveToClass:S=`${t}-leave-to`}=e,A=Eu(s),D=A&&A[0],re=A&&A[1],{onBeforeEnter:B,onEnter:P,onEnterCancelled:U,onLeave:R,onLeaveCancelled:Q,onBeforeAppear:ge=B,onAppear:K=P,onAppearCancelled:Z=U}=n,O=(L,ne,be,oe)=>{L._enterCancelled=oe,Zn(L,ne?f:l),Zn(L,ne?m:o),be&&be()},$=(L,ne)=>{L._isLeaving=!1,Zn(L,g),Zn(L,S),Zn(L,T),ne&&ne()},q=L=>(ne,be)=>{const oe=L?K:P,ce=()=>O(ne,L,be);Yn(oe,[ne,ce]),Wr(()=>{Zn(ne,L?c:r),Tn(ne,L?f:l),Or(oe)||Br(ne,i,D,ce)})};return Ce(n,{onBeforeEnter(L){Yn(B,[L]),Tn(L,r),Tn(L,o)},onBeforeAppear(L){Yn(ge,[L]),Tn(L,c),Tn(L,m)},onEnter:q(!1),onAppear:q(!0),onLeave(L,ne){L._isLeaving=!0;const be=()=>$(L,ne);Tn(L,g),L._enterCancelled?(Tn(L,T),Vr(L)):(Vr(L),Tn(L,T)),Wr(()=>{L._isLeaving&&(Zn(L,g),Tn(L,S),Or(R)||Br(L,i,re,be))}),Yn(R,[L,be])},onEnterCancelled(L){O(L,!1,void 0,!0),Yn(U,[L])},onAppearCancelled(L){O(L,!0,void 0,!0),Yn(Z,[L])},onLeaveCancelled(L){$(L),Yn(Q,[L])}})}function Eu(e){if(e==null)return null;if(fe(e))return[os(e.enter),os(e.leave)];{const n=os(e);return[n,n]}}function os(e){return El(e)}function Tn(e,n){n.split(/\s+/).forEach(t=>t&&e.classList.add(t)),(e[Vt]||(e[Vt]=new Set)).add(n)}function Zn(e,n){n.split(/\s+/).forEach(i=>i&&e.classList.remove(i));const t=e[Vt];t&&(t.delete(n),t.size||(e[Vt]=void 0))}function Wr(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let xu=0;function Br(e,n,t,i){const s=e._endId=++xu,r=()=>{s===e._endId&&i()};if(t!=null)return setTimeout(r,t);const{type:o,timeout:l,propCount:c}=Mu(e,n);if(!o)return i();const m=o+"end";let f=0;const g=()=>{e.removeEventListener(m,T),r()},T=S=>{S.target===e&&++f>=c&&g()};setTimeout(()=>{f<c&&g()},l+1),e.addEventListener(m,T)}function Mu(e,n){const t=window.getComputedStyle(e),i=A=>(t[A]||"").split(", "),s=i(`${Fn}Delay`),r=i(`${Fn}Duration`),o=Kr(s,r),l=i(`${Mt}Delay`),c=i(`${Mt}Duration`),m=Kr(l,c);let f=null,g=0,T=0;n===Fn?o>0&&(f=Fn,g=o,T=r.length):n===Mt?m>0&&(f=Mt,g=m,T=c.length):(g=Math.max(o,m),f=g>0?o>m?Fn:Mt:null,T=f?f===Fn?r.length:c.length:0);const S=f===Fn&&/\b(?:transform|all)(?:,|$)/.test(i(`${Fn}Property`).toString());return{type:f,timeout:g,propCount:T,hasTransform:S}}function Kr(e,n){for(;e.length<n.length;)e=e.concat(e);return Math.max(...n.map((t,i)=>jr(t)+jr(e[i])))}function jr(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function Vr(e){return(e?e.ownerDocument:document).body.offsetHeight}function Lu(e,n,t){const i=e[Vt];i&&(n=(n?[n,...i]:[...i]).join(" ")),n==null?e.removeAttribute("class"):t?e.setAttribute("class",n):e.className=n}const Gr=Symbol("_vod"),zu=Symbol("_vsh"),Au=Symbol(""),Pu=/(?:^|;)\s*display\s*:/;function Fu(e,n,t){const i=e.style,s=ye(t);let r=!1;if(t&&!s){if(n)if(ye(n))for(const o of n.split(";")){const l=o.slice(0,o.indexOf(":")).trim();t[l]==null&&bi(i,l,"")}else for(const o in n)t[o]==null&&bi(i,o,"");for(const o in t)o==="display"&&(r=!0),bi(i,o,t[o])}else if(s){if(n!==t){const o=i[Au];o&&(t+=";"+o),i.cssText=t,r=Pu.test(t)}}else n&&e.removeAttribute("style");Gr in e&&(e[Gr]=r?i.display:"",e[zu]&&(i.display="none"))}const Ur=/\s*!important$/;function bi(e,n,t){if(N(t))t.forEach(i=>bi(e,n,i));else if(t==null&&(t=""),n.startsWith("--"))e.setProperty(n,t);else{const i=Ru(e,n);Ur.test(t)?e.setProperty(rt(i),t.replace(Ur,""),"important"):e[i]=t}}const $r=["Webkit","Moz","ms"],as={};function Ru(e,n){const t=as[n];if(t)return t;let i=Bn(n);if(i!=="filter"&&i in e)return as[n]=i;i=ko(i);for(let s=0;s<$r.length;s++){const r=$r[s]+i;if(r in e)return as[n]=r}return n}const Jr="http://www.w3.org/1999/xlink";function qr(e,n,t,i,s,r=Pl(n)){i&&n.startsWith("xlink:")?t==null?e.removeAttributeNS(Jr,n.slice(6,n.length)):e.setAttributeNS(Jr,n,t):t==null||r&&!To(t)?e.removeAttribute(n):e.setAttribute(n,r?"":yn(t)?String(t):t)}function Xr(e,n,t,i,s){if(n==="innerHTML"||n==="textContent"){t!=null&&(e[n]=n==="innerHTML"?Ta(t):t);return}const r=e.tagName;if(n==="value"&&r!=="PROGRESS"&&!r.includes("-")){const l=r==="OPTION"?e.getAttribute("value")||"":e.value,c=t==null?e.type==="checkbox"?"on":"":String(t);(l!==c||!("_value"in e))&&(e.value=c),t==null&&e.removeAttribute(n),e._value=t;return}let o=!1;if(t===""||t==null){const l=typeof e[n];l==="boolean"?t=To(t):t==null&&l==="string"?(t="",o=!0):l==="number"&&(t=0,o=!0)}try{e[n]=t}catch{}o&&e.removeAttribute(s||n)}function $s(e,n,t,i){e.addEventListener(n,t,i)}function Iu(e,n,t,i){e.removeEventListener(n,t,i)}const Yr=Symbol("_vei");function Hu(e,n,t,i,s=null){const r=e[Yr]||(e[Yr]={}),o=r[n];if(i&&o)o.value=i;else{const[l,c]=Nu(n);if(i){const m=r[n]=Wu(i,s);$s(e,l,m,c)}else o&&(Iu(e,l,o,c),r[n]=void 0)}}const Zr=/(?:Once|Passive|Capture)$/;function Nu(e){let n;if(Zr.test(e)){n={};let i;for(;i=e.match(Zr);)e=e.slice(0,e.length-i[0].length),n[i[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):rt(e.slice(2)),n]}let ls=0;const Du=Promise.resolve(),Ou=()=>ls||(Du.then(()=>ls=0),ls=Date.now());function Wu(e,n){const t=i=>{if(!i._vts)i._vts=Date.now();else if(i._vts<=t.attached)return;dn(Bu(i,t.value),n,5,[i])};return t.value=e,t.attached=Ou(),t}function Bu(e,n){if(N(n)){const t=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{t.call(e),e._stopped=!0},n.map(i=>s=>!s._stopped&&i&&i(s))}else return n}const Qr=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,Ku=(e,n,t,i,s,r)=>{const o=s==="svg";n==="class"?Lu(e,i,o):n==="style"?Fu(e,t,i):zi(n)?Ps(n)||Hu(e,n,t,i,r):(n[0]==="."?(n=n.slice(1),!0):n[0]==="^"?(n=n.slice(1),!1):ju(e,n,i,o))?(Xr(e,n,i),!e.tagName.includes("-")&&(n==="value"||n==="checked"||n==="selected")&&qr(e,n,i,o,r,n!=="value")):e._isVueCE&&(/[A-Z]/.test(n)||!ye(i))?Xr(e,Bn(n),i,r,n):(n==="true-value"?e._trueValue=i:n==="false-value"&&(e._falseValue=i),qr(e,n,i,o))};function ju(e,n,t,i){if(i)return!!(n==="innerHTML"||n==="textContent"||n in e&&Qr(n)&&G(t));if(n==="spellcheck"||n==="draggable"||n==="translate"||n==="autocorrect"||n==="sandbox"&&e.tagName==="IFRAME"||n==="form"||n==="list"&&e.tagName==="INPUT"||n==="type"&&e.tagName==="TEXTAREA")return!1;if(n==="width"||n==="height"){const s=e.tagName;if(s==="IMG"||s==="VIDEO"||s==="CANVAS"||s==="SOURCE")return!1}return Qr(n)&&ye(t)?!1:n in e}const Mi=e=>{const n=e.props["onUpdate:modelValue"]||!1;return N(n)?t=>mi(n,t):n},vt=Symbol("_assign"),eo={deep:!0,created(e,n,t){e[vt]=Mi(t),$s(e,"change",()=>{const i=e._modelValue,s=Gt(e),r=e.checked,o=e[vt];if(N(i)){const l=Is(i,s),c=l!==-1;if(r&&!c)o(i.concat(s));else if(!r&&c){const m=[...i];m.splice(l,1),o(m)}}else if(wt(i)){const l=new Set(i);r?l.add(s):l.delete(s),o(l)}else o(Ea(e,r))})},mounted:no,beforeUpdate(e,n,t){e[vt]=Mi(t),no(e,n,t)}};function no(e,{value:n,oldValue:t},i){e._modelValue=n;let s;if(N(n))s=Is(n,i.props.value)>-1;else if(wt(n))s=n.has(i.props.value);else{if(n===t)return;s=$t(n,Ea(e,!0))}e.checked!==s&&(e.checked=s)}const Vu={deep:!0,created(e,{value:n,modifiers:{number:t}},i){const s=wt(n);$s(e,"change",()=>{const r=Array.prototype.filter.call(e.options,o=>o.selected).map(o=>t?So(Gt(o)):Gt(o));e[vt](e.multiple?s?new Set(r):r:r[0]),e._assigning=!0,Je(()=>{e._assigning=!1})}),e[vt]=Mi(i)},mounted(e,{value:n}){to(e,n)},beforeUpdate(e,n,t){e[vt]=Mi(t)},updated(e,{value:n}){e._assigning||to(e,n)}};function to(e,n){const t=e.multiple,i=N(n);if(!(t&&!i&&!wt(n))){for(let s=0,r=e.options.length;s<r;s++){const o=e.options[s],l=Gt(o);if(t)if(i){const c=typeof l;c==="string"||c==="number"?o.selected=n.some(m=>String(m)===String(l)):o.selected=Is(n,l)>-1}else o.selected=n.has(l);else if($t(Gt(o),n)){e.selectedIndex!==s&&(e.selectedIndex=s);return}}!t&&e.selectedIndex!==-1&&(e.selectedIndex=-1)}}function Gt(e){return"_value"in e?e._value:e.value}function Ea(e,n){const t=n?"_trueValue":"_falseValue";return t in e?e[t]:n}const Gu=["ctrl","shift","alt","meta"],Uu={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,n)=>Gu.some(t=>e[`${t}Key`]&&!n.includes(t))},$u=(e,n)=>{const t=e._withMods||(e._withMods={}),i=n.join(".");return t[i]||(t[i]=((s,...r)=>{for(let o=0;o<n.length;o++){const l=Uu[n[o]];if(l&&l(s,n))return}return e(s,...r)}))},Ju=Ce({patchProp:Ku},_u);let io;function qu(){return io||(io=Qc(Ju))}const Xu=((...e)=>{const n=qu().createApp(...e),{mount:t}=n;return n.mount=i=>{const s=Zu(i);if(!s)return;const r=n._component;!G(r)&&!r.render&&!r.template&&(r.template=s.innerHTML),s.nodeType===1&&(s.textContent="");const o=t(s,!1,Yu(s));return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),o},n});function Yu(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function Zu(e){return ye(e)?document.querySelector(e):e}const Qu="/favicon.png",ed="/images/about_music_logo.png",nd="/images/dk3-min.jpg",td="/images/share-icon.png",id="/images/powered_by_black-4339b4c3c9cf88da9bfb15a16c4f6914.png",st=[{name:"Antonio Vivaldi",birth:1678,death:1741},{name:"Johann Sebastian Bach",birth:1685,death:1750},{name:"Domenico Scarlatti",birth:1685,death:1757},{name:"George Frideric Handel",birth:1685,death:1759},{name:"Joseph Haydn",birth:1732,death:1809},{name:"Wolfgang Amadeus Mozart",birth:1756,death:1791},{name:"Ludwig van Beethoven",birth:1770,death:1827},{name:"Niccolò Paganini",birth:1782,death:1840},{name:"Franz Schubert",birth:1797,death:1828},{name:"Hector Berlioz",birth:1803,death:1869},{name:"Mikhail Glinka",birth:1804,death:1857},{name:"Felix Mendelssohn",birth:1809,death:1847},{name:"Frédéric Chopin",birth:1810,death:1849},{name:"Robert Schumann",birth:1810,death:1856},{name:"Franz Liszt",birth:1811,death:1886},{name:"Giuseppe Verdi",birth:1813,death:1901},{name:"Johann Strauss II",birth:1825,death:1899},{name:"Johannes Brahms",birth:1833,death:1897},{name:"Alexander Borodin",birth:1833,death:1887},{name:"Camille Saint-Saëns",birth:1835,death:1921},{name:"Jacques Offenbach",birth:1819,death:1880},{name:"Georges Bizet",birth:1838,death:1875},{name:"Modest Mussorgsky",birth:1839,death:1881},{name:"Pyotr Ilyich Tchaikovsky",birth:1840,death:1893},{name:"Antonín Dvořák",birth:1841,death:1904},{name:"Edvard Grieg",birth:1843,death:1907},{name:"Nikolai Rimsky-Korsakov",birth:1844,death:1908},{name:"Giacomo Puccini",birth:1858,death:1924},{name:"Gustav Mahler",birth:1860,death:1911},{name:"Claude Debussy",birth:1862,death:1918},{name:"Erik Satie",birth:1866,death:1925},{name:"Alexander Scriabin",birth:1872,death:1915},{name:"Sergei Rachmaninoff",birth:1873,death:1943},{name:"Maurice Ravel",birth:1875,death:1937},{name:"Sergei Prokofiev",birth:1891,death:1953},{name:"Dmitri Shostakovich",birth:1906,death:1975}],sd={"Richard Wagner":"comp/wagner.jpg","Igor Stravinsky":"comp/stravinsky.jpg","Antonio Vivaldi":"comp/vivaldi.jpg","Johann Sebastian Bach":"comp/bach.png","Domenico Scarlatti":"comp/scarlatti.jpg","George Frideric Handel":"comp/handel.jpg","Joseph Haydn":"comp/haydn.jpg","Wolfgang Amadeus Mozart":"comp/mozart.jpg","Ludwig van Beethoven":"comp/beethoven.jpg","Niccolò Paganini":"comp/paganini.jpeg","Franz Schubert":"comp/schubert.jpg","Hector Berlioz":"comp/berlioz.jpg","Mikhail Glinka":"comp/glinka.jpg","Felix Mendelssohn":"comp/mendelssohn.jpg","Frédéric Chopin":"comp/chopin.jpeg","Robert Schumann":"comp/schumann.jpg","Franz Liszt":"comp/liszt.jpg","Giuseppe Verdi":"comp/verdi.jpg","Johann Strauss II":"comp/strauss.jpg","Johannes Brahms":"comp/brahms.jpg","Alexander Borodin":"comp/borodin.jpg","Camille Saint-Saëns":"comp/saint-saens.jpg","Jacques Offenbach":"comp/offenbach.jpg","Georges Bizet":"comp/bizet.jpg","Modest Mussorgsky":"comp/musorgskiy.jpg","Pyotr Ilyich Tchaikovsky":"comp/tchaikovsky.jpg","Antonín Dvořák":"comp/dvorak.jpg","Edvard Grieg":"comp/grieg.jpg","Nikolai Rimsky-Korsakov":"comp/rimsky-korsakov.jpg","Gustav Mahler":"comp/mahler.jpg","Claude Debussy":"comp/debussy.jpg","Erik Satie":"comp/satie.jpg","Alexander Scriabin":"comp/scriabin.jpg","Sergei Rachmaninoff":"comp/rachmaninoff.jpg","Maurice Ravel":"comp/ravel.jpg","Béla Bartók":"comp/bartok.jpg","Sergei Prokofiev":"comp/prokofiev.jpg","Dmitri Shostakovich":"comp/shostakovich.jpg","Carl Maria von Weber":"comp/weber.jpg","Giacomo Puccini":"comp/puccini.jpg","Jean Sibelius":"comp/sibelius.jpg","Christoph Willibald Gluck":"comp/gluck.jpg","Gioachino Rossini":"comp/rossini.jpg","Jean-Philippe Rameau":"comp/rameau.jpg"};function xa(e){const n=sd[e];return n?n.startsWith("/")?n:`/${n}`:null}function rd(e){const n=String(e||"").trim().split(/\s+/).filter(Boolean);if(n.length<=1)return e;const t=n[n.length-1];return/^(?:[IVX]+|\d+|Jr\.?|Sr\.?)$/i.test(t)&&n.length>=2?n[n.length-2]+" "+t:t}function od(e){const n=String(e||"").trim().split(/\s+/).filter(Boolean);if(n.length<=1)return e;const t=n[n.length-1],s=/^(?:[IVX]+|\d+|Jr\.?|Sr\.?)$/i.test(t)&&n.length>=2?2:1,r=n.slice(n.length-s),l=n.slice(0,n.length-s).map(m=>m.trim()).filter(Boolean).map(m=>m[0]?m[0].toUpperCase()+".":"").filter(Boolean).join(" "),c=r.join(" ");return l?`${l} ${c}`:c}const Xt=[{id:"baroque",label:"Baroque",from:1600,to:1750},{id:"classical",label:"Classical",from:1750,to:1820},{id:"romantic",label:"Romantic",from:1820,to:1900},{id:"twentieth",label:"20th Century",from:1900,to:2e3}];let xs=Xt.reduce((e,n)=>(e[n.id]=n.label,e),{});const so=Math.min(...st.map(e=>e.birth)),ad=Math.max(...st.map(e=>e.birth));let Ms=[...st],Nn=null,Dn=null;const ld={r:255,g:255,b:255},cd={r:37,g:99,b:235};zt("#f3f4f6"),ao(1750),zt("#e6eef8"),ao(1820),zt("#e8f4ff"),zt("#eef2f7");const Li=1677.5,vi=1980,Ma=vi-Li,ud=6,dd=2,fd=0,yi={barHeight:50,widthScale:1,fontScale:1},ct={barHeight:{min:25,max:150},widthScale:{min:.05,max:2},fontScale:{min:.9,max:1.8}};let On={...yi};function cs(e,n,t){return Number.isNaN(e)?n:Math.min(t,Math.max(n,e))}function ro(e={}){On={barHeight:cs(e.barHeight??On.barHeight??yi.barHeight,ct.barHeight.min,ct.barHeight.max),widthScale:cs(e.widthScale??On.widthScale??yi.widthScale,ct.widthScale.min,ct.widthScale.max),fontScale:cs(e.fontScale??On.fontScale??yi.fontScale,ct.fontScale.min,ct.fontScale.max)}}function hd(){return ud*On.widthScale}function ci(){const e=document.querySelector(".timeline-inner"),n=document.getElementById("timeline");if(!e||!n)return;const t=Ma*hd()+fd,i=(n.clientWidth||window.innerWidth)*dd*On.widthScale,s=Math.max(t,i);e.style.width=s+"px",e.style.minWidth=s+"px"}function nt(e){return(e-Li)/Ma*100}function La(e){return Number.isNaN(e)?0:Math.min(1,Math.max(0,e))}function zt(e){const n=e.replace("#",""),t=n.length===3?n.split("").map(s=>s+s).join(""):n,i=parseInt(t,16);return{r:i>>16&255,g:i>>8&255,b:i&255}}function us({r:e,g:n,b:t}){const i=s=>Math.round(s).toString(16).padStart(2,"0");return`#${i(e)}${i(n)}${i(t)}`}function oo(e,n,t){const i=La(t);return{r:e.r+(n.r-e.r)*i,g:e.g+(n.g-e.g)*i,b:e.b+(n.b-e.b)*i}}function ao(e){const n=ad-so;return n<=0?0:La((e-so)/n)}const md={baroque:"#f3f4f6",classical:"#eef5ff",romantic:"#e3f0ff",twentieth:"#dfdfdf"};function Js(e){return md[e]||"#f3f4f6"}function pd(e){return e?xs[e]||Xt.find(n=>n.id===e)?.label||e:""}function lo(e={}){!e||typeof e!="object"||(xs={...xs,...e})}function gd(e){const n=Xt.find(t=>e>=t.from&&e<t.to);return n?n.id:null}function bd(e,n){const t=Number(e),i=Number(n),s=gd(t);if(!Number.isFinite(t)||!Number.isFinite(i)||i<=t)return s;const r=i-t;let o=null,l=0;return Xt.forEach(c=>{const m=Math.max(0,Math.min(i,c.to)-Math.max(t,c.from));m>l&&(l=m,o=c.id)}),o&&l>r/2?o:s}function vd(e){const n=Js(e),t=zt(n),i=oo(t,ld,.12),s=oo(t,cd,.04);return`linear-gradient(145deg, ${us(i)} 0%, ${us(t)} 58%, ${us(s)} 100%)`}function co(e){Array.isArray(e)?Ms=[...e]:Ms=[...st]}function qs(){const e=document.getElementById("gantt");if(!e)return;const n=i=>Number.isInteger(Nn)&&i===Nn,t=i=>Number.isInteger(Dn)&&i===Dn;e.querySelectorAll(".bar").forEach(i=>{const s=Number(i.getAttribute("data-lane-index"));i.classList.toggle("bar--selected",n(s)),i.classList.toggle("bar--hovered",t(s))}),e.querySelectorAll(".bar-connector").forEach(i=>{const s=Number(i.getAttribute("data-lane-index")),r=n(s),o=t(s);i.classList.toggle("bar-connector--selected",r),i.classList.toggle("bar-connector--hover",o)})}function za(e){Number.isInteger(e)?Nn=e:Nn=null,qs()}function Ls(e){Number.isInteger(e)?Dn=e:Dn=null,qs()}function uo(){const e=document.getElementById("axis");if(!e)return;e.innerHTML="";const n=Math.ceil(Li/10)*10,t=Math.ceil(vi/10)*10;Xt.forEach(i=>{const s=Math.max(i.from,Li),r=Math.min(i.to,vi);if(r<=s)return;const o=document.createElement("div");o.className="era-band",o.style.left=nt(s)+"%",o.style.width=nt(r)-nt(s)+"%",o.style.backgroundImage="none",o.style.backgroundColor=Js(i.id),o.textContent=pd(i.id)||i.label,i.id==="baroque"&&(o.style.justifyContent="flex-end",o.style.paddingLeft="6px",o.style.paddingRight="26px",o.style.textAlign="right"),r===vi&&(o.style.borderRight="none"),e.appendChild(o)});for(let i=n;i<=t;i+=10){const s=document.createElement("div"),r=i%50===0;s.className="axis-tick "+(r?"major":"minor"),s.style.left=nt(i)+"%",e.appendChild(s);const o=document.createElement("div");o.className="axis-label "+(r?"axis-label-major":"axis-label-minor"),o.style.left=nt(i)+"%",o.textContent=i,e.appendChild(o)}}function ds(){const e=document.getElementById("gantt"),n=document.getElementById("axis"),t=document.getElementById("timeline");if(!e)return;e.innerHTML="";const i=parseFloat(window.getComputedStyle(e).marginTop||"0")||0,s=document.createDocumentFragment(),r=Ms||[];e&&e.clientWidth||n&&n.clientWidth||t&&t.clientWidth||window.innerWidth;const o=[...r].sort((S,A)=>S.birth-A.birth),l=o.length,c=o.map((S,A)=>({composer:S,laneIndex:A}));Number.isInteger(Nn)&&(Nn<0||Nn>=l)&&(Nn=null),Number.isInteger(Dn)&&(Dn<0||Dn>=l)&&(Dn=null);const m=2,f=On.barHeight,g=f+m,T=l*f+Math.max(0,l-1)*m;e.style.height=T+"px",l&&(c.forEach(({composer:S,laneIndex:A})=>{const D=S.displayName||S.name,re=nt(S.birth),B=nt(S.death),P=document.createElement("div");P.className="bar",P.setAttribute("data-lane-index",A),P.setAttribute("data-name",S.name);const U=bd(S.birth,S.death);P.style.backgroundImage=vd(U),P.style.backgroundColor=Js(U);const R=re,Q=B-re,K=A*g+f*.5+i,Z=(oe,ce)=>{const j=document.createElement("div");j.className="bar-connector",j.setAttribute("data-lane-index",A),j.setAttribute("data-side",ce),j.style.left=oe+"%",j.style.top=-i+"px",j.style.height=K+"px",s.appendChild(j)};Z(R,"start"),Z(R+Q,"end"),P.style.left=R+"%",P.style.width=Q+"%",P.style.top=A*g+"px",P.style.height=f+"px",P.style.lineHeight=f+"px",P.style.fontSize=f*.25*On.fontScale+"px";const O=xa(S.name);let $=0;if(O){const oe=document.createElement("img");oe.className="bar-avatar",$=Math.max(10,Math.round(f*1.1)),oe.style.width=$+"px",oe.style.height=$+"px",oe.src=O,oe.alt=D||S.name,P.appendChild(oe)}const q=document.createElement("span");q.className="bar-label",q.textContent=D,P.appendChild(q);const L=document.createElement("span");L.className="bar-dates",L.textContent=`${S.birth} – ${S.death}`,P.appendChild(L),e.appendChild(P),q.scrollWidth>q.clientWidth&&(q.textContent=od(D),q.scrollWidth>q.clientWidth&&(q.textContent=rd(D)));const ne=()=>{const j=P.clientWidth-12-($?$+6:0)-6;if(j<=0){L.style.display="none";return}q.scrollWidth+L.scrollWidth+6>j&&(L.style.display="none")};(()=>{P.clientWidth>0?ne():typeof window<"u"&&window.requestAnimationFrame(ne)})(),P.addEventListener("click",oe=>{oe.stopPropagation(),za(A),window.dispatchEvent(new CustomEvent("composer-select",{detail:{composer:S,laneIndex:A}}))}),P.addEventListener("mouseenter",()=>Ls(A)),P.addEventListener("mouseleave",()=>Ls(null))}),e.appendChild(s),qs())}function yd(){const e=document.getElementById("timeline");if(!e)return;let n=!1,t=!1;const i=4;let s=0,r=0,o=0,l=0,c=0,m=0,f=null;const g=()=>{e.dispatchEvent(new CustomEvent("timeline-pan-end"))},T=()=>{t||(t=!0,e.classList.add("panning"),e.dataset.panning="true")},S=()=>{t&&(t=!1,e.classList.remove("panning"),e.dataset.panning="false",g())};function A(){if(f=null,!n||!t)return;const K=c-s,Z=m-r;e.scrollLeft=o-K,e.scrollTop=l-Z}const D=K=>{K.button===0&&(n=!0,t=!1,e.classList.remove("panning"),s=K.clientX,r=K.clientY,c=K.clientX,m=K.clientY,o=e.scrollLeft,l=e.scrollTop,e.scrollTo&&e.scrollTo({left:e.scrollLeft,top:e.scrollTop,behavior:"auto"}),K.preventDefault())},re=K=>{if(n){if(c=K.clientX,m=K.clientY,!t){const Z=Math.abs(c-s),O=Math.abs(m-r);if(Z>i||O>i)T();else return}f===null&&(f=window.requestAnimationFrame(A)),K.preventDefault()}},B=()=>{n&&(n=!1,S(),f!==null&&(cancelAnimationFrame(f),f=null))};e.addEventListener("mousedown",D),window.addEventListener("mousemove",re),window.addEventListener("mouseup",B);let P=null,U=!1;const R=K=>{if(P!==null||K.touches.length!==1)return;const Z=K.touches[0];P=Z.identifier,U=!1,s=Z.clientX,r=Z.clientY,c=Z.clientX,m=Z.clientY,o=e.scrollLeft,l=e.scrollTop,e.scrollTo&&e.scrollTo({left:e.scrollLeft,top:e.scrollTop,behavior:"auto"}),S()},Q=K=>{if(P===null)return;const Z=Array.from(K.touches).find(ne=>ne.identifier===P);if(!Z)return;const O=Z.clientX-s,$=Z.clientY-r,q=Math.abs(O),L=Math.abs($);if(!U)if(q>i||L>i)U=!0,T();else return;e.scrollLeft=o-O,e.scrollTop=l-$,K.preventDefault()},ge=K=>{P===null||!Array.from(K.changedTouches).some(O=>O.identifier===P)||(P=null,U=!1,S())};e.addEventListener("touchstart",R,{passive:!0}),e.addEventListener("touchmove",Q,{passive:!1}),e.addEventListener("touchend",ge,{passive:!0}),e.addEventListener("touchcancel",ge,{passive:!0})}function wd(){const e=document.getElementById("timeline"),n=document.getElementById("gantt"),t=document.getElementById("axis");if(!e||!n)return()=>{};const i=.5,s=12,r=(m,f,g)=>{const T=m.getBoundingClientRect();return T.bottom>f&&T.top<g},o=()=>e.scrollTop+e.clientHeight>=e.scrollHeight-s,l=()=>{if(o())return;const m=Array.from(n.querySelectorAll(".bar"));if(!m.length)return;const f=e.getBoundingClientRect(),T=(t?.getBoundingClientRect()?.bottom??f.top)+1,S=f.bottom,A=m.find(P=>r(P,T,S));if(!A)return;const D=A.getBoundingClientRect(),re=T,B=D.top-re;Math.abs(B)<=i||zs(e,{left:e.scrollLeft,top:Math.max(0,e.scrollTop+B),behavior:"auto"})},c=()=>{l()};return e.addEventListener("timeline-pan-end",c),()=>{e.removeEventListener("timeline-pan-end",c)}}function zs(e,{left:n=0,top:t=0,behavior:i="smooth"}){const r=window.matchMedia?.("(prefers-reduced-motion: reduce)").matches?"auto":i;if(e.scrollTo){e.scrollTo({left:n,top:t,behavior:r});return}e.scrollLeft=n,e.scrollTop=t}function kd(e={}){ro(e.settings||{});const n=Object.prototype.hasOwnProperty.call(e,"composers")?e.composers:st;co(n),lo(e.eraLabels||{}),ci(),uo(),ds(),yd();const t=wd(),i=()=>ci();window.addEventListener("resize",i);const s=document.getElementById("timeline");s&&(s.style.visibility="visible");function r(){const l=document.getElementById("timeline");l&&zs(l,{left:0,top:0,behavior:"auto"})}function o(){const l=document.getElementById("timeline");l&&zs(l,{left:Math.max(0,l.scrollWidth-l.clientWidth),top:Math.max(0,l.scrollHeight-l.clientHeight),behavior:"auto"})}return{goToStart:r,goToEnd:o,setComposers(l){co(l),ds()},updateSettings(l){ro(l||{}),ci(),ds()},updateEraLabels(l){lo(l||{}),ci(),uo()},setSelectedLane:za,setHoveredLane:Ls,destroy(){window.removeEventListener("resize",i),t()}}}const Aa=(e,n)=>{const t=e.__vccOpts||e;for(const[i,s]of n)t[i]=s;return t},_d={class:"timeline-wrapper"},Sd={__name:"ComposersTimeline",props:{composers:{type:Array,default:()=>[]},settings:{type:Object,default:()=>({})},eraLabels:{type:Object,default:()=>({})}},setup(e){const n=e;let t=null;const i=s=>{const r=s.target?.closest?.(".bar");if(!r)return;const o=r.getAttribute("data-name"),l=Number(r.getAttribute("data-lane-index"));window.dispatchEvent(new CustomEvent("composer-select",{detail:{composer:o?{name:o}:null,laneIndex:Number.isNaN(l)?null:l}}))};return Di(()=>{const s=document.getElementById("timeline");s&&s.addEventListener("click",i),t=kd({composers:n.composers,settings:n.settings,eraLabels:n.eraLabels}),window.timeline=t}),Oi(()=>{const s=document.getElementById("timeline");s&&s.removeEventListener("click",i),t?.destroy?.(),t=null}),Xe(()=>n.composers,s=>{t&&t.setComposers(s)},{deep:!0}),Xe(()=>n.settings,s=>{!t||!t.updateSettings||t.updateSettings(s)},{deep:!0}),Xe(()=>n.eraLabels,s=>{!t||!t.updateEraLabels||t.updateEraLabels(s)},{deep:!0}),(s,r)=>(le(),de("div",_d,[...r[0]||(r[0]=[E("div",{id:"timeline"},[E("div",{class:"timeline-inner"},[E("div",{id:"axis",class:"axis"}),E("div",{id:"gantt"})])],-1)])]))}},Td=Aa(Sd,[["__scopeId","data-v-095e97d5"]]),Cd=`# Composer fact sheets
...
`,Ed={class:"app"},xd={class:"topbar"},Md={class:"language-switcher"},Ld={class:"visually-hidden",for:"language-select"},zd=["aria-label"],Ad=["value"],Pd={class:"menu-nav"},Fd={class:"content"},Rd={key:0},Id={class:"control-stack control-pill",role:"group","aria-label":"Timeline controls"},Hd={class:"filter-dock__header"},Nd=["aria-pressed","aria-label"],Dd={"aria-hidden":"true"},Od={key:0,class:"nav-controls",role:"group","aria-label":"Timeline navigation"},Wd=["disabled"],Bd=["disabled"],Kd={key:1,class:"scale-controls",role:"group","aria-label":"Adjust timeline size"},jd=["disabled"],Vd=["disabled"],Gd=["aria-expanded"],Ud={key:0,id:"filter-panel",class:"filter-panel",role:"dialog","aria-label":"Composer filters"},$d={class:"filter-panel__options"},Jd=["onUpdate:modelValue","aria-label"],qd={class:"filter-panel__label"},Xd={class:"filter-panel__actions"},Yd={key:1,class:"about"},Zd={class:"about__card"},Qd={class:"about__title"},ef={class:"about__text"},nf={class:"about__text"},tf={class:"about__author"},sf={class:"about__author-body"},rf={class:"about__author-label"},of={class:"about__author-name"},af={class:"about__contributors"},lf={class:"about__contributors-title"},cf={class:"about__contributors-list"},uf={class:"about__contributors-name"},df=["href"],ff={key:0,class:"about__contributors-toggle"},hf={class:"about__contributors-toggle-label"},mf={class:"composer-modal__content"},pf={class:"composer-modal__header"},gf={class:"composer-modal__titles"},bf={class:"composer-modal__name"},vf={key:0,class:"composer-modal__dates"},yf={class:"composer-modal__header-actions"},wf=["aria-label"],kf={key:0,class:"composer-modal__share-feedback"},_f={class:"composer-modal__nav composer-modal__nav--header","aria-label":"Composer navigation"},Sf=["disabled"],Tf={class:"composer-modal__position"},Cf=["disabled"],Ef={class:"composer-modal__body"},xf={key:0,class:"composer-modal__hero"},Mf=["src","alt"],Lf={class:"composer-modal__nav composer-modal__nav--mobile","aria-label":"Composer navigation"},zf=["disabled"],Af={class:"composer-modal__position"},Pf=["disabled"],Ff={class:"composer-modal__hero-meta"},Rf={class:"composer-modal__name-small"},If={key:0,class:"composer-modal__dates-small"},Hf={class:"composer-modal__playlist"},Nf={class:"composer-modal__playlist-header"},Df={class:"composer-modal__playlist-title"},Of={key:0,class:"sc-powered",href:"https://soundcloud.com",target:"_blank",rel:"noopener noreferrer","aria-label":"Powered by SoundCloud"},Wf=["data-soundcloud-playlist","data-soundcloud-playlist-alt"],Bf={class:"sc-player__status"},Kf={class:"sc-player__status-text"},jf={key:1,class:"composer-modal__playlist-box composer-modal__playlist-box--empty"},Vf={class:"composer-modal__description"},Gf={key:0,class:"composer-modal__facts-title"},Uf={key:1,class:"composer-modal__facts"},$f={class:"composer-modal__fact-text"},Jf={key:2,class:"composer-modal__muted"},ut="en",fo="timeline-language",ho="timeline-language-user-set",ui="/composer/",di=25,mo=150,fs=.2,po=1.5,qf=.35,hs=1.7,go=.95,Xf=.6,fi=1,pn=12,Yf=320,Zf=.88,Qf=1.12,hi=6,eh={__name:"App",setup(e){const n={en:{label:"En",appTitle:"The Story of Classical Music in Time",languageLabel:"Language",navigation:{composers:"Composers Timeline",about:"About"},modal:{keyWorks:"Key works to know"},share:{button:"Share",copied:"Link copied"},soundcloud:{loading:"Loading tracks from SoundCloud..."},about:{title:"Understand classical music by ear",intro:"Sometimes you hear a familiar melody and know it is classical music. But whose? Bach, Beethoven, or Mozart - it can be hard to tell immediately.",goal:"This site is designed to help you hear the character of each era and each composer, compare their stories and musical voices, and never get lost in the names again.",authorLabel:"Project creator and author",authorName:"Dmitrii Kotikov",contributorsTitle:"Project collaborators",testFeaturesLabel:"Turn on test functions",contributors:[{name:"Timofey Muhortov",url:"https://timofeymuhortov.ru",linkText:"timofeymuhortov.ru"},{name:"Olga Matveeva",url:"https://facebook.com/olga.shibanova",linkText:"facebook.com/olga.shibanova"}]},eras:{baroque:"Baroque",classical:"Classical",romantic:"Romantic",twentieth:"20th Century"},composers:{},filter:{groups:{essentials:"Essential Icons",core:"Core Classics",expanded:"Extended Classics"},apply:"Apply",minimizeControls:"Hide timeline controls",restoreControls:"Show timeline controls"}},de:{label:"De",appTitle:"Die Geschichte der klassischen Musik",languageLabel:"Sprache",navigation:{composers:"Zeitstrahl der Komponisten",about:"Über das Projekt"},modal:{keyWorks:"Wichtige Werke zum Kennenlernen"},share:{button:"Teilen",copied:"Link kopiert"},soundcloud:{loading:"Tracks von SoundCloud werden geladen..."},about:{title:"Klassische Musik mit dem Ohr verstehen",intro:"Manchmal hört man eine vertraute Melodie und weiß: Das ist klassische Musik. Aber von wem? Bach, Beethoven oder Mozart – das erkennt man nicht immer sofort.",goal:"Diese Seite soll helfen, den Charakter jeder Epoche und jedes Komponisten zu hören, ihre Geschichten und Klangfarben zu vergleichen und sich in all den Namen nicht mehr zu verlieren.",authorLabel:"Initiator und Autor des Projekts",authorName:"Dmitrii Kotikov",contributorsTitle:"Projektpartner",contributors:[{name:"Timofey Muhortov",url:"https://timofeymuhortov.ru",linkText:"timofeymuhortov.ru"},{name:"Olga Matveeva",url:"https://facebook.com/olga.shibanova",linkText:"facebook.com/olga.shibanova"}]},eras:{baroque:"Barock",classical:"Klassik",romantic:"Romantik",twentieth:"20. Jahrhundert"},composers:{},filter:{groups:{essentials:"Essenzielle Ikonen",core:"Kernklassiker",expanded:"Erweiterte Klassiker"},apply:"Anwenden",minimizeControls:"Steuerungselemente ausblenden",restoreControls:"Steuerungselemente anzeigen"}},ru:{label:"Ru",appTitle:"История классической музыки",languageLabel:"Язык",navigation:{composers:"Таймлайн композиторов",about:"О проекте"},modal:{keyWorks:"Ключевые произведения"},share:{button:"Поделиться",copied:"Ссылка скопирована"},soundcloud:{loading:"Загружаем треки из SoundCloud..."},about:{title:"Понимать классическую музыку на слух",intro:"Иногда слышишь знакомую мелодию и понимаешь: это классическая музыка. Но чья? Баха, Бетховена или Моцарта - сразу не всегда понятно.",goal:"Этот сайт помогает услышать характер каждой эпохи и каждого композитора, сравнивать их истории и музыкальные голоса - и больше не теряться в именах.",authorLabel:"Автор и создатель проекта",authorName:"Дмитрий Котиков",contributorsTitle:"Соавторы проекта",testFeaturesLabel:"Включить тестовые функции",contributors:[{name:"Тимофей Мухортов",url:"https://timofeymuhortov.ru",linkText:"timofeymuhortov.ru"},{name:"Ольга Матвеева",url:"https://facebook.com/olga.shibanova",linkText:"facebook.com/olga.shibanova"}]},eras:{baroque:"Барокко",classical:"Классицизм",romantic:"Романтизм",twentieth:"XX век"},composers:{},filter:{groups:{essentials:"Ключевые фигуры",core:"Основа классики",expanded:"Расширенный канон"},apply:"Применить",minimizeControls:"Скрыть панель управления",restoreControls:"Показать панель управления"}}},t=Object.keys(n),i=ke(!1),s={en:"essentials",de:"- Kurzprofil",ru:"ключевые факты"},r=ke(ut),o=ke(!1),l=V(()=>!o.value),c=V(()=>n[r.value]||n.en),m=V(()=>t.map(a=>({value:a,label:n[a]?.label||a.toUpperCase()}))),f=V(()=>c.value.appTitle),g=V(()=>c.value.languageLabel||"Language"),T=V(()=>c.value.navigation||n.en.navigation),S=V(()=>c.value.about||n.en.about),A=V(()=>S.value.contributors||n.en.about.contributors||[]),D=V(()=>S.value.testFeaturesLabel||n.en.about.testFeaturesLabel||"Test functions"),re=V(()=>c.value.eras||n.en.eras),B=V(()=>c.value.soundcloud||n.en.soundcloud||{}),P=V(()=>B.value.loading||"Loading tracks from SoundCloud..."),U=V(()=>c.value.composers||{}),R=V(()=>{const a=U.value.names||{},d={};return Object.entries(a).forEach(([p,y])=>{d[He(p)]=y}),d}),Q=V(()=>{const a={};return Object.entries(nn||{}).forEach(([d,p])=>{const y=He(d),F=p?.[r.value];if(F){a[y]=F;return}r.value==="en"&&p?.en&&(a[y]=p.en)}),a}),ge=V(()=>({...Q.value,...R.value})),K=V(()=>c.value.filter||n.en.filter),Z=V(()=>({essentials:K.value.groups?.essentials||"Essential Icons",core:K.value.groups?.core||"Core Classics",expanded:K.value.groups?.expanded||"Extended Classics"})),O=V(()=>K.value.apply||"Apply"),$=V(()=>{const a=U.value.descriptions||{},d={};return Object.entries(a).forEach(([p,y])=>{d[He(p)]=y}),d}),q=V(()=>{const a=U.value.factsTitles||{},d={};return Object.entries(a).forEach(([p,y])=>{d[He(p)]=y}),d}),L=V(()=>c.value.modal||n.en.modal),ne=V(()=>c.value.share||n.en.share),be=ke(!1),oe=ke("composers"),ce=[30,40,50,70,100],j="".replace(/\/$/,""),wn="https://soundcloud.com/dmitry-kotikov/sets/",jn="https://soundcloud.com/dmitry-kotikov/sets/antonio-vivaldi",an=new Set;function Ee(a,d,p){return Number.isNaN(a)?d:Math.min(p,Math.max(d,a))}function kt(a){const d=Ee((a-di)/(mo-di),0,1),p=Math.pow(d,qf),y=fs+(po-fs)*p;return Ee(y,fs,po)}function Yt(a){const d=Ee((a-di)/(mo-di),0,1),p=Math.pow(d,Xf),y=hs-(hs-go)*p;return Ee(y,go,hs)}const Vn=[{id:"essentials",label:"Essential Icons",composers:["Johann Sebastian Bach","Wolfgang Amadeus Mozart","Ludwig van Beethoven","Pyotr Ilyich Tchaikovsky","Frédéric Chopin","Antonio Vivaldi","Johannes Brahms","Giuseppe Verdi","Claude Debussy"]},{id:"core",label:"Core Classics",composers:["Joseph Haydn","George Frideric Handel","Franz Schubert","Felix Mendelssohn","Robert Schumann","Franz Liszt","Antonín Dvořák","Edvard Grieg","Maurice Ravel","Giacomo Puccini","Gustav Mahler","Sergei Rachmaninoff","Domenico Scarlatti","Camille Saint-Saëns","Georges Bizet"]},{id:"expanded",label:"Extended Classics",composers:["Niccolò Paganini","Hector Berlioz","Mikhail Glinka","Johann Strauss II","Alexander Borodin","Jacques Offenbach","Modest Mussorgsky","Nikolai Rimsky-Korsakov","Alexander Scriabin","Erik Satie","Sergei Prokofiev","Dmitri Shostakovich"]}],Ze=ke(Vn.reduce((a,d)=>(a[d.id]=!0,a),{})),Gn=V(()=>{const a=c.value.filter||{};return{minimize:a.minimizeControls||"Hide timeline controls",restore:a.restoreControls||"Show timeline controls"}}),Be=ke(!1),ln=ke(null),xe=ke(pn),Me=ke(null);let u=0;const h=ke(!1),b=ke("bottom-left"),_=ke(null),k=V(()=>{const a={left:`${xe.value}px`};return Me.value!=null&&(a.top=`${Me.value}px`),a}),v=pt({active:!1,pointerId:null,startX:0,startY:0,startLeft:0,startTop:0,element:null}),x=pt({active:!1,startDistance:0});function M(a,d){const p=a.clientX-d.clientX,y=a.clientY-d.clientY;return Math.hypot(p,y)}const C=pt({barHeight:ce[fi],widthScale:kt(ce[fi]),fontScale:Yt(ce[fi])}),w=ke(fi),H=V(()=>w.value<=0),z=V(()=>w.value>=ce.length-1),I=ke(!0),W=ke(!1);function X(a){const d=Ee(a,0,ce.length-1);w.value=d;const p=ce[d];C.barHeight=p,C.widthScale=kt(p),C.fontScale=Yt(p)}function te(a){const d=a>0?1:-1;X(w.value+d)}function Y(){const a=document.getElementById("timeline");if(!a)return;const d=Math.max(0,a.scrollWidth-a.clientWidth),p=Math.max(0,a.scrollHeight-a.clientHeight);I.value=a.scrollLeft<=hi&&a.scrollTop<=hi,W.value=a.scrollLeft>=d-hi&&a.scrollTop>=p-hi}async function Le(){window.timeline&&typeof window.timeline.goToStart=="function"&&window.timeline.goToStart(),Y(),await Je(),ni()}async function ze(){window.timeline&&typeof window.timeline.goToEnd=="function"&&window.timeline.goToEnd(),Y(),await Je(),el()}const Qe=V(()=>{const a=Vn.map(p=>p.id).filter(p=>Ze.value[p]),d=new Set;return a.forEach(p=>{Vn.find(F=>F.id===p)?.composers?.forEach(F=>d.add(F))}),d}),en=V(()=>{const a=Qe.value;return a.size?st.filter(d=>a.has(d.name)):[]}),_e=V(()=>[...en.value].sort((a,d)=>a.birth-d.birth).map(a=>({...a,displayName:Ui(a.name)}))),{descriptionsByLocale:_t,playlistIdsByKey:Ie,namesByLocale:nn}=Wa(Cd),he=ke(null),ot=ke(!1),Zt=ke("");let Un=null;const ji=V(()=>he.value!==null),we=V(()=>he.value===null?null:_e.value[he.value]),Qt=V(()=>we.value?Ui(we.value.name):""),Xs=V(()=>we.value?xa(we.value.name):null),Ys=V(()=>we.value?Ba(we.value.name):""),Zs=V(()=>we.value?Ka(we.value.name):""),Pa=V(()=>we.value?$a(we.value.name):[]),Fa=V(()=>Pa.value.map(a=>fl(a)).filter(Boolean)),$n=V(()=>{const a=Fa.value.filter(Boolean);return a.length?a:[jn]}),Vi=V(()=>(he.value??0)>0),Gi=V(()=>he.value!==null&&he.value<_e.value.length-1);function He(a){return a.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g," ").trim()}function Ra(a){return He(a).replace(/\s+/g,"-")}function Qs(a){const d=Ra(a);return`${ui}${encodeURIComponent(d)}`}function Ia(a){return a.startsWith(ui)?a.slice(ui.length):""}function Ha(a){const d=He(String(a||"").replace(/-/g," ")),p=st.find(y=>He(y.name)===d);return p?p.name:""}function Na(a){if(!a)return;const d=Vn.find(p=>p.composers.includes(a));!d||Ze.value[d.id]||(Ze.value={...Ze.value,[d.id]:!0})}async function er(a=window.location.pathname){ot.value=!0;try{ei(a);const d=Ia(a);if(!d){he.value=null;return}const p=decodeURIComponent(d),y=Ha(p);if(!y){he.value=null;return}Na(y),await Je();const F=_e.value.findIndex(J=>J.name===y);he.value=F>=0?F:null}finally{ot.value=!1}}function Da(a){if(!a||typeof window>"u")return"";const d=Qs(a);return new URL(d,window.location.origin).toString()}async function Oa(){if(!we.value)return;const a=Da(we.value.name);if(!a)return;const d=Qt.value||we.value.name;try{if(navigator.share){await navigator.share({title:d,url:a});return}}catch(p){if(p?.name!=="AbortError")console.warn("Share failed, falling back to clipboard",p);else return}try{if(navigator.clipboard&&navigator.clipboard.writeText)await navigator.clipboard.writeText(a);else{const p=document.createElement("textarea");p.value=a,p.setAttribute("readonly","true"),p.style.position="absolute",p.style.left="-9999px",document.body.appendChild(p),p.select(),document.execCommand("copy"),document.body.removeChild(p)}Zt.value=ne.value.copied||"Link copied",Un&&clearTimeout(Un),Un=setTimeout(()=>{Zt.value="",Un=null},2200)}catch(p){console.warn("Failed to copy share link",p)}}function Ui(a){const d=He(a);return ge.value[d]||a}function nr(a){return Z.value[a]||a}function Wa(a){const d=a.split(`
`),p={},y={},F={};let J=null,ae=null,Ae=null,Ge="en",Se=[];const hn=()=>{(J||ae)&&[J,ae].filter(Boolean).forEach(kn=>{p[kn]=p[kn]||{},p[kn][Ge]=Se.join(`
`).trim(),Ae&&(F[kn]=Ae)}),Se=[],Ae=null,ae=null};for(const Ue of d){const kn=Ue.match(/^##\s+(.+?)\s+essentials(?:\s*\((\w{2})\))?(?:\s*\{#([a-z0-9_-]+)\})?/i);if(kn){hn();const[,ve,tn,$e]=kn;J=He($e||ve),ae=He(ve),Ge=(tn||"en").toLowerCase(),Ae=$e||null;continue}const Et=J?Ue.match(/^name\s*(?:\((\w{2})\))?\s*:\s*(.+)$/i):null;if(Et){const[,ve,tn]=Et,$e=(ve||Ge||"en").toLowerCase(),Te=tn.trim();[J,ae].filter(Boolean).forEach(qi=>{y[qi]=y[qi]||{},y[qi][$e]=Te});continue}J&&Ue.startsWith("- ")&&Se.push(Ue.replace(/^- /,"").trim())}return hn(),{descriptionsByLocale:p,playlistIdsByKey:F,namesByLocale:y}}function Ba(a){const d=Va(a),p=He(a),y=$.value[p];if(y)return y;const F=d[r.value];return F||(d.en?d.en:Object.values(d)[0]||"")}function Ka(a){const d=q.value[He(a)];return d||Ua(a)}function ja(a,d){const p=He(d);if(a[p])return a[p];const y=p.split(" ").filter(Boolean),F=y[y.length-1];return F&&a[F]?a[F]:""}function Va(a){const d=He(a),p=d.split(" ").filter(Boolean),y=[d],F=p[p.length-1];F&&F!==d&&y.push(F);for(const J of y)if(_t[J])return _t[J];return{}}function Ga(a){return He(a).replace(/\s+/g,"-").replace(/-+/g,"-")}function Ua(a){const d=s[r.value]||s.en,p=r.value==="ru"?Ui(a):"";if(r.value==="ru"&&p)return`${p} - ${d}`;const y=String(a||"").trim().split(/\s+/).filter(Boolean);if(!y.length)return"";const F=y[y.length-1];return`${/^(?:[IVX]+|\d+|Jr\.?|Sr\.?)$/i.test(F)&&y.length>=2?y[y.length-2]:F} ${d}`}function $a(a){const d=[],p=Ga(a);p&&!d.includes(p)&&d.push(p);const y=ja(Ie,a);return y&&!d.includes(y)&&d.push(y),d}function ei(a=window.location.pathname){if(a.startsWith(ui)){oe.value="composers";return}oe.value=a==="/about"?"about":"composers"}const tr=()=>er();function ir(a){window.location.pathname!==a&&(history.pushState({},"",a),ei(a)),be.value=!1}function sr(a){ir(a==="about"?"/about":"/")}function Ja(){be.value=!be.value}function qa(){be.value=!1}async function Xa(){fn();const a=!Be.value;a&&(_.value={left:xe.value,top:Me.value,anchor:b.value}),Be.value=a,await Je(),fn()}async function Ya(){Be.value&&!_.value&&(fn(),_.value={left:xe.value,top:Me.value,anchor:b.value}),Be.value=!1,await Je(),fn()}function Za(){return new Promise(a=>{requestAnimationFrame(()=>requestAnimationFrame(a))})}async function rr(){if(await Je(),await Za(),fn(),!Be.value&&_.value){const a=_.value;b.value=a.anchor||b.value,xe.value=Tt(a.left),a.top!=null&&(Me.value=at(a.top)),_.value=null;return}fn()}async function Qa(){if(h.value=!h.value,h.value){Be.value=!1,await Je(),ni();return}await Je(),ni()}function or(){if(typeof document>"u")return 0;const a=document.querySelector(".topbar");return a&&a.offsetHeight?a.offsetHeight:0}function St(){if(typeof window>"u")return{width:0,height:0,offsetLeft:0,offsetTop:0};const a=window.visualViewport;return a?{width:a.width,height:a.height,offsetLeft:a.offsetLeft||0,offsetTop:a.offsetTop||0}:{width:window.innerWidth,height:window.innerHeight,offsetLeft:0,offsetTop:0}}function Tt(a){const d=ln.value;if(!d||typeof window>"u")return a;const{width:p,offsetLeft:y}=St(),F=y+pn,J=Math.max(F,y+p-d.offsetWidth-pn);return Math.min(Math.max(a,F),J)}function at(a){const d=ln.value;if(!d||typeof window>"u")return a;const{height:p,offsetTop:y}=St(),F=Math.max(or()+pn,y+pn),J=Math.max(F,y+p-d.offsetHeight-pn);return Math.min(Math.max(a,F),J)}function fn(){const a=ln.value;if(Me.value==null&&a&&typeof window<"u"){const{height:d,offsetTop:p}=St();Me.value=at(p+d-a.offsetHeight-24)}xe.value=Tt(xe.value),Me.value!=null&&(Me.value=at(Me.value))}function el(){fn(),b.value="top-right";const d=ln.value?.offsetWidth||0,{width:p,offsetLeft:y}=St();xe.value=Tt(y+p-d-pn),Me.value=at(or()+pn)}function ni(){fn(),b.value="bottom-left";const d=ln.value?.offsetHeight||0,{height:p,offsetTop:y}=St();xe.value=Tt(pn),Me.value=at(y+p-d-pn)}function ar(a){if(!v.active||a.pointerId!==v.pointerId)return;a.preventDefault();const d=a.clientX-v.startX,p=a.clientY-v.startY;xe.value=Tt(v.startLeft+d),Me.value!=null&&(Me.value=at(v.startTop+p))}function lr(){window.removeEventListener("pointermove",ar),window.removeEventListener("pointerup",ti),window.removeEventListener("pointercancel",ti)}function cr(a){const d=v.element;if(v.active=!1,v.element=null,v.pointerId=null,d?.releasePointerCapture&&a!=null)try{d.releasePointerCapture(a)}catch{}}function ti(a){!v.active||a.pointerId!==v.pointerId||(lr(),cr(a.pointerId))}function nl(){v.active&&(lr(),cr(v.pointerId))}function tl(a){const d=a.timeStamp||Date.now();d-u<=Yf&&a.preventDefault(),u=d}function il(a){if(v.active||a.pointerType==="mouse"&&a.button!==0)return;const d=a.target;if(d&&typeof d.closest=="function"&&d.closest("button, a, input, select, textarea, label, [role='button'], .filter-panel"))return;fn(),b.value="free",a.preventDefault(),v.active=!0,v.pointerId=a.pointerId,v.startX=a.clientX,v.startY=a.clientY,v.startLeft=xe.value,v.startTop=Me.value??0,v.element=ln.value;const y=ln.value;if(y?.setPointerCapture)try{y.setPointerCapture(a.pointerId)}catch{}window.addEventListener("pointermove",ar),window.addEventListener("pointerup",ti),window.addEventListener("pointercancel",ti)}function ur(a){!a||!a.touches||a.touches.length===2&&(x.active=!0,x.startDistance=M(a.touches[0],a.touches[1]))}function dr(a){if(!x.active||!a||!a.touches||a.touches.length!==2)return;a.preventDefault();const d=M(a.touches[0],a.touches[1]),p=x.startDistance||d,y=p?d/p:1;if(y>=Qf){te(1),x.startDistance=d;return}y<=Zf&&(te(-1),x.startDistance=d)}function ii(a){(a?.touches?.length??0)<2&&(x.active=!1,x.startDistance=0)}function Jn(){fn()}function Ct(a,{persist:d=!1}={}){const p=t.includes(a)?a:ut;if(r.value=p,d)try{localStorage.setItem(fo,p),localStorage.setItem(ho,"1")}catch{}}function sl(a){i.value=!0,Ct(a,{persist:!0})}function rl(a){const d=a?.target?.value;d&&sl(d)}function ol(){try{return localStorage.getItem(fo)}catch{return null}}function al(){try{return localStorage.getItem(ho)==="1"}catch{return!1}}function ll(){const a=ol(),d=al();if(Ct(ut),a&&d&&t.includes(a)){i.value=!0,Ct(a);return}cl()}async function cl(){const a=!i.value;a||(r.value,void 0);const d=[ul,dl];for(const p of d){const y=await p();if(y){const F=String(y).toUpperCase();if(!a)return;const J=F==="RU"?"ru":["DE","AT","CH"].includes(F)?"de":ut;Ct(J);return}}a&&Ct(ut)}async function ul(){try{const a=await fetch("https://ipapi.co/json/");return a.ok&&(await a.json())?.country_code||null}catch(a){console.warn("ipapi lookup failed:",a)}return null}async function dl(){try{const a=await fetch("https://ipwho.is/");return a.ok&&(await a.json())?.country_code||null}catch(a){console.warn("ipwho.is lookup failed:",a)}return null}function th(a,d){}function fr(){ir("/"),window.timeline&&typeof window.timeline.goToStart=="function"&&window.timeline.goToStart()}function $i(a){const d=a.detail,p=d?.laneIndex;if(Number.isInteger(p)&&_e.value[p]){he.value=p;return}const y=d?.composer?.name;if(!y)return;const F=_e.value.findIndex(J=>J.name===y);F>=0&&(he.value=F)}function hr(){he.value=null}function mr(){!Vi.value||he.value===null||(he.value-=1)}function pr(){!Gi.value||he.value===null||(he.value+=1)}Di(async()=>{ll(),await er(),await Je(),ni(),window.timeline&&typeof window.timeline.onBarClick=="function"&&window.timeline.onBarClick($i),window.addEventListener("popstate",tr),window.addEventListener("composer-select",$i),window.addEventListener("resize",Jn),window.visualViewport&&(window.visualViewport.addEventListener("resize",Jn),window.visualViewport.addEventListener("scroll",Jn)),Jn();const a=document.getElementById("timeline");a&&(a.addEventListener("scroll",Y,{passive:!0}),a.addEventListener("touchstart",ur,{passive:!0}),a.addEventListener("touchmove",dr,{passive:!1}),a.addEventListener("touchend",ii,{passive:!0}),a.addEventListener("touchcancel",ii,{passive:!0}),Y())}),Oi(()=>{window.removeEventListener("popstate",tr),window.removeEventListener("composer-select",$i),window.removeEventListener("resize",Jn),window.visualViewport&&(window.visualViewport.removeEventListener("resize",Jn),window.visualViewport.removeEventListener("scroll",Jn)),nl(),Un&&(clearTimeout(Un),Un=null);const a=document.getElementById("timeline");a&&(a.removeEventListener("scroll",Y),a.removeEventListener("touchstart",ur),a.removeEventListener("touchmove",dr),a.removeEventListener("touchend",ii),a.removeEventListener("touchcancel",ii))}),Xe(f,a=>{a&&(document.title=a)},{immediate:!0}),Xe(r,a=>{const d=t.includes(a)?a:ut;if(d!==a){r.value=d;return}try{document.documentElement.setAttribute("data-lang",d)}catch{}window.timeline&&typeof window.timeline.updateEraLabels=="function"&&window.timeline.updateEraLabels(re.value)}),Xe(ji,async a=>{a?(document.documentElement.style.overscrollBehavior="none",document.body.style.overscrollBehavior="none",document.body.style.overflow="hidden",document.body.style.touchAction="none",await Je(),$n.value.length&&br()):(document.documentElement.style.overscrollBehavior="",document.body.style.overscrollBehavior="",document.body.style.overflow="",document.body.style.touchAction="",gr())}),Xe(he,a=>{const d=window.timeline;!d||typeof d.setSelectedLane!="function"||(Number.isInteger(a)?d.setSelectedLane(a):d.setSelectedLane(null))}),Xe(he,a=>{if(ot.value)return;if(Number.isInteger(a)&&_e.value[a]){const p=_e.value[a].name,y=Qs(p);window.location.pathname!==y&&(history.pushState({},"",y),ei(y));return}const d=oe.value==="about"?"/about":"/";window.location.pathname!==d&&(history.replaceState({},"",d),ei(d))}),Xe($n,async a=>{ji.value&&(gr(),await Je(),a.length&&br())}),Xe(()=>_e.value.map(a=>a.name),a=>{if(he.value===null)return;const d=we.value;if(!d){he.value=null;return}const p=a.findIndex(y=>y===d.name);p===-1?he.value=null:he.value=p});function Ji(a){return a?j?j.endsWith("/")&&a.startsWith("/")?j+a.slice(1):!j.endsWith("/")&&!a.startsWith("/")?`${j}/${a}`:j+a:a:j}function fl(a){if(!a)return"";const d=wn;if(!d)return"";const p=d.endsWith("/");return`${d}${p?"":"/"}${a}`}function gr(){an.forEach(a=>{try{a.pause(),a.currentTime=0}catch(d){console.error("Failed to stop SoundCloud audio",d)}}),an.clear()}function br(a,d=document){const y=(d||document).querySelectorAll("[data-soundcloud-playlist]");y.length&&(y.length,y.forEach(F=>{hl(F,()=>{})}))}async function hl(a,d){const p=()=>{typeof d=="function"&&setTimeout(()=>d(),0)};if(!a||a.dataset.soundcloudReady==="true"||a.dataset.soundcloudReady==="loading"||a.dataset.soundcloudReady==="error"){p();return}const y=a.getAttribute("data-soundcloud-playlist"),F=a.getAttribute("data-soundcloud-playlist-alt")||"",J=[y,...F.split("|")].map(Ge=>(Ge||"").trim()).filter(Boolean);if(!J.length){p();return}a.dataset.soundcloudReady="loading",a.innerHTML=ml();let ae=null;for(const Ge of J)try{const Se=await gl(Ge),hn=Array.isArray(Se.tracks)&&Se.tracks.length?Se.tracks:Se&&Se.kind==="track"?[Se]:[],Ue=bl(hn);wl(a,Ue,Ge),p();return}catch(Se){if(ae=Se,Se&&Se.status===429){vr(a,Ge),p();return}}console.error("Failed to build SoundCloud player",ae);const Ae=J[0]||jn;vr(a,Ae),p()}function ml(){return`
  ...
  `.trim()}async function pl(a){if(!a)throw new Error("No track provided");const d=a.media&&Array.isArray(a.media.transcodings)?a.media.transcodings:[];if(d.length){let p=d.find(y=>y&&y.format&&y.format.protocol==="progressive");if(p||(p=d[0]),p&&p.url)try{const y=await vl(p.url,a.track_authorization);return console.debug("[SC] Using transcoding URL",{trackId:a.id,transcodingUrl:p.url,finalUrl:y}),y}catch(y){console.error("[SC] Transcoding proxy failed, falling back to streams endpoint",y)}}if(!a.id)throw new Error("No track id provided");return yl(a.id,a.track_authorization)}async function gl(a){const d=Ji("/api/soundcloud/playlist")+`?url=${encodeURIComponent(a)}`,p=await fetch(d);if(!p.ok){const y=new Error(`SoundCloud playlist error: ${p.status}`);throw y.status=p.status,y.retryAfter=Number(p.headers?.get("Retry-After"))||void 0,y}return p.json()}function bl(a=[]){return Array.isArray(a)?a.map((d,p)=>{if(!d)return null;const y=`Track ${p+1}`,J=[d.title,d.publisher_metadata?.release_title,d.permalink,d.permalink_url,d.id?String(d.id):null].map(ae=>typeof ae=="string"?ae.trim():"").filter(Boolean)[0]||y;return{...d,title:J}}).filter(Boolean):[]}async function vl(a,d){const p=new URLSearchParams;p.set("url",a),d&&p.set("track_authorization",d),l.value&&p.set("proxy","1");const y=Ji("/api/soundcloud/transcoding")+`?${p.toString()}`,F=await fetch(y);if(!F.ok){const ae=new Error(`SoundCloud transcoding error: ${F.status}`);throw ae.status=F.status,ae.retryAfter=Number(F.headers?.get("Retry-After"))||void 0,ae}const J=await F.json();if(!J?.url)throw new Error("Transcoding response missing url");return J.url}async function yl(a,d){const p=new URLSearchParams;d&&p.set("track_authorization",d),l.value&&p.set("proxy","1");const y=p.toString(),F=Ji(`/api/soundcloud/streams/${a}`)+(y?`?${y}`:""),J=await fetch(F);if(!J.ok){const Ae=new Error(`SoundCloud stream error: ${J.status}`);throw Ae.status=J.status,Ae.retryAfter=Number(J.headers?.get("Retry-After"))||void 0,Ae}const ae=await J.json();if(!ae?.url)throw new Error("Stream response missing url");return ae.url}function vr(a,d){const p=`https://w.soundcloud.com/player/?url=${encodeURIComponent(d)}&auto_play=false&show_user=false&hide_related=true&show_comments=false&show_reposts=false&show_teaser=false&show_playcount=false&sharing=false&show_artwork=false&buying=false&liking=false&download=false&visual=false`;a.innerHTML=`
    <iframe
      ...
      src="${p}"
    ></iframe>
  `,a.dataset.soundcloudReady="true"}function wl(a,d,p){if(!Array.isArray(d)||!d.length){a.innerHTML='<div class="sc-player__status sc-player__status--error">No tracks found for this playlist.</div>',a.dataset.soundcloudReady="error";return}a.classList.add("sc-player");const y=document.createElement("div");y.className="sc-track-list";const F=document.createElement("audio");F.preload="none",an.add(F);let J=null,ae=null,Ae=null,Ge=!1;const Se=[],hn=(ve,tn)=>{ve.dataset.state=tn,ve.textContent=tn==="playing"?"⏸":tn==="loading"?"...":"▶"},Ue=ve=>hn(ve,"idle"),kn=()=>{ae&&Ue(ae),J=null,ae=null,Ae=null};F.addEventListener("ended",()=>{const ve=Ae===null?-1:Ae+1;if(ve>=0&&ve<d.length){Et(ve,{auto:!0});return}kn()}),F.addEventListener("pause",()=>{ae&&F.currentTime<(F.duration||1/0)&&Ue(ae)});const Et=async(ve,{auto:tn=!1}={})=>{if(Ge)return;const $e=d[ve],Te=Se[ve];if(!(!$e||!Te)){if(!tn&&Ae===ve&&!F.paused){F.pause(),Ue(Te);return}Ge=!0,hn(Te,"loading");try{const _n=await pl($e);if(!_n)throw new Error("No stream URL returned");F.src=_n,await F.play(),kl($e),ae&&ae!==Te&&Ue(ae),ae=Te,J=$e?.id??ve,Ae=ve,hn(Te,"playing")}catch(_n){console.error("Failed to play SoundCloud track",_n),Ue(Te),a.dataset.soundcloudReady="error"}finally{Ge=!1}}};d.forEach((ve,tn)=>{const $e=document.createElement("div");$e.className="sc-track";const Te=document.createElement("button");Te.type="button",Te.className="sc-track__button",Te.setAttribute("aria-label","Play track"),hn(Te,"idle"),Se.push(Te);const _n=document.createElement("div");_n.className="sc-track__title",_n.textContent=ve?.title||`Track ${tn+1}`,$e.append(Te,_n),y.append($e),Te.addEventListener("click",()=>{Et(tn)})}),a.innerHTML="",a.append(y,F),a.dataset.soundcloudReady="true"}function kl(a){if(!("mediaSession"in navigator)||typeof MediaMetadata>"u")return;const d=a?.title||"Classical Music",p=a?.publisher_metadata?.artist||a?.user?.username||a?.user?.full_name||"",y=a?.publisher_metadata?.album_title||"";navigator.mediaSession.metadata=new MediaMetadata({title:d,artist:p,album:y,artwork:[{src:"/images/about_music_logo.png",type:"image/png"}]})}return(a,d)=>(le(),de("div",Ed,[E("header",xd,[E("button",{class:"menu-button",onClick:Ja,"aria-label":"Toggle navigation menu"},[...d[6]||(d[6]=[E("span",{class:"menu-icon"},null,-1)])]),E("img",{class:"logo",src:Qu,alt:"Logo",onClick:fr}),E("div",{class:"app-title",role:"button",onClick:fr},ee(f.value),1),E("div",Md,[E("label",Ld,ee(g.value),1),ns(E("select",{id:"language-select",class:"language-select","onUpdate:modelValue":d[0]||(d[0]=p=>r.value=p),"aria-label":g.value,onChange:rl},[(le(!0),de(Ve,null,li(m.value,p=>(le(),de("option",{key:p.value,value:p.value},ee(p.label),9,Ad))),128))],40,zd),[[Vu,r.value]])])]),E("aside",{class:mt(["side-menu",{"side-menu--open":be.value}])},[E("nav",Pd,[E("button",{class:mt(["menu-item",{"menu-item--active":oe.value==="composers"}]),onClick:d[1]||(d[1]=p=>sr("composers"))},ee(T.value.composers),3),E("button",{class:mt(["menu-item",{"menu-item--active":oe.value==="about"}]),onClick:d[2]||(d[2]=p=>sr("about"))},ee(T.value.about),3)])],2),be.value?(le(),de("div",{key:0,class:"backdrop",onClick:qa})):Ke("",!0),E("main",Fd,[oe.value==="composers"?(le(),de("section",Rd,[E("div",{class:"filter-dock",style:Fi(k.value),ref_key:"filterDockRef",ref:ln,onPointerdown:il,onTouchend:tl},[E("div",Id,[E("div",Hd,[E("button",{type:"button",class:"filter-dock__collapse control-btn","aria-pressed":h.value,"aria-label":h.value?Gn.value.restore:Gn.value.minimize,onClick:Qa},[E("span",Dd,ee(h.value?"↑":"↓"),1)],8,Nd)]),!Be.value&&!h.value?(le(),de("div",Od,[E("button",{type:"button",class:"control-btn",disabled:I.value,onClick:Le,"aria-label":"Jump to start of timeline"}," ⇤ ",8,Wd),E("button",{type:"button",class:"control-btn",disabled:W.value,onClick:ze,"aria-label":"Jump to end of timeline"}," ⇥ ",8,Bd)])):Ke("",!0),!Be.value&&!h.value?(le(),de("div",Kd,[E("button",{type:"button",class:"control-btn",disabled:H.value,onClick:d[3]||(d[3]=p=>te(-1)),"aria-label":"Make timeline blocks smaller"}," − ",8,jd),E("button",{type:"button",class:"control-btn",disabled:z.value,onClick:d[4]||(d[4]=p=>te(1)),"aria-label":"Make timeline blocks larger"}," + ",8,Vd)])):Ke("",!0),h.value?Ke("",!0):(le(),de("button",{key:2,class:"filter-dock__toggle control-btn control-primary","aria-expanded":Be.value,"aria-controls":"filter-panel",onClick:Xa,"aria-label":"Filter composers"},[...d[7]||(d[7]=[E("svg",{class:"filter-icon",viewBox:"0 0 24 24","aria-hidden":"true",focusable:"false"},[E("path",{d:"M3 5h18l-7 8v5l-4 2v-7L3 5z"})],-1)])],8,Gd)),Fe(Dr,{name:"filter-fade",onAfterEnter:rr,onAfterLeave:rr},{default:ys(()=>[Be.value?(le(),de("div",Ud,[E("div",$d,[(le(),de(Ve,null,li(Vn,p=>E("label",{key:p.id,class:"filter-panel__item"},[ns(E("input",{"onUpdate:modelValue":y=>Ze.value[p.id]=y,type:"checkbox",class:"filter-panel__checkbox","aria-label":`Toggle ${nr(p.id)}`},null,8,Jd),[[eo,Ze.value[p.id]]]),E("span",qd,ee(nr(p.id)),1)])),64))]),E("div",Xd,[E("button",{type:"button",class:"filter-panel__ok control-btn",onClick:Ya,"aria-label":"Close filters"},ee(O.value),1)])])):Ke("",!0)]),_:1})])],36),Fe(Td,{composers:_e.value,settings:C,"era-labels":re.value},null,8,["composers","settings","era-labels"])])):oe.value==="about"?(le(),de("section",Yd,[E("div",Zd,[d[11]||(d[11]=E("img",{class:"about__logo",src:ed,alt:"Music logo",loading:"lazy"},null,-1)),E("h1",Qd,ee(S.value.title),1),E("p",ef,ee(S.value.intro),1),E("p",nf,ee(S.value.goal),1),E("div",tf,[d[10]||(d[10]=E("img",{class:"about__photo",src:nd,alt:"Dmitrii Kotikov",loading:"lazy"},null,-1)),E("div",sf,[E("div",rf,ee(S.value.authorLabel),1),E("div",of,ee(S.value.authorName),1),d[8]||(d[8]=E("a",{class:"about__link",href:"https://www.linkedin.com/in/dmitrykotikov/",target:"_blank",rel:"noreferrer"}," LinkedIn ",-1)),d[9]||(d[9]=E("a",{class:"about__link",href:"https://thequot.es/",target:"_blank",rel:"noreferrer"}," thequot.es ",-1))])]),E("div",af,[E("div",lf,ee(S.value.contributorsTitle),1),E("ul",cf,[(le(!0),de(Ve,null,li(A.value,p=>(le(),de("li",{key:p.url,class:"about__contributors-item"},[E("span",uf,ee(p.name),1),E("a",{class:"about__contributors-link",href:p.url,target:"_blank",rel:"noreferrer"},ee(p.linkText),9,df),p.url==="https://facebook.com/olga.shibanova"?(le(),de("div",ff,[E("label",hf,[ns(E("input",{"onUpdate:modelValue":d[5]||(d[5]=y=>o.value=y),class:"about__contributors-toggle-input",type:"checkbox","aria-label":"Toggle test features"},null,512),[[eo,o.value]]),E("span",null,ee(D.value),1)])])):Ke("",!0)]))),128))])])])])):Ke("",!0)]),Fe(Dr,{name:"fade"},{default:ys(()=>[ji.value?(le(),de("div",{key:0,class:"composer-modal",onClick:$u(hr,["self"])},[E("div",mf,[E("header",pf,[E("div",gf,[E("h2",bf,ee(Qt.value),1),we.value?(le(),de("p",vf,ee(we.value.birth)+" — "+ee(we.value.death),1)):Ke("",!0)]),E("div",yf,[E("button",{class:"composer-modal__share",type:"button",onClick:Oa,"aria-label":ne.value.button},[...d[12]||(d[12]=[E("img",{class:"composer-modal__share-icon",src:td,alt:""},null,-1)])],8,wf),Zt.value?(le(),de("span",kf,ee(Zt.value),1)):Ke("",!0),E("div",_f,[E("button",{class:"composer-modal__arrow",onClick:mr,disabled:!Vi.value,"aria-label":"Previous"}," ← ",8,Sf),E("span",Tf,ee((he.value??0)+1)+" / "+ee(_e.value.length),1),E("button",{class:"composer-modal__arrow",onClick:pr,disabled:!Gi.value,"aria-label":"Next"}," → ",8,Cf)]),E("button",{class:"composer-modal__close",onClick:hr,"aria-label":"Close composer details"},"×")])]),E("div",Ef,[Xs.value?(le(),de("div",xf,[E("img",{class:"composer-modal__photo",src:Xs.value,alt:Qt.value},null,8,Mf),E("div",Lf,[E("button",{class:"composer-modal__arrow",onClick:mr,disabled:!Vi.value,"aria-label":"Previous"}," ← ",8,zf),E("span",Af,ee((he.value??0)+1)+" / "+ee(_e.value.length),1),E("button",{class:"composer-modal__arrow",onClick:pr,disabled:!Gi.value,"aria-label":"Next"}," → ",8,Pf)]),E("div",Ff,[E("div",Rf,ee(Qt.value),1),we.value?(le(),de("div",If,ee(we.value.birth)+" — "+ee(we.value.death),1)):Ke("",!0)])])):Ke("",!0),E("div",Hf,[E("div",Nf,[E("div",Df,ee(L.value.keyWorks),1),$n.value.length?(le(),de("a",Of,[...d[13]||(d[13]=[E("img",{class:"sc-powered__img",src:id,alt:"Powered by SoundCloud"},null,-1)])])):Ke("",!0)]),$n.value.length?(le(),de("div",{key:$n.value[0],class:"composer-modal__playlist-box sc-player","data-soundcloud-playlist":$n.value[0],"data-soundcloud-playlist-alt":$n.value.slice(1).join("|")},[E("div",Bf,[d[14]||(d[14]=E("span",{class:"sc-player__spinner","aria-hidden":"true"},null,-1)),E("span",Kf,ee(P.value),1)])],8,Wf)):(le(),de("div",jf," Playlist will appear here soon. "))]),E("div",Vf,[Zs.value?(le(),de("div",Gf,ee(Zs.value),1)):Ke("",!0),Ys.value?(le(),de("ul",Uf,[(le(!0),de(Ve,null,li(Ys.value.split(`
`),(p,y)=>(le(),de("li",{key:y},[E("span",$f,ee(p),1)]))),128))])):(le(),de("p",Jf,"No description yet."))])])])])):Ke("",!0)]),_:1})]))}},nh=Aa(eh,[["__scopeId","data-v-d38f5ae4"]]);Xu(nh).mount("#app");
